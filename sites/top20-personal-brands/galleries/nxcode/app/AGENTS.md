...
This is a generated ditto.site clone app for https://www.nxcode.io/resources/news/ai-website-examples-2026. It is a static Next.js App Router project produced from captured DOM, CSS, assets, metadata, and interaction recipes.
...
`src/app/ditto` contains generated runtime utilities for captured interactions and motion. Current runtime utilities: DittoMotion, DropdownMenu. Do not casually rewrite these files; they are plumbing that maps captured recipes to stable `data-ditto-id` anchors in delivered apps.
...
- / - AI Website Examples 2026: 30+ Stunning Sites Built with AI | NxCode
