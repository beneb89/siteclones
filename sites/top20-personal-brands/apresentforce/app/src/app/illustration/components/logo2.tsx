      ...
      <div className="contents min-w-0">
        <div className="w-[394.7px] h-full block relative grow shrink-0 basis-0 overflow-hidden max-md:w-[20.4375rem] md:max-lg:w-180 2xl:w-152">
          <div className="h-full block absolute top-0 inset-x-0">
            <img className={cn("w-full h-[27.0625rem] block overflow-clip max-md:h-[22.4375rem] md:max-lg:h-197.5 2xl:h-[41.6875rem]", styles.className2)} data-component="image" alt="" height={d.height} sizes="max(max((100vw - 96px) / 3, 200px), 1px)" src={d.imgSrc} srcSet={d.srcSet} width={d.width} />
          </div>
        </div>
      </div>
    </div>
