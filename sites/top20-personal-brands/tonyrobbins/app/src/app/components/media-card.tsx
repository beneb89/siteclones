  ...
  return (
    <div className="w-75 block relative max-w-75 mr-2.5 shrink-0">
      <figure className="block">
        <a className={cn("flex relative rounded-2xl items-end overflow-hidden aspect-[2/3] bg-surface-2 cursor-pointer", styles.className)} data-component={d.kind} href={d.href}>
