...
export default function MediaCard2({ d, styles }: { d: MediaCard2Data; styles: MediaCard2Styles }) {
  return (
    <li className="block">
      <div className="block relative rounded-xl shrink-0 bg-color-004 h-14 w-14">
        <div className="w-14 h-full flex absolute top-0 left-0 justify-center items-center">
          <img className={cn("block max-w-full overflow-clip align-middle text-clr-0 h-6 w-6", styles.className)} data-component="image" alt="" height={d.height} src={d.imgSrc} srcSet={d.srcSet} width={d.width} />
        </div>
      </div>
      <div className="block">
        ...
        <div className="block text-balance">
          <div className="block text-clr-9 leading-7">
            <div className="inline-flex mb-4 items-center gap-2">
              <span className={cn("block rounded-full bg-foreground h-2", styles.className2)} />
