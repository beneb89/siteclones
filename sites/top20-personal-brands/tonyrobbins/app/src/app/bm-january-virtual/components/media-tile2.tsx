  ...
  return (
    <div className={cn("block", styles.className)}>
      <div className={cn("flex relative mr-4 p-6 rounded-2xl items-end overflow-hidden bg-border", styles.className2)}>
        <img className={cn("w-full block absolute top-0 left-0 min-w-0 max-w-full overflow-clip object-cover align-middle text-clr-0 h-full", styles.className3)} data-component={d.kind} alt={d.alt} height={d.height} src={d.imgSrc} srcSet={d.srcSet} width={d.width} style={d.style} />
