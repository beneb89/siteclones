...
export default function MediaCard3({ d, styles }: { d: MediaCard3Data; styles: MediaCard3Styles }) {
  return (
    <li className="flex relative p-8 rounded-2xl items-end overflow-hidden aspect-[4/3] text-balance bg-color-001 max-md:p-5 max-lg:aspect-square">
      <img className="w-full block absolute top-0 left-0 min-w-0 max-w-full overflow-clip object-cover aspect-[auto_750/600] align-middle text-clr-0 h-full" data-component="image" alt={d.alt} height="600" sizes="(min-width: 1024px) 50vw, 100vw" src={d.imgSrc} width="750" />
