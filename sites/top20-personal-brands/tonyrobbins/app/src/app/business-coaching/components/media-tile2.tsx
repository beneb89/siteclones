  ...
  return (
    <div className={cn("block", styles.className)}>
      <div className={cn("flex relative mr-4 p-6 rounded-2xl items-end overflow-hidden bg-border", styles.className2)}>
        <img className={cn("w-full block absolute top-0 left-0 min-w-0 max-w-full overflow-clip object-cover align-middle text-clr-0 h-full", styles.className3)} data-component={d.kind} alt={d.alt} height={d.height} src={d.imgSrc} srcSet={d.srcSet} width={d.width} />
        ...
        <p className="block relative z-10 text-background">
          ...
          <span className="block text-2xl leading-7.5 tracking-[-1.2px] whitespace-nowrap max-md:hidden md:max-lg:text-[1.4375rem] md:max-lg:leading-[1.8125rem] md:max-lg:tracking-[-1.15px]">
            {d.description2}
          </span>
        </p>
      </div>
