import type { FeatureCard11Styles } from "../_styles";
import { cn } from "../../lib/utils";
export type FeatureCard11Data = {
  href: string;
  title: string;
};
/** A feature card. */
export default function FeatureCard11({ d, styles }: { d: FeatureCard11Data; styles: FeatureCard11Styles }) {
  return (
