import type { FeatureCard9Styles } from "../_styles";
import { cn } from "../../lib/utils";
export type FeatureCard9Data = {
  href: string;
  title: string;
};
/** A feature card. */
export default function FeatureCard9({ d, styles }: { d: FeatureCard9Data; styles: FeatureCard9Styles }) {
  return (
