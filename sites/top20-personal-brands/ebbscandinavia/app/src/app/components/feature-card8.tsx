import type { FeatureCard8Styles } from "../_styles";
import { cn } from "../../lib/utils";
export type FeatureCard8Data = {
  title: string;
};
/** A feature card. */
export default function FeatureCard8({ d, styles }: { d: FeatureCard8Data; styles: FeatureCard8Styles }) {
  return (
