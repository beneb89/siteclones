...
export default function MediaLink({ d, styles }: { d: MediaLinkData; styles: MediaLinkStyles }) {
  return (
    <a className="hidden 2xl:w-full 2xl:flex 2xl:relative 2xl:pb-4 2xl:justify-start 2xl:items-start 2xl:content-start 2xl:shrink-0 2xl:gap-2.5 2xl:text-primary 2xl:cursor-pointer after:content-[''] after:block after:absolute after:inset-0 after:w-460 after:h-33 max-lg:after:hidden" href="/work/alchemain">
      ...
      <div className="hidden 2xl:w-428.5 2xl:flex 2xl:relative 2xl:flex-col 2xl:justify-start 2xl:items-center 2xl:content-center 2xl:grow 2xl:shrink-0 2xl:basis-0 2xl:gap-1">
        <div className="hidden 2xl:w-full 2xl:flex 2xl:relative 2xl:justify-center 2xl:items-center 2xl:content-center 2xl:shrink-0">
          <div className="hidden 2xl:w-428.5 2xl:flex 2xl:relative 2xl:flex-col 2xl:justify-start 2xl:grow 2xl:shrink-0 2xl:basis-0 2xl:whitespace-pre-wrap 2xl:[word-break:break-word] 2xl:[overflow-wrap:break-word]">
        ...
        <div className="hidden 2xl:w-428.5 2xl:flex 2xl:relative 2xl:flex-col 2xl:justify-start 2xl:shrink-0 2xl:whitespace-pre-wrap 2xl:[word-break:break-word] 2xl:[overflow-wrap:break-word]">
