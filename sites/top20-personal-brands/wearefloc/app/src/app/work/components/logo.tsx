...
export default function Logo({ d, styles }: { d: LogoData; styles: LogoStyles }) {
  return (
    <a className={cn("w-8 relative shrink-0 overflow-hidden text-primary transform-[none] max-lg:transform-[matrix(0.9,0,0,0.9,0,0)] max-lg:origin-[16px_16px]", styles.className)} data-component="link" href={d.href} rel="noopener" target="_blank">
