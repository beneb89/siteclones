...
export default function MediaTile3({ d, styles }: { d: MediaTile3Data; styles: MediaTile3Styles }) {
  return (
    <div className={cn("contents min-w-0 2xl:w-[306.7px] 2xl:block 2xl:relative 2xl:grow 2xl:shrink-0 2xl:basis-0", styles.className)}>
      <a className={cn("hidden 2xl:w-[306.7px] 2xl:flex 2xl:relative 2xl:flex-col 2xl:justify-start 2xl:items-start 2xl:content-start 2xl:gap-3 2xl:overflow-clip 2xl:cursor-pointer", styles.className2)}>
        <div className="hidden 2xl:w-full 2xl:block 2xl:relative 2xl:rounded-2xl 2xl:shrink-0 2xl:overflow-clip 2xl:aspect-[1.00131/1] 2xl:bg-surface">
          <div className="hidden 2xl:w-[306.7px] 2xl:h-full 2xl:block 2xl:absolute 2xl:top-0 2xl:shrink-0">
            <div className="hidden 2xl:w-[306.7px] 2xl:h-full 2xl:block 2xl:absolute 2xl:top-0">
              <img className={cn("hidden 2xl:w-full 2xl:h-76.5 2xl:block 2xl:overflow-clip 2xl:object-cover", styles.className3)} alt="" height={d.height} sizes="max(((100vw - 32px) / 2 - 24px) / 3, 1px)" src={d.imgSrc} srcSet={d.srcSet} width={d.width} />
            </div>
          </div>
        </div>
      ...
      <div className={cn("w-50 block relative grow shrink-0 basis-0 max-md:w-[111.7px] md:max-lg:w-[242.7px] 2xl:hidden", styles.className4)}>
        <a className={cn("flex relative flex-col justify-start items-start content-start gap-3 overflow-clip cursor-pointer 2xl:hidden", styles.className5)}>
          <div className="w-full block relative rounded-2xl shrink-0 overflow-clip aspect-[1.00131/1] bg-surface 2xl:hidden">
            <div className="h-full block absolute top-0 inset-x-0 shrink-0 2xl:hidden">
              <div className="h-full block absolute top-0 inset-x-0 2xl:hidden">
                <img className={cn("w-full h-50 block overflow-clip object-cover max-md:h-28 md:max-lg:h-60.5 2xl:hidden", styles.className6)} data-component="image" alt="" height={d.height2} sizes="max(((100vw - 32px) / 2 - 24px) / 3, 1px)" src={d.imgSrc2} srcSet={d.srcSet2} width={d.width2} />
              </div>
            </div>
          </div>
