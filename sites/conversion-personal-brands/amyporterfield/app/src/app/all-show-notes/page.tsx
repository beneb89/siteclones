...
const MediaTile_data = [
    { href: "https://www.amyporterfield.com/show-notes/episode-74-jam-gamble-how-to-stop-replaying-what-you-said/", imgSrc: "/assets/cloned/images/f4b21d4005f6.jpeg", text: "August 25, 2026", href2: "https://www.amyporterfield.com/show-notes/episode-74-jam-gamble-how-to-stop-replaying-what-you-said/", label: "Episode 74: Jam Gamble: How to Stop Replaying What You Said" },
...
const MediaTile_meta: string[][] = [
    ["n54", "n55", "style-heading-7", "n57", "style-br-13", "n59", "n60", "style-p-15", "style-link"],
    ["style-link-2", "style-link-3", "style-heading-22", "n66", "style-p-9", "style-ul-2", "n69", "style-li", "style-p-27"],
    ["style-heading-20", "style-p-16", "style-br-26", "style-br-19", "style-br-14", "style-br-29", "style-heading-16", "n79", "style-p-17"],
    ["n81", "n82", "n83", "n84", "style-link-4", "style-strong-2", "n87", "style-p-30", "style-br-2"],
    ["n90", "n91", "style-br-6", "n93", "style-br-15", "n95", "style-br-21", "n97", "style-br-16"],
    ["style-br-7", "n100", "style-br-24", "n102", "style-br-17", "n104", "style-br-8", "style-br-25", "style-heading-5"]
];
const Logo_meta: string[][] = [
    ["n126", "style-p-21"],
    ["style-heading-8", "style-p-37"],
    ["style-link-5", "style-heading-17"],
    ["style-p", "n133"],
...
const Logo2_meta: string[][] = [
    ["style-b", "style-br-22", "style-br-18"],
    ["style-br-23", "n236", "style-b-2"],
    ["style-link-16", "style-nav-11", "style-div-26"],
    ["style-nav-18", "n242", "style-nav-13"]
];
    ...
    <>
      ...
      <div className="box-content block relative min-w-80 overflow-hidden" id="si-sp">
        ...
        <div className="box-content h-77 block relative pointer-events-none max-md:h-[9.9625rem] md:max-lg:h-[197.1px]" data-ditto-id="style-hero-1" id="hero">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-background pointer-events-none">
            <div className="box-content h-full block absolute top-0 inset-x-0 max-w-full overflow-hidden bg-cover [background-position:50%_50%] bg-no-repeat pointer-events-none" data-ditto-id="style-div-47" />
            <div className="box-content w-300 h-77 block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-md:h-34 max-lg:mx-0 md:max-lg:w-192 md:max-lg:h-[197.1px] 2xl:mx-90">
              <div className="w-91.5 h-[1.6875rem] block absolute top-25.5 left-104.5 transform-[none] max-md:w-[15.9375rem] max-md:h-[1.1875rem] max-md:top-[2.8125rem] max-md:left-[2.0625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5859,9.36719)] max-md:origin-[127.5px_9.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216.36,-41.58)] md:max-lg:origin-[183px_13.5px]" data-ditto-id="style-div-50">
                <p className="box-content h-full block absolute top-0 inset-x-0 text-accent [font-family:'Public_Sans'] text-lg font-medium leading-[1.8125rem] tracking-[0.9px] text-center uppercase max-md:text-[0.8125rem] max-md:leading-[1.125rem] max-md:tracking-[0.65px]">
                  the amy porterfield show
                </p>
              </div>
              <div className="w-[52.0625rem] h-[6.8125rem] block absolute top-[9.0625rem] left-46 transform-[none] max-md:w-69 max-md:h-11.5 max-md:top-[4.3125rem] max-md:left-5.5 max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,15.8125)] max-md:origin-[138px_23px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216.18,-71.82)] md:max-lg:origin-[416.5px_54.5px]">
                <h1 className="box-content h-full block absolute top-0 inset-x-0 text-accent [font-family:'Ivy_Presto_Display_Light'] text-[6.875rem] leading-[7.5625rem] text-center max-md:[font-family:'Editors_Note_Regular'] max-md:text-[2.5rem] max-md:leading-11 max-md:uppercase" data-ditto-id="style-div-51" data-component="heading">
                  SHOW NOTES
        ...
        <div className="box-content h-[95.5625rem] block relative pointer-events-none max-md:h-[227.05rem] md:max-lg:h-[978.5px]" id="page-content">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-background pointer-events-none">
            ...
            <div className="box-content w-300 h-176.5 block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-md:h-78.5 max-lg:mx-0 md:max-lg:w-192 2xl:mx-90">
              <div className="box-content block pointer-events-none">
                <div className="h-[90.1rem] block absolute top-8 inset-x-[3.0625rem] transform-[none] max-md:h-[191.8875rem] max-md:top-0 max-md:right-20 max-md:left-[1.5625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,263.847)] max-md:origin-[135px_1535.11px] md:max-lg:-right-[23.9375rem] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216,-271.006)] md:max-lg:origin-[551px_720.797px]">
                  <div className="box-content h-full block relative text-border [font-family:AcuminProSemiCondRegular] text-xl leading-9 text-left max-md:leading-[1.625rem] max-md:[font-size:inherit] after:content-[''] after:table after:w-0 after:h-0" data-ditto-id="style-div-54">
                    <div className="flex mb-7.5 flex-wrap justify-between items-center gap-2.5 max-md:mb-2.5 max-md:gap-2" id="show-notes-search">
                      <div className="box-content block">
                        <span className="box-content inline-block relative" data-ditto-id="style-br-20">
                          <i className="box-content h-full block absolute top-0 right-0 left-56.5 opacity-50 italic leading-5 cursor-pointer max-md:leading-4" data-ditto-id="style-heading-3" />
                          <input className="box-content w-full h-[1.9375rem] border-[3px] border-solid border-accent inline-block min-w-65 pt-2 pb-[0.1875rem] rounded-[100px] overflow-clip text-[1.0625rem] leading-[1.9375rem] text-start indent-4 bg-background cursor-text max-md:h-[1.6875rem] max-md:leading-[1.6875rem]" data-ditto-id="style-p-25" data-component="input" placeholder="Search Show notes" type="text" value="" />
                        </span>
                      </div>
                      {" "}
                      <div className="box-content block max-md:text-xs max-md:leading-[1.1875rem]" data-ditto-id="style-br-28">
                        81 results
                      </div>
                      {" "}
                    </div>
                    {" "}
                    <div className="box-content block">
                      <div className="box-content grid gap-12.5 grid-cols-[334px_334px_334px] max-md:grid-cols-[270px]">
                    ...
                    <div className="box-content block mt-25 mb-10 text-center max-md:mt-10 max-md:mb-0" data-ditto-id="style-p-18">
                      <button className="border-2 border-solid border-accent inline-block pt-5 pb-3.5 px-[2.1875rem] rounded-[100px] text-accent [font-family:AcuminProSemibold] text-lg leading-5.5 tracking-[1.8px] uppercase cursor-default max-md:pt-[0.8125rem] max-md:pb-[0.5625rem] max-md:px-5 max-md:text-sm max-md:leading-[1.0625rem] max-md:tracking-[1.4px]" data-component="button">
                        Load More Posts →
                      </button>
                    </div>
                    {" "}
        ...
        <div className="box-content h-[48.6875rem] block relative z-3 pointer-events-none max-md:h-[58.3rem] md:max-lg:h-[498.5px]" data-ditto-id="style-p-39" id="podcast-footer">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-accent pointer-events-none" data-ditto-id="style-p-19">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-p-31">
              ...
              <div className="w-[39.3125rem] h-5 block absolute top-[45.4375rem] left-132.5 transform-[matrix(1,0,0,1,40,0)] origin-[314.5px_10px] max-md:w-[16.9375rem] max-md:h-7 max-md:top-183.5 max-md:left-[1.0625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,26.2109,128.562)] max-md:origin-[135.5px_14px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-304.02,-265.32)] 2xl:transform-[matrix(1,0,0,1,360,0)]">
                <p className="box-content h-full block absolute top-0 inset-x-0 text-background [font-family:AcuminProSemibold] text-[0.625rem] leading-4.5 tracking-[1px] text-right uppercase max-md:text-[0.5625rem] max-md:leading-[1rem] max-md:tracking-[0.9px]" data-ditto-id="style-heading-12">
                  {" Design by "}
              ...
              <a className="w-[21.8125rem] h-[2.4375rem] block absolute top-27.5 left-210.5 transform-[matrix(1,0,0,1,40,0)] origin-[174.5px_19.5px] cursor-pointer max-md:w-57.5 max-md:h-5 max-md:top-[13.9375rem] max-md:left-[4.6875rem] max-md:transform-[matrix(1.17188,0,0,1.17188,32.6562,40.0469)] max-md:origin-[115px_10px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-365.94,-46.62)] 2xl:transform-[matrix(1,0,0,1,360,0)]" data-ditto-id="style-p-26" data-component="link" href="https://podcasts.apple.com/us/podcast/online-marketing-made-easy-with-amy-porterfield/id594703545" target="_blank">
                <p className="box-content h-full block absolute top-0 inset-x-0 text-background [font-family:AcuminProSemibold] text-[1.5625rem] leading-[2.8125rem] text-left max-md:leading-[1.8125rem] max-md:[font-size:inherit]" data-ditto-id="style-p-40">
                  Listen on Apple
                </p>
              </a>
              <div className="w-[156.3125rem] h-71 block absolute top-[23.0625rem] -left-180 overflow-hidden transform-[none] max-md:w-211.5 max-md:h-[10.5625rem] max-md:top-[26.8125rem] max-md:-left-[12.1875rem] max-md:transform-[matrix(1.17188,0,0,1.17188,39.1875,88.2578)] max-md:origin-[423px_84.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-190.98,-183.96)] md:max-lg:origin-[1250.5px_142px]" data-ditto-id="style-p-34">
        ...
        <div className="box-content h-20 block relative z-4 pointer-events-none max-md:h-[263.7px] md:max-lg:h-[3.2rem]" data-ditto-id="style-div-39" id="footer-legal-accessibility">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-border pointer-events-none">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-div-16">
              <a className="w-26.5 h-4.5 block absolute top-[1.9375rem] left-[29.5625rem] transform-[matrix(1,0,0,1,40,0)] origin-[53px_9px] cursor-pointer max-md:w-23.5 max-md:h-[1.3125rem] max-md:top-21.5 max-md:left-6 max-md:transform-[matrix(1.17188,0,0,1.17188,12.2031,16.5859)] max-md:origin-[47px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-189.36,-14.4)] 2xl:transform-[matrix(1,0,0,1,360,0)]" data-ditto-id="style-link-33" data-component="link" href="https://www.amyporterfield.com/privacy" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-background [font-family:Montserrat] text-[0.6875rem] font-medium leading-[1.125rem] tracking-[0.55px] text-right uppercase max-md:text-[0.625rem] max-md:leading-4.5 max-md:tracking-[0.5px] max-md:text-left" data-ditto-id="style-nav-20" data-component="nav">
                  privacy policy
                  <br className="box-content inline" />
                </nav>
              </a>
              {TextLink2_data.map((d, i) => <TextLink2 key={i} d={d} styles={TextLink2_styles[i]} />)}
              <a className="w-[21.1875rem] h-4.5 block absolute top-[1.9375rem] left-5 transform-[matrix(1,0,0,1,-40,0)] origin-[169.5px_9px] cursor-pointer max-md:w-68.5 max-md:h-[1.4375rem] max-md:top-6 max-md:left-6 max-md:transform-[matrix(1.17188,0,0,1.17188,27.6719,6.10156)] max-md:origin-[137px_11.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-68.22,-14.4)] 2xl:transform-[matrix(1,0,0,1,-360,0)]" data-ditto-id="style-link-34" data-component="link" href="/" target="_self">
                <h2 className="box-content h-full block absolute top-0 inset-x-0 text-background [font-family:Montserrat] text-[0.6875rem] font-light leading-[1.125rem] tracking-[0.55px] text-left uppercase max-md:leading-[1.25rem] max-md:tracking-[inherit]" data-ditto-id="style-heading-11" data-component="heading">
