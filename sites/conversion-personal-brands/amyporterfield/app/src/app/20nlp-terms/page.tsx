...
const TextLink_data = [
    ...
    { href: "https://twoweeksnoticebook.com/?__hstc=164447072.70b03fdf2a004f20f29987e58adcb3e5.1767225603915.1767225603915.1767225603915.1&__hssc=164447072.1.1767225603915&__hsfp=94ef76e50aa552668c1276dec3915e7a", target: "_blank", text: "two weeks notice" },
...
const TextLink_meta: string[][] = [
    ["n136", "style-p-3"],
    ["style-p-38", "style-p-4"],
    ["style-p-41", "style-p-5"]
];
const Logo_meta: string[][] = [
    ["style-heading-14", "style-p-46", "style-heading"],
    ["style-p-44", "n158", "style-p-11"],
    ["style-heading-10", "n161", "style-p-12"],
    ...
    <>
      ...
      <div className="box-content block relative min-w-80 overflow-hidden" id="si-sp">
          ...
          <div className="box-content h-91.5 block relative pointer-events-none max-md:h-[24.975rem] md:max-lg:h-[14.6375rem]" data-ditto-id="style-hero-1" id="hero(1)">
            <div className="box-content h-full block absolute top-0 inset-x-0 bg-background pointer-events-none">
              ...
              <div className="box-content w-300 h-[19.6875rem] block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-md:h-50 max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-div-50">
                ...
                <div className="w-31 h-30 block absolute top-[12.1875rem] left-249.5 transform-[matrix(1,0,0,1,0,51)] origin-[62px_60px] max-md:w-[3.6875rem] max-md:h-14.5 max-md:top-35.5 max-md:left-60.5 max-md:transform-[matrix(1.17188,0,0,1.17188,46.6641,194.625)] max-md:origin-[29.5px_29px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-381.6,-59.16)]" data-ditto-id="style-div-51">
                ...
                <div className="w-[47.8125rem] h-[9.225rem] block absolute top-[7.4375rem] left-54.5 transform-[none] max-md:w-70 max-md:h-[223.1px] max-md:top-15 max-md:left-5 max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,29.4873)] max-md:origin-[140px_111.562px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216.18,-69.4012)] md:max-lg:origin-[382.5px_73.7812px]">
          ...
          <div className="box-content h-[440.3125rem] block relative pointer-events-none max-md:h-[1097.6875rem] md:max-lg:h-[281.8rem]" id="terms(1)">
            <div className="box-content h-full block absolute top-0 inset-x-0 bg-background pointer-events-none">
              <div className="box-content w-300 h-[34.5625rem] block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-md:h-284.5 max-lg:mx-0 md:max-lg:w-192 2xl:mx-90">
                <div className="w-198.5 h-[6978.5px] block absolute top-10 left-51 transform-[none] max-md:w-67.5 max-md:h-[14901.5px] max-md:top-[2.8125rem] max-md:left-[1.5625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,1288.33)] max-md:origin-[135px_7450.75px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216.36,-1270.53)] md:max-lg:origin-[397px_3489.25px]">
                  <div className="box-content h-full block relative text-border [font-family:Montserrat] text-[0.9375rem] leading-[1.6875rem] text-left max-md:leading-6 after:content-[''] after:table after:w-0 after:h-0" data-ditto-id="style-div-54">
                    ...
                    <p className="box-content block mb-4">
                      ...
                      <a className="box-content inline text-color-001 underline cursor-pointer" data-ditto-id="style-p-9" data-component="link" href="mailto:support@amyporterfield.com">
                    ...
                    {" "}
                    <p className="box-content block mb-4" data-ditto-id="style-br-26">
                    ...
                    {" "}
                    <h2 className="box-content block mt-7.5 mb-3 font-bold leading-[1.25rem] uppercase" data-ditto-id="style-br-2" data-component="heading">
                      FORCE MAJEURE
                    </h2>
                    {" "}
                    <p className="box-content block mb-4">
                    ...
                    {" "}
                    <h2 className="box-content block mt-7.5 mb-3 font-bold leading-[1.25rem] uppercase" data-ditto-id="style-br-25" data-component="heading">
                    ...
                    <p className="box-content block mb-4" data-ditto-id="style-p-28">
                      ...
                      <a className="box-content inline text-color-001 underline cursor-pointer" data-ditto-id="style-link-8" data-component="link" href="mailto:support@amyporterfield.com">
                        support@amyporterfield.com
                      </a>
                      .
                    </p>
                    ...
                    <p className="box-content block mb-4" data-ditto-id="style-p-26">
                      <em className="box-content inline italic" data-ditto-id="style-p-40">
        ...
        <div className="box-content h-87.5 block relative pointer-events-none max-md:h-[64.525rem] md:max-lg:h-56" data-ditto-id="style-p-20" id="footer">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-color-002 pointer-events-none" data-ditto-id="style-p-35">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90">
              <a className="w-60 h-30 block absolute top-22 left-[56.1875rem] transform-[none] cursor-pointer max-md:w-68.5 max-md:h-[9.5625rem] max-md:top-160 max-md:left-6 max-md:transform-[matrix(1.17188,0,0,1.17188,27.6719,123.148)] max-md:origin-[137px_76.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-366.84,-53.28)] md:max-lg:origin-[120px_60px]" data-ditto-id="style-p-21" data-component="link" href="https://www.amyporterfield.com/side-hustle-ideas-guide-ap" target="_self">
                <div className="box-content h-full block absolute top-0 inset-x-0 bg-cover [background-position:10%_10%] bg-no-repeat" style={{ backgroundImage: "url(\"/assets/cloned/images/be1a66f154c7.gif\")" }} data-ditto-id="style-heading-8" src="/assets/cloned/images/be1a66f154c7.gif" />
              </a>
              <a className="w-[7.3125rem] h-4.5 block absolute top-47.5 left-115 transform-[none] cursor-pointer max-md:w-28 max-md:h-[1.3125rem] max-md:top-69 max-md:left-41 max-md:transform-[matrix(1.17188,0,0,1.17188,37.8125,49.2422)] max-md:origin-[56px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-186.66,-71.64)] md:max-lg:origin-[58.5px_9px]" data-ditto-id="style-p-37" data-component="link" href="https://www.amyporterfield.com/online-business-courses" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.8125rem] font-semibold leading-[1.3125rem] tracking-[0.65px] text-left uppercase max-md:leading-[1.4375rem] max-md:tracking-[inherit]" data-ditto-id="style-link-5" data-component="nav">
                  Courses
                </nav>
              </a>
              <a className="w-[8.1875rem] h-4.5 block absolute top-[7.8125rem] left-115 transform-[none] cursor-pointer max-md:w-[7.9375rem] max-md:h-[1.3125rem] max-md:top-77.5 max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,14.8672,55.0859)] max-md:origin-[63.5px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-189.18,-48.24)] md:max-lg:origin-[65.5px_9px]" data-ditto-id="style-heading-17" data-component="link" href="/about" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.8125rem] font-semibold leading-[1.3125rem] tracking-[0.65px] text-left uppercase max-md:leading-[1.4375rem] max-md:tracking-[inherit]" data-ditto-id="style-p" data-component="nav">
                  About Amy
                </nav>
              </a>
              <a className="w-30 h-4.5 block absolute top-39.5 left-115 transform-[none] cursor-pointer max-md:w-30.5 max-md:h-[1.3125rem] max-md:top-86 max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,14.4375,60.9297)] max-md:origin-[61px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-187.2,-60.12)] md:max-lg:origin-[60px_9px]" data-component="link" href="https://www.amyporterfield.com/marketing-strategy-podcast" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.8125rem] font-semibold leading-[1.3125rem] tracking-[0.65px] text-left uppercase max-md:leading-[1.4375rem]" data-ditto-id="style-p-2" data-component="nav">
                  Podcast
              ...
              <a className="w-60 h-10.5 block absolute top-55.5 left-[56.1875rem] transform-[none] cursor-pointer max-md:w-56.5 max-md:h-[1.3125rem] max-md:top-201.5 max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,23.375,140.336)] max-md:origin-[113px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-366.84,-87.48)] md:max-lg:origin-[120px_21px]" data-ditto-id="style-heading-18" data-component="link" href="https://www.amyporterfield.com/side-hustle-ideas-guide-ap" target="_self">
              ...
              <div className="w-[19.1875rem] h-[7.3125rem] block absolute top-[5.6875rem] left-15 transform-[none] max-md:w-[14.0625rem] max-md:h-[8.9375rem] max-md:top-[4.4375rem] max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,23.2891,24.4922)] max-md:origin-[112.5px_71.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-76.86,-53.82)] md:max-lg:origin-[153.5px_58.5px]" data-ditto-id="style-heading-21">
                <p className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.8125rem] leading-[1.3125rem] text-left max-md:leading-[1.4375rem]" data-ditto-id="style-p-23">
              ...
              <a className="w-52.5 h-[1.5625rem] block absolute top-[3.0625rem] left-14 transform-[none] cursor-pointer max-md:w-[13.3125rem] max-md:h-[2.1875rem] max-md:top-6 max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,22.2578,7.13281)] max-md:origin-[106.5px_17.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-57.96,-22.14)] md:max-lg:origin-[105px_12.5px]" data-ditto-id="style-heading-15" data-component="link" href="/" target="_self">
                <div className="box-content h-full block absolute top-0 inset-x-0 bg-contain [background-position:50%_50%] bg-no-repeat" style={{ backgroundImage: "url(\"/assets/cloned/images/1e9e95f91617.png\")" }} data-ditto-id="style-p-42" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" />
              </a>
              <a className="w-47.5 h-4.5 block absolute top-[17.5625rem] left-231.5 transform-[matrix(1,0,0,1,40,0)] origin-[95px_9px] cursor-pointer max-md:hidden md:max-lg:transform-[matrix(0.64,0,0,0.64,-367.56,-104.4)] 2xl:transform-[matrix(1,0,0,1,360,0)]" data-ditto-id="style-heading-9" data-component="link" href="#si-sp" target="_self">
              ...
              <div className="w-58.5 h-[1.3125rem] block absolute top-[15.1875rem] left-15 transform-[none] max-md:hidden md:max-lg:transform-[matrix(0.64,0,0,0.64,-63.72,-91.26)] md:max-lg:origin-[117px_10.5px]" data-ditto-id="style-p-45">
              ...
              <a className="w-49.5 h-4.5 block absolute top-[5.8125rem] left-158 transform-[none] cursor-pointer max-md:w-[12.1875rem] max-md:h-[1.3125rem] max-md:top-[26.9375rem] max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,20.7109,75.8828)] max-md:origin-[97.5px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-263.16,-36.72)] md:max-lg:origin-[99px_9px]" data-ditto-id="style-link-6" data-component="link" href="https://www.amyporterfield.com/mylogin" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.8125rem] font-semibold leading-[1.3125rem] tracking-[0.65px] text-left uppercase max-md:leading-[1.4375rem] max-md:tracking-[inherit]" data-ditto-id="style-strong" data-component="nav">
                  student login
                </nav>
              </a>
              {Tile_data.map((d, i) => <Tile key={i} d={d} styles={Tile_styles[i]} />)}
              <a className="w-49.5 h-4.5 block absolute top-[7.8125rem] left-158 transform-[none] cursor-pointer max-md:w-[12.1875rem] max-md:h-[1.3125rem] max-md:top-[28.8125rem] max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,20.7109,81.0391)] max-md:origin-[97.5px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-263.16,-48.24)] md:max-lg:origin-[99px_9px]" data-ditto-id="style-link-7" data-component="link" href="https://www.amyporterfield.com/reviews" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.8125rem] font-semibold leading-[1.3125rem] tracking-[0.65px] text-left uppercase max-md:leading-[1.4375rem] max-md:tracking-[inherit]" data-ditto-id="style-p-8" data-component="nav">
                  student stories
                </nav>
              </a>
              <div className="w-[13.9375rem] h-[1.4375rem] block absolute top-12.5 left-[56.1875rem] transform-[none] max-md:w-62.5 max-md:h-7 max-md:top-149.5 max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,25.4375,105.188)] max-md:origin-[125px_14px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-363.78,-22.14)] md:max-lg:origin-[111.5px_11.5px]" data-ditto-id="style-em">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-primary [font-family:'IvyPresto_Headline_Regular'] text-lg leading-[1.8125rem] text-left max-md:leading-[2rem]" data-ditto-id="style-p-43" data-component="nav">
              ...
              <a className="w-[7.3125rem] h-4.5 block absolute top-[15.9375rem] left-115 transform-[none] cursor-pointer max-md:w-33.5 max-md:h-[1.3125rem] max-md:top-86 max-md:left-41 max-md:transform-[matrix(1.17188,0,0,1.17188,39.7031,60.9297)] max-md:origin-[67px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-186.66,-95.04)] md:max-lg:origin-[58.5px_9px]" data-component="link" href="https://www.amyporterfield.com/newsletter" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.8125rem] font-semibold leading-[1.3125rem] tracking-[0.65px] text-left uppercase max-md:leading-[1.4375rem] max-md:tracking-[inherit]" data-ditto-id="style-div-6" data-component="nav">
                  NEWSLETTER
                </nav>
              </a>
            </div>
          ...
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-surface-3 pointer-events-none">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-div-12">
              ...
              <div className="w-46.5 h-18.5 block absolute top-8.5 left-9.5 transform-[matrix(1,0,0,1,-40,0)] origin-[93px_37px] max-md:w-[18.9375rem] max-md:h-9.5 max-md:top-7 max-md:left-[0.5625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5859,8.07812)] max-md:origin-[151.5px_19px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-47.16,-25.56)] 2xl:transform-[matrix(1,0,0,1,-360,0)]" data-ditto-id="style-div-10">
                <p className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:'Ivy_Presto'] text-[1.6875rem] leading-[2rem] text-center max-md:text-[1.625rem] max-md:leading-[1.9375rem]" data-ditto-id="style-p-32">
        ...
        <div className="box-content h-20 block relative z-4 pointer-events-none max-md:h-[263.7px] md:max-lg:h-[3.2rem]" id="footer-legal-accessibility">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-border pointer-events-none" data-ditto-id="style-div-11">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-div-53">
              <a className="w-26.5 h-4.5 block absolute top-[1.9375rem] left-[29.5625rem] transform-[matrix(1,0,0,1,40,0)] origin-[53px_9px] cursor-pointer max-md:w-23.5 max-md:h-[1.3125rem] max-md:top-21.5 max-md:left-6 max-md:transform-[matrix(1.17188,0,0,1.17188,12.2031,16.5859)] max-md:origin-[47px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-189.36,-14.4)] 2xl:transform-[matrix(1,0,0,1,360,0)]" data-ditto-id="style-link-31" data-component="link" href="https://www.amyporterfield.com/privacy" target="_self">
