...
const TextLink_data = [
    ...
    { href: "https://twoweeksnoticebook.com/?__hstc=164447072.3df16dcbed0a8e29ac2dbbdd50da71e9.1767225601784.1767225601784.1767225601784.1&__hssc=164447072.1.1767225601784&__hsfp=94ef76e50aa552668c1276dec3915e7a", target: "_blank", text: "two weeks notice" },
...
const Logo_meta: string[][] = [
    ["style-heading-2", "n214", "style-i"],
    ["n216", "n217", "style-about-amy"],
    ["style-div-13", "n220", "style-div-4"],
    ["style-div-14", "n223", "style-div-5"],
    ["style-div-15", "style-heading-4", "style-br"]
];
...
const Logo2_meta: string[][] = [
    ...
    ["n296", "n297"],
    ["style-link-13", "n299"],
    ["style-link-14", "style-div-29"],
    ["style-icon-3", "n303"],
    ["style-div-11", "style-div-53"],
    ["style-link-31", "n307"],
    ["style-br-12", "style-div-46"],
    ["style-icon-4", "style-footer-legal-accessibility-2"],
    ["style-div-44", "n313"],
    ["style-link-15", "n315"],
    ["n316", "style-div-22"],
    ["style-div-45", "n319"],
    ...
    ["style-hs-web-interactives-floating-container-2", "style-div-48"],
    ["style-div-23", "style-button-3"],
    ["n328", "style-div-24"],
    ["style-div-49", "n331"],
    ["style-hs-web-interactives-floating-container-3", "style-nav-15"],
    ...
    ["n342", "style-nav-22"],
    ["n344", "style-nav-17"],
    ["style-footer-legal-accessibility", "n347"],
    ["n348", "style-link-38"]
];
    ...
    <>
      ...
      <div className="box-content block relative min-w-80 overflow-hidden" id="si-sp">
          ...
          <div className="box-content h-79 block relative pointer-events-none max-md:h-[269.5px] md:max-lg:h-[12.6375rem]" data-ditto-id="style-hero-1" id="hero(1)">
            <div className="box-content h-full block absolute top-0 inset-x-0 bg-background pointer-events-none">
              ...
              <div className="box-content w-300 h-[19.6875rem] block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-md:h-50 max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-div-50">
                ...
                <div className="w-31 h-30 block absolute top-[12.1875rem] left-249.5 transform-[matrix(1,0,0,1,0,1)] origin-[62px_60px] max-md:w-[3.6875rem] max-md:h-14.5 max-md:top-35.5 max-md:left-60.5 max-md:transform-[matrix(1.17188,0,0,1.17188,46.6641,64.5469)] max-md:origin-[29.5px_29px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-381.6,-91.16)]" data-ditto-id="style-div-51">
                ...
                <div className="w-[47.8125rem] h-[6.15rem] block absolute top-[7.4375rem] left-54.5 transform-[none] max-md:w-70 max-md:h-[6.975rem] max-md:top-15 max-md:left-5 max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,19.8999)] max-md:origin-[140px_55.7812px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216.18,-60.5475)] md:max-lg:origin-[382.5px_49.1875px]">
          ...
          <div className="box-content h-2945.5 block relative pointer-events-none max-md:h-[1935.0625rem] md:max-lg:h-[7540.5px]" id="terms(1)">
            <div className="box-content h-full block absolute top-0 inset-x-0 bg-background pointer-events-none">
              <div className="box-content w-300 h-[34.5625rem] block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-md:h-284.5 max-lg:mx-0 md:max-lg:w-192 2xl:mx-90">
                <div className="w-198.5 h-2929 block absolute top-10 left-51 transform-[none] max-md:w-67.5 max-md:h-[1645.9375rem] max-md:top-[2.8125rem] max-md:left-[1.5625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,2270.9)] max-md:origin-[135px_13167.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216.36,-2123.28)] md:max-lg:origin-[397px_5858px]">
                  <div className="box-content h-full block relative text-border [font-family:Montserrat] text-[0.9375rem] leading-[1.6875rem] text-left max-md:leading-6 after:content-[''] after:table after:w-0 after:h-0" data-ditto-id="style-div-54">
                    ...
                    {" "}
                    <h2 className="box-content block mt-7.5 mb-3 font-bold leading-[1.25rem] uppercase" data-ditto-id="style-heading-3" data-component="heading">
                      PROGRAM/SERVICE
                    </h2>
                    {" "}
                    ...
                    {" "}
                    <h2 className="box-content block mt-7.5 mb-3 font-bold leading-[1.25rem] uppercase" data-ditto-id="style-heading-7" data-component="heading">
                      PARTICIPANTS
                    </h2>
                    {" "}
                    <p className="box-content block mb-4">
                    ...
                    <p className="box-content block mb-4" data-ditto-id="style-p-15">
                      {"The Company’s "}
                      <a className="box-content inline text-color-001 underline cursor-pointer" data-ditto-id="style-link" data-component="link" href="http://www.amyporterfield.com/terms-and-conditions/" rel="noreferrer noopener" target="_blank">
                        Terms of Use
                      </a>
                      {", "}
                      <a className="box-content inline text-color-001 underline cursor-pointer" data-ditto-id="style-link-2" data-component="link" href="https://amyporterfield.com/privacy" rel="noreferrer noopener" target="_blank">
                        Privacy Policy
                      </a>
                      {", and "}
                      <a className="box-content inline text-color-001 underline cursor-pointer" data-ditto-id="style-link-3" data-component="link" href="http://www.amyporterfield.com/earnings-disclaimer/" rel="noreferrer noopener" target="_blank">
                        Disclaimer
                      </a>
                    ...
                    {" "}
                    <h2 className="box-content block mt-7.5 mb-3 font-bold leading-[1.25rem] uppercase" data-ditto-id="style-heading-16" data-component="heading">
                      REFUND POLICY
                    </h2>
                    {" "}
                    <p className="box-content block mb-4">
                    ...
                    <p className="box-content block mb-4">
                      ...
                      <a className="box-content inline text-color-001 underline cursor-pointer" data-ditto-id="style-link-4" data-component="link" href="mailto:support@amyporterfield.com">
                    ...
                    {" "}
                    <h2 className="box-content block mt-7.5 mb-3 font-bold leading-[1.25rem] uppercase" data-ditto-id="style-heading-5" data-component="heading">
                    ...
                    <p className="box-content block mb-4" data-ditto-id="style-p-37">
                      ...
                      <a className="box-content inline text-color-001 underline cursor-pointer" data-ditto-id="style-link-5" data-component="link" href="http://amyporterfield.com/privacy" rel="noreferrer noopener" target="_blank">
                        Privacy Policy
                      </a>
                      .
                    </p>
                    ...
                    {" "}
                    <p className="box-content block mb-4" data-ditto-id="style-p-41">
                    ...
                    {" "}
                    <h2 className="box-content block mt-7.5 mb-3 font-bold leading-[1.25rem] uppercase" data-ditto-id="style-heading-10" data-component="heading">
                    ...
                    <p className="box-content block mb-4">
                      ...
                      <a className="box-content inline text-color-001 underline cursor-pointer" data-ditto-id="style-link-6" data-component="link" href="mailto:support@amyporterfield.com">
                    ...
                    <p className="box-content block mb-4" data-ditto-id="style-p-47">
                      ...
                      <strong className="box-content inline font-bold" data-ditto-id="style-strong-5">
                        <a className="box-content inline text-color-001 underline cursor-pointer" data-ditto-id="style-link-7" data-component="link" href="mailto:support@amyporterfield.com">
                          support@amyporterfield.com
                        </a>
                      </strong>
                    </p>
        ...
        <div className="box-content h-87.5 block relative pointer-events-none max-md:h-[64.525rem] md:max-lg:h-56" id="footer">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-color-002 pointer-events-none" data-ditto-id="style-div-6">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90">
              ...
              <a className="w-[7.3125rem] h-4.5 block absolute top-47.5 left-115 transform-[none] cursor-pointer max-md:w-28 max-md:h-[1.3125rem] max-md:top-69 max-md:left-41 max-md:transform-[matrix(1.17188,0,0,1.17188,37.8125,49.2422)] max-md:origin-[56px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-186.66,-71.64)] md:max-lg:origin-[58.5px_9px]" data-ditto-id="style-link-36" data-component="link" href="https://www.amyporterfield.com/online-business-courses" target="_self">
              ...
              <a className="w-[8.1875rem] h-4.5 block absolute top-[7.8125rem] left-115 transform-[none] cursor-pointer max-md:w-[7.9375rem] max-md:h-[1.3125rem] max-md:top-77.5 max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,14.8672,55.0859)] max-md:origin-[63.5px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-189.18,-48.24)] md:max-lg:origin-[65.5px_9px]" data-ditto-id="style-link-35" data-component="link" href="/about" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.8125rem] font-semibold leading-[1.3125rem] tracking-[0.65px] text-left uppercase max-md:leading-[1.4375rem] max-md:tracking-[inherit]" data-ditto-id="style-nav-5" data-component="nav">
                  About Amy
                </nav>
              </a>
              <a className="w-30 h-4.5 block absolute top-39.5 left-115 transform-[none] cursor-pointer max-md:w-30.5 max-md:h-[1.3125rem] max-md:top-86 max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,14.4375,60.9297)] max-md:origin-[61px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-187.2,-60.12)] md:max-lg:origin-[60px_9px]" data-component="link" href="https://www.amyporterfield.com/marketing-strategy-podcast" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.8125rem] font-semibold leading-[1.3125rem] tracking-[0.65px] text-left uppercase max-md:leading-[1.4375rem]" data-ditto-id="style-nav-6" data-component="nav">
                  Podcast
              ...
              <a className="w-60 h-10.5 block absolute top-55.5 left-[56.1875rem] transform-[none] cursor-pointer max-md:w-56.5 max-md:h-[1.3125rem] max-md:top-201.5 max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,23.375,140.336)] max-md:origin-[113px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-366.84,-87.48)] md:max-lg:origin-[120px_21px]" data-component="link" href="https://www.amyporterfield.com/side-hustle-ideas-guide-ap" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.8125rem] font-semibold leading-[1.3125rem] tracking-[0.65px] text-left uppercase max-md:leading-[1.4375rem]" data-ditto-id="style-nav-7" data-component="nav">
              ...
              <a className="w-49.5 h-4.5 block absolute top-[5.8125rem] left-158 transform-[none] cursor-pointer max-md:w-[12.1875rem] max-md:h-[1.3125rem] max-md:top-[26.9375rem] max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,20.7109,75.8828)] max-md:origin-[97.5px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-263.16,-36.72)] md:max-lg:origin-[99px_9px]" data-ditto-id="style-link-17" data-component="link" href="https://www.amyporterfield.com/mylogin" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.8125rem] font-semibold leading-[1.3125rem] tracking-[0.65px] text-left uppercase max-md:leading-[1.4375rem] max-md:tracking-[inherit]" data-ditto-id="style-nav-10" data-component="nav">
                  student login
                </nav>
              </a>
              {Tile_data.map((d, i) => <Tile key={i} d={d} styles={Tile_styles[i]} />)}
              <a className="w-49.5 h-4.5 block absolute top-[7.8125rem] left-158 transform-[none] cursor-pointer max-md:w-[12.1875rem] max-md:h-[1.3125rem] max-md:top-[28.8125rem] max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,20.7109,81.0391)] max-md:origin-[97.5px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-263.16,-48.24)] md:max-lg:origin-[99px_9px]" data-ditto-id="style-link-16" data-component="link" href="https://www.amyporterfield.com/reviews" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.8125rem] font-semibold leading-[1.3125rem] tracking-[0.65px] text-left uppercase max-md:leading-[1.4375rem] max-md:tracking-[inherit]" data-ditto-id="style-nav-11" data-component="nav">
                  student stories
                </nav>
              </a>
              ...
              <a className="w-[7.3125rem] h-4.5 block absolute top-[15.9375rem] left-115 transform-[none] cursor-pointer max-md:w-33.5 max-md:h-[1.3125rem] max-md:top-86 max-md:left-41 max-md:transform-[matrix(1.17188,0,0,1.17188,39.7031,60.9297)] max-md:origin-[67px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-186.66,-95.04)] md:max-lg:origin-[58.5px_9px]" data-component="link" href="https://www.amyporterfield.com/newsletter" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.8125rem] font-semibold leading-[1.3125rem] tracking-[0.65px] text-left uppercase max-md:leading-[1.4375rem] max-md:tracking-[inherit]" data-ditto-id="style-nav-13" data-component="nav">
                  NEWSLETTER
                </nav>
              </a>
            </div>
          ...
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-surface-3 pointer-events-none">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90">
              ...
              <div className="w-[16.3125rem] h-48.5 block absolute top-0 transform-[matrix(1,0,0,1,-40,0)] origin-[130.5px_97px] max-md:w-80 max-md:h-40 max-md:-top-px max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,13.5781)] max-md:origin-[160px_80px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-46.98,-34.92)] 2xl:transform-[matrix(1,0,0,1,-360,0)]">
                <div className="h-full block bg-surface-2" data-ditto-id="style-div-30" />
              </div>
              <div className="w-46.5 h-18.5 block absolute top-8.5 left-9.5 transform-[matrix(1,0,0,1,-40,0)] origin-[93px_37px] max-md:w-[18.9375rem] max-md:h-9.5 max-md:top-7 max-md:left-[0.5625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5859,8.07812)] max-md:origin-[151.5px_19px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-47.16,-25.56)] 2xl:transform-[matrix(1,0,0,1,-360,0)]" data-ditto-id="style-div-52">
              ...
              <a className="w-56 h-10.5 block absolute top-29.5 left-5.5 transform-[matrix(1,0,0,1,-40,0)] origin-[112px_21px] cursor-pointer max-md:w-[15.8125rem] max-md:h-[2.8125rem] max-md:top-[4.9375rem] max-md:left-8.5 max-md:transform-[matrix(1.17188,0,0,1.17188,27.5859,17.4453)] max-md:origin-[126.5px_22.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-48.24,-50.04)] 2xl:transform-[matrix(1,0,0,1,-360,0)]" data-ditto-id="style-link-39" data-component="link" href="https://www.instagram.com/amyporterfield" target="_blank">
        ...
        <div className="box-content h-20 block relative z-4 pointer-events-none max-md:h-[263.7px] md:max-lg:h-[3.2rem]" id="footer-legal-accessibility">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-border pointer-events-none">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90">
              <a className="w-26.5 h-4.5 block absolute top-[1.9375rem] left-[29.5625rem] transform-[matrix(1,0,0,1,40,0)] origin-[53px_9px] cursor-pointer max-md:w-23.5 max-md:h-[1.3125rem] max-md:top-21.5 max-md:left-6 max-md:transform-[matrix(1.17188,0,0,1.17188,12.2031,16.5859)] max-md:origin-[47px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-189.36,-14.4)] 2xl:transform-[matrix(1,0,0,1,360,0)]" data-ditto-id="style-link-30" data-component="link" href="https://www.amyporterfield.com/privacy" target="_self">
