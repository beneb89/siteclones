...
const ListRow2_data = [
    { text: "Flexible Work Schedule (32 Hour Workweek)", text2: " – We genuinely believe that amazing work and full lives CAN co-exist. So, enjoy a 32 hour workweek (Monday - Friday), designed for work-life optimization. Now, this benefit requires strong personal discipline and effective time management. Because if you haven’t caught on by now, we’re highly outcome oriented. We lean on personal and cross-company systems and structures to help maximize efficiency so we can enjoy the flexibility and freedom it allows us to get the work done, then logging off and hitting the trails, the shops, the beach… whatever!" },
    { text: "Flexible Time Off and Sick Leave ", text2: "– Two words…unlimited PTO. Because working hard and taking full ownership of your role doesn’t come at the expense of lifestyle freedom. " },
    { text: "Paid Holidays", text2: " – including a Thanksgiving Break and Holiday Break!" },
    ...
    { text: "Team Vacation", text2: " – Pack your bags! Amy treats her team members to an annual team trip to celebrate the accomplishments and hard work of our employees. No work — just play!" },
    { text: "Wellness Reimbursement", text2: " – Whether it’s a gym membership or acupuncture… therapy or a massage… F45 or a get-out-of-the-house day at WeWork or a coffee shop, if it strengthens your body or betters your mind, then this benefit applies!" },
    { text: "Professional Development ", text2: "– You get to choose between live events, life coaching sessions, digital courses, or mentorship programs - this benefit fuels your growth journey!" },
    { text: "Health, Dental, and Vision Insurance", text2: " – Health is wealth, my friend! And we make sure that accessing quality healthcare is never a concern for members of Team Porterfield." },
    { text: "Retirement Savings Plan", text2: " – Roth or 401k…whatever your preference, we’ve got a generous contribution! " },
    { text: "Financial Planning Assistance", text2: " – You’re an expert at a lot of things…why not add personal finances to that list! A team of professional wealth strategy partners is available to provide financial planning assistance however you’d like it, from retirement to personal finances to investing to saving." },
    { text: "New Parent Leave", text2: " – A benefit bundle of joy! Full-time team members receive 10 weeks of paid parental leave and an optional 2 weeks of unpaid leave." },
    { text: "Base Compensation –", text2: " $60,000 - $65,000, based on experience." },
    { text: "Performance-Based Earnings (Commission + Bonuses) ", text2: "– ~$12,500 - ~$19,500+ annually, based on client renewals, upsells, and team performance." }
];
const ListRow_data7 = [
    { text: "Tell us about your experience coaching entrepreneurs or service-based business owners. What types of businesses have you supported, and what outcomes are you most proud of helping clients achieve over a 90-day or 6-month period?" },
    { text: "Describe a time when a client was stuck, either due to mindset challenges, operational issues, or both. How did you “hold space” while also helping them move forward in a practical, results-driven way?" },
                ...
                <div className="h-174.5 block absolute top-18 right-0 left-[2.6875rem] max-md:h-[88.8125rem] max-md:top-24.5 max-md:left-0" data-ditto-id="style-link-2">
                  <div className="box-content h-full block absolute top-0 inset-x-0 text-color-001 [font-family:Montserrat] text-[0.9375rem] leading-6 text-left" data-ditto-id="style-link-3">
                    ...
                    <ul className="box-content block ml-[1.3125rem] [list-style-type:disc] list-outside" data-ditto-id="style-p-30">
                      ...
                      <li className="box-content list-item ml-[0.9375rem] pl-[1.5px]" data-ditto-id="style-strong-2">
              ...
              <div className="w-[49.1875rem] h-275 block absolute top-6.5 left-[12.9375rem] transform-[none] max-md:w-71.5 max-md:h-290 max-md:top-9.5 max-md:left-[1.0625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,106.219)] max-md:origin-[143px_580px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216.18,-207.36)] md:max-lg:origin-[393.5px_550px]" data-ditto-id="style-p-48">
                ...
                <div className="h-257 block absolute top-18 right-0 left-[2.6875rem] max-md:h-[65.9375rem] max-md:top-[6.5625rem] max-md:left-0" data-ditto-id="style-p-38">
                  <div className="box-content h-full block absolute top-0 inset-x-0 text-color-001 [font-family:Montserrat] text-[0.9375rem] leading-6 text-left" data-ditto-id="style-strong-8">
                    ...
                    Please include your preferred employment type in the subject line:
