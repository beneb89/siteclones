...
const ListRow_data = [
    { text: "Host 45-minute onboarding sessions with each new client." },
    { text: "Create a personalized path forward: review her business goals, set 90-day + 6-month milestones, and align her next steps with the program frameworks." },
    { text: "Help her feel confident, clear, and connected from day one." }
];
const ListRow_data2 = [
    { text: "Lead 25-minute accountability calls every other week with each client." },
    { text: "Identify where she’s stuck or overextended, redirect her to her highest-impact actions, and celebrate her progress." },
    { text: "Track goals, document progress in HubSpot, and follow up as needed to ensure results." }
];
const ListRow_data3 = [
    { text: "Serve inside our group coaching community, answering questions, sharing insights, and directing clients to the right trainings and resources." },
    { text: "Model strong boundaries, compassionate accountability, and confident leadership." },
    { text: "Partner with Amy, VP of Client Success, Program Director and other coaches to refine frameworks, share success stories, and identify coaching trends." }
];
const ListRow_data4 = [
    { text: "Master Amy Porterfield’s proprietary frameworks for scalable business growth." },
    { text: "Bring your own online marketing and business expertise and use our systems to help every client reach her next milestone. " },
    { text: "Demonstrate a commitment to continuous learning and staying current with industry best practices and trends." }
];
const ListRow_data5 = [
    { text: "A seasoned business or marketing coach, with 3–5+ years of experience coaching entrepreneurs or service-based business owners." },
    { text: "Deeply familiar with online business models, digital marketing, course creation, or memberships." },
    { text: "Skilled at holding space and driving results; you can spot mindset blocks and operational bottlenecks with equal precision." },
    { text: "An empathetic listener and strategic problem-solver who can meet each student where she is and move her forward." },
    { text: "A natural motivator, confident communicator, and calm under pressure." },
    { text: "Passionate about helping women succeed without sacrificing their peace, family, or freedom." }
];
const ListRow_data6 = [
    { text: "Your clients consistently hit their 90-day and 6-month goals." },
    { text: "You’re known for making members feel supported, encouraged, and equipped." },
    { text: "You maintain clean notes, organized systems, and strong follow-through." },
    { text: "You hit (or exceed) your renewal targets through genuine connection and results-driven coaching." },
    { text: "You embody the tone and ethos of Amy Porterfield’s brand: thoughtful, strategic, and human." }
];
const ListRow2_data = [
    { text: "Paid Holidays ", text2: "– We offer 6 paid holidays per year so team members can take time away from work to rest and celebrate. Holiday dates are communicated each year." },
    { text: "Birthday Leave ", text2: "– Oh yes, you read that right. Never working on your birthday again. Hit the beach or the spa, we don’t care what you do, just don’t come to work! " },
    { text: "Sick Leave ", text2: "– Paid sick leave is available to support your health and well-being. Sick time accrues in accordance with applicable state and local requirements." },
    { text: "Retirement Savings Plan ", text2: "– Roth or 401k…whatever your preference, we’ve got a generous contribution! " },
    { text: "New Parent Leave –", text2: " A benefit bundle of joy! Part-time team members receive 5 weeks of paid parental leave and an optional 1 week of unpaid leave." },
    { text: "Compensation", text2: " – $28.85 - $31.25 per hour based on experience " },
    { text: "Performance-Based Earnings (Commission + Bonuses) ", text2: "– ~$7,500 – $12,000+ annually, based on student renewals, upsells, and team performance." }
];
const ListRow_data7 = [
    { text: "Cover letter and PDF of your resume." },
    { text: "Please note in your application email that you are applying for the Part-Time Business Success Coach position. " },
    { text: "A 3-minute video to introduce yourself and let us know how you heard about the position. (We will not review videos longer than 3 minutes). Please ensure the video is viewable to anyone with the link." }
];
const TextLink_data = [
    { href: "/online-marketing-tools", target: "_self", text: "Resources" },
    { href: "https://twoweeksnoticebook.com/?__hstc=164447072.2067d187dcda81799503e44d3c22756b.1767225601342.1767225601342.1767225601342.1&__hssc=164447072.1.1767225601344&__hsfp=94ef76e50aa552668c1276dec3915e7a", target: "_blank", text: "two weeks notice" },
...
const Logo_meta: string[][] = [
    ...
    ["style-div-38", "style-div-18", "style-link-38"],
    ["style-heading-16", "style-div-19", "style-div-44"]
];
  ...
  return (
    <>
      ...
      <div className="box-content block relative min-w-80 overflow-hidden" id="si-sp">
        ...
        <div className="box-content h-63.5 block relative pointer-events-none max-md:h-[15.0875rem] md:max-lg:h-[162.5px]" data-ditto-id="style-hero-1" id="hero">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-background pointer-events-none">
            ...
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-div-59">
              <div className="w-[55.5625rem] h-21.5 block absolute top-[5.3125rem] left-39 transform-[none] max-md:w-61.5 max-md:h-[5.4375rem] max-md:top-9.5 max-md:left-[2.3125rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,14.0078)] max-md:origin-[123px_43.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216.18,-46.08)] md:max-lg:origin-[444.5px_43px]">
                <h1 className="box-content h-full block absolute top-0 inset-x-0 text-color-001 [font-family:'Ivy_Presto'] text-6xl leading-18 text-center max-md:text-4xl max-md:leading-[2.6875rem]" data-ditto-id="style-div-92" data-component="heading">
                  Business Success Coach (Part-Time)
                </h1>
              </div>
              <div className="w-31 h-30 block absolute left-8 transform-[matrix(-1,0,0,-1,0,0)] origin-[62px_60px] max-md:w-[3.6875rem] max-md:h-14.5 max-md:left-[1.1875rem] max-md:transform-[matrix(-1.17188,0,0,-1.17188,8.33594,4.98438)] max-md:origin-[29.5px_29px] md:max-lg:transform-[matrix(-0.64,0,0,-0.64,-33.84,-21.6)]" data-ditto-id="style-div-60">
              ...
              <div className="w-31 h-30 block absolute top-33.5 left-[65.3125rem] transform-[none] max-md:w-[3.6875rem] max-md:h-14.5 max-md:top-37 max-md:left-[15.1875rem] max-md:transform-[matrix(1.17188,0,0,1.17188,46.8359,30.4219)] max-md:origin-[29.5px_29px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-398.52,-69.84)] md:max-lg:origin-[62px_60px]" data-ditto-id="style-div-73">
        ...
        <div className="box-content h-[43.0625rem] block relative pointer-events-none max-md:h-[50.025rem] md:max-lg:h-[27.5625rem]" id="position-overview">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-background pointer-events-none" data-ditto-id="style-div-90">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90">
              <div className="w-[49.1875rem] h-[21.4375rem] block absolute top-[3.6875rem] left-[12.9375rem] transform-[none] max-md:w-[15.4375rem] max-md:h-269.5 max-md:top-5 max-md:left-5 max-md:transform-[matrix(1.17188,0,0,1.17188,24.6641,96.0781)] max-md:origin-[123.5px_539px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216.18,-82.98)] md:max-lg:origin-[393.5px_171.5px]" data-ditto-id="style-div-75">
                <div className="w-[28.3125rem] h-12 block absolute max-md:w-[15.4375rem] max-md:h-9" data-ditto-id="style-div-76">
                ...
                <div className="h-[16.9375rem] block absolute top-18 right-0 left-[2.6875rem] max-md:h-[63.9375rem] max-md:top-[3.4375rem] max-md:left-0" data-ditto-id="style-br-22">
                  <p className="box-content h-full block absolute top-0 inset-x-0 text-color-001 [font-family:Montserrat] text-[0.9375rem] leading-6 text-left" data-ditto-id="style-heading-4">
                    As a Business Success Coach, you’ll be the front line of transformation inside The Calibrae Collective (our newest coaching experience designed for women founders ready to grow profitable and sustainable businesses with modern online marketing strategies), guiding up to 30 clients through their next phase of business growth.
                    <br className="box-content inline" data-ditto-id="style-p-25" />
                    <br className="box-content inline" data-ditto-id="style-br-24" />
                    Your job? To help each student feel seen, supported, and strategically led as they set goals, build momentum, and implement our frameworks to strengthen their business so that it runs with more ease and profit.
        ...
        <div className="box-content h-177 block relative pointer-events-none max-md:h-[115.9375rem] md:max-lg:h-[453.1px]" data-ditto-id="style-br-35" id="duties-and-responsibilities">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-background pointer-events-none" data-ditto-id="style-heading-12">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-p-54">
              <div className="w-[49.1875rem] h-192.5 block absolute -top-65 left-[12.9375rem] transform-[none] max-md:w-71.5 max-md:h-[94.9375rem] max-md:top-9.5 max-md:left-[1.0625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,137.07)] max-md:origin-[143px_759.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216.18,-45)] md:max-lg:origin-[393.5px_385px]" data-ditto-id="style-br-13">
                <div className="w-[28.3125rem] h-12 block absolute max-md:w-71.5 max-md:h-17.5" data-ditto-id="style-br-44">
                  <h2 className="box-content h-full block absolute top-0 inset-x-0 text-primary [font-family:'Ivy_Presto_Italic'] text-[2.1875rem] leading-10.5 text-left max-md:text-3xl max-md:leading-9" data-ditto-id="style-heading-30" data-component="heading">
                    Duties and Responsibilities:
                    <br className="box-content inline" data-ditto-id="style-p-15" />
                  </h2>
                </div>
                <div className="h-174.5 block absolute top-18 right-0 left-[2.6875rem] max-md:h-[88.8125rem] max-md:top-24.5 max-md:left-0" data-ditto-id="style-link">
                  <div className="box-content h-full block absolute top-0 inset-x-0 text-color-001 [font-family:Montserrat] text-[0.9375rem] leading-6 text-left" data-ditto-id="style-link-2">
                    1. Onboard + Strategize
                    <br className="box-content inline" data-ditto-id="style-link-3" />
                    <ul className="box-content block ml-[1.3125rem] [list-style-type:disc] list-outside" data-ditto-id="style-heading-31">
                    ...
                    <ul className="box-content block ml-[1.3125rem] [list-style-type:disc] list-outside" data-ditto-id="style-p-27">
                    ...
                    <ul className="box-content block ml-[1.3125rem] [list-style-type:disc] list-outside" data-ditto-id="style-br-37">
                    ...
                    <ul className="box-content block ml-[1.3125rem] [list-style-type:disc] list-outside" data-ditto-id="style-p-56">
                      <li className="box-content list-item ml-[0.9375rem] pl-[1.5px]" data-ditto-id="style-p-30">
                    ...
                    <ul className="box-content block ml-[1.3125rem] [list-style-type:disc] list-outside" data-ditto-id="style-p-39">
        ...
        <div className="box-content h-126.5 block relative pointer-events-none max-md:h-[97.1875rem] md:max-lg:h-[20.2375rem]" id="skills-and-experience">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-background pointer-events-none" data-ditto-id="style-br-15">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-br-29">
              <div className="w-[49.1875rem] h-157 block absolute -top-[10.9375rem] left-[12.9375rem] transform-[none] max-md:w-71.5 max-md:h-231.5 max-md:top-9.5 max-md:left-[1.0625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,86.1094)] max-md:origin-[143px_463px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216.18,-50.04)] md:max-lg:origin-[393.5px_314px]" data-ditto-id="style-br-23">
                <div className="w-[28.3125rem] h-12 block absolute max-md:w-71.5 max-md:h-16" data-ditto-id="style-br-30">
                  <h2 className="box-content h-full block absolute top-0 inset-x-0 text-primary [font-family:'Ivy_Presto_Italic'] text-[2.1875rem] leading-10.5 text-left max-md:text-3xl max-md:leading-9" data-ditto-id="style-br-16" data-component="heading">
                    Skills, Abilities and Experience:
                    <br className="box-content inline" data-ditto-id="style-br-7" />
                  </h2>
                </div>
                <div className="h-139 block absolute top-18 right-0 left-[2.6875rem] max-md:h-204.5 max-md:top-27 max-md:left-0" data-ditto-id="style-br-41">
                  <div className="box-content h-full block absolute top-0 inset-x-0 text-color-001 [font-family:Montserrat] text-[0.9375rem] leading-6 text-left" data-ditto-id="style-br-40">
                    ...
                    <ul className="box-content block ml-[1.3125rem] [list-style-type:disc] list-outside" data-ditto-id="style-br-8">
                    ...
                    <ul className="box-content block ml-[1.3125rem] [list-style-type:disc] list-outside" data-ditto-id="style-ul-2">
        ...
        <div className="box-content h-[30.4375rem] block relative pointer-events-none max-md:h-[89.5rem] md:max-lg:h-[311.7px]" data-ditto-id="style-p-26" id="pay-and-perks">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-background pointer-events-none" data-ditto-id="style-p-57">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-p-43">
              <div className="w-[28.3125rem] h-12 block absolute -top-13.5 left-[13.3125rem] transform-[none] max-md:w-71.5 max-md:h-16 max-md:top-9.5 max-md:left-[1.0625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,12.0312)] max-md:origin-[143px_32px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-158.22,10.8)] md:max-lg:origin-[226.5px_24px]" data-ditto-id="style-p-20">
                <h2 className="box-content h-full block absolute top-0 inset-x-0 text-primary [font-family:'Ivy_Presto_Italic'] text-[2.1875rem] leading-10.5 text-left max-md:text-3xl max-md:leading-9" data-ditto-id="style-p-35" data-component="heading">
                  Perks and Pay:
                  <br className="box-content inline" data-ditto-id="style-p-65" />
                </h2>
              </div>
              <div className="w-186 h-[27.6875rem] block absolute top-2 left-[15.1875rem] transform-[none] max-md:w-71.5 max-md:h-204.5 max-md:top-23.5 max-md:left-[1.0625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,86.4531)] max-md:origin-[143px_409px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-221.4,-82.62)] md:max-lg:origin-[372px_221.5px]" data-ditto-id="style-p-21">
                <div className="box-content h-full block absolute top-0 inset-x-0 text-color-001 [font-family:Montserrat] text-[0.9375rem] leading-6 text-left" data-ditto-id="style-heading-13">
                  ...
                  <ul className="box-content block ml-[1.3125rem] [list-style-type:disc] list-outside" data-ditto-id="style-heading-11">
                    {ListRow2_data.map((d, i) => <ListRow2 key={i} d={d} />)}
                    <li className="box-content list-item ml-[0.9375rem] pl-[1.5px]" data-ditto-id="style-p-22">
                      <b className="box-content inline font-bold" data-ditto-id="style-p-10">
                        {"Total On-Track Earnings (OTE) "}
                      </b>
                      – ~$38,000 – $44,500 per year*
        ...
        <div className="box-content h-[40.6875rem] block relative pointer-events-none max-md:h-[1545.7px] md:max-lg:h-[26.0375rem]" data-ditto-id="style-p-7" id="application-instructions">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-background pointer-events-none" data-ditto-id="style-heading-19">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-p-36">
              <div className="w-[49.1875rem] h-[40.8125rem] block absolute top-[1.9375rem] left-[12.9375rem] transform-[none] max-md:w-71.5 max-md:h-290 max-md:top-9.5 max-md:left-[1.0625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,106.219)] max-md:origin-[143px_580px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216.18,-128.7)] md:max-lg:origin-[393.5px_326.5px]" data-ditto-id="style-heading-2">
                <div className="w-[28.3125rem] h-12 block absolute max-md:w-71.5 max-md:h-[4.5625rem]" data-ditto-id="style-p-47">
                  <h2 className="box-content h-full block absolute top-0 inset-x-0 text-primary [font-family:'Ivy_Presto_Italic'] text-[2.1875rem] leading-10.5 text-left max-md:text-3xl max-md:leading-9" data-ditto-id="style-p-49" data-component="heading">
                    Application Instructions:
                    <br className="box-content inline" data-ditto-id="style-p-11" />
                  </h2>
                </div>
                <div className="h-[36.3125rem] block absolute top-18 right-0 left-[2.6875rem] max-md:h-[65.9375rem] max-md:top-[6.5625rem] max-md:left-0" data-ditto-id="style-heading-15">
                  <div className="box-content h-full block absolute top-0 inset-x-0 text-color-001 [font-family:Montserrat] text-[0.9375rem] leading-6 text-left" data-ditto-id="style-strong-4">
                    {"If you’d like to be considered for this role please submit the following via email to "}
                    <a className="box-content inline text-accent underline cursor-pointer" data-ditto-id="style-p-12" data-component="link" href="mailto:careers@amyporterfield.com" target="_self">
                    ...
                    <ol className="box-content block ml-[1.3125rem] [list-style-type:decimal] list-outside" data-ditto-id="style-p-13">
                      {ListRow_data7.map((d, i) => <ListRow key={i} d={d} />)}
                      <li className="box-content list-item ml-[0.9375rem] pl-[1.5px]" data-ditto-id="style-p-48">
                        {"Answers to the following questions "}
                        <u className="box-content inline underline" data-ditto-id="style-p-37">
                          via email
                        </u>
                        :
                      </li>
                    </ol>
                    <ul className="box-content block ml-[1.3125rem] [list-style-type:disc] list-outside" data-ditto-id="style-link-6">
                      <li className="box-content list-item ml-[0.9375rem] pl-[1.5px]" data-ditto-id="style-strong">
                        <span className="box-content inline" data-ditto-id="style-p-38">
                          Tell us about your experience coaching entrepreneurs or service-based business owners. What types of businesses have you supported, and what outcomes are you most proud of helping clients achieve over a 90-day or 6-month period?
                        </span>
                      </li>
                      <li className="box-content list-item ml-[0.9375rem] pl-[1.5px]" data-ditto-id="style-strong-8">
                        <span className="box-content inline" data-ditto-id="style-br-9">
                          {"Describe a time when a client was stuck - either due to mindset challenges, operational issues, or both. "}
                        </span>
                        <span className="box-content inline" data-ditto-id="style-br-21">
                          How did you “hold space” while also helping them move forward in a practical, results-driven way?
                        </span>
                      </li>
                      <li className="box-content list-item ml-[0.9375rem] pl-[1.5px]" data-ditto-id="style-p-63">
                        <span className="box-content inline" data-ditto-id="style-strong-7">
                          Amy Porterfield’s brand is rooted in sustainable business growth. How do you help clients achieve meaningful results while maintaining balance, boundaries, and overall well-being.
        ...
        <div className="box-content h-[15.6875rem] block relative pointer-events-none max-md:h-[34.35rem] md:max-lg:h-[10.0375rem]" data-ditto-id="style-div-52" id="please-note">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-background pointer-events-none" data-ditto-id="style-link-43">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-div-12">
              <div className="w-[49.1875rem] h-[13.4375rem] block absolute top-[1.6875rem] left-[12.9375rem] transform-[none] max-md:w-71.5 max-md:h-106 max-md:top-9.5 max-md:left-[1.0625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,42.9688)] max-md:origin-[143px_212px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216.18,-48.42)] md:max-lg:origin-[393.5px_107.5px]" data-ditto-id="style-link-34">
                <div className="w-[28.3125rem] h-12 block absolute max-md:w-71.5 max-md:h-10.5" data-ditto-id="style-nav-4">
                  <h2 className="box-content h-full block absolute top-0 inset-x-0 text-primary [font-family:'Ivy_Presto_Italic'] text-[2.1875rem] leading-10.5 text-left max-md:text-3xl max-md:leading-9" data-ditto-id="style-link-31" data-component="heading">
                    {"Please Note: "}
                    <br className="box-content inline" data-ditto-id="style-nav-5" />
                  </h2>
                </div>
                <div className="h-[8.9375rem] block absolute top-18 right-0 left-[2.6875rem] max-md:h-90 max-md:top-16 max-md:left-0" data-ditto-id="style-link-32">
                  <p className="box-content h-full block absolute top-0 inset-x-0 text-color-001 [font-family:Montserrat] text-[0.9375rem] leading-6 text-left" data-ditto-id="style-nav-6">
        ...
        <div className="box-content h-104 block relative pointer-events-none max-md:h-[49.5875rem] md:max-lg:h-[16.6375rem]" data-ditto-id="style-div" id="what-we-do">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-background pointer-events-none" data-ditto-id="style-div-32">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-heading">
              <div className="w-[49.1875rem] h-[21.4375rem] block absolute top-[1.6875rem] left-[12.9375rem] transform-[none] max-md:w-71.5 max-md:h-[39.0625rem] max-md:top-9.5 max-md:left-[1.0625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,60.2422)] max-md:origin-[143px_312.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216.18,-71.46)] md:max-lg:origin-[393.5px_171.5px]" data-ditto-id="style-div-33">
                <div className="w-[28.3125rem] h-12 block absolute max-md:w-71.5 max-md:h-10.5" data-ditto-id="style-div-2">
                  <h2 className="box-content h-full block absolute top-0 inset-x-0 text-primary [font-family:'Ivy_Presto_Italic'] text-[2.1875rem] leading-10.5 text-left max-md:text-3xl max-md:leading-9" data-ditto-id="style-link-33" data-component="heading">
                    What We Do:
                    <br className="box-content inline" data-ditto-id="style-nav-7" />
                  </h2>
                </div>
                <div className="h-[16.9375rem] block absolute top-18 right-0 left-[2.6875rem] max-md:h-[35.0625rem] max-md:top-16 max-md:left-0" data-ditto-id="style-br-11">
                  <p className="box-content h-full block absolute top-0 inset-x-0 text-color-001 [font-family:Montserrat] text-[0.9375rem] leading-6 text-left" data-ditto-id="style-link-50">
        ...
        <div className="box-content h-[22.6875rem] block relative pointer-events-none max-md:h-[72.3625rem] md:max-lg:h-[232.3px]" data-ditto-id="style-div-65" id="disclaimer">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-surface pointer-events-none" data-ditto-id="style-link-49">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-nav-8">
              <div className="w-213.5 h-[18.3125rem] block absolute top-[2.1875rem] left-[10.8125rem] transform-[none] max-md:w-71.5 max-md:h-222.5 max-md:top-[3.0625rem] max-md:left-[1.0625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,84.9062)] max-md:origin-[143px_445px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216,-65.34)] md:max-lg:origin-[427px_146.5px]" data-ditto-id="style-heading-3">
                <p className="box-content h-full block absolute top-0 inset-x-0 text-color-001 [font-family:Montserrat] text-[0.9375rem] leading-6 text-left" data-ditto-id="style-i-4">
                  <i className="box-content inline italic" data-ditto-id="style-i">
                    ...
                    <b className="box-content inline font-bold" data-ditto-id="style-about-amy">
                      Disclaimer:
                    </b>
        ...
        <div className="box-content h-87.5 block relative pointer-events-none max-md:h-[64.525rem] md:max-lg:h-56" data-ditto-id="style-div-69" id="footer">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-color-003 pointer-events-none" data-ditto-id="style-div-3">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-div-14">
              <a className="w-60 h-30 block absolute top-22 left-[56.1875rem] transform-[none] cursor-pointer max-md:w-68.5 max-md:h-[9.5625rem] max-md:top-160 max-md:left-6 max-md:transform-[matrix(1.17188,0,0,1.17188,27.6719,123.148)] max-md:origin-[137px_76.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-366.84,-53.28)] md:max-lg:origin-[120px_60px]" data-ditto-id="style-heading-28" data-component="link" href="/side-hustle-ideas-guide-ap" target="_self">
                <div className="box-content h-full block absolute top-0 inset-x-0 bg-cover [background-position:10%_10%] bg-no-repeat" style={{ backgroundImage: "url(\"/assets/cloned/images/be1a66f154c7.gif\")" }} data-ditto-id="style-div-4" src="/assets/cloned/images/be1a66f154c7.gif" />
              </a>
              <a className="w-[7.3125rem] h-4.5 block absolute top-47.5 left-115 transform-[none] cursor-pointer max-md:w-28 max-md:h-[1.3125rem] max-md:top-69 max-md:left-41 max-md:transform-[matrix(1.17188,0,0,1.17188,37.8125,49.2422)] max-md:origin-[56px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-186.66,-71.64)] md:max-lg:origin-[58.5px_9px]" data-ditto-id="style-div-15" data-component="link" href="/online-business-courses" target="_self">
              ...
              <a className="w-[8.1875rem] h-4.5 block absolute top-[7.8125rem] left-115 transform-[none] cursor-pointer max-md:w-[7.9375rem] max-md:h-[1.3125rem] max-md:top-77.5 max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,14.8672,55.0859)] max-md:origin-[63.5px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-189.18,-48.24)] md:max-lg:origin-[65.5px_9px]" data-ditto-id="style-br" data-component="link" href="/about" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-color-001 [font-family:Montserrat] text-[0.8125rem] font-semibold leading-[1.3125rem] tracking-[0.65px] text-left uppercase max-md:leading-[1.4375rem] max-md:tracking-[inherit]" data-ditto-id="style-div-25" data-component="nav">
                  About Amy
                </nav>
              </a>
              <a className="w-30 h-4.5 block absolute top-39.5 left-115 transform-[none] cursor-pointer max-md:w-30.5 max-md:h-[1.3125rem] max-md:top-86 max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,14.4375,60.9297)] max-md:origin-[61px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-187.2,-60.12)] md:max-lg:origin-[60px_9px]" data-ditto-id="style-heading-25" data-component="link" href="/marketing-strategy-podcast" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-color-001 [font-family:Montserrat] text-[0.8125rem] font-semibold leading-[1.3125rem] tracking-[0.65px] text-left uppercase max-md:leading-[1.4375rem]" data-ditto-id="style-link-16" data-component="nav">
                  Podcast
              ...
              <a className="w-60 h-10.5 block absolute top-55.5 left-[56.1875rem] transform-[none] cursor-pointer max-md:w-56.5 max-md:h-[1.3125rem] max-md:top-201.5 max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,23.375,140.336)] max-md:origin-[113px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-366.84,-87.48)] md:max-lg:origin-[120px_21px]" data-ditto-id="style-link-15" data-component="link" href="/side-hustle-ideas-guide-ap" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-color-001 [font-family:Montserrat] text-[0.8125rem] font-semibold leading-[1.3125rem] tracking-[0.65px] text-left uppercase max-md:leading-[1.4375rem]" data-ditto-id="style-nav-11" data-component="nav">
                  Map Out Your Side Hustle Idea Profit Potential
                  <br className="box-content inline" data-ditto-id="style-div-26" />
                </nav>
              </a>
              <a className="w-5.5 h-7.5 block absolute top-54.5 left-280.5 transform-[none] cursor-pointer max-md:h-[1.5625rem] max-md:top-201 max-md:left-[15.6875rem] max-md:transform-[matrix(1.17188,0,0,1.17188,45.0312,140.336)] max-md:origin-[11px_12.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-407.88,-83.88)] md:max-lg:origin-[11px_15px]" data-ditto-id="style-nav-19" data-component="link" href="/side-hustle-ideas-guide-ap" target="_self">
                <div className="box-content h-full block" data-ditto-id="style-link-42">
                  <svg className="box-content w-5.5 h-7.5 inline overflow-hidden align-top max-md:h-[1.5625rem]" data-ditto-id="style-nav-13" data-component="icon" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                    <path d="M85 277.375h259.704L225.002 397.077 256 427l171-171L256 85l-29.922 29.924 118.626 119.701H85v42.75z" />
                  </svg>
                </div>
              </a>
              <div className="w-[19.1875rem] h-[7.3125rem] block absolute top-[5.6875rem] left-15 transform-[none] max-md:w-[14.0625rem] max-md:h-[8.9375rem] max-md:top-[4.4375rem] max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,23.2891,24.4922)] max-md:origin-[112.5px_71.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-76.86,-53.82)] md:max-lg:origin-[153.5px_58.5px]" data-ditto-id="style-instagram-feed">
                <p className="box-content h-full block absolute top-0 inset-x-0 text-color-001 [font-family:Montserrat] text-[0.8125rem] leading-[1.3125rem] text-left max-md:leading-[1.4375rem]" data-ditto-id="style-div-53">
              ...
              <a className="w-52.5 h-[1.5625rem] block absolute top-[3.0625rem] left-14 transform-[none] cursor-pointer max-md:w-[13.3125rem] max-md:h-[2.1875rem] max-md:top-6 max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,22.2578,7.13281)] max-md:origin-[106.5px_17.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-57.96,-22.14)] md:max-lg:origin-[105px_12.5px]" data-ditto-id="style-div-67" data-component="link" href="/" target="_self">
                <div className="box-content h-full block absolute top-0 inset-x-0 bg-contain [background-position:50%_50%] bg-no-repeat" style={{ backgroundImage: "url(\"/assets/cloned/images/1e9e95f91617.png\")" }} data-ditto-id="style-div-36" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" />
              </a>
              <a className="w-47.5 h-4.5 block absolute top-[17.5625rem] left-231.5 transform-[matrix(1,0,0,1,40,0)] origin-[95px_9px] cursor-pointer max-md:hidden md:max-lg:transform-[matrix(0.64,0,0,0.64,-367.56,-104.4)] 2xl:transform-[matrix(1,0,0,1,360,0)]" data-ditto-id="style-instagram-feed-0" data-component="link" href="#si-sp" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-primary [font-family:Montserrat] text-[0.8125rem] leading-[1.3125rem] tracking-[0.65px] text-right uppercase" data-ditto-id="style-div-42" data-component="nav">
                  back to top
                </nav>
              </a>
              {Logo_data.map((d, i) => <Logo key={i} d={d} styles={Logo_styles[i]} />)}
              <div className="w-58.5 h-[1.3125rem] block absolute top-[15.1875rem] left-15 transform-[none] max-md:hidden md:max-lg:transform-[matrix(0.64,0,0,0.64,-63.72,-91.26)] md:max-lg:origin-[117px_10.5px]" data-ditto-id="style-button-3">
                <h3 className="box-content h-full block absolute top-0 inset-x-0 text-primary [font-family:Montserrat] font-semibold leading-[1.1875rem] tracking-[1.6px] text-left uppercase" data-ditto-id="style-nav-26" data-component="heading">
                  Let's be friends
                </h3>
              </div>
              <a className="w-49.5 h-4.5 block absolute top-[5.8125rem] left-158 transform-[none] cursor-pointer max-md:w-[12.1875rem] max-md:h-[1.3125rem] max-md:top-[26.9375rem] max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,20.7109,75.8828)] max-md:origin-[97.5px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-263.16,-36.72)] md:max-lg:origin-[99px_9px]" data-ditto-id="style-hs-web-interactives-top-anchor-4" data-component="link" href="/mylogin" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-color-001 [font-family:Montserrat] text-[0.8125rem] font-semibold leading-[1.3125rem] tracking-[0.65px] text-left uppercase max-md:leading-[1.4375rem] max-md:tracking-[inherit]" data-ditto-id="style-hs-web-interactives-floating-container-2" data-component="nav">
                  student login
                </nav>
              </a>
              {Tile_data.map((d, i) => <Tile key={i} d={d} styles={Tile_styles[i]} />)}
              <a className="w-49.5 h-4.5 block absolute top-[7.8125rem] left-158 transform-[none] cursor-pointer max-md:w-[12.1875rem] max-md:h-[1.3125rem] max-md:top-[28.8125rem] max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,20.7109,81.0391)] max-md:origin-[97.5px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-263.16,-48.24)] md:max-lg:origin-[99px_9px]" data-ditto-id="style-div-114" data-component="link" href="/reviews" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-color-001 [font-family:Montserrat] text-[0.8125rem] font-semibold leading-[1.3125rem] tracking-[0.65px] text-left uppercase max-md:leading-[1.4375rem] max-md:tracking-[inherit]" data-ditto-id="style-p-24" data-component="nav">
                  student stories
                </nav>
              </a>
              <div className="w-[13.9375rem] h-[1.4375rem] block absolute top-12.5 left-[56.1875rem] transform-[none] max-md:w-62.5 max-md:h-7 max-md:top-149.5 max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,25.4375,105.188)] max-md:origin-[125px_14px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-363.78,-22.14)] md:max-lg:origin-[111.5px_11.5px]" data-ditto-id="style-i-6">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-primary [font-family:'IvyPresto_Headline_Regular'] text-lg leading-[1.8125rem] text-left max-md:leading-[2rem]" data-ditto-id="style-reviews-review-1-3" data-component="nav">
                  Get Started For Free
                </nav>
              </div>
              <a className="w-[7.3125rem] h-4.5 block absolute top-[15.9375rem] left-115 transform-[none] cursor-pointer max-md:w-33.5 max-md:h-[1.3125rem] max-md:top-86 max-md:left-41 max-md:transform-[matrix(1.17188,0,0,1.17188,39.7031,60.9297)] max-md:origin-[67px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-186.66,-95.04)] md:max-lg:origin-[58.5px_9px]" data-ditto-id="style-div-21" data-component="link" href="/newsletter" target="_self">
        ...
        <div className="box-content h-[12.0625rem] block relative pointer-events-none max-md:h-[372.7px] md:max-lg:h-[123.5px]" id="instagram-feed">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-surface-4 pointer-events-none" data-ditto-id="style-i-2">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-div-79">
              <div className="w-261.5 h-45.5 block absolute top-[0.3125rem] left-[16.3125rem] overflow-hidden transform-[matrix(1,0,0,1,-40,0)] origin-[523px_91px] max-md:w-80 max-md:h-36 max-md:top-42 max-md:left-0 max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,41.25)] max-md:origin-[160px_72px] md:max-lg:w-241.5 md:max-lg:transform-[matrix(0.64,0,0,0.64,-267.84,-34.56)] md:max-lg:origin-[483px_91px] 2xl:w-421.5 2xl:transform-[matrix(1,0,0,1,-360,0)] 2xl:origin-[843px_91px]" data-ditto-id="style-button-2">
                <div className="box-content block overflow-hidden" data-ditto-id="style-footer" id="instagram-feed_0">
                  <div className="box-content grid justify-center gap-[0.3125rem] grid-cols-[182px_182px_182px_182px_182px] grid-rows-10 max-md:grid-cols-[144px_144px] max-md:grid-rows-[144px_144px_144px_144px_144px_144px_144px_144px_144px_144px_144px_144px_144px_144px_144px_144px_144px_144px_144px_144px_144px_144px_144px_144px_144px] md:max-lg:grid-rows-[182px_182px_182px_182px_182px_182px_182px_182px_182px_182px] 2xl:grid-cols-9 2xl:grid-rows-6" data-ditto-id="style-div-80">
                    {Logo2_data.map((d, i) => <Logo2 key={i} d={d} />)}
                  </div>
                </div>
              </div>
              <div className="w-[16.3125rem] h-48.5 block absolute top-0 transform-[matrix(1,0,0,1,-40,0)] origin-[130.5px_97px] max-md:w-80 max-md:h-40 max-md:-top-px max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,13.5781)] max-md:origin-[160px_80px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-46.98,-34.92)] 2xl:transform-[matrix(1,0,0,1,-360,0)]" data-ditto-id="style-heading-32">
                <div className="h-full block bg-surface" data-ditto-id="style-i-7" />
              </div>
              <div className="w-46.5 h-18.5 block absolute top-8.5 left-9.5 transform-[matrix(1,0,0,1,-40,0)] origin-[93px_37px] max-md:w-[18.9375rem] max-md:h-9.5 max-md:top-7 max-md:left-[0.5625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5859,8.07812)] max-md:origin-[151.5px_19px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-47.16,-25.56)] 2xl:transform-[matrix(1,0,0,1,-360,0)]" data-ditto-id="style-recent-episodes-1">
              ...
              <a className="w-56 h-10.5 block absolute top-29.5 left-5.5 transform-[matrix(1,0,0,1,-40,0)] origin-[112px_21px] cursor-pointer max-md:w-[15.8125rem] max-md:h-[2.8125rem] max-md:top-[4.9375rem] max-md:left-8.5 max-md:transform-[matrix(1.17188,0,0,1.17188,27.5859,17.4453)] max-md:origin-[126.5px_22.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-48.24,-50.04)] 2xl:transform-[matrix(1,0,0,1,-360,0)]" data-ditto-id="style-div-71" data-component="link" href="https://www.instagram.com/amyporterfield" target="_blank">
                <div className="h-full block bg-accent" data-ditto-id="style-div-85" />
              </a>
        ...
        <div className="box-content h-20 block relative z-4 pointer-events-none max-md:h-[263.7px] md:max-lg:h-[3.2rem]" id="footer-legal-accessibility">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-color-001 pointer-events-none">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90">
              <a className="w-26.5 h-4.5 block absolute top-[1.9375rem] left-[29.5625rem] transform-[matrix(1,0,0,1,40,0)] origin-[53px_9px] cursor-pointer max-md:w-23.5 max-md:h-[1.3125rem] max-md:top-21.5 max-md:left-6 max-md:transform-[matrix(1.17188,0,0,1.17188,12.2031,16.5859)] max-md:origin-[47px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-189.36,-14.4)] 2xl:transform-[matrix(1,0,0,1,360,0)]" data-ditto-id="style-div-39" data-component="link" href="/privacy" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-background [font-family:Montserrat] text-[0.6875rem] font-medium leading-[1.125rem] tracking-[0.55px] text-right uppercase max-md:text-[0.625rem] max-md:leading-4.5 max-md:tracking-[0.5px] max-md:text-left" data-ditto-id="style-div-86" data-component="nav">
                  privacy policy
                  <br className="box-content inline" />
                </nav>
              </a>
              {TextLink2_data.map((d, i) => <TextLink2 key={i} d={d} styles={TextLink2_styles[i]} />)}
              <a className="w-[21.1875rem] h-4.5 block absolute top-[1.9375rem] left-5 transform-[matrix(1,0,0,1,-40,0)] origin-[169.5px_9px] cursor-pointer max-md:w-68.5 max-md:h-[1.4375rem] max-md:top-6 max-md:left-6 max-md:transform-[matrix(1.17188,0,0,1.17188,27.6719,6.10156)] max-md:origin-[137px_11.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-68.22,-14.4)] 2xl:transform-[matrix(1,0,0,1,-360,0)]" data-ditto-id="style-icon-4" data-component="link" href="/" target="_self">
                <h2 className="box-content h-full block absolute top-0 inset-x-0 text-background [font-family:Montserrat] text-[0.6875rem] font-light leading-[1.125rem] tracking-[0.55px] text-left uppercase max-md:leading-[1.25rem] max-md:tracking-[inherit]" data-ditto-id="style-the-latest-1-1" data-component="heading">
