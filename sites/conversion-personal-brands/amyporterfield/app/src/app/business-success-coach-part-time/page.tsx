...
const TextLink_data = [
    ...
    { href: "https://twoweeksnoticebook.com/?__hstc=164447072.fe04dbf884f62deb1f85978d734c3857.1767225601408.1767225601408.1767225601408.1&__hssc=164447072.1.1767225601408&__hsfp=94ef76e50aa552668c1276dec3915e7a", target: "_blank", text: "two weeks notice" },
...
const Logo_meta: string[][] = [
    ["n250", "style-div-16", "style-link-33"],
    ["style-nav-20", "n254", "style-div-40"],
    ["style-div-34", "style-div-17", "style-div-37"],
    ["style-div-35", "style-div-18", "style-link-34"],
    ["style-heading-11", "style-div-19", "style-div-41"]
];
    ...
    <>
      ...
      <div className="box-content block relative min-w-80 overflow-hidden" id="si-sp">
        ...
        <div className="box-content h-63.5 block relative pointer-events-none max-md:h-[15.0875rem] md:max-lg:h-[162.5px]" data-ditto-id="style-hero-1" id="hero">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-background pointer-events-none">
            ...
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-div-50">
              ...
              <div className="w-31 h-30 block absolute left-8 transform-[matrix(-1,0,0,-1,0,0)] origin-[62px_60px] max-md:w-[3.6875rem] max-md:h-14.5 max-md:left-[1.1875rem] max-md:transform-[matrix(-1.17188,0,0,-1.17188,8.33594,4.98438)] max-md:origin-[29.5px_29px] md:max-lg:transform-[matrix(-0.64,0,0,-0.64,-33.84,-21.6)]" data-ditto-id="style-div-51">
              ...
              <div className="w-31 h-30 block absolute top-33.5 left-[65.3125rem] transform-[none] max-md:w-[3.6875rem] max-md:h-14.5 max-md:top-37 max-md:left-[15.1875rem] max-md:transform-[matrix(1.17188,0,0,1.17188,46.8359,30.4219)] max-md:origin-[29.5px_29px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-398.52,-69.84)] md:max-lg:origin-[62px_60px]">
        ...
        <div className="box-content h-[43.0625rem] block relative pointer-events-none max-md:h-[50.025rem] md:max-lg:h-[27.5625rem]" id="position-overview">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-background pointer-events-none">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90">
              <div className="w-[49.1875rem] h-[21.4375rem] block absolute top-[3.6875rem] left-[12.9375rem] transform-[none] max-md:w-[15.4375rem] max-md:h-269.5 max-md:top-5 max-md:left-5 max-md:transform-[matrix(1.17188,0,0,1.17188,24.6641,96.0781)] max-md:origin-[123.5px_539px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216.18,-82.98)] md:max-lg:origin-[393.5px_171.5px]">
                <div className="w-[28.3125rem] h-12 block absolute max-md:w-[15.4375rem] max-md:h-9" data-ditto-id="style-div-54">
                ...
                <div className="h-[16.9375rem] block absolute top-18 right-0 left-[2.6875rem] max-md:h-[63.9375rem] max-md:top-[3.4375rem] max-md:left-0" data-ditto-id="style-br-20">
                  <p className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.9375rem] leading-6 text-left" data-ditto-id="style-heading-3">
        ...
        <div className="box-content h-177 block relative pointer-events-none max-md:h-[115.9375rem] md:max-lg:h-[453.1px]" id="duties-and-responsibilities">
            ...
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90">
              <div className="w-[49.1875rem] h-192.5 block absolute -top-65 left-[12.9375rem] transform-[none] max-md:w-71.5 max-md:h-[94.9375rem] max-md:top-9.5 max-md:left-[1.0625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,137.07)] max-md:origin-[143px_759.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216.18,-45)] md:max-lg:origin-[393.5px_385px]" data-ditto-id="style-br-13">
                ...
                <div className="h-174.5 block absolute top-18 right-0 left-[2.6875rem] max-md:h-[88.8125rem] max-md:top-24.5 max-md:left-0" data-ditto-id="style-link">
                  <div className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.9375rem] leading-6 text-left" data-ditto-id="style-link-2">
                    1. Onboard + Strategize
                    <br className="box-content inline" data-ditto-id="style-link-3" />
                    <ul className="box-content block ml-[1.3125rem] [list-style-type:disc] list-outside" data-ditto-id="style-heading-22">
                    ...
                    <ul className="box-content block ml-[1.3125rem] [list-style-type:disc] list-outside" data-ditto-id="style-br-29">
        ...
        <div className="box-content h-126.5 block relative pointer-events-none max-md:h-[97.1875rem] md:max-lg:h-[20.2375rem]" id="skills-and-experience">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-background pointer-events-none" data-ditto-id="style-br-15">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90">
              <div className="w-[49.1875rem] h-157 block absolute -top-[10.9375rem] left-[12.9375rem] transform-[none] max-md:w-71.5 max-md:h-231.5 max-md:top-9.5 max-md:left-[1.0625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,86.1094)] max-md:origin-[143px_463px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216.18,-50.04)] md:max-lg:origin-[393.5px_314px]" data-ditto-id="style-br-21">
                <div className="w-[28.3125rem] h-12 block absolute max-md:w-71.5 max-md:h-16">
                ...
                <div className="h-139 block absolute top-18 right-0 left-[2.6875rem] max-md:h-204.5 max-md:top-27 max-md:left-0">
                  <div className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.9375rem] leading-6 text-left" data-ditto-id="style-br-24">
                    ...
                    <ul className="box-content block ml-[1.3125rem] [list-style-type:disc] list-outside" data-ditto-id="style-ul">
        ...
        <div className="box-content h-[30.4375rem] block relative pointer-events-none max-md:h-[89.5rem] md:max-lg:h-[311.7px]" data-ditto-id="style-p-26" id="pay-and-perks">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-background pointer-events-none" data-ditto-id="style-p-40">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-p-34">
              ...
              <div className="w-186 h-[27.6875rem] block absolute top-2 left-[15.1875rem] transform-[none] max-md:w-71.5 max-md:h-204.5 max-md:top-23.5 max-md:left-[1.0625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,86.4531)] max-md:origin-[143px_409px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-221.4,-82.62)] md:max-lg:origin-[372px_221.5px]" data-ditto-id="style-p-21">
                <div className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.9375rem] leading-6 text-left" data-ditto-id="style-heading-8">
                  ...
                  <ul className="box-content block ml-[1.3125rem] [list-style-type:disc] list-outside" data-ditto-id="style-heading-17">
        ...
        <div className="box-content h-[40.6875rem] block relative pointer-events-none max-md:h-[1545.7px] md:max-lg:h-[26.0375rem]" data-ditto-id="style-p-7" id="application-instructions">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-background pointer-events-none" data-ditto-id="style-heading-14">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-p-46">
              <div className="w-[49.1875rem] h-[40.8125rem] block absolute top-[1.9375rem] left-[12.9375rem] transform-[none] max-md:w-71.5 max-md:h-290 max-md:top-9.5 max-md:left-[1.0625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,106.219)] max-md:origin-[143px_580px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216.18,-128.7)] md:max-lg:origin-[393.5px_326.5px]" data-ditto-id="style-heading">
                <div className="w-[28.3125rem] h-12 block absolute max-md:w-71.5 max-md:h-[4.5625rem]" data-ditto-id="style-p-44">
                  <h2 className="box-content h-full block absolute top-0 inset-x-0 text-primary [font-family:'Ivy_Presto_Italic'] text-[2.1875rem] leading-10.5 text-left max-md:text-3xl max-md:leading-9" data-component="heading">
                    Application Instructions:
                    <br className="box-content inline" data-ditto-id="style-p-11" />
                  </h2>
                </div>
                <div className="h-[36.3125rem] block absolute top-18 right-0 left-[2.6875rem] max-md:h-[65.9375rem] max-md:top-[6.5625rem] max-md:left-0" data-ditto-id="style-heading-10">
                  <div className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.9375rem] leading-6 text-left">
                    ...
                    <a className="box-content inline text-color-001 underline cursor-pointer" data-ditto-id="style-p-12" data-component="link" href="mailto:careers@amyporterfield.com" target="_self">
                    ...
                    <ol className="box-content block ml-[1.3125rem] [list-style-type:decimal] list-outside" data-ditto-id="style-p-13">
                      ...
                      <li className="box-content list-item ml-[0.9375rem] pl-[1.5px]" data-ditto-id="style-p-45">
                    ...
                    <ul className="box-content block ml-[1.3125rem] [list-style-type:disc] list-outside" data-ditto-id="style-link-6">
                      ...
                      <li className="box-content list-item ml-[0.9375rem] pl-[1.5px]" data-ditto-id="style-strong-6">
                      ...
                      <li className="box-content list-item ml-[0.9375rem] pl-[1.5px]" data-ditto-id="style-p-47">
                        <span className="box-content inline" data-ditto-id="style-strong-5">
        ...
        <div className="box-content h-[15.6875rem] block relative pointer-events-none max-md:h-[34.35rem] md:max-lg:h-[10.0375rem]" id="please-note">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-background pointer-events-none">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-div-12">
              <div className="w-[49.1875rem] h-[13.4375rem] block absolute top-[1.6875rem] left-[12.9375rem] transform-[none] max-md:w-71.5 max-md:h-106 max-md:top-9.5 max-md:left-[1.0625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,42.9688)] max-md:origin-[143px_212px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216.18,-48.42)] md:max-lg:origin-[393.5px_107.5px]" data-ditto-id="style-link-36">
                <div className="w-[28.3125rem] h-12 block absolute max-md:w-71.5 max-md:h-10.5" data-ditto-id="style-nav-4">
                  <h2 className="box-content h-full block absolute top-0 inset-x-0 text-primary [font-family:'Ivy_Presto_Italic'] text-[2.1875rem] leading-10.5 text-left max-md:text-3xl max-md:leading-9" data-ditto-id="style-link-35" data-component="heading">
                    {"Please Note: "}
                    <br className="box-content inline" data-ditto-id="style-nav-5" />
                  </h2>
                </div>
                <div className="h-[8.9375rem] block absolute top-18 right-0 left-[2.6875rem] max-md:h-90 max-md:top-16 max-md:left-0">
                  <p className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.9375rem] leading-6 text-left" data-ditto-id="style-nav-6">
        ...
        <div className="box-content h-104 block relative pointer-events-none max-md:h-[49.5875rem] md:max-lg:h-[16.6375rem]" data-ditto-id="style-div" id="what-we-do">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-background pointer-events-none">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-div-2">
              <div className="w-[49.1875rem] h-[21.4375rem] block absolute top-[1.6875rem] left-[12.9375rem] transform-[none] max-md:w-71.5 max-md:h-[39.0625rem] max-md:top-9.5 max-md:left-[1.0625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,60.2422)] max-md:origin-[143px_312.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216.18,-71.46)] md:max-lg:origin-[393.5px_171.5px]">
                <div className="w-[28.3125rem] h-12 block absolute max-md:w-71.5 max-md:h-10.5" data-ditto-id="style-div-3">
                  <h2 className="box-content h-full block absolute top-0 inset-x-0 text-primary [font-family:'Ivy_Presto_Italic'] text-[2.1875rem] leading-10.5 text-left max-md:text-3xl max-md:leading-9" data-component="heading">
                    What We Do:
        ...
        <div className="box-content h-[22.6875rem] block relative pointer-events-none max-md:h-[72.3625rem] md:max-lg:h-[232.3px]" id="disclaimer">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-surface-2 pointer-events-none">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-nav-8">
              <div className="w-213.5 h-[18.3125rem] block absolute top-[2.1875rem] left-[10.8125rem] transform-[none] max-md:w-71.5 max-md:h-222.5 max-md:top-[3.0625rem] max-md:left-[1.0625rem] max-md:transform-[matrix(1.17188,0,0,1.17188,27.5,84.9062)] max-md:origin-[143px_445px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-216,-65.34)] md:max-lg:origin-[427px_146.5px]" data-ditto-id="style-heading-2">
                <p className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.9375rem] leading-6 text-left">
        ...
        <div className="box-content h-87.5 block relative pointer-events-none max-md:h-[64.525rem] md:max-lg:h-56" id="footer">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-color-002 pointer-events-none" data-ditto-id="style-div-4">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90" data-ditto-id="style-div-14">
              <a className="w-60 h-30 block absolute top-22 left-[56.1875rem] transform-[none] cursor-pointer max-md:w-68.5 max-md:h-[9.5625rem] max-md:top-160 max-md:left-6 max-md:transform-[matrix(1.17188,0,0,1.17188,27.6719,123.148)] max-md:origin-[137px_76.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-366.84,-53.28)] md:max-lg:origin-[120px_60px]" data-component="link" href="https://www.amyporterfield.com/side-hustle-ideas-guide-ap" target="_self">
                <div className="box-content h-full block absolute top-0 inset-x-0 bg-cover [background-position:10%_10%] bg-no-repeat" style={{ backgroundImage: "url(\"/assets/cloned/images/be1a66f154c7.gif\")" }} data-ditto-id="style-div-5" src="/assets/cloned/images/be1a66f154c7.gif" />
              </a>
              <a className="w-[7.3125rem] h-4.5 block absolute top-47.5 left-115 transform-[none] cursor-pointer max-md:w-28 max-md:h-[1.3125rem] max-md:top-69 max-md:left-41 max-md:transform-[matrix(1.17188,0,0,1.17188,37.8125,49.2422)] max-md:origin-[56px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-186.66,-71.64)] md:max-lg:origin-[58.5px_9px]" data-ditto-id="style-div-15" data-component="link" href="https://www.amyporterfield.com/online-business-courses" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.8125rem] font-semibold leading-[1.3125rem] tracking-[0.65px] text-left uppercase max-md:leading-[1.4375rem] max-md:tracking-[inherit]" data-ditto-id="style-heading-4" data-component="nav">
                  Courses
                </nav>
              </a>
              <a className="w-[8.1875rem] h-4.5 block absolute top-[7.8125rem] left-115 transform-[none] cursor-pointer max-md:w-[7.9375rem] max-md:h-[1.3125rem] max-md:top-77.5 max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,14.8672,55.0859)] max-md:origin-[63.5px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-189.18,-48.24)] md:max-lg:origin-[65.5px_9px]" data-ditto-id="style-br" data-component="link" href="/about" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.8125rem] font-semibold leading-[1.3125rem] tracking-[0.65px] text-left uppercase max-md:leading-[1.4375rem] max-md:tracking-[inherit]" data-ditto-id="style-div-25" data-component="nav">
                  About Amy
                </nav>
              </a>
              <a className="w-30 h-4.5 block absolute top-39.5 left-115 transform-[none] cursor-pointer max-md:w-30.5 max-md:h-[1.3125rem] max-md:top-86 max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,14.4375,60.9297)] max-md:origin-[61px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-187.2,-60.12)] md:max-lg:origin-[60px_9px]" data-component="link" href="https://www.amyporterfield.com/marketing-strategy-podcast" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.8125rem] font-semibold leading-[1.3125rem] tracking-[0.65px] text-left uppercase max-md:leading-[1.4375rem]" data-ditto-id="style-link-17" data-component="nav">
                  Podcast
              ...
              <a className="w-60 h-10.5 block absolute top-55.5 left-[56.1875rem] transform-[none] cursor-pointer max-md:w-56.5 max-md:h-[1.3125rem] max-md:top-201.5 max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,23.375,140.336)] max-md:origin-[113px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-366.84,-87.48)] md:max-lg:origin-[120px_21px]" data-ditto-id="style-link-16" data-component="link" href="https://www.amyporterfield.com/side-hustle-ideas-guide-ap" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.8125rem] font-semibold leading-[1.3125rem] tracking-[0.65px] text-left uppercase max-md:leading-[1.4375rem]" data-ditto-id="style-nav-11" data-component="nav">
                  Map Out Your Side Hustle Idea Profit Potential
                  <br className="box-content inline" data-ditto-id="style-div-26" />
                </nav>
              </a>
              <a className="w-5.5 h-7.5 block absolute top-54.5 left-280.5 transform-[none] cursor-pointer max-md:h-[1.5625rem] max-md:top-201 max-md:left-[15.6875rem] max-md:transform-[matrix(1.17188,0,0,1.17188,45.0312,140.336)] max-md:origin-[11px_12.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-407.88,-83.88)] md:max-lg:origin-[11px_15px]" data-ditto-id="style-nav-18" data-component="link" href="https://www.amyporterfield.com/side-hustle-ideas-guide-ap" target="_self">
              ...
              <a className="w-52.5 h-[1.5625rem] block absolute top-[3.0625rem] left-14 transform-[none] cursor-pointer max-md:w-[13.3125rem] max-md:h-[2.1875rem] max-md:top-6 max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,22.2578,7.13281)] max-md:origin-[106.5px_17.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-57.96,-22.14)] md:max-lg:origin-[105px_12.5px]" data-component="link" href="/" target="_self">
                <div className="box-content h-full block absolute top-0 inset-x-0 bg-contain [background-position:50%_50%] bg-no-repeat" style={{ backgroundImage: "url(\"/assets/cloned/images/1e9e95f91617.png\")" }} data-ditto-id="style-div-33" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" />
              </a>
              <a className="w-47.5 h-4.5 block absolute top-[17.5625rem] left-231.5 transform-[matrix(1,0,0,1,40,0)] origin-[95px_9px] cursor-pointer max-md:hidden md:max-lg:transform-[matrix(0.64,0,0,0.64,-367.56,-104.4)] 2xl:transform-[matrix(1,0,0,1,360,0)]" data-ditto-id="style-instagram-feed-0" data-component="link" href="#si-sp" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-primary [font-family:Montserrat] text-[0.8125rem] leading-[1.3125rem] tracking-[0.65px] text-right uppercase" data-ditto-id="style-div-39" data-component="nav">
                  back to top
                </nav>
              </a>
              {Logo_data.map((d, i) => <Logo key={i} d={d} styles={Logo_styles[i]} />)}
              <div className="w-58.5 h-[1.3125rem] block absolute top-[15.1875rem] left-15 transform-[none] max-md:hidden md:max-lg:transform-[matrix(0.64,0,0,0.64,-63.72,-91.26)] md:max-lg:origin-[117px_10.5px]" data-ditto-id="style-button-2">
              ...
              <a className="w-49.5 h-4.5 block absolute top-[7.8125rem] left-158 transform-[none] cursor-pointer max-md:w-[12.1875rem] max-md:h-[1.3125rem] max-md:top-[28.8125rem] max-md:left-[1.4375rem] max-md:transform-[matrix(1.17188,0,0,1.17188,20.7109,81.0391)] max-md:origin-[97.5px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-263.16,-48.24)] md:max-lg:origin-[99px_9px]" data-component="link" href="https://www.amyporterfield.com/reviews" target="_self">
                <nav className="box-content h-full block absolute top-0 inset-x-0 text-border [font-family:Montserrat] text-[0.8125rem] font-semibold leading-[1.3125rem] tracking-[0.65px] text-left uppercase max-md:leading-[1.4375rem] max-md:tracking-[inherit]" data-ditto-id="style-p-24" data-component="nav">
                  student stories
                </nav>
              </a>
              ...
              <a className="w-[7.3125rem] h-4.5 block absolute top-[15.9375rem] left-115 transform-[none] cursor-pointer max-md:w-33.5 max-md:h-[1.3125rem] max-md:top-86 max-md:left-41 max-md:transform-[matrix(1.17188,0,0,1.17188,39.7031,60.9297)] max-md:origin-[67px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-186.66,-95.04)] md:max-lg:origin-[58.5px_9px]" data-ditto-id="style-div-21" data-component="link" href="https://www.amyporterfield.com/newsletter" target="_self">
          ...
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-surface-3 pointer-events-none" data-ditto-id="style-i-2">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90">
              ...
              <a className="w-7 h-[1.5625rem] block absolute top-31.5 left-[2.0625rem] transform-[matrix(1,0,0,1,-40,0)] origin-[14px_12.5px] cursor-pointer max-md:w-[1.6875rem] max-md:h-[1.6875rem] max-md:top-22 max-md:left-12 max-md:transform-[matrix(1.17188,0,0,1.17188,10.5703,17.4453)] max-md:origin-[13.5px_13.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-16.92,-49.86)] 2xl:transform-[matrix(1,0,0,1,-360,0)]" data-component="link" href="https://www.instagram.com/amyporterfield" target="_self">
                <div className="box-content h-full block">
                  <svg className="box-content w-7 h-[1.5625rem] inline overflow-hidden align-top max-md:w-[1.6875rem] max-md:h-[1.6875rem]" data-ditto-id="style-div-42" data-component="icon" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                    <circle cx="255.25" cy="256.21" r="70.68" />
                    <path d="M338,54.63H174c-62.72,0-114,51.31-114,114V343.33c0,62.73,51.32,114,114,114H338c62.72,0,114-51.31,114-114V168.67C452,105.94,400.68,54.63,338,54.63ZM255.77,364.07A107.95,107.95,0,1,1,363.71,256.13,107.95,107.95,0,0,1,255.77,364.07Zm109.67-192A25.56,25.56,0,1,1,391,146.5,25.56,25.56,0,0,1,365.44,172.06Z" />
                  </svg>
                </div>
        ...
        <div className="box-content h-20 block relative z-4 pointer-events-none max-md:h-[263.7px] md:max-lg:h-[3.2rem]" id="footer-legal-accessibility">
          <div className="box-content h-full block absolute top-0 inset-x-0 bg-border pointer-events-none">
            <div className="box-content w-300 h-full block relative max-h-20000 mx-10 pointer-events-none max-md:w-[23.4375rem] max-lg:mx-0 md:max-lg:w-192 2xl:mx-90">
              <a className="w-26.5 h-4.5 block absolute top-[1.9375rem] left-[29.5625rem] transform-[matrix(1,0,0,1,40,0)] origin-[53px_9px] cursor-pointer max-md:w-23.5 max-md:h-[1.3125rem] max-md:top-21.5 max-md:left-6 max-md:transform-[matrix(1.17188,0,0,1.17188,12.2031,16.5859)] max-md:origin-[47px_10.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-189.36,-14.4)] 2xl:transform-[matrix(1,0,0,1,360,0)]" data-ditto-id="style-div-36" data-component="link" href="https://www.amyporterfield.com/privacy" target="_self">
              ...
              <a className="w-[21.1875rem] h-4.5 block absolute top-[1.9375rem] left-5 transform-[matrix(1,0,0,1,-40,0)] origin-[169.5px_9px] cursor-pointer max-md:w-68.5 max-md:h-[1.4375rem] max-md:top-6 max-md:left-6 max-md:transform-[matrix(1.17188,0,0,1.17188,27.6719,6.10156)] max-md:origin-[137px_11.5px] md:max-lg:transform-[matrix(0.64,0,0,0.64,-68.22,-14.4)] 2xl:transform-[matrix(1,0,0,1,-360,0)]" data-ditto-id="style-icon-5" data-component="link" href="/" target="_self">
