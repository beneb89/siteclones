...
export default function MediaTile({ d, styles }: { d: MediaTileData; styles: MediaTileStyles }) {
  return (
    <li className={cn("relative mb-1.5 items-center", styles.className)}>
      <a className="flex px-[0.9375rem] items-center gap-0.5 text-[0.9375rem] font-semibold leading-[1.4375rem] tracking-[0.15px] uppercase whitespace-nowrap text-nowrap cursor-pointer" data-component={d.kind} href={d.href}>
        {" "}
