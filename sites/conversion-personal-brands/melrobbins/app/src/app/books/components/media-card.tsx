...
export default function MediaCard({ d, styles }: { d: MediaCardData; styles: MediaCardStyles }) {
  return (
    <li className={cn("w-[322.7px] flex flex-col gap-3 max-md:w-[9.325rem] max-md:shrink-0 md:max-lg:w-[14.2625rem] 2xl:w-[28.6375rem]", styles.className)}>
      <a className={cn("block cursor-pointer w-full", styles.className2)} data-component="link" href={d.href}>
        ...
        <div className="block pt-3">
          <h3 className="block text-[0.9375rem] font-semibold leading-[1.125rem] max-md:text-sm max-md:leading-[1.0625rem] 2xl:leading-[1.1875rem] 2xl:[font-size:inherit]" data-component="heading">
            {d.title}
          </h3>
          {" "}
