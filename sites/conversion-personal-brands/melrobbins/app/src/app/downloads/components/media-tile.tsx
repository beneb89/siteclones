...
export default function MediaTile({ d }: { d: MediaTileData }) {
  return (
    <li className="list-item py-[5.3px] 2xl:py-1.5">
      <div className="block">
        <label className="flex items-center gap-2 cursor-pointer">
          ...
          <span className="border border-solid border-border block relative rounded-md shrink-0 aspect-square w-6 h-6 max-md:w-5 max-md:h-5">
            {"  "}
            <span className="flex absolute top-[0.6875rem] left-[0.6875rem] justify-center items-center transform-[matrix(1,0,0,1,-12,-12)] aspect-square w-6 h-6 max-md:w-5 max-md:h-5">
              {" "}
