...
export default function MediaCard2({ d, styles }: { d: MediaCard2Data; styles: MediaCard2Styles }) {
  return (
    <div className="block p-1 overflow-hidden shadow-[var(--clr-10)_0px_0px_50px_0px]">
      <div className="h-full min-h-143.5 flex relative rounded-[10px] flex-col bg-background shadow-[var(--clr-10)_0px_0px_50px_0px]">
        ...
        <div className={cn("h-[20.55rem] min-h-75 flex p-4 flex-col justify-between grow", styles.className2)}>
          ...
          <div className="flex relative justify-between items-center">
            <div className="h-0.5 block absolute -top-4 inset-x-0 z-1 min-w-0 bg-surface">
              ...
              {" "}
              <span className="w-7 h-4.5 block absolute -top-[0.3125rem] left-82.5 z-10 opacity-0 px-2.5 text-color-008 font-bold leading-4.5 [text-shadow:var(--color-015)_1px_1px_2px] bg-background">
                {" "}
            ...
            <div className="w-3/4 flex items-center gap-3">
              <a className="h-[3.4375rem] block text-primary cursor-pointer" data-component="link" aria-label={d.ariaLabel} href="/blog/author/brittany-werdowatz">
                {" "}
                <img className="w-full h-[3.4375rem] border-2 border-solid border-surface block max-w-full rounded-[50%] overflow-clip object-cover aspect-[auto_55/55]" data-component="avatar" alt={d.alt2} height="55" src={d.imgSrc2} width="55" />
                {" "}
              </a>
              {" "}
