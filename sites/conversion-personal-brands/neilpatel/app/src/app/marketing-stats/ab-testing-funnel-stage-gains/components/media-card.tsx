    ...
    <div className="block basis-[calc(33.3333%_-_16px)] max-lg:basis-full">
      <article className="h-full border border-solid border-border flex p-4 rounded-lg items-center gap-4 bg-background">
        <a className="h-30 block rounded-sm shrink-0 basis-[120px] overflow-hidden aspect-square text-primary cursor-pointer" data-component="link" href={d.href}>
          {" "}
          <img className={cn("w-30 h-30 block max-w-full overflow-clip object-cover", styles.className)} data-component="image" alt={d.alt} height={d.height} sizes="auto, (max-width: 350px) 100vw, 350px" src={d.imgSrc} srcSet={d.srcSet} width="350" />
          {" "}
        </a>
        {" "}
