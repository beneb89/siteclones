...
export default function MediaTile({ d }: { d: MediaTileData }) {
  return (
    <div className="flex items-center gap-2">
      <img className="w-12 h-12 block max-w-full rounded-[50%] shrink-0 overflow-clip object-cover aspect-[auto_48/48]" data-component="avatar" alt={d.alt} height="48" src={d.imgSrc} width="48" />
      {" "}
