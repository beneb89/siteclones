...
export default function MediaCard2({ d, styles }: { d: MediaCard2Data; styles: MediaCard2Styles }) {
  return (
    <li className="flex flex-col gap-8">
      <h2 className="block text-color-002 text-[1.3125rem] font-bold leading-0.5" data-component="heading">
        <a className="inline text-color-003 text-[1.75rem] leading-[2.1875rem] cursor-pointer" data-component="link" href="/marketing-stats/category/ad-spend-budgets">
          {d.title}
        </a>
      </h2>
      {" "}
      <div className="flex flex-wrap justify-start gap-6 text-left">
        <div className="block basis-[calc(33.3333%_-_16px)] max-lg:basis-full">
          <article className={cn("border border-solid border-border flex p-4 rounded-lg items-center gap-4 bg-background", styles.className)}>
            <a className="h-30 block rounded-sm shrink-0 basis-[120px] overflow-hidden aspect-square cursor-pointer" data-component="link" href="/marketing-stats/ab-testing-funnel-stage-gains">
            ...
            <div className="flex min-w-0 flex-col grow">
              ...
              <h3 className="block mb-2 text-color-002 text-[1.3125rem] font-medium leading-0.5" data-component="heading">
                <a className="inline text-lg leading-7 cursor-pointer" data-component="link" href="/marketing-stats/ab-testing-funnel-stage-gains">
                  {d.title2}
                </a>
              </h3>
              {" "}
        ...
        <div className="block basis-[calc(33.3333%_-_16px)] max-lg:basis-full">
          <article className={cn("border border-solid border-border flex p-4 rounded-lg items-center gap-4 bg-background", styles.className7)}>
            <a className="h-30 block rounded-sm shrink-0 basis-[120px] overflow-hidden aspect-square cursor-pointer" data-component="link" href={d.href}>
            ...
            <div className="flex min-w-0 flex-col grow">
              ...
              {" "}
              <h3 className="block mb-2 text-color-002 text-[1.3125rem] font-medium leading-0.5" data-component="heading">
                <a className="inline text-lg leading-7 cursor-pointer" data-component="link" href={d.href2}>
                  {d.title5}
                </a>
              </h3>
              {" "}
        ...
        <div className="block basis-[calc(33.3333%_-_16px)] max-lg:basis-full">
          <article className={cn("border border-solid border-border flex p-4 rounded-lg items-center gap-4 bg-background", styles.className9)}>
            <a className="h-30 block rounded-sm shrink-0 basis-[120px] overflow-hidden aspect-square cursor-pointer" data-component="link" href={d.href3}>
        ...
        <div className="block basis-[calc(33.3333%_-_16px)] max-lg:basis-full">
          <article className={cn("border border-solid border-border flex p-4 rounded-lg items-center gap-4 bg-background", styles.className11)}>
            ...
            <div className="flex min-w-0 flex-col grow">
              ...
              {" "}
              <h3 className="block mb-2 text-color-002 text-[1.3125rem] font-medium leading-0.5" data-component="heading">
                <a className="inline text-lg leading-7 cursor-pointer" data-component="link" href={d.href6}>
                  {d.title7}
                </a>
              </h3>
              {" "}
      ...
      <p className="w-308 h-[26.7px] block text-base font-medium leading-[1.6875rem] max-md:w-[20.4375rem] md:max-lg:w-180 2xl:w-[77.3125rem]">
        <a className="inline cursor-pointer" data-component="link" href="/marketing-stats/category/ad-spend-budgets">
          More →
        </a>
      </p>
      {" "}
