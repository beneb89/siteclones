...
export default function MediaCard({ d, styles }: { d: MediaCardData; styles: MediaCardStyles }) {
  return (
    <div className="block p-1 basis-[calc(33.3333%_-_16px)] overflow-hidden shadow-[var(--clr-11)_0px_0px_50px_0px] max-lg:basis-full">
      <div className={cn("min-h-146 flex relative rounded-[10px] flex-col bg-background shadow-[var(--clr-11)_0px_0px_50px_0px]", styles.className)}>
        ...
        <div className={cn("h-[20.9rem] min-h-75 flex p-4 flex-col justify-between grow", styles.className3)}>
          <div className="flex justify-between text-color-009 text-base leading-[1.6875rem]">
            <a className="block text-muted text-[0.8125rem] font-medium leading-7 tracking-[0.5px] uppercase cursor-pointer" data-component="link" href="https://neilpatel.com/blog/category/tools-tech/">
              {"Tools & Tech"}
            </a>
            {" "}
          ...
          <h3 className="block mb-2 text-color-001 text-[1.3125rem] font-semibold leading-[1.8125rem]" data-component="heading">
            <a className="inline text-color-002 text-[1.375rem] leading-7 cursor-pointer" data-component="link" href={d.href2}>
              {d.title}
            </a>
            {" "}
          </h3>
          ...
          <div className="flex relative justify-between items-center">
            <div className="h-0.5 block absolute -top-4 inset-x-0 z-1 min-w-0 bg-surface-2">
              ...
              {" "}
              <span className="w-7 h-4.5 block absolute -top-[0.3125rem] left-[19.625rem] z-10 opacity-0 px-2.5 text-color-008 font-bold leading-4.5 [text-shadow:var(--clr-13)_1px_1px_2px] bg-background">
                {" "}
            ...
            <div className="w-3/4 flex items-center gap-3">
              <a className="h-[3.4375rem] block text-primary cursor-pointer" data-component="link" aria-label="View posts by Pedro Pereira" href="https://neilpatel.com/blog/author/pedro-pereira/">
                {" "}
                <img className="w-full h-[3.4375rem] border-2 border-solid border-surface-2 block max-w-full rounded-[50%] overflow-clip object-cover aspect-[auto_55/55]" data-component="avatar" alt="Pedro Pereira" height="55" src="/assets/cloned/images/b631b381ef83.png" width="55" />
                {" "}
              </a>
              {" "}
              <div className="flex flex-col flex-1">
                <a className="block text-xl font-semibold leading-6 cursor-pointer" data-component="link" href="https://neilpatel.com/blog/author/pedro-pereira/">
                  Pedro Pereira
                </a>
                {" "}
            ...
            <div className="flex flex-col items-start gap-1">
              <span className="flex flex-col items-center gap-1 text-muted text-[0.8125rem] leading-[1.375rem]">
                {" "}
                <svg className="w-auto h-5 block shrink-0 overflow-hidden align-middle text-color-007" data-component="icon" fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
