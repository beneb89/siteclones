...
export default function ListRow4({ d, styles }: { d: ListRow4Data; styles: ListRow4Styles }) {
  return (
    <li className="list-item bg-background shadow-[var(--clr-21)_0px_29px_60px_0px]">
      <a className={cn("block p-[1.5625rem] text-color-006 cursor-pointer", styles.className)} data-component="link" href={d.href}>
        {" "}
