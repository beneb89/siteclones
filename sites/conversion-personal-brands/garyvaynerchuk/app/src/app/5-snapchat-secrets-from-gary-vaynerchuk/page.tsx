      ...
      <div className="min-h-screen block">
        ...
        <div className="h-full min-h-screen block ml-[17.1875rem] overflow-hidden max-lg:pt-18.5 max-lg:ml-0">
          ...
          <main className="block" id="main-content">
            ...
            <div className="h-[2602.5px] min-h-screen block overflow-hidden bg-background max-md:h-[203.8125rem]" data-ditto-id="style-main-content-2">
              ...
              <article className="box-content w-200 block mx-auto pt-20 pb-27.5 text-[1.0625rem] font-medium leading-[1.6875rem] max-md:w-82.5 max-md:pt-10 max-md:pb-20 md:max-lg:-mr-8 md:max-lg:ml-0" data-ditto-id="style-header">
                ...
                {" "}
                <p className="block pb-[25.5px]" data-ditto-id="style-button-2">
                  <span className="inline font-normal" data-ditto-id="style-heading-2">
                ...
                <h2 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.8125rem] font-normal leading-12.5 uppercase max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-ditto-id="style-span-14" data-component="heading">
                  <span className="inline" data-ditto-id="style-blockquote-2">
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-p-24">
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-p-23" data-component="link" href="https://www.garyvaynerchuk.com/images/linked-articles/5-snapchat-secrets-from-gary-vaynerchuk/01.jpg">
                    <img className="w-96.5 h-96.5 block max-w-full overflow-clip aspect-[auto_386/386] align-middle text-clr-1 max-md:w-82.5 max-md:h-82.5" data-ditto-id="style-span-12" data-component="image" alt="CXhztQPWEAEFcL9" height="386" sizes="(max-width: 700px) calc(100vw - 45px), 800px" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="386" />
                  </a>
                </p>
                {" "}
