...
const ListRow_data = [
    { text: "If an opportunity feels suspicious, inauthentic or too good to be true, it most likely is." },
    { text: "Always back up your private keys/seed phrases in secure locations, and never share them with anyone, under any circumstances." },
    { text: "Do not send money, crypto or sensitive personal information to people you don’t know." },
    { text: "Never assume a website is legitimate. Always do your research and check for the official site, logo and URL address." }
];
const Logo3_data = [
...
const Logo2_styles = [
    ...
    { className: "h-376.5 aspect-[auto_1082/2037] max-md:h-[38.8125rem]" },
    { className: "h-[108.1875rem] aspect-[auto_941/2037] max-md:h-178.5" }
];
          ...
          <main className="block" id="main-content">
            ...
            <div className="h-[10453.9px] min-h-screen block overflow-hidden bg-background max-md:h-[665.8625rem]" data-ditto-id="style-span-18">
              ...
              <article className="box-content w-200 block mx-auto pt-20 pb-27.5 text-[1.0625rem] font-medium leading-[1.6875rem] max-md:w-82.5 max-md:pt-10 max-md:pb-20 md:max-lg:-mr-8 md:max-lg:ml-0">
                                    ...
                                    <article className="w-128.5 flex relative z-0 min-w-0 flex-col items-stretch shrink-0" data-ditto-id="style-article" role="article">
                                      ...
                                      <div className="w-128.5 flex relative z-0 min-w-0 mt-1 mb-3 px-3 flex-col items-stretch shrink-0" data-ditto-id="style-div-3">
                                        <div className="block relative min-w-0 text-color-003 [font-family:-apple-system,_BlinkMacSystemFont,_'Segoe_UI',_Roboto,_Helvetica,_Arial,_sans-serif] text-[0.9375rem] leading-5 whitespace-pre-wrap [overflow-wrap:break-word]" data-ditto-id="style-div-21" dir="auto" lang="en">
                                          ...
                                          <span className="inline">
                                            {" 5/5 announcement - this is a SCAM. Never ever reveal your 12 word phrase!"}
                                          </span>
                                        </div>
                                      </div>
                ...
                {" "}
                <h2 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.8125rem] font-normal leading-12.5 uppercase max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-component="heading" id="h-3-never-assume-the-name-or-profile-you-see-is-the-right-one">
                ...
                <p className="block pb-[25.5px]">
                  {"For reference, "}
                  <a className="inline text-primary font-bold cursor-pointer" data-component="link" href="https://medium.com/@garyvee/addressing-fake-garyvee-accounts-and-scams-86ae0e773780">
                    check out this article
                  </a>
                  {" for a comprehensive list of all of Gary’s official social channels. If the name or username contacting you is not on this list, you can assume that it is not affiliated with Gary or any of the VaynerX companies. "}
                </p>
                {" "}
                <h2 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.8125rem] font-normal leading-12.5 uppercase max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-component="heading" id="h-4-look-out-for-spam-messages">
                  <strong className="inline font-bold">
                ...
                {" "}
                <h2 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.8125rem] font-normal leading-12.5 uppercase max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-component="heading" id="h-5-always-verify-official-websites-and-links">
                  <strong className="inline font-bold">
                ...
                <p className="block pb-[25.5px]">
                  ...
                  <a className="inline text-primary font-bold cursor-pointer" data-component="link" href="https://help.coinbase.com/en/coinbase/privacy-and-security/avoiding-phishing-and-scams/what-is-phishing">
                    check this Coinbase anti-phishing resource
                  </a>
                ...
                {" "}
                <h2 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.8125rem] font-normal leading-12.5 uppercase max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-component="heading" id="h-6-never-share-your-private-key-or-seed-phrase">
                  <strong className="inline font-bold">
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-heading-10">
                  ...
                  <a className="inline text-primary font-bold cursor-pointer" data-component="link" href="https://www.ledger.com/blog/how-to-protect-your-seed-phrase">
                    Take a look at this guide
                  </a>
                  {" for secure seed phrase storage. "}
                </p>
                {" "}
                <p className="block pb-[25.5px]">
                ...
                {" "}
                <h2 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.8125rem] font-normal leading-12.5 uppercase max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-component="heading" id="h-7-beware-of-advance-fee-schemes">
                  <strong className="inline font-bold">
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-p-32">
                  ...
                  {" are fairly common with both traditional and cryptocurrency. In these cases, someone will ask you to send a sum of money or crypto in exchange for the promise of a greater reward later. Victims send funds willingly because they believe they are making an investment, only to see their money disappear. "}
                </p>
                {" "}
                ...
                {" "}
                <h2 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.8125rem] font-normal leading-12.5 uppercase max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-component="heading" id="h-9-beware-of-requests-for-cryptocurrency-wire-transfers-or-gift-cards">
                  <strong className="inline font-bold">
                ...
                {" "}
                <h2 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.8125rem] font-normal leading-12.5 uppercase max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-component="heading" id="h-10-beware-of-covid-19-scams">
                  <strong className="inline font-bold">
                ...
                {" "}
                <h2 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.8125rem] font-normal leading-12.5 uppercase max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-component="heading" id="h-reminders">
                  <strong className="inline font-bold">
                    Reminders
                  </strong>
                </h2>
            ...
            <div className="flex relative z-1 max-w-250 flex-col items-center text-center mx-auto">
              ...
              <form className="w-full max-w-106.5 block gap-2.5 text-left max-md:flex-col max-md:items-stretch">
                <label className="w-px h-px block absolute -m-px overflow-hidden [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase whitespace-nowrap text-nowrap [clip-path:inset(50%)] cursor-default max-md:text-[1.1875rem]" aria-hidden="true" htmlFor="newsletter-website">
                  Website
                  <input className="w-4.5 h-11 min-h-11 border border-solid border-border inline-block p-2 overflow-clip text-[0.9375rem] text-start normal-case bg-border cursor-text max-md:h-12.5 max-md:min-h-12.5 max-md:block" data-ditto-id="style-newsletter-website-3" data-component="input" id="newsletter-website" name="website" type="text" />
                </label>
