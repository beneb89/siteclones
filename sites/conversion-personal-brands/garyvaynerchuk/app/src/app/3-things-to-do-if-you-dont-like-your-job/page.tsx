...
const Logo2_meta: string[][] = [
    ...
    ["n472", "n473"],
    ["n474", "n475"],
    ["style-newsletter-3", "n477"],
    ["n478", "n479"],
    ["n480", "n481"],
    ["style-newsletter-website-3", "n483"],
    ["n484", "style-newsletter-email-3"]
];
              ...
              <ol className="flex flex-wrap gap-[0.4375rem] [list-style-type:none] list-outside">
                ...
                <li className="flex min-w-0 items-center before:content-['/'] before:block before:w-[0.3125rem] before:h-5 before:mr-[0.4375rem] before:text-clr-4 before:text-[0.8125rem] before:leading-5" data-ditto-id="style-link-2">
                  <span className="block overflow-hidden whitespace-nowrap text-nowrap" data-ditto-id="style-li-2" aria-current="page">
                    3 things to do if you don’t like your job
                  </span>
                </li>
              </ol>
            </nav>
            <div className="h-[4125.3px] min-h-screen block overflow-hidden bg-background max-md:h-[4382.9px]" data-ditto-id="style-link-3">
              ...
              <article className="box-content w-200 block mx-auto pt-20 pb-27.5 text-[1.0625rem] font-medium leading-[1.6875rem] max-md:w-82.5 max-md:pt-10 max-md:pb-20 md:max-lg:-mr-8 md:max-lg:ml-0">
                          ...
                          <div className="box-content block" data-ditto-id="style-p-7">
                            <div className="h-13.5 flex p-2.5 items-center" data-ditto-id="style-span-11">
                              <div className="box-content flex p-0.5 rounded-[50%] flex-col justify-center items-center bg-foreground" data-ditto-id="style-p">
                                ...
                                <a className="box-content w-7.5 h-7.5 block absolute min-w-0 text-color-002 cursor-pointer" data-ditto-id="style-p-21" data-component="link" href={"https://www.instagram.com/stories/garyvee/?utm_source=ig_embed&ig_rid=Anl601dTcaS-kCviiW0fnEI"} target="_blank">
                              ...
                              <div className="box-content block mx-2.5 items-start grow overflow-hidden" data-ditto-id="style-p-9">
                                <a className="box-content flex items-center text-color-002 font-semibold whitespace-nowrap text-nowrap cursor-pointer" data-ditto-id="style-p-14" data-component="link" href={"https://www.instagram.com/garyvee/?utm_source=ig_embed&ig_rid=Anl601dTcaS-kCviiW0fnEI"} target="_blank">
                              ...
                              <div className="box-content flex ml-[0.9375rem] justify-end grow" data-ditto-id="style-p-16">
                                <a className="box-content block ml-2.5 py-[0.3125rem] px-3 rounded-[3px] shrink-0 text-foreground font-semibold bg-color-015 cursor-pointer" data-ditto-id="style-p-22" data-component="link" href={"https://www.instagram.com/garyvee/?utm_source=ig_embed&ig_rid=Anl601dTcaS-kCviiW0fnEI"} target="_blank">
                                  View profile
                                </a>
                              </div>
                            </div>
                            <div className="box-content block relative pb-[672.5px] max-md:pb-102.5" data-ditto-id="style-heading-5">
                              <a className="box-content h-full block absolute top-0 inset-x-0 text-color-002 bg-surface-4 cursor-pointer" data-ditto-id="style-p-3" data-component="link" href={"https://www.instagram.com/reel/Cnr4PlqA7Iq/?utm_source=ig_embed&ig_rid=Anl601dTcaS-kCviiW0fnEI"} target="_blank">
                                <img className="box-content w-134.5 h-[42.0625rem] inline overflow-clip pointer-events-none max-md:w-82 max-md:h-102.5" data-ditto-id="style-link-9" data-component="image" alt="Instagram post shared by @garyvee" src="/assets/cloned/images/c2ec06e07e15.jpg" srcSet="/assets/cloned/images/c2ec06e07e15.jpg 720w, /assets/cloned/images/30f4c07c372b.jpg 640w, /assets/cloned/images/8556b22dce59.jpg 480w, /assets/cloned/images/21f3de5317fc.jpg 320w, /assets/cloned/images/4748990ca863.jpg 240w, /assets/cloned/images/60b619edb53e.jpg 720w, /assets/cloned/images/60b619edb53e.jpg 720w, /assets/cloned/images/d3b559cd2268.jpg 640w, /assets/cloned/images/f7dd7d05c758.jpg 480w, /assets/cloned/images/705b834616e9.jpg 320w, /assets/cloned/images/bb07941be877.jpg 240w, /assets/cloned/images/29fd3aba7538.jpg 150w" />
                              </a>
                              <div className="box-content h-full block absolute top-0 inset-x-0" data-ditto-id="style-p-28">
                                <div className="box-content h-full block relative pb-[671.5px] overflow-hidden max-md:pb-[25.5625rem]" data-ditto-id="style-heading-9">
                                  <div className="box-content h-full block absolute top-0 inset-x-0" data-ditto-id="style-p-24">
                                    <video className="box-content w-full h-full min-h-full block absolute top-0 left-0 min-w-full overflow-clip object-contain bg-color-002" data-ditto-id="style-p-23" playsInline poster="/assets/cloned/images/c2ec06e07e15.jpg" preload="none" src="/assets/cloned/videos/6f4be434fbe1.mp4" />
                                  </div>
                            ...
                            <div className="box-content block relative" data-ditto-id="style-span-13">
                              <a className="box-content w-[13.0625rem] h-0 block absolute left-3 pt-3 px-3 rounded-tl-[3px] rounded-tr-[3px] overflow-hidden text-color-002 bg-foreground cursor-pointer" data-ditto-id="style-image-3" data-component="link" href={"https://www.instagram.com/garyvee/?utm_source=ig_embed&ig_rid=Anl601dTcaS-kCviiW0fnEI"} target="_blank">
                                ...
                                <div className="box-content flex mt-3 items-center" data-ditto-id="style-p-13">
                                  <img className="box-content w-26 h-26 block mr-px overflow-clip" data-ditto-id="style-span-5" data-component="image" src="/assets/cloned/images/57723f78c80b.jpg" srcSet="/assets/cloned/images/efa73f815933.jpg, /assets/cloned/images/57723f78c80b.jpg 2x" />
                                  <img className="box-content w-26 h-26 block mr-px overflow-clip" data-ditto-id="style-p-5" data-component="image" src="/assets/cloned/images/b4dc0d2218a9.jpg" srcSet="/assets/cloned/images/30ec6c6caf12.jpg, /assets/cloned/images/b4dc0d2218a9.jpg 2x" />
                                </div>
                              </a>
                              <div className="box-content h-11 flex relative mx-3 flex-col justify-center items-stretch bg-foreground" data-ditto-id="style-image-4">
                                <a className="box-content block overflow-hidden text-color-015 font-semibold whitespace-nowrap text-nowrap cursor-pointer" data-ditto-id="style-heading" data-component="link" href={"https://www.instagram.com/garyvee/?utm_source=ig_embed&ig_rid=Anl601dTcaS-kCviiW0fnEI"} target="_blank">
                                  View more on Instagram
                                </a>
                              </div>
                            </div>
                            <div className="box-content border-t border-solid border-t-surface-2 flex mx-2.5 py-2" data-ditto-id="style-span-20">
                              <a className="box-content h-6 flex mr-3 items-center text-color-002 text-[0.6875rem] cursor-pointer" data-ditto-id="style-p-15" data-component="link" href={"https://www.instagram.com/reel/Cnr4PlqA7Iq/?utm_source=ig_embed&ig_rid=Anl601dTcaS-kCviiW0fnEI"} target="_blank">
                            ...
                            <div className="box-content flex pb-1.5 px-2.5 items-start" data-ditto-id="style-link-14">
                              <a className="box-content block text-color-002 font-semibold cursor-pointer" data-ditto-id="style-link-7" data-component="link" href={"https://www.instagram.com/reel/Cnr4PlqA7Iq/?utm_source=ig_embed&ig_rid=Anl601dTcaS-kCviiW0fnEI"} target="_blank">
                                11,364 likes
                              </a>
                            </div>
                            <div className="box-content block pb-2.5 px-2.5" data-ditto-id="style-link-6">
                              <a className="box-content inline -my-[0.3125rem] -ml-[0.3125rem] p-[0.3125rem] text-color-002 font-semibold cursor-pointer" data-ditto-id="style-p-29" data-component="link" href={"https://www.instagram.com/garyvee/?utm_source=ig_embed&ig_rid=Anl601dTcaS-kCviiW0fnEI"} target="_blank">
                                garyvee
                              </a>
                              <br className="box-content inline" data-ditto-id="style-link-5" />
                              <br className="box-content inline" data-ditto-id="style-p-12" />
                              Wanna get out of your job? Ok, so … 2023 is here .. we are almost a month in … if you’re thrilled this morning cause u don’t have to go to work and you’re miserable Monday morning ☀️cause you hate your job .. you can change it … and it comes down to creating content on LinkedIn the way you do on Instagram or Tiktok .. share what you see in your industry .. or what you see in other industries.. you’re one smart comment away from changing your life ❤️❣️❣️❣️❣️❣️
                              <div className="box-content block pt-1.5" data-ditto-id="style-newsletter">
                                <a className="box-content inline text-color-011 cursor-pointer" data-ditto-id="style-div" data-component="link" href={"https://www.instagram.com/reel/Cnr4PlqA7Iq/?utm_source=ig_embed&ig_rid=Anl601dTcaS-kCviiW0fnEI"} target="_blank">
                            ...
                            <div className="box-content h-11 border-t border-solid border-t-surface-2 flex px-2.5 items-center" data-ditto-id="style-image">
                              <a className="box-content block text-color-011 leading-[1.0625rem] cursor-pointer" data-ditto-id="style-newsletter-title" data-component="link" href={"https://www.instagram.com/reel/Cnr4PlqA7Iq/?utm_source=ig_embed&ig_rid=Anl601dTcaS-kCviiW0fnEI"} target="_blank">
                                Add a comment...
                              </a>
                              <a className="box-content h-6 flex ml-[384.3px] text-color-002 cursor-pointer max-md:ml-[174.3px]" data-ditto-id="style-form" data-component="link" href={"https://www.instagram.com/reel/Cnr4PlqA7Iq/?utm_source=ig_embed&ig_rid=Anl601dTcaS-kCviiW0fnEI"} target="_blank">
                                <i className="box-content w-6 h-6 block overflow-hidden italic indent-[-1.39999e+06px] [background-position:-62px_-136px] bg-no-repeat" style={{ backgroundImage: "url(\"/assets/cloned/images/5de20771a30a.png\")" }} data-ditto-id="style-label">
                                  <u className="box-content w-px h-px block absolute top-[1024.5px] left-[-1.39948e+06px] overflow-hidden underline whitespace-nowrap text-nowrap" data-ditto-id="style-newsletter-website">
                                    Instagram
                                  </u>
                                </i>
                              </a>
                ...
                {" "}
                <h2 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.8125rem] font-normal leading-12.5 uppercase max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-ditto-id="style-article" data-component="heading">
                  <strong className="inline font-bold" data-ditto-id="style-visit-this-post-on-x">
                    {"Don’t know what you love? Go out and try a bunch of things "}
                  </strong>
                </h2>
                {" "}
                <p className="block pb-[25.5px]" data-ditto-id="style-div-10">
                  <span className="inline font-normal" data-ditto-id="style-div-16">
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-iframe">
                  <span className="inline font-normal" data-ditto-id="style-heading-4">
                ...
                <div className="w-full max-w-137.5 flex my-2.5">
                  <div className="w-137.5 h-[47.0625rem] block relative grow overflow-hidden aspect-[25/14] align-middle" data-ditto-id="style-span-23" id="twitter-widget-0" title="X Post">
                    <div className="box-content block text-color-002 [font-family:'Times_New_Roman'] text-base font-normal leading-4.5" data-ditto-id="style-span-24">
                      <div className="box-content block" data-ditto-id="style-link-13" id="f2-app">
                        <div className="flex relative z-0 flex-col items-stretch flex-1 pointer-events-none">
                          <div className="flex relative z-0 min-w-0 flex-col items-stretch flex-1 pointer-events-none" data-ditto-id="style-button-6">
                            <div className="w-137.5 border border-solid border-color-005 flex relative z-0 min-w-62.5 max-w-137.5 rounded-xl flex-col items-stretch shrink-0 overflow-hidden cursor-pointer" data-ditto-id="style-div-19">
                              ...
                              <article className="w-137 flex relative z-0 min-w-0 pt-3 pb-1 px-4 flex-col items-stretch shrink-0 bg-foreground" role="article">
                                <a className="flex relative z-0 min-w-0 flex-col items-stretch shrink-0" data-ditto-id="style-div-25" data-component="link" aria-label="Visit this post on X" href={"https://x.com/garyvee/status/1314013258140004353?ref_src=twsrc%5Etfw%7Ctwcamp%5Etweetembed%7Ctwterm%5E1314013258140004353%7Ctwgr%5E499d90954932fe0ebdf6b183c0b65de103cd2db0%7Ctwcon%5Es1_&ref_url=https%3A%2F%2Fgaryvaynerchuk.com%2F3-things-to-do-if-you-dont-like-your-job%2F"} rel="noopener noreferrer nofollow" role="link" target="_blank" />
                                <div className="flex relative z-0 min-w-0 pb-3 items-stretch shrink-0">
                                  <div className="flex relative z-0 min-w-0 flex-col items-stretch shrink-0" data-ditto-id="style-div-11">
                                    <div className="w-12 h-12 block relative z-0 min-w-0 flex-col items-stretch shrink-0">
                                      <div className="box-content block pb-12" data-ditto-id="style-p-20" />
                                      <div className="box-content w-12 h-full block absolute top-0" data-ditto-id="style-image-2">
                                        <div className="w-12 h-12 block absolute top-6 left-6 z-0 flex-col items-stretch shrink-0 transform-[matrix(1,0,0,1,-24,-24)]" data-ditto-id="style-heading-6">
                                          <div className="box-content block pb-12" />
                                          <div className="box-content w-12 h-full block absolute top-0">
                                            <div className="w-13 h-13 flex absolute -top-0.5 -left-0.5 z-0 rounded-full flex-col items-stretch shrink-0 overflow-hidden" data-ditto-id="style-verified-account">
                                              <a className="h-13 flex relative z-0 min-w-0 flex-col items-stretch shrink-0" data-ditto-id="style-div-23" data-component="link" aria-hidden="true" href="https://twitter.com/garyvee" rel="noopener noreferrer nofollow" role="link" target="_blank">
                                                <div className="w-12 h-12 flex absolute top-6.5 left-6.5 z-0 min-w-0 rounded-full flex-col items-stretch shrink-0 overflow-hidden transform-[matrix(1,0,0,1,-24,-24)] pointer-events-none" data-ditto-id="style-div-5">
                                                  <div className="h-full flex relative z-0 min-w-0 flex-col items-stretch shrink-0 pointer-events-none" data-ditto-id="style-div-22" />
                                                </div>
                                                <div className="w-12 h-12 flex absolute top-6.5 left-6.5 z-0 min-w-0 rounded-full flex-col items-stretch shrink-0 overflow-hidden transform-[matrix(1,0,0,1,-24,-24)] pointer-events-none">
                                                  <div className="h-full flex relative z-0 min-w-0 flex-col items-stretch shrink-0 bg-foreground pointer-events-none" data-ditto-id="style-span-4" />
                                                </div>
                                                <div className="w-12 h-12 flex absolute top-6.5 left-6.5 z-0 min-w-0 rounded-full flex-col items-stretch shrink-0 overflow-hidden bg-foreground transform-[matrix(1,0,0,1,-24,-24)] pointer-events-none" data-ditto-id="style-div-3">
                                                  <div className="w-12 block relative z-0 min-w-0 flex-col items-stretch shrink-0 overflow-hidden pointer-events-none" data-ditto-id="style-div-21">
                                                ...
                                                <div className="w-12 h-12 flex absolute top-6.5 left-6.5 z-0 min-w-0 rounded-full flex-col items-stretch shrink-0 overflow-hidden transform-[matrix(1,0,0,1,-24,-24)]">
                                                  <div className="h-full flex relative z-0 min-w-0 flex-col items-stretch shrink-0 shadow-[var(--clr-7)_0px_0px_2px_0px_inset]" data-ditto-id="style-div-33" />
                                                </div>
                                              </a>
                                            </div>
                                          </div>
                                  ...
                                  <div className="w-[165.3px] flex relative z-0 min-w-0 max-w-[calc(100%_-_84px)] mx-1 flex-col justify-center items-stretch shrink-0" data-ditto-id="style-link-12">
                                    <div className="w-[165.3px] flex relative z-0 min-w-0 flex-col items-stretch shrink-0">
                                      <div className="flex relative z-0 min-w-0 max-w-full flex-col items-stretch">
                                        <div className="flex relative z-0 min-w-0 max-w-full flex-col items-stretch" data-ditto-id="style-div-32">
                                          <a className="flex relative z-0 min-w-0 max-w-full flex-col items-stretch" data-component="link" href="https://twitter.com/garyvee" rel="noopener noreferrer nofollow" role="link" target="_blank">
                                            <div className="flex relative z-0 min-w-0 max-w-full items-center shrink-0">
                                              <div className="flex min-w-0 items-center overflow-hidden text-color-003 [font-family:-apple-system,_BlinkMacSystemFont,_'Segoe_UI',_Roboto,_Helvetica,_Arial,_sans-serif] text-[0.9375rem] font-bold leading-5 whitespace-nowrap [overflow-wrap:break-word] text-nowrap" data-ditto-id="style-div-13" dir="auto">
                                              ...
                                              <div className="w-[42.7px] flex min-w-0 shrink-0 text-color-003 [font-family:-apple-system,_BlinkMacSystemFont,_'Segoe_UI',_Roboto,_Helvetica,_Arial,_sans-serif] text-[0.9375rem] leading-5 whitespace-pre-wrap [overflow-wrap:break-word]" data-ditto-id="style-span-15" dir="auto">
                                                <span className="flex min-w-0 items-center">
                                                  <svg className="box-content w-auto h-[1.1875rem] block relative max-w-5 max-h-5 ml-0.5 overflow-hidden align-text-bottom text-color-010" data-ditto-id="style-time" data-component="icon" aria-label="Verified account" role="img" viewBox="0 0 22 22" data-testid="icon-verified" fill="currentColor">
                                                    <g>
                                                  ...
                                                  <div className="flex relative z-0 min-w-0 mr-0.5 ml-1 flex-col justify-center items-stretch shrink-0" data-ditto-id="style-x-ads-info-and-privacy" role="link">
                                                    <div className="w-4 h-4 block relative z-0 min-w-0 max-w-[1.0625rem] max-h-[1.0625rem] flex-col items-stretch shrink-0">
                                                      <div className="block relative z-0 flex-col items-stretch shrink-0 overflow-hidden">
                                                        ...
                                                        <div className="box-content w-4 h-full block absolute top-0" data-ditto-id="style-div-4">
                                                          <div className="h-full border border-solid border-color-005 flex relative z-0 rounded-xs flex-col items-stretch shrink-0 overflow-hidden" data-ditto-id="style-icon">
                                          ...
                                          <div className="flex relative z-0 min-w-0 items-center">
                                            ...
                                            <div className="flex relative z-0 min-w-0 items-stretch shrink-0">
                                              ...
                                              <a className="block min-w-0 text-color-009 [font-family:-apple-system,_BlinkMacSystemFont,_'Segoe_UI',_Roboto,_Helvetica,_Arial,_sans-serif] text-[0.9375rem] font-bold leading-5 whitespace-pre-wrap [overflow-wrap:break-word]" data-component="link" dir="auto" href={"https://x.com/intent/follow?ref_src=twsrc%5Etfw%7Ctwcamp%5Etweetembed%7Ctwterm%5E1314013258140004353%7Ctwgr%5E499d90954932fe0ebdf6b183c0b65de103cd2db0%7Ctwcon%5Es1_&ref_url=https%3A%2F%2Fgaryvaynerchuk.com%2F3-things-to-do-if-you-dont-like-your-job%2F&screen_name=garyvee"} rel="noopener noreferrer nofollow" role="link" target="_blank">
                                  ...
                                  <a className="h-12 flex relative z-0 min-w-0 ml-[269.7px] rounded-full flex-col items-stretch shrink-0" data-component="link" aria-label="View on X" href={"https://x.com/garyvee/status/1314013258140004353?ref_src=twsrc%5Etfw%7Ctwcamp%5Etweetembed%7Ctwterm%5E1314013258140004353%7Ctwgr%5E499d90954932fe0ebdf6b183c0b65de103cd2db0%7Ctwcon%5Es1_&ref_url=https%3A%2F%2Fgaryvaynerchuk.com%2F3-things-to-do-if-you-dont-like-your-job%2F"} rel="noopener noreferrer nofollow" role="link" target="_blank">
                                ...
                                <div className="w-129 flex relative z-0 min-w-0 flex-col items-stretch shrink-0">
                                  <div className="block relative min-w-0 text-color-003 [font-family:-apple-system,_BlinkMacSystemFont,_'Segoe_UI',_Roboto,_Helvetica,_Arial,_sans-serif] text-xl leading-6 whitespace-pre-wrap [overflow-wrap:break-word] cursor-text" dir="auto" lang="en">
                                    ...
                                    <img className="box-content w-6 h-6 inline-block mx-[1.5px] overflow-clip [vertical-align:-20%]" data-ditto-id="style-i" data-component="image" alt="♥️" src="/assets/cloned/svg/ced6cc6c3413.svg" />
                                ...
                                <div className="w-129 border border-solid border-color-005 flex relative z-0 min-w-0 mt-3 rounded-xl flex-col items-stretch shrink-0 overflow-hidden" data-ditto-id="style-link-17">
                                  <div className="w-px h-px flex absolute z-0 min-w-0 flex-col items-stretch shrink-0 overflow-hidden" data-ditto-id="style-link-16" />
                                  <div className="w-128.5 block relative z-0 min-w-0 flex-col items-stretch shrink-0 overflow-hidden">
                                    <div className="box-content block pb-128.5" data-ditto-id="style-strong" />
                                    <div className="box-content w-128.5 h-full block absolute top-0">
                                      <div className="box-content h-full block relative">
                                        <div className="box-content w-128.5 h-full block absolute top-0" data-ditto-id="style-strong-2">
                                          <div className="box-content h-full block relative overflow-hidden" data-ditto-id="style-p-19" />
                                        </div>
                                    ...
                                    <div className="inline-flex relative z-0 flex-col items-stretch shrink-0">
                                      <div className="block relative z-0 min-w-0 items-baseline">
                                        <span className="inline text-color-004">
                                          <a className="inline-flex flex-wrap shrink-0 gap-1" data-ditto-id="style-p-30" data-component="link" aria-label="1:22 AM · Oct 8, 2020" href={"https://x.com/garyvee/status/1314013258140004353?ref_src=twsrc%5Etfw%7Ctwcamp%5Etweetembed%7Ctwterm%5E1314013258140004353%7Ctwgr%5E499d90954932fe0ebdf6b183c0b65de103cd2db0%7Ctwcon%5Es1_&ref_url=https%3A%2F%2Fgaryvaynerchuk.com%2F3-things-to-do-if-you-dont-like-your-job%2F"} rel="noopener noreferrer nofollow" role="link" target="_blank">
                                            <time className="box-content block" dateTime="2020-10-08T01:22:28.000Z">
                                              1:22 AM · Oct 8, 2020
                                            </time>
                                          </a>
                                        </span>
                                ...
                                <div className="border-t border-solid border-t-color-005 flex relative z-0 min-w-0 mt-1 pt-1 items-start shrink-0">
                                  <a className="h-8 flex relative z-0 min-w-0 mr-5 items-center shrink-0" data-ditto-id="style-heading-10" data-component="link" aria-label="Like. This post has 1.6K likes" href={"https://x.com/intent/like?ref_src=twsrc%5Etfw%7Ctwcamp%5Etweetembed%7Ctwterm%5E1314013258140004353%7Ctwgr%5E499d90954932fe0ebdf6b183c0b65de103cd2db0%7Ctwcon%5Es1_&ref_url=https%3A%2F%2Fgaryvaynerchuk.com%2F3-things-to-do-if-you-dont-like-your-job%2F&tweet_id=1314013258140004353"} rel="noopener noreferrer nofollow" role="link" target="_blank">
                                    <div className="w-8 h-8 flex relative z-0 min-w-0 -ml-1 rounded-full flex-col justify-center items-stretch shrink-0" data-ditto-id="style-image-5">
                                  ...
                                  <a className="h-8 flex relative z-0 min-w-0 mr-5 items-center shrink-0" data-component="link" aria-label="Reply to this post on X" href={"https://x.com/intent/tweet?ref_src=twsrc%5Etfw%7Ctwcamp%5Etweetembed%7Ctwterm%5E1314013258140004353%7Ctwgr%5E499d90954932fe0ebdf6b183c0b65de103cd2db0%7Ctwcon%5Es1_&ref_url=https%3A%2F%2Fgaryvaynerchuk.com%2F3-things-to-do-if-you-dont-like-your-job%2F&in_reply_to=1314013258140004353"} rel="noopener noreferrer nofollow" role="link" target="_blank">
                                    <div className="w-8 h-8 flex relative z-0 min-w-0 rounded-full flex-col justify-center items-stretch shrink-0" data-ditto-id="style-p-32">
                                  ...
                                  <div className="flex relative z-0 min-w-0 items-center" data-ditto-id="style-p-31" data-component="button" role="button">
                                ...
                                <div className="flex relative z-0 min-w-0 pt-1 pb-3 flex-col items-stretch shrink-0">
                                  <a className="w-129 h-8 min-h-8 border border-solid border-color-005 flex relative z-0 min-w-8 px-4 rounded-full flex-col items-stretch shrink-0" data-component="link" href={"https://x.com/garyvee/status/1314013258140004353?ref_src=twsrc%5Etfw%7Ctwcamp%5Etweetembed%7Ctwterm%5E1314013258140004353%7Ctwgr%5E499d90954932fe0ebdf6b183c0b65de103cd2db0%7Ctwcon%5Es1_&ref_url=https%3A%2F%2Fgaryvaynerchuk.com%2F3-things-to-do-if-you-dont-like-your-job%2F"} rel="noopener noreferrer nofollow" role="link" target="_blank">
                ...
                {" "}
                <p className="block pb-[25.5px]" data-ditto-id="style-newsletter-2" />
                {" "}
                    ...
                    <div className="box-content block">
                      <div className="box-content block">
                        <div className="box-content block [font-family:-apple-system,_BlinkMacSystemFont,_'Segoe_UI',_Roboto,_Helvetica,_Arial,_sans-serif] text-sm leading-4.5 text-left">
                          <div className="box-content block" data-ditto-id="style-newsletter-website-2">
                            <div className="h-13.5 flex p-2.5 items-center">
                              <div className="box-content flex p-0.5 rounded-[50%] flex-col justify-center items-center bg-foreground">
                                <i className="box-content w-9 h-9 block overflow-hidden italic indent-[-1.39999e+06px] [background-position:0px_-136px] bg-no-repeat" style={{ backgroundImage: "url(\"/assets/cloned/images/5de20771a30a.png\")" }} data-ditto-id="style-newsletter-email-2" />
                                <a className="box-content w-7.5 h-7.5 block absolute min-w-0 text-color-002 cursor-pointer" data-ditto-id="style-button-7" data-component="link" href={"https://www.instagram.com/stories/garyvee/?utm_source=ig_embed&ig_rid=AnO1_7icFVZ0RW5rMmuaPWE"} target="_blank">
                                  <img className="box-content w-7.5 h-7.5 inline rounded-[50%] overflow-clip" data-component="avatar" alt="garyvee" src="/assets/cloned/images/d668aded585b.jpg" />
                                </a>
                              </div>
                              <div className="box-content block mx-2.5 items-start grow overflow-hidden">
                                <a className="box-content flex items-center text-color-002 font-semibold whitespace-nowrap text-nowrap cursor-pointer" data-component="link" href={"https://www.instagram.com/garyvee/?utm_source=ig_embed&ig_rid=AnO1_7icFVZ0RW5rMmuaPWE"} target="_blank">
                                  <span className="box-content block max-w-[calc(100%_-_21px)] overflow-hidden">
                                    garyvee
                                  </span>
                              ...
                              <div className="box-content flex ml-[0.9375rem] justify-end grow">
                                <a className="box-content block ml-2.5 py-[0.3125rem] px-3 rounded-[3px] shrink-0 text-foreground font-semibold bg-color-015 cursor-pointer" data-component="link" href={"https://www.instagram.com/garyvee/?utm_source=ig_embed&ig_rid=AnO1_7icFVZ0RW5rMmuaPWE"} target="_blank">
                                  View profile
                                </a>
                              </div>
                            </div>
                            <div className="box-content block relative pb-[672.5px] max-md:pb-102.5">
                              <a className="box-content h-full block absolute top-0 inset-x-0 text-color-002 bg-surface-4 cursor-pointer" data-component="link" href={"https://www.instagram.com/reel/CkGwLu6JBJT/?utm_source=ig_embed&ig_rid=AnO1_7icFVZ0RW5rMmuaPWE"} target="_blank">
                                <img className="box-content w-134.5 h-[42.0625rem] inline overflow-clip pointer-events-none max-md:w-82 max-md:h-102.5" data-component="image" alt="Instagram post shared by @garyvee" src="/assets/cloned/images/18ce5afe542a.jpg" srcSet="/assets/cloned/images/18ce5afe542a.jpg 1124w, /assets/cloned/images/da68d07fc92a.jpg 720w, /assets/cloned/images/fd1b5e25ed1b.jpg 640w, /assets/cloned/images/29bac535a93a.jpg 480w, /assets/cloned/images/0257070f2a1c.jpg 320w, /assets/cloned/images/5949f2a20076.jpg 240w, /assets/cloned/images/fd36a75039fd.jpg 1080w, /assets/cloned/images/954af321a764.jpg 750w, /assets/cloned/images/6b2361e9e787.jpg 640w, /assets/cloned/images/5fc47087740d.jpg 480w, /assets/cloned/images/674d29fe716f.jpg 320w, /assets/cloned/images/6f1399a95a1d.jpg 240w, /assets/cloned/images/2c2738b1a906.jpg 150w" />
                              </a>
                              <div className="box-content h-full block absolute top-0 inset-x-0">
                                <div className="box-content h-full block relative pb-[671.5px] overflow-hidden max-md:pb-[25.5625rem]">
                                  <div className="box-content h-full block absolute top-0 inset-x-0">
                                    <video className="box-content w-full h-full min-h-full block absolute top-0 left-0 min-w-full overflow-clip object-contain bg-color-002" playsInline poster="/assets/cloned/images/18ce5afe542a.jpg" preload="none" src="/assets/cloned/videos/7d44c8830ea2.mp4" />
                                  </div>
                                  <div className="box-content h-full block absolute top-0 inset-x-0">
                            ...
                            <div className="box-content block relative">
                              <a className="box-content w-[13.0625rem] h-0 block absolute left-3 pt-3 px-3 rounded-tl-[3px] rounded-tr-[3px] overflow-hidden text-color-002 bg-foreground cursor-pointer" data-component="link" href={"https://www.instagram.com/garyvee/?utm_source=ig_embed&ig_rid=AnO1_7icFVZ0RW5rMmuaPWE"} target="_blank">
                                <div className="box-content flex items-center">
                                  ...
                                  <div className="box-content w-[10.1875rem] block" data-ditto-id="style-button-8">
                                    <div className="box-content flex items-center">
                                ...
                                <div className="box-content flex mt-3 items-center">
                                  <img className="box-content w-26 h-26 block mr-px overflow-clip" data-component="image" src="/assets/cloned/images/3125861d101b.jpg" srcSet="/assets/cloned/images/0e7044cfaf37.jpg, /assets/cloned/images/3125861d101b.jpg 2x" />
                                  <img className="box-content w-26 h-26 block mr-px overflow-clip" data-component="image" src="/assets/cloned/images/bff49bf6a43e.jpg" srcSet="/assets/cloned/images/da2517ef9484.jpg, /assets/cloned/images/bff49bf6a43e.jpg 2x" />
                                </div>
                              </a>
                              <div className="box-content h-11 flex relative mx-3 flex-col justify-center items-stretch bg-foreground">
                                <a className="box-content block overflow-hidden text-color-015 font-semibold whitespace-nowrap text-nowrap cursor-pointer" data-component="link" href={"https://www.instagram.com/garyvee/?utm_source=ig_embed&ig_rid=AnO1_7icFVZ0RW5rMmuaPWE"} target="_blank">
                                  View more on Instagram
                                </a>
                              </div>
                            </div>
                            <div className="box-content border-t border-solid border-t-surface-2 flex mx-2.5 py-2">
                              <a className="box-content h-6 flex mr-3 items-center text-color-002 text-[0.6875rem] cursor-pointer" data-component="link" href={"https://www.instagram.com/reel/CkGwLu6JBJT/?utm_source=ig_embed&ig_rid=AnO1_7icFVZ0RW5rMmuaPWE"} target="_blank">
                            ...
                            <div className="box-content flex pb-1.5 px-2.5 items-start">
                              <a className="box-content block text-color-002 font-semibold cursor-pointer" data-component="link" href={"https://www.instagram.com/reel/CkGwLu6JBJT/?utm_source=ig_embed&ig_rid=AnO1_7icFVZ0RW5rMmuaPWE"} target="_blank">
                                58,085 likes
                              </a>
                            </div>
                            <div className="box-content block pb-2.5 px-2.5">
                              <a className="box-content inline -my-[0.3125rem] -ml-[0.3125rem] p-[0.3125rem] text-color-002 font-semibold cursor-pointer" data-component="link" href={"https://www.instagram.com/garyvee/?utm_source=ig_embed&ig_rid=AnO1_7icFVZ0RW5rMmuaPWE"} target="_blank">
                                garyvee
                              </a>
                              <br className="box-content inline" />
                              <br className="box-content inline" />
                              Post post post on LinkedIn so much opportunity.. so much! I’m proud of sooooo many of you who are doing ! Make Monday is what I want Monday to be - keep going - execute - the last 2 posts here show the opportunities
                              <div className="box-content block pt-1.5">
                                <a className="box-content inline text-color-011 cursor-pointer" data-component="link" href={"https://www.instagram.com/reel/CkGwLu6JBJT/?utm_source=ig_embed&ig_rid=AnO1_7icFVZ0RW5rMmuaPWE"} target="_blank">
                                  View all 609 comments
                                </a>
                              </div>
                            </div>
                            <div className="box-content h-11 border-t border-solid border-t-surface-2 flex px-2.5 items-center">
                              <a className="box-content block text-color-011 leading-[1.0625rem] cursor-pointer" data-component="link" href={"https://www.instagram.com/reel/CkGwLu6JBJT/?utm_source=ig_embed&ig_rid=AnO1_7icFVZ0RW5rMmuaPWE"} target="_blank">
                                Add a comment...
                              </a>
                              <a className="box-content h-6 flex ml-[384.3px] text-color-002 cursor-pointer max-md:ml-[174.3px]" data-component="link" href={"https://www.instagram.com/reel/CkGwLu6JBJT/?utm_source=ig_embed&ig_rid=AnO1_7icFVZ0RW5rMmuaPWE"} target="_blank">
                                <i className="box-content w-6 h-6 block overflow-hidden italic indent-[-1.39999e+06px] [background-position:-62px_-136px] bg-no-repeat" style={{ backgroundImage: "url(\"/assets/cloned/images/5de20771a30a.png\")" }}>
                                  <u className="box-content w-px h-px block absolute top-[970.5px] left-[-1.39948e+06px] overflow-hidden underline whitespace-nowrap text-nowrap">
                                    Instagram
                                  </u>
                                </i>
                              </a>
                ...
                {" "}
                <p className="block pb-[25.5px]">
                  {"Who’s ready to make the pivot happen? "}
                  <span className="inline font-normal">
                    {"Share you execution stories with me on Twitter at "}
                  </span>
            ...
            <div className="flex relative z-1 max-w-250 flex-col items-center text-center mx-auto">
              ...
              <form className="w-full max-w-106.5 block gap-2.5 text-left max-md:flex-col max-md:items-stretch">
                <label className="w-px h-px block absolute -m-px overflow-hidden [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase whitespace-nowrap text-nowrap [clip-path:inset(50%)] cursor-default max-md:text-[1.1875rem]" aria-hidden="true" htmlFor="newsletter-website">
                  Website
                  <input className="w-4.5 h-11 min-h-11 border border-solid border-border inline-block p-2 overflow-clip text-[0.9375rem] text-start normal-case bg-border cursor-text max-md:h-12.5 max-md:min-h-12.5 max-md:block" data-ditto-id="style-p-17" data-component="input" id="newsletter-website" name="website" type="text" />
                </label>
                ...
                <div className="grid items-center gap-[0.5375rem] grid-cols-[317.328px_100.109px] max-md:block max-md:grid-cols-[317.34px_100.11px]">
                  <input className="w-[19.8125rem] h-11 min-h-11 border border-solid border-border block p-2 overflow-clip text-[0.9375rem] leading-[1.4375rem] text-start bg-border cursor-text max-md:w-82.5 max-md:h-12.5 max-md:min-h-12.5" data-ditto-id="style-p-18" data-component="input" id="newsletter-email" name="email" type="email" />
              ...
              <footer className="flex mt-[1.775rem] flex-col justify-center items-center text-[0.875rem] max-md:mt-[0.925rem]" data-ditto-id="style-button-10">
                <span className="block">
                ...
                <span className="block text-color-006">
                  ...
                  {" | "}
                  <button className="inline-block underline cursor-pointer" data-ditto-id="style-div-12" data-component="button" type="button">
                    Cookie Settings
                  </button>
                </span>
              </footer>
