...
export default function TextLink3({ d, styles }: { d: TextLink3Data; styles: TextLink3Styles }) {
  return (
    <a className={cn("box-content h-6 flex items-center text-color-002 text-[0.6875rem] cursor-pointer", styles.className)} data-component="link" href={"https://www.instagram.com/reel/Cnr4PlqA7Iq/?utm_source=ig_embed&ig_rid=Anl601dTcaS-kCviiW0fnEI"} target="_blank">
