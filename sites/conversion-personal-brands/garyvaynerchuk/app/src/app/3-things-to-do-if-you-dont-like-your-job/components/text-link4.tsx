...
export default function TextLink4({ d, styles }: { d: TextLink4Data; styles: TextLink4Styles }) {
  return (
    <a className={cn("box-content h-6 flex items-center text-color-002 text-[0.6875rem] cursor-pointer", styles.className)} data-component="link" href={"https://www.instagram.com/reel/CkGwLu6JBJT/?utm_source=ig_embed&ig_rid=AnO1_7icFVZ0RW5rMmuaPWE"} target="_blank">
