      ...
      <div className="min-h-screen block">
        ...
        <div className="h-full min-h-screen block ml-[17.1875rem] overflow-hidden max-lg:pt-18.5 max-lg:ml-0">
          ...
          <main className="block" data-ditto-id="style-main-content" id="main-content">
            ...
            <div className="h-[184.8125rem] min-h-screen block overflow-hidden bg-background max-md:h-[4539.5px]" data-ditto-id="style-link-3">
              ...
              <article className="box-content w-200 block mx-auto pt-20 pb-27.5 text-[1.0625rem] font-medium leading-[1.6875rem] max-md:w-82.5 max-md:pt-10 max-md:pb-20 md:max-lg:-mr-8 md:max-lg:ml-0">
                <p className="block pb-[25.5px]" data-ditto-id="style-span-22">
                  One of the unique things about a career in marketing is there’s no right path to success. Even the definition of success is up to you. So we compiled guests from the
                  <a className="inline text-primary font-bold cursor-pointer" data-component="link" href="https://vaynermedia.com/vaynerx-presents-marketing-for-the-now/">
                    {" Marketing For The Now"}
                  </a>
                  {" series who are living proof that if marketing’s your passion, there are countless ways to get there. From national champions to chance encounters, here are just a few of these leaders’ unconventional paths to success."}
                </p>
                {" "}
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-span-21">
                  <strong className="inline font-bold" data-ditto-id="style-p-7">
                    Musa Tariq (Advisor, Masterclass): “
                  </strong>
                  {"That’s a great question. [At first], I was adamant I wanted to be a banker. I was growing up in London, I wanted to drive a fast car…unfortunately, halfway through university I lost both my parents. I had to pivot. [Later], I met someone who told me to do something I love with my life, and I would do well. I loved marketing, but there was no one for me to talk to about it. LinkedIn wasn’t around and Facebook had only just started and there was no way to connect with people. "}
                </p>
                {" "}
                <p className="block pb-[25.5px]" data-ditto-id="style-span-11">
                  {"It was really, really hard. It only happened because one individual who worked in marketing happened to sit next to me while I was in a restaurant. We randomly started talking, and he sort of guided me [into that world]. His name was "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-p" data-component="link" href="https://www.thegrocer.co.uk/people-news/michael-inpong-promoted-to-new-strategy-director-role-at-muller-yogurt-and-desserts/601668.article">
                    Michael Inpong
                  </a>
                  {" and he’s a marketing director in the UK. [Our connection] was as random as him sitting next to me in a restaurant."}
                </p>
                {" "}
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-p-9">
                  ...
                  {"Haha, well I’ve certainly had an unusual childhood; I was an elite gymnast. At five years old, with an unnatural combination of discipline, commitment, and a degree of talent I got [on the national team]. I was there for eight years and I was the national champion in 1986. I wrote a book about my experiences and was featured in the Netflix documentary, "}
                  <em className="inline italic">
                    {"Athlete A. "}
                  </em>
                </p>
                {" "}
                <h3 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.1875rem] font-normal leading-10.5 uppercase max-md:text-3xl max-md:leading-[2.1875rem]" data-ditto-id="style-p-10" data-component="heading">
                  <strong className="inline font-bold" data-ditto-id="style-span-14">
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-blockquote-2">
                  ...
                  Unfortunately, despite my success, I left the sport pretty emotionally broken. There’s a culture of coaching cruelty that, I would say, is pretty dominant in the sport. Not every coach practices it, but it’s way way too common.
                </p>
                {" "}
                <h3 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.1875rem] font-normal leading-10.5 uppercase max-md:text-3xl max-md:leading-[2.1875rem]" data-ditto-id="style-p-16" data-component="heading">
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-heading-5">
                  ...
                  {"It was challenging. I went to college to figure my shit out, [which is hard] when you’ve spent the part of your childhood being told you’re garbage. You [eventually] begin to think you’re garbage. I kind of didn’t know who I was without [gymnastics]. "}
                </p>
                {" "}
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-p-23">
                  ...
                  {"[Actually], I had a pretty unconventional past. I often wonder how I got into marketing…what am I doing here? When I was a kid I wanted to be an actor. "}
                </p>
                {" "}
                <h3 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.1875rem] font-normal leading-10.5 uppercase max-md:text-3xl max-md:leading-[2.1875rem]" data-ditto-id="style-span-17" data-component="heading">
                ...
                {" "}
                <h3 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.1875rem] font-normal leading-10.5 uppercase max-md:text-3xl max-md:leading-[2.1875rem]" data-ditto-id="style-link-15" data-component="heading">
                  <strong className="inline font-bold" data-ditto-id="style-br-2">
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-blockquote">
                  <em className="inline italic" data-ditto-id="style-p-8">
                    {"That’s all for now, Vaynernation. If you liked this post, be sure to "}
                    <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-p-13" data-component="link" href="https://twitter.com/intent/tweet?text=Great%20article%20about%20how%20to%20start%20a%20career%20in%20marketing!">
                      share it
                    </a>
                    {" on "}
                  </em>
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-span-5" data-component="link" href="https://twitter.com/">
                    <em className="inline italic" data-ditto-id="style-p-5">
                      {"Twitter "}
                    </em>
                  </a>
                  <em className="inline italic" data-ditto-id="style-image-4">
                    with the #MarketingForTheNow.
                  </em>
                </p>
                {" "}
              </article>
          ...
          <section className="h-[30.4375rem] min-h-[30.4375rem] block relative pt-[1.0875rem] pb-[1.0625rem] px-[3.5625rem] overflow-hidden bg-color-007 bg-cover [background-position:50%_100%] bg-no-repeat max-md:h-[622.7px] max-md:min-h-[622.7px] max-md:mx-[5.5px] max-md:pt-[0.4125rem] max-md:px-[1.0625rem] max-md:pb-0 md:max-lg:h-152 md:max-lg:min-h-152 md:max-lg:pt-[6.7125rem]" style={{ backgroundImage: "url(\"/assets/cloned/images/70cdd4bc96ea.jpg\")" }} data-ditto-id="style-heading" aria-labelledby="newsletter-title" id="newsletter">
            <div className="flex relative z-1 max-w-250 flex-col items-center text-center mx-auto" data-ditto-id="style-span-20">
              <img className="w-69.5 h-18 block mb-[8.5px] overflow-clip aspect-[auto_902/234] align-middle text-clr-1 max-md:w-82.5 max-md:h-21.5 max-md:max-w-full" data-ditto-id="style-p-15" data-component="image" alt="GaryVee Weekly" height="234" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="902" />
              <h2 className="block mb-[2.1875rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.375rem] leading-[2.6875rem] uppercase max-md:mb-[35.5px] max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-ditto-id="style-em" data-component="heading" id="newsletter-title">
                Sign up for my weekly newsletter
              </h2>
              <form className="w-full max-w-106.5 block gap-2.5 text-left max-md:flex-col max-md:items-stretch" data-ditto-id="style-span-9">
                <label className="w-px h-px block absolute -m-px overflow-hidden [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase whitespace-nowrap text-nowrap [clip-path:inset(50%)] cursor-default max-md:text-[1.1875rem]" data-ditto-id="style-p-26" aria-hidden="true" htmlFor="newsletter-website">
                  Website
                  <input className="w-4.5 h-11 min-h-11 border border-solid border-border inline-block p-2 overflow-clip text-[0.9375rem] text-start normal-case bg-border cursor-text max-md:h-12.5 max-md:min-h-12.5 max-md:block" data-ditto-id="style-span-7" data-component="input" id="newsletter-website" name="website" type="text" />
                </label>
                <label className="block [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase cursor-default max-md:mb-1.5 max-md:text-[1.1875rem]" data-ditto-id="style-span-6" htmlFor="newsletter-email">
                  Email
                </label>
                <div className="grid items-center gap-[0.5375rem] grid-cols-[317.328px_100.109px] max-md:block max-md:grid-cols-[317.34px_100.11px]" data-ditto-id="style-p-6">
                  ...
                  <button className="w-full h-[3.5625rem] flex rounded-[999px] justify-center items-center [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[1.0625rem] leading-[1.0625rem] text-center uppercase bg-primary transform-[matrix(1,0,0,1,0,-6.5)] cursor-default max-md:block max-md:mt-4 max-lg:transform-[none] max-md:h-auto" data-ditto-id="style-p-11" data-component="button" type="submit">
                    Subscribe
                  </button>
                </div>
              </form>
              <div className="w-[51%] grid mt-[108.5px] gap-2.5 transform-[matrix(1,0,0,1,23.6094,0)] grid-cols-[repeat(auto-fit,_minmax(41px,_1fr))] max-md:w-full max-md:mt-22 max-md:pl-[0.6875rem] max-md:justify-start max-md:gap-[8.3px] max-lg:transform-[none] md:max-lg:w-[69.5%] md:max-lg:mt-[7.1875rem] 2xl:w-[45.5%]" data-ditto-id="style-p-4" aria-label="Social media">
                {Logo2_data.map((d, i) => <Logo2 key={i} d={d} />)}
              </div>
              <footer className="flex mt-[1.775rem] flex-col justify-center items-center text-[0.875rem] max-md:mt-[0.925rem]" data-ditto-id="style-button-3">
                <span className="block" data-ditto-id="style-social-media">
                  ©Gary Vee IP, LLC 2024
                </span>
                <span className="block text-color-006" data-ditto-id="style-div-6">
                  <a className="inline cursor-pointer" data-ditto-id="style-div-9" data-component="link" href="https://www.garyvaynerchuk.com/privacy-policy/">
                    Privacy Policy
                  </a>
                  {" | "}
                  <a className="inline cursor-pointer" data-ditto-id="style-article" data-component="link" href="https://www.garyvaynerchuk.com/terms-of-use/">
                    Terms of Use
                  </a>
                  {" | "}
                  <button className="inline-block underline cursor-pointer" data-ditto-id="style-visit-this-post-on-x" data-component="button" type="button">
                    Cookie Settings
                  </button>
                </span>
              </footer>
