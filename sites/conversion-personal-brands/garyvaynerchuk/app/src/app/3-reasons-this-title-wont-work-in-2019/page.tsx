    ...
    <>
      <div className="min-h-screen block">
        ...
        <div className="h-full min-h-screen block ml-[17.1875rem] overflow-hidden max-lg:pt-18.5 max-lg:ml-0">
              ...
              <ol className="flex flex-wrap gap-[0.4375rem] [list-style-type:none] list-outside">
                ...
                <li className="flex min-w-0 items-center before:content-['/'] before:block before:w-[0.3125rem] before:h-5 before:mr-[0.4375rem] before:text-clr-4 before:text-[0.8125rem] before:leading-5" data-ditto-id="style-link-2">
                  <span className="block overflow-hidden whitespace-nowrap text-nowrap" data-ditto-id="style-li-2" aria-current="page">
                    3 Reasons This Title Won’t Work in 2019
                  </span>
                </li>
              </ol>
            </nav>
            <div className="h-456.5 min-h-screen block overflow-hidden bg-background max-md:h-[2490.5px]" data-ditto-id="style-link-3">
              ...
              <article className="box-content w-200 block mx-auto pt-20 pb-27.5 text-[1.0625rem] font-medium leading-[1.6875rem] max-md:w-82.5 max-md:pt-10 max-md:pb-20 md:max-lg:-mr-8 md:max-lg:ml-0">
                <p className="block pb-[25.5px]" data-ditto-id="style-span-22">
                  {"There is a very significant reason that I am writing this article and using the title above. It has to do with the fact that "}
                  <a className="inline text-primary font-bold cursor-pointer" data-component="link" href="https://www.youtube.com/watch?v=ML_ec6XRYQA">
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-heading-3">
                  {"Much in the same way that I have talked about email open rates going down from 90%, and Google AdWords going up from ten cents, "}
                  <strong className="inline font-bold" data-ditto-id="style-span-21">
                    it’s always about being a first mover
                  </strong>
                  . People who are executing properly and making the right assumptions create the market.
                </p>
                {" "}
                <p className="block pb-[25.5px]" data-ditto-id="style-p-7">
                  {"In this case, it was Buzzfeed. Buzzfeed was right. Let me say it again: Buzzfeed was 100% right. And now, "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-span-11" data-component="link" href="https://www.nytimes.com/2015/01/04/travel/8-ways-to-save-on-travel-in-2015.html">
                    <u className="inline underline" data-ditto-id="style-p">
                      the rest of the market
                    </u>
                  </a>
                  {" "}
                  <a className="inline text-primary font-bold cursor-pointer" data-component="link" href="https://www.theguardian.com/technology/2015/feb/12/10-reasons-to-hope-apple-isnt-really-making-a-car">
                    <u className="inline underline" data-ditto-id="style-p-21">
                      is following them
                    </u>
                  </a>
                  .
                ...
                {" "}
                <p className="block pb-[25.5px]">
                  {"Well, as media properties like "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-p-10" data-component="link" href="https://www.theguardian.com/global-development-professionals-network/2015/mar/03/ngos-positive-media-attention-communications-pr">
                    <u className="inline underline" data-ditto-id="style-span-14">
                      The Guardian
                    </u>
                  </a>
                  {", and "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-blockquote-2" data-component="link" href="https://www.washingtonpost.com/blogs/wonkblog/wp/2015/01/07/the-top-10-reasons-american-politics-are-worse-than-ever/">
                    <u className="inline underline" data-ditto-id="style-p-27">
                      The Washington Post,
                    </u>
                  </a>
                  {" and "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-p-16" data-component="link" href="https://www.vox.com/2014/6/5/5779040/7-reasons-America-fail-global-warming">
                    <u className="inline underline" data-ditto-id="style-p-22">
                      Vox
                    </u>
                  </a>
                  {", and "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-heading-5" data-component="link" href="https://www.wired.com/2010/12/20-things-you-didnt-know-about-kissing/">
                    <u className="inline underline" data-ditto-id="style-p-3">
                      Wired
                    </u>
                  </a>
                  , and handfuls of others join in, it becomes a classic game of the supply and demand of attention.
                </p>
                {" "}
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-heading-9">
                  {"Sure. Google AdWords still work. Email marketing still works. Radio and television and billboards still work. But are they as valuable? "}
                  <strong className="inline font-bold" data-ditto-id="style-p-24">
                    Absolutely not.
                  </strong>
                  {" The ROI of attention and the upside practices of 2019 will not include this headline."}
                </p>
                {" "}
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-span-12">
                  <strong className="inline font-bold" data-ditto-id="style-i-3">
                    <strong className="inline font-black" data-ditto-id="style-span-17">
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-p-2">
                  <strong className="inline font-bold" data-ditto-id="style-link-15">
                    <strong className="inline font-black" data-ditto-id="style-br-2">
          ...
          <section className="h-[30.4375rem] min-h-[30.4375rem] block relative pt-[1.0875rem] pb-[1.0625rem] px-[3.5625rem] overflow-hidden bg-color-007 bg-cover [background-position:50%_100%] bg-no-repeat max-md:h-[622.7px] max-md:min-h-[622.7px] max-md:mx-[5.5px] max-md:pt-[0.4125rem] max-md:px-[1.0625rem] max-md:pb-0 md:max-lg:h-152 md:max-lg:min-h-152 md:max-lg:pt-[6.7125rem]" style={{ backgroundImage: "url(\"/assets/cloned/images/70cdd4bc96ea.jpg\")" }} data-ditto-id="style-br" aria-labelledby="newsletter-title" id="newsletter">
            <div className="flex relative z-1 max-w-250 flex-col items-center text-center mx-auto" data-ditto-id="style-p-25">
              <img className="w-69.5 h-18 block mb-[8.5px] overflow-clip aspect-[auto_902/234] align-middle text-clr-1 max-md:w-82.5 max-md:h-21.5 max-md:max-w-full" data-ditto-id="style-span-16" data-component="image" alt="GaryVee Weekly" height="234" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="902" />
              <h2 className="block mb-[2.1875rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.375rem] leading-[2.6875rem] uppercase max-md:mb-[35.5px] max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-ditto-id="style-i-2" data-component="heading" id="newsletter-title">
                Sign up for my weekly newsletter
              </h2>
              <form className="w-full max-w-106.5 block gap-2.5 text-left max-md:flex-col max-md:items-stretch" data-ditto-id="style-blockquote">
                <label className="w-px h-px block absolute -m-px overflow-hidden [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase whitespace-nowrap text-nowrap [clip-path:inset(50%)] cursor-default max-md:text-[1.1875rem]" data-ditto-id="style-p-8" aria-hidden="true" htmlFor="newsletter-website">
                  Website
                  <input className="w-4.5 h-11 min-h-11 border border-solid border-border inline-block p-2 overflow-clip text-[0.9375rem] text-start normal-case bg-border cursor-text max-md:h-12.5 max-md:min-h-12.5 max-md:block" data-ditto-id="style-p-13" data-component="input" id="newsletter-website" name="website" type="text" />
                </label>
                <label className="block [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase cursor-default max-md:mb-1.5 max-md:text-[1.1875rem]" data-ditto-id="style-span-5" htmlFor="newsletter-email">
                  Email
                </label>
                <div className="grid items-center gap-[0.5375rem] grid-cols-[317.328px_100.109px] max-md:block max-md:grid-cols-[317.34px_100.11px]" data-ditto-id="style-p-5">
                  <input className="w-[19.8125rem] h-11 min-h-11 border border-solid border-border block p-2 overflow-clip text-[0.9375rem] leading-[1.4375rem] text-start bg-border cursor-text max-md:w-82.5 max-md:h-12.5 max-md:min-h-12.5" data-ditto-id="style-image-4" data-component="input" id="newsletter-email" name="email" type="email" />
                  <button className="w-full h-[3.5625rem] flex rounded-[999px] justify-center items-center [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[1.0625rem] leading-[1.0625rem] text-center uppercase bg-primary transform-[matrix(1,0,0,1,0,-6.5)] cursor-default max-md:block max-md:mt-4 max-lg:transform-[none] max-md:h-auto" data-ditto-id="style-heading" data-component="button" type="submit">
                    Subscribe
                  </button>
                </div>
              </form>
              <div className="w-[51%] grid mt-[108.5px] gap-2.5 transform-[matrix(1,0,0,1,23.6094,0)] grid-cols-[repeat(auto-fit,_minmax(41px,_1fr))] max-md:w-full max-md:mt-22 max-md:pl-[0.6875rem] max-md:justify-start max-md:gap-[8.3px] max-lg:transform-[none] md:max-lg:w-[69.5%] md:max-lg:mt-[7.1875rem] 2xl:w-[45.5%]" data-ditto-id="style-span-20" aria-label="Social media">
                {Logo2_data.map((d, i) => <Logo2 key={i} d={d} />)}
              </div>
              <footer className="flex mt-[1.775rem] flex-col justify-center items-center text-[0.875rem] max-md:mt-[0.925rem]" data-ditto-id="style-newsletter">
                <span className="block" data-ditto-id="style-div">
                  ©Gary Vee IP, LLC 2024
                </span>
                <span className="block text-color-006" data-ditto-id="style-image">
                  <a className="inline cursor-pointer" data-ditto-id="style-newsletter-title" data-component="link" href="https://www.garyvaynerchuk.com/privacy-policy/">
                    Privacy Policy
                  </a>
                  {" | "}
                  <a className="inline cursor-pointer" data-ditto-id="style-form" data-component="link" href="https://www.garyvaynerchuk.com/terms-of-use/">
                    Terms of Use
                  </a>
                  {" | "}
                  <button className="inline-block underline cursor-pointer" data-ditto-id="style-label" data-component="button" type="button">
                    Cookie Settings
                  </button>
                </span>
              </footer>
