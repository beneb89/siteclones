      ...
      <div className="min-h-screen block">
        ...
        <div className="h-full min-h-screen block ml-[17.1875rem] overflow-hidden max-lg:pt-18.5 max-lg:ml-0">
          ...
          <main className="block" data-ditto-id="style-main-content-2" id="main-content">
            ...
            <div className="h-1424 min-h-screen block overflow-hidden bg-background max-md:h-[6362.3px]" data-ditto-id="style-div-24">
              ...
              <article className="box-content w-200 block mx-auto pt-20 pb-27.5 text-[1.0625rem] font-medium leading-[1.6875rem] max-md:w-82.5 max-md:pt-10 max-md:pb-20 md:max-lg:-mr-8 md:max-lg:ml-0">
                <p className="block pb-[25.5px]" data-ditto-id="style-heading-3">
                  <span className="inline font-normal" data-ditto-id="style-span-21">
                    I wanted to round up five problems you may face as a company leader in 2019 and offer my solutions to those problems. Whether you’re a small start up or a Fortune 500, these four pieces of advice have always helped me in growing and maintaining my businesses.
                  </span>
                </p>
                {" "}
                <p className="block pb-[25.5px]" data-ditto-id="style-p-7" />
                {" "}
                <h3 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.1875rem] font-normal leading-10.5 uppercase max-md:text-3xl max-md:leading-[2.1875rem]" data-ditto-id="style-span-11" data-component="heading">
                  {"1. "}
                  <span className="inline" data-ditto-id="style-p">
                    How To Motivate Employees When They Don’t Want to Put in the Work
                  </span>
                </h3>
                {" "}
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-p-14">
                  <a className="inline text-primary font-bold cursor-pointer" data-component="link" href="https://www.garyvaynerchuk.com/images/linked-articles/4-common-company-problems-and-solutions-that-demand-attention/01.png">
                    <picture className="inline" data-ditto-id="style-p-10">
                      <img className="w-200 h-100 block max-w-full overflow-clip aspect-[auto_1200/600] align-middle text-clr-1 max-md:w-82.5 max-md:h-[10.3125rem]" data-ditto-id="style-blockquote-2" data-component="image" alt="160105-4-Common-company-issues-and-how-to-solve-them-01-(1200x600)" height="600" sizes="(max-width: 700px) calc(100vw - 45px), 800px" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="1200" />
                      {" "}
                    </picture>
                  </a>
                </p>
                {" "}
                <h3 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.1875rem] font-normal leading-10.5 uppercase max-md:text-3xl max-md:leading-[2.1875rem]" data-ditto-id="style-p-27" data-component="heading">
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-p-3">
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-link-9" data-component="link" href="https://www.garyvaynerchuk.com/images/linked-articles/4-common-company-problems-and-solutions-that-demand-attention/02.png">
                    <picture className="inline" data-ditto-id="style-p-28">
                      <img className="w-200 h-100 block max-w-full overflow-clip aspect-[auto_1200/600] align-middle text-clr-1 max-md:w-82.5 max-md:h-[10.3125rem]" data-ditto-id="style-p-24" data-component="image" alt="160105-4-Common-company-issues-and-how-to-solve-them-02-(1200x600)" height="600" sizes="(max-width: 700px) calc(100vw - 45px), 800px" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="1200" />
                      {" "}
                    </picture>
                  </a>
                </p>
                {" "}
                <h3 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.1875rem] font-normal leading-10.5 uppercase max-md:text-3xl max-md:leading-[2.1875rem]" data-ditto-id="style-p-23" data-component="heading">
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-image-3">
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-p-2" data-component="link" href="https://www.garyvaynerchuk.com/images/linked-articles/4-common-company-problems-and-solutions-that-demand-attention/03.png">
                    <picture className="inline" data-ditto-id="style-link-15">
                      <img className="w-200 h-100 block max-w-full overflow-clip aspect-[auto_1200/600] align-middle text-clr-1 max-md:w-82.5 max-md:h-[10.3125rem]" data-ditto-id="style-br" data-component="image" alt="160105-4-Common-company-issues-and-how-to-solve-them-03-(1200x600)" height="600" sizes="(max-width: 700px) calc(100vw - 45px), 800px" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="1200" />
                      {" "}
                    </picture>
                  </a>
                </p>
                {" "}
                <h3 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.1875rem] font-normal leading-10.5 uppercase max-md:text-3xl max-md:leading-[2.1875rem]" data-ditto-id="style-p-25" data-component="heading">
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-span-5">
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-p-5" data-component="link" href="https://www.garyvaynerchuk.com/images/linked-articles/4-common-company-problems-and-solutions-that-demand-attention/04.png">
                    <picture className="inline" data-ditto-id="style-image-4">
                      <img className="w-200 h-100 block max-w-full overflow-clip aspect-[auto_1200/600] align-middle text-clr-1 max-md:w-82.5 max-md:h-[10.3125rem]" data-ditto-id="style-span-20" data-component="image" alt="160105-4-Common-company-issues-and-how-to-solve-them-04-(1200x600)" height="600" sizes="(max-width: 700px) calc(100vw - 45px), 800px" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="1200" />
                      {" "}
                    </picture>
                  </a>
                </p>
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-em">
                  {"The reason that so many companies and teams go slow is because "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-span-9" data-component="link" href="https://www.garyvaynerchuk.com/blog/">
                    first time managers
                  </a>
                  {" struggle to trust their employees."}
                </p>
                {" "}
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-span-6">
                  {"A lot of managers withhold trust because they fear the ramifications. They "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-p-6" data-component="link" href="https://www.garyvaynerchuk.com/tips-for-dealing-with-anxiety/">
                    fear the anxiety
                  </a>
                  {" that comes with losing. They’re afraid of what will happen when an employee messes up, or when mistakes happen."}
                </p>
                {" "}
                ...
                {" "}
                <p className="block pb-[25.5px] text-center" data-ditto-id="style-link-14">
                  <iframe className="w-200 h-112 block overflow-clip aspect-[25/14] align-middle [background-size:100%_100%] bg-no-repeat max-md:w-82.5 max-md:h-[11.5625rem] max-lg:[background-size:initial] max-lg:[background-repeat:initial]" style={{ backgroundImage: "url(\"/assets/cloned/images/5fa414a956bd.jpg\")" }} data-ditto-id="style-link-7" height="315" width="100%">
                    {"&lt;span data-mce-type=\"bookmark\" style=\"display: inline-block; width: 0px; overflow: hidden; line-height: 0;\" class=\"mce_SELRES_start\"&gt; &lt;/span&gt;"}
                  </iframe>
                </p>
                {" "}
                <p className="block pb-[25.5px]" data-ditto-id="style-link-6">
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-p-29" data-component="link" href="https://youtu.be/zeMYOJtTy_U">
                    Giving trust easily
                  </a>
                  {" is crucial to my success as a CEO and entrepreneur."}
                </p>
                {" "}
              </article>
            </div>
          </main>
          <section className="h-[30.4375rem] min-h-[30.4375rem] block relative pt-[1.0875rem] pb-[1.0625rem] px-[3.5625rem] overflow-hidden bg-color-007 bg-cover [background-position:50%_100%] bg-no-repeat max-md:h-[622.7px] max-md:min-h-[622.7px] max-md:mx-[5.5px] max-md:pt-[0.4125rem] max-md:px-[1.0625rem] max-md:pb-0 md:max-lg:h-152 md:max-lg:min-h-152 md:max-lg:pt-[6.7125rem]" style={{ backgroundImage: "url(\"/assets/cloned/images/70cdd4bc96ea.jpg\")" }} data-ditto-id="style-link-5" aria-labelledby="newsletter-title" id="newsletter">
            <div className="flex relative z-1 max-w-250 flex-col items-center text-center mx-auto" data-ditto-id="style-p-12">
              <img className="w-69.5 h-18 block mb-[8.5px] overflow-clip aspect-[auto_902/234] align-middle text-clr-1 max-md:w-82.5 max-md:h-21.5 max-md:max-w-full" data-ditto-id="style-newsletter" data-component="image" alt="GaryVee Weekly" height="234" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="902" />
              <h2 className="block mb-[2.1875rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.375rem] leading-[2.6875rem] uppercase max-md:mb-[35.5px] max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-ditto-id="style-div" data-component="heading" id="newsletter-title">
                Sign up for my weekly newsletter
              </h2>
              <form className="w-full max-w-106.5 block gap-2.5 text-left max-md:flex-col max-md:items-stretch" data-ditto-id="style-image">
                <label className="w-px h-px block absolute -m-px overflow-hidden [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase whitespace-nowrap text-nowrap [clip-path:inset(50%)] cursor-default max-md:text-[1.1875rem]" data-ditto-id="style-newsletter-title" aria-hidden="true" htmlFor="newsletter-website">
                  Website
                  <input className="w-4.5 h-11 min-h-11 border border-solid border-border inline-block p-2 overflow-clip text-[0.9375rem] text-start normal-case bg-border cursor-text max-md:h-12.5 max-md:min-h-12.5 max-md:block" data-ditto-id="style-form" data-component="input" id="newsletter-website" name="website" type="text" />
                </label>
                <label className="block [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase cursor-default max-md:mb-1.5 max-md:text-[1.1875rem]" data-ditto-id="style-label" htmlFor="newsletter-email">
                  Email
                </label>
                <div className="grid items-center gap-[0.5375rem] grid-cols-[317.328px_100.109px] max-md:block max-md:grid-cols-[317.34px_100.11px]" data-ditto-id="style-newsletter-website">
                  <input className="w-[19.8125rem] h-11 min-h-11 border border-solid border-border block p-2 overflow-clip text-[0.9375rem] leading-[1.4375rem] text-start bg-border cursor-text max-md:w-82.5 max-md:h-12.5 max-md:min-h-12.5" data-ditto-id="style-label-2" data-component="input" id="newsletter-email" name="email" type="email" />
                  <button className="w-full h-[3.5625rem] flex rounded-[999px] justify-center items-center [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[1.0625rem] leading-[1.0625rem] text-center uppercase bg-primary transform-[matrix(1,0,0,1,0,-6.5)] cursor-default max-md:block max-md:mt-4 max-lg:transform-[none] max-md:h-auto" data-ditto-id="style-div-15" data-component="button" type="submit">
                    Subscribe
                  </button>
                </div>
              </form>
              <div className="w-[51%] grid mt-[108.5px] gap-2.5 transform-[matrix(1,0,0,1,23.6094,0)] grid-cols-[repeat(auto-fit,_minmax(41px,_1fr))] max-md:w-full max-md:mt-22 max-md:pl-[0.6875rem] max-md:justify-start max-md:gap-[8.3px] max-lg:transform-[none] md:max-lg:w-[69.5%] md:max-lg:mt-[7.1875rem] 2xl:w-[45.5%]" data-ditto-id="style-newsletter-email" aria-label="Social media">
                {Logo2_data.map((d, i) => <Logo2 key={i} d={d} />)}
              </div>
              <footer className="flex mt-[1.775rem] flex-col justify-center items-center text-[0.875rem] max-md:mt-[0.925rem]" data-ditto-id="style-div-17">
                <span className="block">
                  ©Gary Vee IP, LLC 2024
                </span>
                <span className="block text-color-006">
                  <a className="inline cursor-pointer" data-ditto-id="style-span-23" data-component="link" href="https://www.garyvaynerchuk.com/privacy-policy/">
                    Privacy Policy
                  </a>
                  {" | "}
                  <a className="inline cursor-pointer" data-ditto-id="style-span-24" data-component="link" href="https://www.garyvaynerchuk.com/terms-of-use/">
                    Terms of Use
                  </a>
                  {" | "}
                  <button className="inline-block underline cursor-pointer" data-ditto-id="style-link-13" data-component="button" type="button">
                    Cookie Settings
                  </button>
                </span>
              </footer>
