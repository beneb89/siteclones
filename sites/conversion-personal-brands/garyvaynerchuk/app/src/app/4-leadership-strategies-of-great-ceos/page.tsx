      ...
      <div className="min-h-screen block">
        ...
        <div className="h-full min-h-screen block ml-[17.1875rem] overflow-hidden max-lg:pt-18.5 max-lg:ml-0">
          ...
          <main className="block" data-ditto-id="style-main-content" id="main-content">
            ...
            <div className="h-[4768.5px] min-h-screen block overflow-hidden bg-background max-md:h-[382.35rem]" data-ditto-id="style-link-3">
              ...
              <article className="box-content w-200 block mx-auto pt-20 pb-27.5 text-[1.0625rem] font-medium leading-[1.6875rem] max-md:w-82.5 max-md:pt-10 max-md:pb-20 md:max-lg:-mr-8 md:max-lg:ml-0">
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-p-7">
                  {"Some of them thought I was like the “crazy founder” who has wild ideas on "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-span-11" data-component="link" href="https://www.garyvaynerchuk.com/marketing-opportunities-in-2019/">
                    marketing opportunities
                  </a>
                  {" that can’t actually be implemented in reality. "}
                </p>
                {" "}
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-link-15">
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-br-2" data-component="link" href="https://www.garyvaynerchuk.com/management-strategies-and-tips/">
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-p-13">
                  <em className="inline italic" data-ditto-id="style-span-5">
                    <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-p-5" data-component="link" href="https://twitter.com/home?status=Great%20article%20by%20%40GaryVee%20on%20Twitter%3A%204%20Leadership%20Strategies%20of%20Great%20CEOs%20https%3A//www.garyvaynerchuk.com/4-leadership-strategies-of-great-ceos/">
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-image-4">
                  <em className="inline italic" data-ditto-id="style-heading">
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-span-20">
                  <iframe className="w-200 h-112 block overflow-clip aspect-[25/14] align-middle [background-size:100%_100%] bg-no-repeat max-md:w-82.5 max-md:h-[11.5625rem] max-lg:[background-size:initial] max-lg:[background-repeat:initial]" style={{ backgroundImage: "url(\"/assets/cloned/images/941d4c13a757.jpg\")" }} data-ditto-id="style-p-15" height="315" width="100%" />
                </p>
                {" "}
                <p className="block pb-[25.5px]" data-ditto-id="style-em">
                  <em className="inline italic" data-ditto-id="style-span-9">
                    {" "}
                  </em>
                </p>
                {" "}
          ...
          <section className="h-[30.4375rem] min-h-[30.4375rem] block relative pt-[1.0875rem] pb-[1.0625rem] px-[3.5625rem] overflow-hidden bg-color-007 bg-cover [background-position:50%_100%] bg-no-repeat max-md:h-[622.7px] max-md:min-h-[622.7px] max-md:mx-[5.5px] max-md:pt-[0.4125rem] max-md:px-[1.0625rem] max-md:pb-0 md:max-lg:h-152 md:max-lg:min-h-152 md:max-lg:pt-[6.7125rem]" style={{ backgroundImage: "url(\"/assets/cloned/images/70cdd4bc96ea.jpg\")" }} data-ditto-id="style-p-26" aria-labelledby="newsletter-title" id="newsletter">
            <div className="flex relative z-1 max-w-250 flex-col items-center text-center mx-auto" data-ditto-id="style-span-7">
              <img className="w-69.5 h-18 block mb-[8.5px] overflow-clip aspect-[auto_902/234] align-middle text-clr-1 max-md:w-82.5 max-md:h-21.5 max-md:max-w-full" data-ditto-id="style-span-6" data-component="image" alt="GaryVee Weekly" height="234" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="902" />
              <h2 className="block mb-[2.1875rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.375rem] leading-[2.6875rem] uppercase max-md:mb-[35.5px] max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-ditto-id="style-p-6" data-component="heading" id="newsletter-title">
                Sign up for my weekly newsletter
              </h2>
              <form className="w-full max-w-106.5 block gap-2.5 text-left max-md:flex-col max-md:items-stretch" data-ditto-id="style-span-8">
                <label className="w-px h-px block absolute -m-px overflow-hidden [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase whitespace-nowrap text-nowrap [clip-path:inset(50%)] cursor-default max-md:text-[1.1875rem]" data-ditto-id="style-p-11" aria-hidden="true" htmlFor="newsletter-website">
                  Website
                  <input className="w-4.5 h-11 min-h-11 border border-solid border-border inline-block p-2 overflow-clip text-[0.9375rem] text-start normal-case bg-border cursor-text max-md:h-12.5 max-md:min-h-12.5 max-md:block" data-ditto-id="style-p-4" data-component="input" id="newsletter-website" name="website" type="text" />
                </label>
                <label className="block [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase cursor-default max-md:mb-1.5 max-md:text-[1.1875rem]" data-ditto-id="style-link-4" htmlFor="newsletter-email">
                  Email
                </label>
              ...
              <footer className="flex mt-[1.775rem] flex-col justify-center items-center text-[0.875rem] max-md:mt-[0.925rem]" data-ditto-id="style-visit-this-post-on-x">
                ...
                <span className="block text-color-006" data-ditto-id="style-div-16">
                  ...
                  {" | "}
                  <a className="inline cursor-pointer" data-ditto-id="style-div-31" data-component="link" href="https://www.garyvaynerchuk.com/terms-of-use/">
                    Terms of Use
                  </a>
                  {" | "}
                  <button className="inline-block underline cursor-pointer" data-ditto-id="style-div-20" data-component="button" type="button">
                    Cookie Settings
                  </button>
                </span>
              </footer>
