      ...
      <div className="min-h-screen block">
        ...
        <div className="h-full min-h-screen block ml-[17.1875rem] overflow-hidden max-lg:pt-18.5 max-lg:ml-0">
          ...
          <main className="block" data-ditto-id="style-main-content" id="main-content">
            ...
            <div className="h-[450.9375rem] min-h-screen block overflow-hidden bg-background max-md:h-[481.925rem]" data-ditto-id="style-link-3">
              ...
              <article className="box-content w-200 block mx-auto pt-20 pb-27.5 text-[1.0625rem] font-medium leading-[1.6875rem] max-md:w-82.5 max-md:pt-10 max-md:pb-20 md:max-lg:-mr-8 md:max-lg:ml-0">
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-p-9">
                  {"I give trust a lot easier than most CEOs. To me, it’s just faster. I blindly trust all my employees. If they prove themselves to be incapable, I’ll put restrictions around them. I genuinely believe that the phrase: “Trust is not given, it’s earned” is slow and egotistical. "}
                </p>
                {" "}
                <h2 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.8125rem] font-normal leading-12.5 uppercase max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-ditto-id="style-p-14" data-component="heading">
                ...
                {" "}
                <h2 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.8125rem] font-normal leading-12.5 uppercase max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-ditto-id="style-span-14" data-component="heading">
                  2. Stop micromanaging and teach your team how to swim.
                </h2>
                {" "}
                <div className="block" data-ditto-id="style-blockquote-2">
                  <figure className="block max-w-full my-9" data-ditto-id="style-p-27">
                    <img className="w-200 h-250 block max-w-full overflow-clip aspect-[auto_1080/1350] align-middle text-clr-1 max-md:w-82.5 max-md:h-[25.8125rem]" data-ditto-id="style-p-16" data-component="image" alt="" height="1350" sizes="(max-width: 700px) calc(100vw - 45px), 800px" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="1080" />
                  </figure>
                </div>
                {" "}
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-link-9">
                  {"After you’ve internalized that you work for them, it’s time to establish what sort of legacy you want to leave behind. What does it mean for someone to say they’ve worked at your company? What do you want it to say on your tombstone? For this reason, among others, I call "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-p-28" data-component="link" href="https://vaynerx.com/">
                    Vayner X
                  </a>
                  {" my “honey empire”. "}
                </p>
                ...
                <div className="block" data-ditto-id="style-heading-9">
                  <figure className="block max-w-full my-9" data-ditto-id="style-p-24">
                    <img className="w-200 h-250 block max-w-full overflow-clip aspect-[auto_1080/1350] align-middle text-clr-1 max-md:w-82.5 max-md:h-[25.8125rem]" data-ditto-id="style-p-23" data-component="image" alt="" height="1350" sizes="(max-width: 700px) calc(100vw - 45px), 800px" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="1080" />
                  </figure>
                </div>
                {" "}
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-span-13">
                  {"Remember, my words mean nothing if you don’t listen to them and internalize them, so they’re a part of your everyday life. So, what do you do now? Share it with a leader you admire or someone you know that is actively trying to become a better leader. While you’re at it, "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-image-3" data-component="link" href="https://twitter.com/GaryVee">
                    tweet me
                  </a>
                  {" your biggest takeaways. Oh, and of course, practice, practice, practice doing these things yourself. "}
                </p>
                {" "}
                <div className="w-200 h-112 block relative overflow-hidden aspect-[25/14] align-middle max-md:w-82.5 max-md:h-[11.5625rem]" data-ditto-id="style-p-2" title="Embedded post">
                  <div className="h-full block text-color-013 [font-family:-apple-system,_system-ui,_BlinkMacSystemFont,_'Segoe_UI',_Roboto,_'Helvetica_Neue',_'Fira_Sans',_Ubuntu,_Oxygen,_'Oxygen_Sans',_Cantarell,_'Droid_Sans',_'Apple_Color_Emoji',_'Segoe_UI_Emoji',_'Segoe_UI_Emoji',_'Segoe_UI_Symbol',_'Lucida_Grande',_Helvetica,_Arial,_sans-serif] text-base font-normal leading-6" data-ditto-id="style-link-15" dir="ltr">
                    <article className="h-full block relative pb-2 bg-foreground shadow-[var(--clr-1)_0px_0px_0px_0px,var(--clr-1)_0px_0px_0px_0px,var(--clr-9)_0px_0px_0px_0.5px] max-w-[100vw]" data-ditto-id="style-br-2">
                      <div className="flex" data-ditto-id="style-br">
                        {" "}
                      </div>
                      {" "}
                      <div className="block" data-ditto-id="style-p-25">
                        <div className="h-[2.4375rem] flex pl-4 items-center w-full max-md:h-[4.4375rem] max-md:flex-col" data-ditto-id="style-span-16">
                          <div className="block z-400 grow overflow-hidden text-foreground font-semibold text-left whitespace-nowrap text-nowrap w-full max-md:pt-2" data-ditto-id="style-i-2">
                            {" For those of you who are growing and have employees or are aspiring to own a business one day, I really hope this clicks. What was your biggest takeaway? I'm looking forward to reading your comments. "}
                          </div>
                          {" "}
                          <div className="w-1/4 flex max-md:w-full max-md:justify-end" data-ditto-id="style-blockquote">
                            <a className="h-[2.4375rem] flex z-400 mr-4 pr-4 items-center content-center text-foreground font-semibold cursor-pointer" data-ditto-id="style-p-8" data-component="link" href={"https://www.linkedin.com/signup/cold-join?session_redirect=https%3A%2F%2Fwww%2Elinkedin%2Ecom%2Ffeed%2Fupdate%2Furn%3Ali%3Aactivity%3A6755167763674746880&trk=public_post_embed_embed-like"} target="_blank">
                              {" "}
                              <icon className="block mr-2 w-4 h-4" data-ditto-id="style-p-13" aria-hidden="true">
                                <svg className="w-auto h-4 inline overflow-hidden" data-ditto-id="style-span-5" data-component="icon" aria-busy="false" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" focusable="false">
                                  <path d="M19.5 11l-3.9-3.9c-.8-.8-1.3-1.7-1.7-2.7l-.5-1.5C13 1.8 11.9 1 10.8 1 9.2 1 8 2.2 8 3.8v1.1c0 1 .2 1.9.5 2.8L8.9 9H4.1C3 9 2 10 2 11.1c0 .7.4 1.4.9 1.8-.6.4-.9 1-.9 1.7 0 .9.5 1.6 1.3 2-.2.3-.3.7-.3 1 0 1.1.9 2.1 2 2.1v.1C5 21 6 22 7.1 22h7.5c1.2 0 2.5-.3 3.6-.8l.3-.2H21V11h-1.5zm-.5 8h-1l-.7.4c-.8.4-1.8.6-2.7.6H7.7c-.4 0-.8-.3-1-.7l-.3-.9-.8-.4c-.4-.1-.7-.6-.6-1l.2-1-.8-.7c-.3-.4-.4-.9-.1-1.3l.7-1.1-.7-1.1c-.3-.4-.1-.8.3-.8h7l-1.3-3.9c-.2-.7-.3-1.5-.3-2.2V3.8c0-.5.3-.8.8-.8.3 0 .6.2.7.5L12 5c.4 1.3 1.2 2.5 2.2 3.5l4.5 4.5h.3v6z" fill="currentColor" />
                                </svg>
                              </icon>
                              {" "}
                            ...
                            {" "}
                            <div className="block z-400" data-ditto-id="style-image-4">
                              <div className="block" data-ditto-id="style-heading">
                                <button className="h-[2.4375rem] min-h-8 border border-solid border-clr-1 flex min-w-[fit-content] py-[0.4375rem] px-4 justify-center items-center grow text-foreground text-sm font-semibold leading-4 text-center shadow-[var(--clr-1)_0px_0px_0px_1px] cursor-pointer" data-ditto-id="style-span-20" data-component="button" aria-hidden="false">
                                  <icon className="block" data-ditto-id="style-p-15" aria-hidden="true">
                                    <svg className="w-auto h-5 inline mr-1 overflow-hidden max-md:mr-0" data-ditto-id="style-em" data-component="icon" aria-busy="false" fill="none" height="14" viewBox="0 0 15 14" width="15" xmlns="http://www.w3.org/2000/svg" focusable="false">
                                      <path d="M14.375 0L0.375 4.67L5.375 7.31L11.045 3.33L7.075 9L9.705 14L14.375 0Z" fill="currentcolor" fillOpacity="0.75" />
                                    </svg>
                                  </icon>
                                  {" "}
                                  <span className="block max-md:pl-1" data-ditto-id="style-span-9">
                                    {" Share "}
                                  </span>
                                  {" "}
                                </button>
                                {" "}
                                <div className="block" data-ditto-id="style-p-26" id="f0-social-share-compact-embed-native-embedded-social-share-modal">
                                  {" "}
                                </div>
                                {" "}
                              </div>
                        ...
                        {" "}
                        <div className="h-112 flex absolute top-0 inset-x-0 z-300 justify-center items-center overflow-hidden max-md:h-[11.5625rem]" data-ditto-id="style-span-7">
                          <img className="w-full block absolute left-1/2 min-w-0 overflow-clip object-contain transform-[matrix(1,0,0,1,-400,0)] cursor-pointer h-full max-md:transform-[matrix(1,0,0,1,-165,0)]" data-ditto-id="style-span-6" data-component="image" alt="Video poster image" aria-hidden="true" src="/assets/cloned/images/c10d89f45cb8.jpg" />
                          {" "}
                          <div className="block relative align-middle cursor-pointer w-12" data-ditto-id="style-p-6">
                            <button className="border border-solid border-clr-1 inline-block text-foreground text-[0.8125rem] leading-[0.9375rem] text-center bg-color-013 cursor-default w-12" data-ditto-id="style-span-8" data-component="button" aria-label="Play video">
                              {" "}
                              <icon className="inline" data-ditto-id="style-p-11" aria-hidden="true">
                                <svg className="w-auto h-11.5 block overflow-hidden" data-ditto-id="style-p-4" data-component="icon" aria-busy="false" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" version="1.1" focusable="false" fill="currentColor">
                                  <g className="large-icon" style={{ fill: "currentColor" }} id="play-icon-large">
                        ...
                        {" "}
                        <div className="flex absolute bottom-0 inset-x-0 z-400 p-4 items-end h-16" style={{ backgroundImage: "linear-gradient(0deg, var(--clr-10) 50%, var(--clr-1) 100%)" }} data-ditto-id="style-link-4">
                          <div className="block flex-1 overflow-hidden text-foreground w-full" data-ditto-id="style-link-8">
                            <a className="h-6 block z-100 overflow-hidden font-semibold text-left whitespace-nowrap text-nowrap cursor-pointer" data-ditto-id="style-link-14" data-component="link" href="https://www.linkedin.com/in/garyvaynerchuk?trk=public_post_embed_embed-actor" target="_blank">
                              {" Gary Vaynerchuk "}
                            </a>
                            {" "}
                            <div className="block z-100 overflow-hidden text-left whitespace-nowrap text-nowrap" data-ditto-id="style-link-7">
                              {" Chairman – VaynerX, CEO – VaynerMedia, Creator – VeeFriends "}
                            </div>
                            {" "}
                          </div>
                          {" "}
                          <a className="block mb-2 text-color-025 font-semibold cursor-pointer w-6 h-6" data-ditto-id="style-link-6" data-component="link" aria-label="Open video on LinkedIn" href={"https://www.linkedin.com/signup/cold-join?session_redirect=https%3A%2F%2Fwww%2Elinkedin%2Ecom%2Ffeed%2Fupdate%2Furn%3Ali%3Aactivity%3A6755167763674746880&trk=public_post_embed_embed-inbug"} target="_blank">
                            {" "}
                            <icon className="inline" data-ditto-id="style-p-29" aria-hidden="true">
                              <svg className="w-auto h-6 inline overflow-hidden" data-ditto-id="style-link-5" data-component="icon" aria-busy="false" height="24px" viewBox="0 0 24 24" width="24px" xmlns="http://www.w3.org/2000/svg" version="1.1" preserveAspectRatio="xMinYMin meet" focusable="false" fill="currentColor">
                                <g>
                      ...
                      {" "}
                      <div className="block absolute top-0 right-0 left-4 -ml-4 h-full" data-ditto-id="style-p-12" aria-hidden="true">
                        <div className="h-full flex relative max-w-full justify-center items-center overflow-hidden text-foreground bg-color-002" data-ditto-id="style-newsletter" aria-label="Video Player" id="f0-vjs_video_3" lang="en" playsInline role="region">
                          <div className="w-200 h-112 block absolute opacity-60 min-w-0 bg-cover [background-position:50%_50%] bg-no-repeat [filter:blur(20px)] transform-[matrix(1.1,0,0,1.1,0,0)] origin-[400px_224px] max-md:w-82.5 max-md:h-[11.5625rem] max-md:origin-[165px_92.5px]" style={{ backgroundImage: "url(\"/assets/cloned/images/c10d89f45cb8.jpg\")" }} data-ditto-id="style-div" />
                          <video className="w-full h-full block absolute top-0 left-0 min-w-0 overflow-clip object-contain" data-ditto-id="style-image" id="f0-vjs_video_3_html5_api" playsInline poster="/assets/cloned/images/c10d89f45cb8.jpg" preload="none" />
                          <div className="w-px h-px block absolute min-w-0 -m-px overflow-hidden whitespace-nowrap text-nowrap" data-ditto-id="style-newsletter-title" aria-live="polite" />
                          <div className="h-full block absolute top-0 inset-x-0 min-w-0 align-middle bg-contain [background-position:50%_50%] bg-no-repeat cursor-pointer" style={{ backgroundImage: "url(\"/assets/cloned/images/c10d89f45cb8.jpg\")" }} data-ditto-id="style-form" aria-disabled="false" />
                        </div>
                        {" "}
                      </div>
                      {" "}
