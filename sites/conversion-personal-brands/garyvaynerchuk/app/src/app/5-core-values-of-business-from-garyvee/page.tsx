              ...
              <ol className="flex flex-wrap gap-[0.4375rem] [list-style-type:none] list-outside">
                ...
                <li className="flex min-w-0 items-center before:content-['/'] before:block before:w-[0.3125rem] before:h-5 before:mr-[0.4375rem] before:text-clr-4 before:text-[0.8125rem] before:leading-5" data-ditto-id="style-li-3">
                  <span className="block overflow-hidden whitespace-nowrap text-nowrap" data-ditto-id="style-span-18" aria-current="page">
                    5 Core Values of Business from GaryVee
                  </span>
                </li>
              </ol>
            </nav>
            <div className="h-[3107.5px] min-h-screen block overflow-hidden bg-background max-md:h-[5209.5px]" data-ditto-id="style-div-24">
              ...
              <article className="box-content w-200 block mx-auto pt-20 pb-27.5 text-[1.0625rem] font-medium leading-[1.6875rem] max-md:w-82.5 max-md:pt-10 max-md:pb-20 md:max-lg:-mr-8 md:max-lg:ml-0">
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-p-14">
                  {"For a long time, I’ve been talking about how "}
                  <a className="inline text-primary font-bold cursor-pointer" data-component="link" href="https://www.inc.com/gary-vaynerchuk/everybody-should-be-doing-content-marketing.html">
                    <u className="inline underline" data-ditto-id="style-p-10">
                      every company
                    </u>
                  </a>
                  {" "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-span-14" data-component="link" href="https://www.garyvaynerchuk.com/blog/">
                    <u className="inline underline" data-ditto-id="style-blockquote-2">
                      is a media company
                    </u>
                  </a>
                  {". You may not have the dollars to pay Ron Howard to create an original eight part miniseries for your brand. But this is why Instagram and Snapchat and all these other social media platforms are so valuable for your business’s content that actually affects your company’s revenue. There is disproportionate content virality, and new stars are being built every day. The awareness is huge. I used Twitter and YouTube to establish myself in the wine business as they were emerging, and I definitely did not have millions of dollars. That is every small business’s opportunity. Take advantage of the upside of writing on "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-p-27" data-component="link" href="https://medium.com/">
                    <u className="inline underline" data-ditto-id="style-p-16">
                      Medium
                    </u>
                  </a>
                  , or becoming the first influencer on Meerkat. That upside is the jumpstart that you need when you don’t have dollars.
                </p>
                {" "}
                <p className="block pb-[25.5px]" data-ditto-id="style-p-22">
                  {"Now, how do you make good content? I talked about that "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-heading-5" data-component="link" href="https://www.linkedin.com/pulse/20141205181506-10486099-a-guide-to-creating-the-best-content-possible" rel="noopener noreferrer" target="_blank">
                    here
                  </a>
                  .
                </p>
