      ...
      <div className="min-h-screen block">
        ...
        <div className="h-full min-h-screen block ml-[17.1875rem] overflow-hidden max-lg:pt-18.5 max-lg:ml-0">
          ...
          <main className="block" id="main-content">
            ...
            <div className="h-200 min-h-screen block overflow-hidden bg-background max-md:h-203 md:max-lg:h-256 2xl:h-270" data-ditto-id="style-li">
          ...
          <section className="h-[30.4375rem] min-h-[30.4375rem] block relative pt-[1.0875rem] pb-[1.0625rem] px-[3.5625rem] overflow-hidden bg-color-007 bg-cover [background-position:50%_100%] bg-no-repeat max-md:h-[622.7px] max-md:min-h-[622.7px] max-md:mx-[5.5px] max-md:pt-[0.4125rem] max-md:px-[1.0625rem] max-md:pb-0 md:max-lg:h-152 md:max-lg:min-h-152 md:max-lg:pt-[6.7125rem]" style={{ backgroundImage: "url(\"/assets/cloned/images/70cdd4bc96ea.jpg\")" }} data-ditto-id="style-heading-2" aria-labelledby="newsletter-title" id="newsletter">
            <div className="flex relative z-1 max-w-250 flex-col items-center text-center mx-auto">
              ...
              <h2 className="block mb-[2.1875rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.375rem] leading-[2.6875rem] uppercase max-md:mb-[35.5px] max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-ditto-id="style-span-22" data-component="heading" id="newsletter-title">
              ...
              <form className="w-full max-w-106.5 block gap-2.5 text-left max-md:flex-col max-md:items-stretch">
                <label className="w-px h-px block absolute -m-px overflow-hidden [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase whitespace-nowrap text-nowrap [clip-path:inset(50%)] cursor-default max-md:text-[1.1875rem]" aria-hidden="true" htmlFor="newsletter-website">
                  Website
                  <input className="w-4.5 h-11 min-h-11 border border-solid border-border inline-block p-2 overflow-clip text-[0.9375rem] text-start normal-case bg-border cursor-text max-md:h-12.5 max-md:min-h-12.5 max-md:block" data-ditto-id="style-heading-3" data-component="input" id="newsletter-website" name="website" type="text" />
                </label>
                <label className="block [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase cursor-default max-md:mb-1.5 max-md:text-[1.1875rem]" data-ditto-id="style-span-21" htmlFor="newsletter-email">
                  Email
                </label>
                <div className="grid items-center gap-[0.5375rem] grid-cols-[317.328px_100.109px] max-md:block max-md:grid-cols-[317.34px_100.11px]" data-ditto-id="style-p-7">
              ...
              <footer className="flex mt-[1.775rem] flex-col justify-center items-center text-[0.875rem] max-md:mt-[0.925rem]" data-ditto-id="style-span-12">
                <span className="block" data-ditto-id="style-i-3">
                  ©Gary Vee IP, LLC 2024
                </span>
                <span className="block text-color-006" data-ditto-id="style-span-17">
                  <a className="inline cursor-pointer" data-ditto-id="style-span-13" data-component="link" href="https://www.garyvaynerchuk.com/privacy-policy/">
                    Privacy Policy
                  </a>
                  {" | "}
                  <a className="inline cursor-pointer" data-ditto-id="style-image-3" data-component="link" href="https://www.garyvaynerchuk.com/terms-of-use/">
                    Terms of Use
                  </a>
                  {" | "}
                  <button className="inline-block underline cursor-pointer" data-ditto-id="style-p-2" data-component="button" type="button">
                    Cookie Settings
                  </button>
                </span>
              </footer>
