      ...
      <div className="min-h-screen block">
        ...
        <div className="h-full min-h-screen block ml-[17.1875rem] overflow-hidden max-lg:pt-18.5 max-lg:ml-0">
          ...
          <main className="block" data-ditto-id="style-main-content" id="main-content">
            ...
            <div className="h-[7319.5px] min-h-screen block overflow-hidden bg-background max-md:h-[536.0875rem]" data-ditto-id="style-link-3">
              ...
              <article className="box-content w-200 block mx-auto pt-20 pb-27.5 text-[1.0625rem] font-medium leading-[1.6875rem] max-md:w-82.5 max-md:pt-10 max-md:pb-20 md:max-lg:-mr-8 md:max-lg:ml-0">
                ...
                <ul className="block [list-style-type:none] list-outside" data-ditto-id="style-p-7">
                  <li className="list-item" data-ditto-id="style-span-11">
                    {"Familiarize yourself with the "}
                    <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-p" data-component="link" href="https://www.garyvaynerchuk.com/instagram-for-business-180-strategy-grow-business-brand/">
                      $1.80 strategy
                    </a>
                    {". I’ve written about this, in depth, a few years back. To summarize, this is all about finding hashtags/content that’s relevant to your business, and commenting on that content. If you leave thoughtful comments, aka your .02 cents, on 9 posts for 10 hashtags–that’ll add up to $1.80. "}
                  </li>
                </ul>
                {" "}
                <p className="block pb-[25.5px]">
                ...
                {" "}
                <h2 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.8125rem] font-normal leading-12.5 uppercase max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-ditto-id="style-p-21" data-component="heading">
                ...
                {" "}
                <h2 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.8125rem] font-normal leading-12.5 uppercase max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-ditto-id="style-p-9" data-component="heading">
                  3. Be Authentic
                </h2>
                {" "}
                <div className="block" data-ditto-id="style-p-14">
                  <figure className="block max-w-full my-9">
                    <img className="w-200 h-250 block max-w-full overflow-clip aspect-[auto_1080/1350] align-middle text-clr-1 max-md:w-82.5 max-md:h-[25.8125rem]" data-ditto-id="style-p-10" data-component="image" alt="" height="1350" sizes="(max-width: 700px) calc(100vw - 45px), 800px" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="1080" />
                  </figure>
                </div>
                {" "}
                <p className="block pb-[25.5px]" data-ditto-id="style-span-14">
                  {"Authenticity is important. "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-blockquote-2" data-component="link" href="https://www.garyvaynerchuk.com/6-ways-to-be-more-authentic-on-social-media/">
                    I’ve spoken it about it a few times
                  </a>
                  {", but to summarize everything: don’t put on a show. Be authentic and real in categories you’re willing to be authentic and real in. What I think many people are missing is, "}
                  <em className="inline italic" data-ditto-id="style-p-27">
                    you don’t have to be in every conversation
                  </em>
                  {". There are people who don’t even do social media because they say ‘Gary, I don’t want my business out there’–okay, so don’t. "}
                </p>
                {" "}
                ...
                {" "}
                <h2 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.8125rem] font-normal leading-12.5 uppercase max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-ditto-id="style-heading-5" data-component="heading">
                  4. Content, Content, Content (that’s relevant and consistent)
                </h2>
                {" "}
                <p className="block pb-[25.5px]" data-ditto-id="style-p-3">
                  {"Now it’s time to put out content. Your content should be relevant and consistent. It should speak to your community. A good way to do that is to follow the "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-link-9" data-component="link" href="https://www.garyvaynerchuk.com/the-79-21-rule-to-build-a-long-term-business/">
                    79/21
                  </a>
                  {" rule and look at how your community behaves on other platforms. Once you have that down, you’re ready to post."}
                </p>
                {" "}
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-p-24">
                  {"As important as content is, context is even more important. Just think about it, you wouldn’t post something for LinkedIn on TikTok. Everything you post has to be contextual to that platform. People forget that great content is predicated on context. If you want a more tactical overview, "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-p-23" data-component="link" href="https://www.garyvaynerchuk.com/content-is-king-but-context-is-god/">
                    check out a blog post I wrote about this topic
                  </a>
                  .
                </p>
                {" "}
                <h2 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.8125rem] font-normal leading-12.5 uppercase max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-ditto-id="style-span-12" data-component="heading">
                ...
                <div className="block" data-ditto-id="style-span-17">
                  <figure className="block max-w-full my-9" data-ditto-id="style-span-13">
                    <img className="w-200 h-[58.0625rem] block max-w-full overflow-clip aspect-[auto_1080/1255] align-middle text-clr-1 max-md:w-82.5 max-md:h-[23.9375rem]" data-ditto-id="style-image-3" data-component="image" alt="" height="1255" sizes="(max-width: 700px) calc(100vw - 45px), 800px" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="1080" />
                  </figure>
                </div>
                {" "}
                <p className="block pb-[25.5px]" data-ditto-id="style-p-2">
                  {"Another way to promote your account is to pay for it. There are "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-link-15" data-component="link" href="https://www.wordstream.com/blog/ws/2016/10/19/get-more-instagram-followers">
                    tons of ways
                  </a>
                  {" to partner with influencers and community groups–just reach out. Sponsor some of their content and ask what their rates are if they were to promote your page/products. Some influencers are underpriced and some influencers are overpriced, so it’s important to do your research."}
                  <br className="inline" data-ditto-id="style-br-2" />
                  <br className="inline" data-ditto-id="style-br" />
                  {"As always, "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-p-25" data-component="link" href="https://sproutsocial.com/insights/how-to-get-followers-on-instagram/">
                ...
                {" "}
                <h2 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.8125rem] font-normal leading-12.5 uppercase max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-ditto-id="style-span-16" data-component="heading">
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-span-5">
                  ...
                  Use the comments to figure out what your community wants. When you do choose to
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-heading" data-component="link" href="https://www.garyvaynerchuk.com/bestinclass/">
                    {" run a contest "}
                  </a>
                  {"or "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-span-20" data-component="link" href="https://www.instagram.com/tv/CLXzLMXgEXf/?utm_source=ig_web_copy_link">
                    start a series on Instagram
                  </a>
                  {"–make sure it’s something that provides value to them. "}
                </p>
                {" "}
                <h2 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.8125rem] font-normal leading-12.5 uppercase max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-ditto-id="style-p-15" data-component="heading">
                ...
                {" "}
                <h2 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.8125rem] font-normal leading-12.5 uppercase max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-ditto-id="style-span-7" data-component="heading">
                ...
                {" "}
                <figure className="block max-w-full my-9" data-ditto-id="style-p-6">
                  <img className="w-200 h-200 block max-w-full overflow-clip aspect-[auto_1080/1080] align-middle text-clr-1 max-md:w-82.5 max-md:h-82.5" data-ditto-id="style-span-8" data-component="image" alt="" height="1080" sizes="(max-width: 700px) calc(100vw - 45px), 800px" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="1080" />
                </figure>
                {" "}
                <p className="block pb-[25.5px]" data-ditto-id="style-p-11">
                  {"Try some of these tips and let me know what worked for you. As always, if you liked this article, be sure to "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-p-4" data-component="link" href="https://twitter.com/">
                    share it on Twitter.
                  </a>
                </p>
                {" "}
          ...
          <section className="h-[30.4375rem] min-h-[30.4375rem] block relative pt-[1.0875rem] pb-[1.0625rem] px-[3.5625rem] overflow-hidden bg-color-007 bg-cover [background-position:50%_100%] bg-no-repeat max-md:h-[622.7px] max-md:min-h-[622.7px] max-md:mx-[5.5px] max-md:pt-[0.4125rem] max-md:px-[1.0625rem] max-md:pb-0 md:max-lg:h-152 md:max-lg:min-h-152 md:max-lg:pt-[6.7125rem]" style={{ backgroundImage: "url(\"/assets/cloned/images/70cdd4bc96ea.jpg\")" }} data-ditto-id="style-link-4" aria-labelledby="newsletter-title" id="newsletter">
            <div className="flex relative z-1 max-w-250 flex-col items-center text-center mx-auto" data-ditto-id="style-link-8">
              <img className="w-69.5 h-18 block mb-[8.5px] overflow-clip aspect-[auto_902/234] align-middle text-clr-1 max-md:w-82.5 max-md:h-21.5 max-md:max-w-full" data-ditto-id="style-link-14" data-component="image" alt="GaryVee Weekly" height="234" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="902" />
              <h2 className="block mb-[2.1875rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.375rem] leading-[2.6875rem] uppercase max-md:mb-[35.5px] max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-ditto-id="style-link-7" data-component="heading" id="newsletter-title">
                Sign up for my weekly newsletter
              </h2>
              <form className="w-full max-w-106.5 block gap-2.5 text-left max-md:flex-col max-md:items-stretch" data-ditto-id="style-link-6">
                <label className="w-px h-px block absolute -m-px overflow-hidden [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase whitespace-nowrap text-nowrap [clip-path:inset(50%)] cursor-default max-md:text-[1.1875rem]" data-ditto-id="style-p-29" aria-hidden="true" htmlFor="newsletter-website">
                  Website
                  <input className="w-4.5 h-11 min-h-11 border border-solid border-border inline-block p-2 overflow-clip text-[0.9375rem] text-start normal-case bg-border cursor-text max-md:h-12.5 max-md:min-h-12.5 max-md:block" data-ditto-id="style-link-5" data-component="input" id="newsletter-website" name="website" type="text" />
                </label>
                <label className="block [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase cursor-default max-md:mb-1.5 max-md:text-[1.1875rem]" data-ditto-id="style-p-12" htmlFor="newsletter-email">
                  Email
                </label>
                <div className="grid items-center gap-[0.5375rem] grid-cols-[317.328px_100.109px] max-md:block max-md:grid-cols-[317.34px_100.11px]" data-ditto-id="style-newsletter">
                  <input className="w-[19.8125rem] h-11 min-h-11 border border-solid border-border block p-2 overflow-clip text-[0.9375rem] leading-[1.4375rem] text-start bg-border cursor-text max-md:w-82.5 max-md:h-12.5 max-md:min-h-12.5" data-ditto-id="style-div" data-component="input" id="newsletter-email" name="email" type="email" />
                  <button className="w-full h-[3.5625rem] flex rounded-[999px] justify-center items-center [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[1.0625rem] leading-[1.0625rem] text-center uppercase bg-primary transform-[matrix(1,0,0,1,0,-6.5)] cursor-default max-md:block max-md:mt-4 max-lg:transform-[none] max-md:h-auto" data-ditto-id="style-image" data-component="button" type="submit">
                    Subscribe
                  </button>
                </div>
              </form>
              <div className="w-[51%] grid mt-[108.5px] gap-2.5 transform-[matrix(1,0,0,1,23.6094,0)] grid-cols-[repeat(auto-fit,_minmax(41px,_1fr))] max-md:w-full max-md:mt-22 max-md:pl-[0.6875rem] max-md:justify-start max-md:gap-[8.3px] max-lg:transform-[none] md:max-lg:w-[69.5%] md:max-lg:mt-[7.1875rem] 2xl:w-[45.5%]" data-ditto-id="style-newsletter-title" aria-label="Social media">
              ...
              <footer className="flex mt-[1.775rem] flex-col justify-center items-center text-[0.875rem] max-md:mt-[0.925rem]">
                ...
                <span className="block text-color-006" data-ditto-id="style-iframe">
                  <a className="inline cursor-pointer" data-ditto-id="style-heading-4" data-component="link" href="https://www.garyvaynerchuk.com/privacy-policy/">
                    Privacy Policy
                  </a>
                  {" | "}
                  <a className="inline cursor-pointer" data-ditto-id="style-span-19" data-component="link" href="https://www.garyvaynerchuk.com/terms-of-use/">
                    Terms of Use
                  </a>
                  {" | "}
                  <button className="inline-block underline cursor-pointer" data-ditto-id="style-button-9" data-component="button" type="button">
                    Cookie Settings
                  </button>
                </span>
              </footer>
