        ...
        <div className="h-full min-h-screen block ml-[17.1875rem] overflow-hidden max-lg:pt-18.5 max-lg:ml-0">
          <a className="h-8.5 flex relative z-30 items-center overflow-hidden text-color-002 [font-family:'Open_Sans',_'Open_Sans_Fallback',_Arial,_sans-serif] font-semibold leading-6.5 text-center whitespace-nowrap text-nowrap bg-accent cursor-pointer max-md:h-[2.0625rem] max-md:text-xs max-md:leading-[2.0625rem]" data-component="link" aria-label="Check out VeeFriends Cartoons!" href="https://garyvee.com/cartoons" rel="noreferrer" target="_blank">
            <span className="h-6.5 flex shrink-0 [animation-name:announcement-scroll-right] [animation-duration:24s] [animation-timing-function:linear] [animation-iteration-count:infinite] max-md:h-[2.0625rem] max-md:[animation-duration:18s]" data-ditto-id="style-span-2" aria-hidden="true">
              <span className="w-1/2 flex min-w-320 shrink-0 max-md:min-w-[23.4375rem] md:max-lg:min-w-192 2xl:min-w-480">
          ...
          <main className="block" data-ditto-id="style-main-content" id="main-content">
            ...
            <div className="h-[7319.5px] min-h-screen block overflow-hidden bg-background max-md:h-[536.0875rem]" data-ditto-id="style-div">
              ...
              <article className="box-content w-200 block mx-auto pt-20 pb-27.5 text-[1.0625rem] font-medium leading-[1.6875rem] max-md:w-82.5 max-md:pt-10 max-md:pb-20 md:max-lg:-mr-8 md:max-lg:ml-0" data-ditto-id="style-article">
                ...
                {" "}
                <h2 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.8125rem] font-normal leading-12.5 uppercase max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-ditto-id="style-p-2" data-component="heading">
                ...
                <div className="block">
                  <figure className="block max-w-full my-9">
                    <img className="w-200 h-250 block max-w-full overflow-clip aspect-[auto_1080/1350] align-middle text-clr-1 max-md:w-82.5 max-md:h-[25.8125rem]" data-component="image" alt="" height="1350" sizes="(max-width: 700px) calc(100vw - 45px), 800px" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="1080" />
                  </figure>
                </div>
                {" "}
                <p className="block pb-[25.5px]" data-ditto-id="style-p-5">
                  {"Authenticity is important. "}
                  <a className="inline text-primary font-bold cursor-pointer" data-component="link" href="https://www.garyvaynerchuk.com/6-ways-to-be-more-authentic-on-social-media/">
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-p-7">
                  ...
                  <a className="inline text-primary font-bold cursor-pointer" data-component="link" href="https://www.garyvaynerchuk.com/the-79-21-rule-to-build-a-long-term-business/">
                    79/21
                  </a>
                ...
                <p className="block pb-[25.5px]">
                  ...
                  <a className="inline text-primary font-bold cursor-pointer" data-component="link" href="https://www.garyvaynerchuk.com/content-is-king-but-context-is-god/">
                ...
                {" "}
                <div className="block">
                  <figure className="block max-w-full my-9" data-ditto-id="style-figure">
                    <img className="w-200 h-[58.0625rem] block max-w-full overflow-clip aspect-[auto_1080/1255] align-middle text-clr-1 max-md:w-82.5 max-md:h-[23.9375rem]" data-ditto-id="style-image-2" data-component="image" alt="" height="1255" sizes="(max-width: 700px) calc(100vw - 45px), 800px" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="1080" />
                  </figure>
                </div>
                {" "}
                <p className="block pb-[25.5px]" data-ditto-id="style-p-9">
                  {"Another way to promote your account is to pay for it. There are "}
                  <a className="inline text-primary font-bold cursor-pointer" data-component="link" href="https://www.wordstream.com/blog/ws/2016/10/19/get-more-instagram-followers">
                    tons of ways
                  </a>
                  ...
                  <br className="inline" />
                  {"As always, "}
                  <a className="inline text-primary font-bold cursor-pointer" data-component="link" href="https://sproutsocial.com/insights/how-to-get-followers-on-instagram/">
                ...
                <p className="block pb-[25.5px]">
                  ...
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-em" data-component="link" href="https://www.garyvaynerchuk.com/bestinclass/">
                    {" run a contest "}
                  </a>
                  {"or "}
                  <a className="inline text-primary font-bold cursor-pointer" data-component="link" href="https://www.instagram.com/tv/CLXzLMXgEXf/?utm_source=ig_web_copy_link">
                ...
                {" "}
                <figure className="block max-w-full my-9">
                  <img className="w-200 h-200 block max-w-full overflow-clip aspect-[auto_1080/1080] align-middle text-clr-1 max-md:w-82.5 max-md:h-82.5" data-ditto-id="style-link-7" data-component="image" alt="" height="1080" sizes="(max-width: 700px) calc(100vw - 45px), 800px" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="1080" />
                </figure>
                {" "}
                <p className="block pb-[25.5px]" data-ditto-id="style-link-6">
                  ...
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-link-10" data-component="link" href="https://twitter.com/">
                    share it on Twitter.
                  </a>
                </p>
                {" "}
          ...
          <section className="h-[30.4375rem] min-h-[30.4375rem] block relative pt-[1.0875rem] pb-[1.0625rem] px-[3.5625rem] overflow-hidden bg-color-008 bg-cover [background-position:50%_100%] bg-no-repeat max-md:h-[622.7px] max-md:min-h-[622.7px] max-md:mx-[5.5px] max-md:pt-[0.4125rem] max-md:px-[1.0625rem] max-md:pb-0 md:max-lg:h-152 md:max-lg:min-h-152 md:max-lg:pt-[6.7125rem]" style={{ backgroundImage: "url(\"/assets/cloned/images/70cdd4bc96ea.jpg\")" }} data-ditto-id="style-link-4" aria-labelledby="newsletter-title" id="newsletter">
            <div className="flex relative z-1 max-w-250 flex-col items-center text-center mx-auto" data-ditto-id="style-link-9">
              ...
              <form className="w-full max-w-106.5 block gap-2.5 text-left max-md:flex-col max-md:items-stretch" data-ditto-id="style-p">
                <label className="w-px h-px block absolute -m-px overflow-hidden [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase whitespace-nowrap text-nowrap [clip-path:inset(50%)] cursor-default max-md:text-[1.1875rem]" data-ditto-id="style-newsletter" aria-hidden="true" htmlFor="newsletter-website">
                  Website
                  <input className="w-4.5 h-11 min-h-11 border border-solid border-border inline-block p-2 overflow-clip text-[0.9375rem] text-start normal-case bg-border cursor-text max-md:h-12.5 max-md:min-h-12.5 max-md:block" data-ditto-id="style-div-2" data-component="input" id="newsletter-website" name="website" type="text" />
                </label>
                ...
                <div className="grid items-center gap-[0.5375rem] grid-cols-[317.328px_100.109px] max-md:block max-md:grid-cols-[317.34px_100.11px]" data-ditto-id="style-newsletter-title">
                  <input className="w-[19.8125rem] h-11 min-h-11 border border-solid border-border block p-2 overflow-clip text-[0.9375rem] leading-[1.4375rem] text-start bg-border cursor-text max-md:w-82.5 max-md:h-12.5 max-md:min-h-12.5" data-ditto-id="style-form" data-component="input" id="newsletter-email" name="email" type="email" />
                  <button className="w-full h-[3.5625rem] flex rounded-[999px] justify-center items-center [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[1.0625rem] leading-[1.0625rem] text-center uppercase bg-primary transform-[matrix(1,0,0,1,0,-6.5)] cursor-default max-md:block max-md:mt-4 max-lg:transform-[none] max-md:h-auto" data-ditto-id="style-label" data-component="button" type="submit">
                    Subscribe
                  </button>
                </div>
              </form>
              <div className="w-[51%] grid mt-[108.5px] gap-2.5 transform-[matrix(1,0,0,1,23.6094,0)] grid-cols-[repeat(auto-fit,_minmax(41px,_1fr))] max-md:w-full max-md:mt-22 max-md:pl-[0.6875rem] max-md:justify-start max-md:gap-[8.3px] max-lg:transform-[none] md:max-lg:w-[69.5%] md:max-lg:mt-[7.1875rem] 2xl:w-[45.5%]" data-ditto-id="style-newsletter-website" aria-label="Social media">
                {Logo2_data.map((d, i) => <Logo2 key={i} d={d} />)}
              </div>
              <footer className="flex mt-[1.775rem] flex-col justify-center items-center text-[0.875rem] max-md:mt-[0.925rem]" data-ditto-id="style-footer-2">
                <span className="block" data-ditto-id="style-heading">
                  ©Gary Vee IP, LLC 2024
                </span>
                <span className="block text-color-005" data-ditto-id="style-iframe">
                  ...
                  {" | "}
                  <button className="inline-block underline cursor-pointer" data-ditto-id="style-footer" data-component="button" type="button">
                    Cookie Settings
                  </button>
                </span>
              </footer>
