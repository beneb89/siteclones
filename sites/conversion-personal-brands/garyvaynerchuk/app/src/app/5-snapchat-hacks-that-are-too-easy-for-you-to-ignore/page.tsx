      ...
      <div className="min-h-screen block">
        ...
        <div className="h-full min-h-screen block ml-[17.1875rem] overflow-hidden max-lg:pt-18.5 max-lg:ml-0">
          ...
          <main className="block" data-ditto-id="style-main-content" id="main-content">
            ...
            <div className="h-[391.325rem] min-h-screen block overflow-hidden bg-background max-md:h-[292.95rem]" data-ditto-id="style-link-3">
              ...
              <article className="box-content w-200 block mx-auto pt-20 pb-27.5 text-[1.0625rem] font-medium leading-[1.6875rem] max-md:w-82.5 max-md:pt-10 max-md:pb-20 md:max-lg:-mr-8 md:max-lg:ml-0">
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-span-21">
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-p-7" data-component="link" href="https://www.garyvaynerchuk.com/images/linked-articles/5-snapchat-hacks-that-are-too-easy-for-you-to-ignore/remote-d716940bdc82.png">
                    <img className="w-200 h-200 block max-w-full overflow-clip aspect-[auto_744/744] align-middle text-clr-1 max-md:w-82.5 max-md:h-82.5" data-ditto-id="style-span-11" data-component="image" alt="Using emojis as a Snapchat hack" height="744" sizes="(max-width: 700px) calc(100vw - 45px), 800px" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="744" />
                  </a>
                </p>
                {" "}
                <p className="block pb-[25.5px] text-center" data-ditto-id="style-p">
                  <em className="inline italic">
                    DRock looks a little different today…
                  </em>
                </p>
                {" "}
                <p className="block pb-[25.5px]" data-ditto-id="style-p-21">
                  Ever gotten a snap with a giant emoji in it? It’s too easy (and looks awesome). After you’ve taken your snap, type in an emoji like you normally would, but then tap that big T button in the top corner. And there it is. Even better, now you can drag it anywhere on the screen.
                </p>
                {" "}
                ...
                {" "}
                <p className="block pb-[25.5px]">
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-p-10" data-component="link" href="https://www.garyvaynerchuk.com/images/linked-articles/5-snapchat-hacks-that-are-too-easy-for-you-to-ignore/remote-146fa9f0347e.png">
                    <img className="w-200 h-200 block max-w-full overflow-clip aspect-[auto_744/744] align-middle text-clr-1 max-md:w-82.5 max-md:h-82.5" data-ditto-id="style-span-14" data-component="image" alt="Using Snapchat's location features " height="744" sizes="(max-width: 700px) calc(100vw - 45px), 800px" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="744" />
                  </a>
                </p>
                {" "}
                <p className="block pb-[25.5px]" data-ditto-id="style-blockquote-2" />
                {" "}
                <p className="block pb-[25.5px] text-center" data-ditto-id="style-p-27">
                  <em className="inline italic" data-ditto-id="style-p-16">
                    The view from the Vayner New York office 🙂
                  </em>
                </p>
                {" "}
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-p-28">
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-heading-9" data-component="link" href="https://gv2016wp.s3.amazonaws.com/wp-content/uploads/20150126180301/150126-5_Snapchat_Hacks_GIF_744x744.gif">
                    <img className="w-200 h-200 block max-w-full overflow-clip aspect-[auto_744/744] align-middle max-md:w-82.5 max-md:h-82.5" data-ditto-id="style-p-24" data-component="image" alt="Drawing Snapchats with a tablet" height="744" src="/assets/cloned/images/7e3e54a2358d.gif" width="744" />
                  </a>
                </p>
                {" "}
                <p className="block pb-[25.5px] text-center" data-ditto-id="style-p-23">
                  ...
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-i-3" data-component="link" href="https://dbatsnap.com/" rel="noopener noreferrer" target="_blank">
                    <em className="inline italic" data-ditto-id="style-span-17">
                      Dasha Battelle
                    </em>
                  </a>
                </p>
                ...
                {" "}
                <h2 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.8125rem] font-normal leading-12.5 uppercase max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-ditto-id="style-image-3" data-component="heading">
                  BONUS TIP:
                </h2>
                {" "}
                <h3 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.1875rem] font-normal leading-10.5 uppercase max-md:text-3xl max-md:leading-[2.1875rem]" data-ditto-id="style-p-2" data-component="heading">
                  6. Follow me on Snapchat! Username: Garyvee
                </h3>
                {" "}
                <p className="block pb-[25.5px]" data-ditto-id="style-link-15">
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-br-2" data-component="link" href="https://www.garyvaynerchuk.com/images/linked-articles/5-snapchat-hacks-that-are-too-easy-for-you-to-ignore/remote-720caee0c582.png">
                    <img className="w-200 h-355.5 block max-w-full overflow-clip aspect-[auto_1242/2208] align-middle text-clr-1 max-md:w-82.5 max-md:h-[36.6875rem]" data-ditto-id="style-br" data-component="image" alt="@Garyvee_Snapchat" height="2208" sizes="(max-width: 700px) calc(100vw - 45px), 800px" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="1242" />
                  </a>
                </p>
                {" "}
          ...
          <section className="h-[30.4375rem] min-h-[30.4375rem] block relative pt-[1.0875rem] pb-[1.0625rem] px-[3.5625rem] overflow-hidden bg-color-007 bg-cover [background-position:50%_100%] bg-no-repeat max-md:h-[622.7px] max-md:min-h-[622.7px] max-md:mx-[5.5px] max-md:pt-[0.4125rem] max-md:px-[1.0625rem] max-md:pb-0 md:max-lg:h-152 md:max-lg:min-h-152 md:max-lg:pt-[6.7125rem]" style={{ backgroundImage: "url(\"/assets/cloned/images/70cdd4bc96ea.jpg\")" }} data-ditto-id="style-span-16" aria-labelledby="newsletter-title" id="newsletter">
            <div className="flex relative z-1 max-w-250 flex-col items-center text-center mx-auto" data-ditto-id="style-i-2">
              <img className="w-69.5 h-18 block mb-[8.5px] overflow-clip aspect-[auto_902/234] align-middle text-clr-1 max-md:w-82.5 max-md:h-21.5 max-md:max-w-full" data-ditto-id="style-blockquote" data-component="image" alt="GaryVee Weekly" height="234" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="902" />
              <h2 className="block mb-[2.1875rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.375rem] leading-[2.6875rem] uppercase max-md:mb-[35.5px] max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-ditto-id="style-p-8" data-component="heading" id="newsletter-title">
                Sign up for my weekly newsletter
              </h2>
              <form className="w-full max-w-106.5 block gap-2.5 text-left max-md:flex-col max-md:items-stretch" data-ditto-id="style-p-13">
                <label className="w-px h-px block absolute -m-px overflow-hidden [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase whitespace-nowrap text-nowrap [clip-path:inset(50%)] cursor-default max-md:text-[1.1875rem]" data-ditto-id="style-span-5" aria-hidden="true" htmlFor="newsletter-website">
                  Website
                  <input className="w-4.5 h-11 min-h-11 border border-solid border-border inline-block p-2 overflow-clip text-[0.9375rem] text-start normal-case bg-border cursor-text max-md:h-12.5 max-md:min-h-12.5 max-md:block" data-ditto-id="style-p-5" data-component="input" id="newsletter-website" name="website" type="text" />
                </label>
                <label className="block [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase cursor-default max-md:mb-1.5 max-md:text-[1.1875rem]" data-ditto-id="style-image-4" htmlFor="newsletter-email">
                  Email
                </label>
                <div className="grid items-center gap-[0.5375rem] grid-cols-[317.328px_100.109px] max-md:block max-md:grid-cols-[317.34px_100.11px]" data-ditto-id="style-heading">
                  <input className="w-[19.8125rem] h-11 min-h-11 border border-solid border-border block p-2 overflow-clip text-[0.9375rem] leading-[1.4375rem] text-start bg-border cursor-text max-md:w-82.5 max-md:h-12.5 max-md:min-h-12.5" data-ditto-id="style-span-20" data-component="input" id="newsletter-email" name="email" type="email" />
                  <button className="w-full h-[3.5625rem] flex rounded-[999px] justify-center items-center [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[1.0625rem] leading-[1.0625rem] text-center uppercase bg-primary transform-[matrix(1,0,0,1,0,-6.5)] cursor-default max-md:block max-md:mt-4 max-lg:transform-[none] max-md:h-auto" data-ditto-id="style-p-15" data-component="button" type="submit">
                    Subscribe
                  </button>
                </div>
              </form>
              <div className="w-[51%] grid mt-[108.5px] gap-2.5 transform-[matrix(1,0,0,1,23.6094,0)] grid-cols-[repeat(auto-fit,_minmax(41px,_1fr))] max-md:w-full max-md:mt-22 max-md:pl-[0.6875rem] max-md:justify-start max-md:gap-[8.3px] max-lg:transform-[none] md:max-lg:w-[69.5%] md:max-lg:mt-[7.1875rem] 2xl:w-[45.5%]" data-ditto-id="style-em" aria-label="Social media">
              ...
              <footer className="flex mt-[1.775rem] flex-col justify-center items-center text-[0.875rem] max-md:mt-[0.925rem]" data-ditto-id="style-image">
                <span className="block" data-ditto-id="style-newsletter-title">
                  ©Gary Vee IP, LLC 2024
                </span>
                <span className="block text-color-006" data-ditto-id="style-form">
                  <a className="inline cursor-pointer" data-ditto-id="style-label" data-component="link" href="https://www.garyvaynerchuk.com/privacy-policy/">
                    Privacy Policy
                  </a>
                  {" | "}
                  <a className="inline cursor-pointer" data-ditto-id="style-newsletter-website" data-component="link" href="https://www.garyvaynerchuk.com/terms-of-use/">
                    Terms of Use
                  </a>
                  {" | "}
                  <button className="inline-block underline cursor-pointer" data-ditto-id="style-label-2" data-component="button" type="button">
                    Cookie Settings
                  </button>
                </span>
              </footer>
