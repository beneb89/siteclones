      ...
      <div className="min-h-screen block">
        ...
        <div className="h-full min-h-screen block ml-[17.1875rem] overflow-hidden max-lg:pt-18.5 max-lg:ml-0">
              ...
              <ol className="flex flex-wrap gap-[0.4375rem] [list-style-type:none] list-outside">
                ...
                <li className="flex min-w-0 items-center before:content-['/'] before:block before:w-[0.3125rem] before:h-5 before:mr-[0.4375rem] before:text-clr-4 before:text-[0.8125rem] before:leading-5" data-ditto-id="style-span-10">
                  <span className="block overflow-hidden whitespace-nowrap text-nowrap" aria-current="page">
                    3 Easy Steps for Real Estate Agents on Social Media
                  </span>
                </li>
              </ol>
            </nav>
            <div className="h-[82.0625rem] min-h-screen block overflow-hidden bg-background max-md:h-[1329.5px]" data-ditto-id="style-main-content-2">
              ...
              <article className="box-content w-200 block mx-auto pt-20 pb-27.5 text-[1.0625rem] font-medium leading-[1.6875rem] max-md:w-82.5 max-md:pt-10 max-md:pb-20 md:max-lg:-mr-8 md:max-lg:ml-0" data-ditto-id="style-header">
                <p className="block pb-[25.5px]" data-ditto-id="style-image-6">
                  {"A few times on the "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-div-2" data-component="link" href="https://www.youtube.com/playlist?list=PLfA33-E9P7FC0AoARnMLvgFgESJe4_Ngs" rel="noopener noreferrer" target="_blank">
                    #AskGaryVee Show
                  </a>
                  , I’ve received questions from real estate agents, or given answers that I think could apply to that industry. Here are three quick steps to get you started.
                </p>
                {" "}
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-heading-2">
                  {"Get on Twitter and engage with people authentically. Don’t try to make the sell right away. Have a conversation. Check out the full answer "}
                  <a className="inline text-primary font-bold cursor-pointer" data-component="link" href="https://www.linkedin.com/pulse/20130829164107-10486099-13-tweets-a-real-estate-agent-should-have-answered-not-me?trk=mp-reader-card">
                    here in an article
                  </a>
                  {" I wrote on this exact topic."}
                </p>
                {" "}
                <h2 className="block mt-2.5 mb-[0.4375rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.8125rem] font-normal leading-12.5 uppercase max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-component="heading">
                  2. Get out of the industry norms
                </h2>
                {" "}
                <p className="block pb-[25.5px]" data-ditto-id="style-span-22">
                  {"FIRST) Your industry is not boring. SECOND) Don’t spend time in your world. Go beyond it. Listen to me talk about it more "}
                  <a className="inline text-primary font-bold cursor-pointer" data-component="link" href="https://www.youtube.com/watch?v=g8lGg2TA-T0#t=5m22s">
                    here
                  </a>
                  .
                </p>
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-heading-3">
                  {"Review local schools, interview residents, talk about the best cafes in the neighborhood; create a story around the places you are trying to sell, and get people feeling sentimental towards them. I talked about it "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-span-21" data-component="link" href="https://www.youtube.com/watch?v=h6M3PsghaI4#t=5m43s">
                    here
                  </a>
                  .
                </p>
          ...
          <section className="h-[30.4375rem] min-h-[30.4375rem] block relative pt-[1.0875rem] pb-[1.0625rem] px-[3.5625rem] overflow-hidden bg-color-007 bg-cover [background-position:50%_100%] bg-no-repeat max-md:h-[622.7px] max-md:min-h-[622.7px] max-md:mx-[5.5px] max-md:pt-[0.4125rem] max-md:px-[1.0625rem] max-md:pb-0 md:max-lg:h-152 md:max-lg:min-h-152 md:max-lg:pt-[6.7125rem]" style={{ backgroundImage: "url(\"/assets/cloned/images/70cdd4bc96ea.jpg\")" }} data-ditto-id="style-p-7" aria-labelledby="newsletter-title" id="newsletter">
            <div className="flex relative z-1 max-w-250 flex-col items-center text-center mx-auto" data-ditto-id="style-span-11">
              <img className="w-69.5 h-18 block mb-[8.5px] overflow-clip aspect-[auto_902/234] align-middle text-clr-1 max-md:w-82.5 max-md:h-21.5 max-md:max-w-full" data-ditto-id="style-p" data-component="image" alt="GaryVee Weekly" height="234" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="902" />
              ...
              <form className="w-full max-w-106.5 block gap-2.5 text-left max-md:flex-col max-md:items-stretch" data-ditto-id="style-p-21">
                <label className="w-px h-px block absolute -m-px overflow-hidden [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase whitespace-nowrap text-nowrap [clip-path:inset(50%)] cursor-default max-md:text-[1.1875rem]" aria-hidden="true" htmlFor="newsletter-website">
                  Website
                  <input className="w-4.5 h-11 min-h-11 border border-solid border-border inline-block p-2 overflow-clip text-[0.9375rem] text-start normal-case bg-border cursor-text max-md:h-12.5 max-md:min-h-12.5 max-md:block" data-ditto-id="style-p-9" data-component="input" id="newsletter-website" name="website" type="text" />
                </label>
                <label className="block [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase cursor-default max-md:mb-1.5 max-md:text-[1.1875rem]" data-ditto-id="style-p-14" htmlFor="newsletter-email">
                  Email
                </label>
                <div className="grid items-center gap-[0.5375rem] grid-cols-[317.328px_100.109px] max-md:block max-md:grid-cols-[317.34px_100.11px]">
                  <input className="w-[19.8125rem] h-11 min-h-11 border border-solid border-border block p-2 overflow-clip text-[0.9375rem] leading-[1.4375rem] text-start bg-border cursor-text max-md:w-82.5 max-md:h-12.5 max-md:min-h-12.5" data-ditto-id="style-p-10" data-component="input" id="newsletter-email" name="email" type="email" />
                  <button className="w-full h-[3.5625rem] flex rounded-[999px] justify-center items-center [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[1.0625rem] leading-[1.0625rem] text-center uppercase bg-primary transform-[matrix(1,0,0,1,0,-6.5)] cursor-default max-md:block max-md:mt-4 max-lg:transform-[none] max-md:h-auto" data-ditto-id="style-span-14" data-component="button" type="submit">
                    Subscribe
                  </button>
                </div>
              </form>
              <div className="w-[51%] grid mt-[108.5px] gap-2.5 transform-[matrix(1,0,0,1,23.6094,0)] grid-cols-[repeat(auto-fit,_minmax(41px,_1fr))] max-md:w-full max-md:mt-22 max-md:pl-[0.6875rem] max-md:justify-start max-md:gap-[8.3px] max-lg:transform-[none] md:max-lg:w-[69.5%] md:max-lg:mt-[7.1875rem] 2xl:w-[45.5%]" data-ditto-id="style-blockquote-2" aria-label="Social media">
                {Logo2_data.map((d, i) => <Logo2 key={i} d={d} />)}
              </div>
              <footer className="flex mt-[1.775rem] flex-col justify-center items-center text-[0.875rem] max-md:mt-[0.925rem]" data-ditto-id="style-br">
                <span className="block" data-ditto-id="style-p-25">
                  ©Gary Vee IP, LLC 2024
                </span>
                <span className="block text-color-006" data-ditto-id="style-span-16">
                  <a className="inline cursor-pointer" data-ditto-id="style-i-2" data-component="link" href="https://www.garyvaynerchuk.com/privacy-policy/">
                    Privacy Policy
                  </a>
                  {" | "}
                  <a className="inline cursor-pointer" data-ditto-id="style-blockquote" data-component="link" href="https://www.garyvaynerchuk.com/terms-of-use/">
                    Terms of Use
                  </a>
                  {" | "}
                  <button className="inline-block underline cursor-pointer" data-ditto-id="style-p-8" data-component="button" type="button">
                    Cookie Settings
                  </button>
                </span>
              </footer>
