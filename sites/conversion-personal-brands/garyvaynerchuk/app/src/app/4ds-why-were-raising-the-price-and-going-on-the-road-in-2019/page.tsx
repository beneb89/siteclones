...
const Tile3_data = [
    { description: "With the backbone of the programing in digital marketing, and supporting sessions in company culture, emerging technology, and a Q&A session with me, we’ve been able to build the framework for something much bigger that I’m excited to announce in 2019 😉 What we’re getting ready to launch is really going to make a difference for small to mid-market businesses and I’m mentioning it because it has been substantially predicated from our insights and findings during 4Ds sessions." },
    { description: "Since we launched 4Ds, over 350 4Ds alumni have been through the program, a conservative number but a sample size large enough to give us real data on the current obstacles and challenges businesses are facing. Ecommerce businesses, consumer packaged goods, B2B, real estate, retail, service industry, fashion, insurance, auto, pharma, from $1M to $100M annually, we’re seeing and tasting all of it. " },
    { description: "On average, We’re running 2 sessions a month, mostly in New York City, and up until now we’ve been tweaking and adjusting the programming, case studies, and subject matter to get to a point where we’ll be able to fully prove out that original thesis. What we’ve found is that in order for us to best serve the 4Ds community and bring value in every session, we need to keep it “intimate”. We need to go deep not wide." }
];
const Tile3_data2 = [
    { description: "I want to leave you with this, there’s an inscription on the inside of the notebook that the OG 4Ds alumni got, this is what it says…" },
    { description: "Thank you so, so much for participating in VaynerMedia’s Daily Digital Deep Dive." },
    { description: "Not only am I excited about this new program at VaynerMedia but I am incredibly humbled that you’ve taken the time out of your busy lives to spend it here with us at VM." },
    { description: "As I’ve communicated before, I hope the value you get from this day far exceeds the financial commitment it took to get here. I hope more than anything, that you leave equipped with the tools to take your ambitions to the next level and that you met some amazing people along the way." },
    { description: "And, as some of you may have heard in my content before, you can sit through all the conferences, take all the classes, read all the books, but nothing will ever come about unless you DO." },
    { description: "Remember as far as we know, we’ve only got one shot at this. Let’s make it worthwhile." },
    { description: "Xoxox," },
    { description: "Gary" }
];
const Logo2_data = [
      ...
      <div className="min-h-screen block">
        ...
        <div className="h-full min-h-screen block ml-[17.1875rem] overflow-hidden max-lg:pt-18.5 max-lg:ml-0">
          ...
          <main className="block" data-ditto-id="style-main-content" id="main-content">
            ...
            <div className="h-[154.4375rem] min-h-screen block overflow-hidden bg-background max-md:h-[3864.5px]" data-ditto-id="style-link-3">
              ...
              <article className="box-content w-200 block mx-auto pt-20 pb-27.5 text-[1.0625rem] font-medium leading-[1.6875rem] max-md:w-82.5 max-md:pt-10 max-md:pb-20 md:max-lg:-mr-8 md:max-lg:ml-0">
                <p className="block pb-[25.5px]" data-ditto-id="style-span-22">
                  <span className="inline font-normal">
                    {"Yesterday we finished our last 4Ds (Daily Digital Deep Dive) of 2018. A program we launched only 18 months ago on the thesis that we would be able to raise the collective IQ and EQ of operators, entrepreneurs, founders, and businesses by spending the day with them at VaynerMedia offices. "}
                  </span>
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-span-14">
                  <span className="inline font-normal" data-ditto-id="style-blockquote-2">
                    {"To see upcoming 4Ds dates, visit "}
                  </span>
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-p-27" data-component="link" href="https://vaynermedia.com/events">
                    <span className="inline font-normal" data-ditto-id="style-p-16">
                      vaynermedia.com/events
                    </span>
                  </a>
                  <span className="inline font-normal" data-ditto-id="style-p-22">
                    {" and to get a glimpse of what’s going on in these sessions, check out the latest episode of Inside 4Ds on the podcast."}
                  </span>
                </p>
          ...
          <section className="h-[30.4375rem] min-h-[30.4375rem] block relative pt-[1.0875rem] pb-[1.0625rem] px-[3.5625rem] overflow-hidden bg-color-007 bg-cover [background-position:50%_100%] bg-no-repeat max-md:h-[622.7px] max-md:min-h-[622.7px] max-md:mx-[5.5px] max-md:pt-[0.4125rem] max-md:px-[1.0625rem] max-md:pb-0 md:max-lg:h-152 md:max-lg:min-h-152 md:max-lg:pt-[6.7125rem]" style={{ backgroundImage: "url(\"/assets/cloned/images/70cdd4bc96ea.jpg\")" }} data-ditto-id="style-p-25" aria-labelledby="newsletter-title" id="newsletter">
            <div className="flex relative z-1 max-w-250 flex-col items-center text-center mx-auto" data-ditto-id="style-span-16">
              <img className="w-69.5 h-18 block mb-[8.5px] overflow-clip aspect-[auto_902/234] align-middle text-clr-1 max-md:w-82.5 max-md:h-21.5 max-md:max-w-full" data-ditto-id="style-i-2" data-component="image" alt="GaryVee Weekly" height="234" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="902" />
              <h2 className="block mb-[2.1875rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.375rem] leading-[2.6875rem] uppercase max-md:mb-[35.5px] max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-ditto-id="style-blockquote" data-component="heading" id="newsletter-title">
              ...
              <form className="w-full max-w-106.5 block gap-2.5 text-left max-md:flex-col max-md:items-stretch" data-ditto-id="style-p-8">
                <label className="w-px h-px block absolute -m-px overflow-hidden [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase whitespace-nowrap text-nowrap [clip-path:inset(50%)] cursor-default max-md:text-[1.1875rem]" data-ditto-id="style-p-13" aria-hidden="true" htmlFor="newsletter-website">
                  Website
                  <input className="w-4.5 h-11 min-h-11 border border-solid border-border inline-block p-2 overflow-clip text-[0.9375rem] text-start normal-case bg-border cursor-text max-md:h-12.5 max-md:min-h-12.5 max-md:block" data-ditto-id="style-span-5" data-component="input" id="newsletter-website" name="website" type="text" />
                </label>
                <label className="block [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase cursor-default max-md:mb-1.5 max-md:text-[1.1875rem]" data-ditto-id="style-p-5" htmlFor="newsletter-email">
                  Email
                </label>
                <div className="grid items-center gap-[0.5375rem] grid-cols-[317.328px_100.109px] max-md:block max-md:grid-cols-[317.34px_100.11px]" data-ditto-id="style-image-4">
                  ...
                  <button className="w-full h-[3.5625rem] flex rounded-[999px] justify-center items-center [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[1.0625rem] leading-[1.0625rem] text-center uppercase bg-primary transform-[matrix(1,0,0,1,0,-6.5)] cursor-default max-md:block max-md:mt-4 max-lg:transform-[none] max-md:h-auto" data-ditto-id="style-span-20" data-component="button" type="submit">
                    Subscribe
                  </button>
                </div>
              </form>
              <div className="w-[51%] grid mt-[108.5px] gap-2.5 transform-[matrix(1,0,0,1,23.6094,0)] grid-cols-[repeat(auto-fit,_minmax(41px,_1fr))] max-md:w-full max-md:mt-22 max-md:pl-[0.6875rem] max-md:justify-start max-md:gap-[8.3px] max-lg:transform-[none] md:max-lg:w-[69.5%] md:max-lg:mt-[7.1875rem] 2xl:w-[45.5%]" data-ditto-id="style-p-15" aria-label="Social media">
                {Logo2_data.map((d, i) => <Logo2 key={i} d={d} />)}
              </div>
              <footer className="flex mt-[1.775rem] flex-col justify-center items-center text-[0.875rem] max-md:mt-[0.925rem]" data-ditto-id="style-div">
                <span className="block" data-ditto-id="style-image">
                  ©Gary Vee IP, LLC 2024
                </span>
                <span className="block text-color-006" data-ditto-id="style-newsletter-title">
                  <a className="inline cursor-pointer" data-ditto-id="style-form" data-component="link" href="https://www.garyvaynerchuk.com/privacy-policy/">
                    Privacy Policy
                  </a>
                  {" | "}
                  <a className="inline cursor-pointer" data-ditto-id="style-label" data-component="link" href="https://www.garyvaynerchuk.com/terms-of-use/">
                    Terms of Use
                  </a>
                  {" | "}
                  <button className="inline-block underline cursor-pointer" data-ditto-id="style-newsletter-website" data-component="button" type="button">
                    Cookie Settings
                  </button>
                </span>
              </footer>
