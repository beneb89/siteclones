...
const Tile2_meta: string[][] = [
    ...
    ["style-breadcrumb", "n138", "style-li-2"]
];
    ...
    <>
      <div className="min-h-screen block">
        ...
        <div className="h-full min-h-screen block ml-[17.1875rem] overflow-hidden max-lg:pt-18.5 max-lg:ml-0">
          <a className="h-8.5 flex relative z-30 items-center overflow-hidden text-color-002 [font-family:'Open_Sans',_'Open_Sans_Fallback',_Arial,_sans-serif] font-semibold leading-6.5 text-center whitespace-nowrap text-nowrap bg-accent cursor-pointer max-md:h-[2.0625rem] max-md:text-xs max-md:leading-[2.0625rem]" data-component="link" aria-label="Check out VeeFriends Cartoons!" href="https://garyvee.com/cartoons" rel="noreferrer" target="_blank">
            <span className="h-6.5 flex shrink-0 [animation-name:announcement-scroll-right] [animation-duration:24s] [animation-timing-function:linear] [animation-iteration-count:infinite] max-md:h-[2.0625rem] max-md:[animation-duration:18s]" data-ditto-id="style-span-2" aria-hidden="true">
              ...
              <span className="w-466.5 flex min-w-320 shrink-0 max-md:w-339 max-md:min-w-[23.4375rem] md:max-lg:min-w-192 2xl:w-480 2xl:min-w-480">
                ...
                <span className="w-[19.4375rem] flex pl-7 items-center shrink-0 gap-7 max-md:w-56.5 max-md:pl-5 max-md:gap-5" data-ditto-id="style-link-2">
          ...
          <main className="block" data-ditto-id="style-link-3" id="main-content">
            <nav className="block pt-3.5 pb-3 px-15 text-muted text-[0.8125rem] leading-5 bg-background max-md:pt-[0.6875rem] max-md:pb-[0.5625rem] max-md:px-[22.5px]" data-ditto-id="style-li" data-component="nav" aria-label="Breadcrumb">
              <ol className="flex flex-wrap gap-[0.4375rem] [list-style-type:none] list-outside">
                <li className="flex min-w-0 items-center" data-ditto-id="style-div">
                  <a className="block text-foreground cursor-pointer" data-ditto-id="style-header" data-component="link" href="/">
                    Home
                  </a>
                </li>
                <li className="flex min-w-0 items-center before:content-['/'] before:block before:w-[0.3125rem] before:h-5 before:mr-[0.4375rem] before:text-clr-5 before:text-[0.8125rem] before:leading-5">
                  <a className="block text-foreground cursor-pointer" data-ditto-id="style-div-7" data-component="link" href="https://www.garyvaynerchuk.com/blog/">
                    Blog
                  </a>
                </li>
                <li className="flex min-w-0 items-center before:content-['/'] before:block before:w-[0.3125rem] before:h-5 before:mr-[0.4375rem] before:text-clr-5 before:text-[0.8125rem] before:leading-5" data-ditto-id="style-button">
                  <span className="block overflow-hidden whitespace-nowrap text-nowrap" aria-current="page">
                    2015 Has Been Huge So Far
                  </span>
                </li>
              </ol>
            </nav>
            <div className="h-[5196.5px] min-h-screen block overflow-hidden bg-background max-md:h-[144.55rem]">
              <header className="h-137.5 block relative overflow-hidden bg-color-008 max-md:h-[339.5px] after:content-[''] after:block after:absolute after:inset-0 after:bg-clr-4 after:opacity-40" data-ditto-id="style-span-3">
              ...
              <article className="box-content w-200 block mx-auto pt-20 pb-27.5 text-[1.0625rem] font-medium leading-[1.6875rem] max-md:w-82.5 max-md:pt-10 max-md:pb-20 md:max-lg:-mr-8 md:max-lg:ml-0">
                <p className="block pb-[25.5px]">
                  <a className="inline text-primary font-bold cursor-pointer" data-component="link" href="https://www.garyvaynerchuk.com/images/linked-articles/2015-has-been-huge-so-far/remote-eee8ac134d42.jpg">
                    <img className="w-200 h-[276.9375rem] block max-w-full overflow-clip aspect-[auto_800/4431] align-middle text-clr-1 max-md:w-82.5 max-md:h-457" data-component="image" alt="garyvee2015-infographic" height="4431" sizes="(max-width: 700px) calc(100vw - 45px), 800px" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="800" />
                  </a>
                </p>
                {" "}
              </article>
            ...
            <div className="flex relative z-1 max-w-250 flex-col items-center text-center mx-auto">
              ...
              <form className="w-full max-w-106.5 block gap-2.5 text-left max-md:flex-col max-md:items-stretch">
                ...
                <div className="grid items-center gap-[0.5375rem] grid-cols-[317.328px_100.109px] max-md:block max-md:grid-cols-[317.34px_100.11px]" data-ditto-id="style-span-13">
                  <input className="w-[19.8125rem] h-11 min-h-11 border border-solid border-border block p-2 overflow-clip text-[0.9375rem] leading-[1.4375rem] text-start bg-border cursor-text max-md:w-82.5 max-md:h-12.5 max-md:min-h-12.5" data-ditto-id="style-p-6" data-component="input" id="newsletter-email" name="email" type="email" />
                  <button className="w-full h-[3.5625rem] flex rounded-[999px] justify-center items-center [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[1.0625rem] leading-[1.0625rem] text-center uppercase bg-primary transform-[matrix(1,0,0,1,0,-6.5)] cursor-default max-md:block max-md:mt-4 max-lg:transform-[none] max-md:h-auto" data-ditto-id="style-p-3" data-component="button" type="submit">
                    Subscribe
                  </button>
                </div>
              </form>
              ...
              <footer className="flex mt-[1.775rem] flex-col justify-center items-center text-[0.875rem] max-md:mt-[0.925rem]" data-ditto-id="style-span-9">
