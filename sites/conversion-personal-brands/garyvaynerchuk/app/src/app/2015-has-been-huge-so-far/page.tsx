      ...
      <div className="min-h-screen block">
        ...
        <div className="h-full min-h-screen block ml-[17.1875rem] overflow-hidden max-lg:pt-18.5 max-lg:ml-0">
          ...
          <main className="block" id="main-content">
            ...
            <div className="h-[5196.5px] min-h-screen block overflow-hidden bg-background max-md:h-[144.55rem]" data-ditto-id="style-main-content-2">
              ...
              <article className="box-content w-200 block mx-auto pt-20 pb-27.5 text-[1.0625rem] font-medium leading-[1.6875rem] max-md:w-82.5 max-md:pt-10 max-md:pb-20 md:max-lg:-mr-8 md:max-lg:ml-0" data-ditto-id="style-header">
                <p className="block pb-[25.5px]" data-ditto-id="style-image-6">
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-div-2" data-component="link" href="https://www.garyvaynerchuk.com/images/linked-articles/2015-has-been-huge-so-far/remote-eee8ac134d42.jpg">
                    <img className="w-200 h-[276.9375rem] block max-w-full overflow-clip aspect-[auto_800/4431] align-middle text-clr-1 max-md:w-82.5 max-md:h-457" data-ditto-id="style-button-2" data-component="image" alt="garyvee2015-infographic" height="4431" sizes="(max-width: 700px) calc(100vw - 45px), 800px" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="800" />
                  </a>
                </p>
                {" "}
              </article>
