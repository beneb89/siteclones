...
const Tile2_data = [
    { href: "https://twitter.com/billconnell23", description: "@billconnell23" },
    { href: "https://twitter.com/billconnell23", description: "[rebelmouse-image 449093 expand=1]" },
    { href: "https://twitter.com/dadovanpeteghem", description: "@dadovanpeteghem" },
    { href: "https://twitter.com/dadovanpeteghem", description: "[rebelmouse-image 449073 expand=1]" },
    { href: "https://twitter.com/DashDennis", description: "@DashDennis" },
    { href: "https://twitter.com/DashDennis", description: "[rebelmouse-image 449074 expand=1]" },
    { href: "https://twitter.com/DominicSicotte", description: "@DominicSicotte" },
    { href: "https://twitter.com/DominicSicotte", description: "[rebelmouse-image 449075 expand=1]" },
    { href: "https://twitter.com/kylereed", description: "@kylereed" },
    { href: "https://twitter.com/kylereed", description: "[rebelmouse-image 449077 expand=1]" },
    { href: "https://twitter.com/MatthewLiberty", description: "@MatthewLiberty" },
    { href: "https://twitter.com/MatthewLiberty", description: "[rebelmouse-image 449079 expand=1]" },
    { href: "https://twitter.com/MemphisBraces", description: "@MemphisBraces" },
    { href: "https://twitter.com/MemphisBraces", description: "[rebelmouse-image 449080 expand=1]" },
    { href: "https://twitter.com/patlee", description: "@patlee" },
    { href: "https://twitter.com/patlee", description: "[rebelmouse-image 449081 expand=1]" },
    { href: "https://twitter.com/PhilKiel", description: "@PhilKiel" },
    { href: "https://twitter.com/PhilKiel", description: "[rebelmouse-image 449083 expand=1]" },
    { href: "https://twitter.com/pituvision", description: "@Pituvision" },
    { href: "https://twitter.com/pituvision", description: "[rebelmouse-image 449084 expand=1]" },
    { href: "https://twitter.com/smlmldn", description: "@smlmldn" },
    { href: "https://twitter.com/smlmldn", description: "[rebelmouse-image 449086 expand=1]" },
    { href: "https://twitter.com/tadtippling", description: "@tadtippling" },
    { href: "https://twitter.com/tadtippling", description: "[rebelmouse-image 449087 expand=1]" },
    { href: "https://twitter.com/TaureanDoll", description: "@TaureanDoll" },
    { href: "https://twitter.com/TaureanDoll", description: "[rebelmouse-image 449088 expand=1]" },
    { href: "https://twitter.com/turkphish", description: "@turkphish" },
    { href: "https://twitter.com/turkphish", description: "[rebelmouse-image 449089 expand=1]" }
];
const Logo2_data = [
      ...
      <div className="min-h-screen block">
        ...
        <div className="h-full min-h-screen block ml-[17.1875rem] overflow-hidden max-lg:pt-18.5 max-lg:ml-0">
          ...
          <main className="block" id="main-content">
            ...
            <div className="h-[2316.5px] min-h-screen block overflow-hidden bg-background max-md:h-[155.9375rem]" data-ditto-id="style-main-content-2">
          ...
          <section className="h-[30.4375rem] min-h-[30.4375rem] block relative pt-[1.0875rem] pb-[1.0625rem] px-[3.5625rem] overflow-hidden bg-color-007 bg-cover [background-position:50%_100%] bg-no-repeat max-md:h-[622.7px] max-md:min-h-[622.7px] max-md:mx-[5.5px] max-md:pt-[0.4125rem] max-md:px-[1.0625rem] max-md:pb-0 md:max-lg:h-152 md:max-lg:min-h-152 md:max-lg:pt-[6.7125rem]" style={{ backgroundImage: "url(\"/assets/cloned/images/70cdd4bc96ea.jpg\")" }} data-ditto-id="style-span-7" aria-labelledby="newsletter-title" id="newsletter">
            <div className="flex relative z-1 max-w-250 flex-col items-center text-center mx-auto" data-ditto-id="style-span-6">
              ...
              <form className="w-full max-w-106.5 block gap-2.5 text-left max-md:flex-col max-md:items-stretch" data-ditto-id="style-p-11">
                <label className="w-px h-px block absolute -m-px overflow-hidden [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase whitespace-nowrap text-nowrap [clip-path:inset(50%)] cursor-default max-md:text-[1.1875rem]" data-ditto-id="style-p-4" aria-hidden="true" htmlFor="newsletter-website">
                  Website
                  <input className="w-4.5 h-11 min-h-11 border border-solid border-border inline-block p-2 overflow-clip text-[0.9375rem] text-start normal-case bg-border cursor-text max-md:h-12.5 max-md:min-h-12.5 max-md:block" data-ditto-id="style-link-4" data-component="input" id="newsletter-website" name="website" type="text" />
                </label>
                <label className="block [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase cursor-default max-md:mb-1.5 max-md:text-[1.1875rem]" data-ditto-id="style-link-8" htmlFor="newsletter-email">
                  Email
                </label>
                <div className="grid items-center gap-[0.5375rem] grid-cols-[317.328px_100.109px] max-md:block max-md:grid-cols-[317.34px_100.11px]" data-ditto-id="style-link-14">
              ...
              <div className="w-[51%] grid mt-[108.5px] gap-2.5 transform-[matrix(1,0,0,1,23.6094,0)] grid-cols-[repeat(auto-fit,_minmax(41px,_1fr))] max-md:w-full max-md:mt-22 max-md:pl-[0.6875rem] max-md:justify-start max-md:gap-[8.3px] max-lg:transform-[none] md:max-lg:w-[69.5%] md:max-lg:mt-[7.1875rem] 2xl:w-[45.5%]" data-ditto-id="style-p-29" aria-label="Social media">
                {Logo2_data.map((d, i) => <Logo2 key={i} d={d} />)}
              </div>
              <footer className="flex mt-[1.775rem] flex-col justify-center items-center text-[0.875rem] max-md:mt-[0.925rem]" data-ditto-id="style-div-10">
                <span className="block" data-ditto-id="style-div-16">
                  ©Gary Vee IP, LLC 2024
                </span>
                <span className="block text-color-006" data-ditto-id="style-div-8">
                  <a className="inline cursor-pointer" data-ditto-id="style-div-31" data-component="link" href="https://www.garyvaynerchuk.com/privacy-policy/">
                    Privacy Policy
                  </a>
                  {" | "}
                  <a className="inline cursor-pointer" data-ditto-id="style-div-20" data-component="link" href="https://www.garyvaynerchuk.com/terms-of-use/">
                    Terms of Use
                  </a>
                  {" | "}
                  <button className="inline-block underline cursor-pointer" data-ditto-id="style-div-7" data-component="button" type="button">
                    Cookie Settings
                  </button>
                </span>
              </footer>
