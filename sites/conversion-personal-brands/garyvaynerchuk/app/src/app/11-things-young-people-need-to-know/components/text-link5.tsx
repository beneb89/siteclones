...
export default function TextLink5({ d, styles }: { d: TextLink5Data; styles: TextLink5Styles }) {
  return (
    <a className={cn("box-content h-6 flex items-center text-color-002 text-[0.6875rem] cursor-pointer", styles.className)} data-component="link" href={"https://www.instagram.com/reel/CmCA0Tqg8sq/?utm_source=ig_embed&ig_rid=APMURqEqh1jgplsKj8Adp6f"} target="_blank">
