    ...
    <>
      <div className="min-h-screen block">
        ...
        <div className="h-full min-h-screen block ml-[17.1875rem] overflow-hidden max-lg:pt-18.5 max-lg:ml-0">
              ...
              <ol className="flex flex-wrap gap-[0.4375rem] [list-style-type:none] list-outside">
                ...
                <li className="flex min-w-0 items-center before:content-['/'] before:block before:w-[0.3125rem] before:h-5 before:mr-[0.4375rem] before:text-clr-4 before:text-[0.8125rem] before:leading-5" data-ditto-id="style-span-10">
                  <span className="block overflow-hidden whitespace-nowrap text-nowrap" aria-current="page">
                    3 Ways To Go Out Of Business…FAST
                  </span>
                </li>
              </ol>
            </nav>
            <div className="h-[1837.5px] min-h-screen block overflow-hidden bg-background max-md:h-[2462.5px]" data-ditto-id="style-main-content-2">
              ...
              <article className="box-content w-200 block mx-auto pt-20 pb-27.5 text-[1.0625rem] font-medium leading-[1.6875rem] max-md:w-82.5 max-md:pt-10 max-md:pb-20 md:max-lg:-mr-8 md:max-lg:ml-0" data-ditto-id="style-header">
                <p className="block pb-[25.5px]" data-ditto-id="style-image-6">
                  {"Let’s face it: there are hundreds of ways your company can fail even if you think you have a unique idea. But, these are the top three ways to ensure "}
                  <strong className="inline font-bold" data-ditto-id="style-div-2">
                    you won’t even get your startup or business off the ground
                  </strong>
                  . I’m serious. If any of these three business problems are an issue now for your company, fix it. And fix it soon.
                </p>
                {" "}
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-heading-2">
                  {"I get so many questions every day in my inbox asking me the same thing over and over: “Hey Gary. How do I hire a ______.” My response is this: "}
                  <em className="inline italic">
                    seriously?
                  </em>
                  {" If you’re not capable of finding a business partner or developer or assistant, how the hell are you going to make it? Ideas are shit. Execution is the name of the game. Just. Make. It. Happen."}
                </p>
                {" "}
                ...
                <p className="block pb-[25.5px]" data-ditto-id="style-p-7">
                  {"One of them ring a bell? I know I was a bit doomsday guy at the beginning but, you guys: I really want you to understand the importance of execution over just business thinking. There is no original idea and if you can’t grasp the importance of selling you’ll be going out of business soon.all of these. Remember that "}
                  <a className="inline text-primary font-bold cursor-pointer" data-ditto-id="style-span-11" data-component="link" href="https://medium.com/@garyvee/we-need-to-talk-about-the-importance-of-self-awareness-6202135bd244">
                    <u className="inline underline" data-ditto-id="style-p">
                      self-awareness is the most important quality you can have
                    </u>
                  </a>
                  {", so the fact that you even recognize they are issues to begin with is tremendous. Self audit and keep hustling. "}
          ...
          <section className="h-[30.4375rem] min-h-[30.4375rem] block relative pt-[1.0875rem] pb-[1.0625rem] px-[3.5625rem] overflow-hidden bg-color-007 bg-cover [background-position:50%_100%] bg-no-repeat max-md:h-[622.7px] max-md:min-h-[622.7px] max-md:mx-[5.5px] max-md:pt-[0.4125rem] max-md:px-[1.0625rem] max-md:pb-0 md:max-lg:h-152 md:max-lg:min-h-152 md:max-lg:pt-[6.7125rem]" style={{ backgroundImage: "url(\"/assets/cloned/images/70cdd4bc96ea.jpg\")" }} data-ditto-id="style-p-21" aria-labelledby="newsletter-title" id="newsletter">
            <div className="flex relative z-1 max-w-250 flex-col items-center text-center mx-auto">
              <img className="w-69.5 h-18 block mb-[8.5px] overflow-clip aspect-[auto_902/234] align-middle text-clr-1 max-md:w-82.5 max-md:h-21.5 max-md:max-w-full" data-ditto-id="style-p-9" data-component="image" alt="GaryVee Weekly" height="234" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" width="902" />
              <h2 className="block mb-[2.1875rem] [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[2.375rem] leading-[2.6875rem] uppercase max-md:mb-[35.5px] max-md:text-[2.125rem] max-md:leading-[2.375rem]" data-ditto-id="style-p-14" data-component="heading" id="newsletter-title">
                Sign up for my weekly newsletter
              </h2>
              <form className="w-full max-w-106.5 block gap-2.5 text-left max-md:flex-col max-md:items-stretch">
                <label className="w-px h-px block absolute -m-px overflow-hidden [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase whitespace-nowrap text-nowrap [clip-path:inset(50%)] cursor-default max-md:text-[1.1875rem]" data-ditto-id="style-p-10" aria-hidden="true" htmlFor="newsletter-website">
                  Website
                  <input className="w-4.5 h-11 min-h-11 border border-solid border-border inline-block p-2 overflow-clip text-[0.9375rem] text-start normal-case bg-border cursor-text max-md:h-12.5 max-md:min-h-12.5 max-md:block" data-ditto-id="style-span-14" data-component="input" id="newsletter-website" name="website" type="text" />
                </label>
                <label className="block [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-lg leading-7 uppercase cursor-default max-md:mb-1.5 max-md:text-[1.1875rem]" data-ditto-id="style-blockquote-2" htmlFor="newsletter-email">
                  Email
                </label>
                <div className="grid items-center gap-[0.5375rem] grid-cols-[317.328px_100.109px] max-md:block max-md:grid-cols-[317.34px_100.11px]" data-ditto-id="style-p-27">
                  <input className="w-[19.8125rem] h-11 min-h-11 border border-solid border-border block p-2 overflow-clip text-[0.9375rem] leading-[1.4375rem] text-start bg-border cursor-text max-md:w-82.5 max-md:h-12.5 max-md:min-h-12.5" data-ditto-id="style-p-16" data-component="input" id="newsletter-email" name="email" type="email" />
                  <button className="w-full h-[3.5625rem] flex rounded-[999px] justify-center items-center [font-family:'Bebas_Neue',_'Bebas_Neue_Fallback',_Impact,_sans-serif] text-[1.0625rem] leading-[1.0625rem] text-center uppercase bg-primary transform-[matrix(1,0,0,1,0,-6.5)] cursor-default max-md:block max-md:mt-4 max-lg:transform-[none] max-md:h-auto" data-ditto-id="style-p-22" data-component="button" type="submit">
                    Subscribe
                  </button>
                </div>
              </form>
              <div className="w-[51%] grid mt-[108.5px] gap-2.5 transform-[matrix(1,0,0,1,23.6094,0)] grid-cols-[repeat(auto-fit,_minmax(41px,_1fr))] max-md:w-full max-md:mt-22 max-md:pl-[0.6875rem] max-md:justify-start max-md:gap-[8.3px] max-lg:transform-[none] md:max-lg:w-[69.5%] md:max-lg:mt-[7.1875rem] 2xl:w-[45.5%]" data-ditto-id="style-heading-5" aria-label="Social media">
                {Logo2_data.map((d, i) => <Logo2 key={i} d={d} />)}
              </div>
              <footer className="flex mt-[1.775rem] flex-col justify-center items-center text-[0.875rem] max-md:mt-[0.925rem]" data-ditto-id="style-blockquote">
                <span className="block" data-ditto-id="style-p-8">
                  ©Gary Vee IP, LLC 2024
                </span>
                <span className="block text-color-006" data-ditto-id="style-p-13">
                  <a className="inline cursor-pointer" data-ditto-id="style-span-5" data-component="link" href="https://www.garyvaynerchuk.com/privacy-policy/">
                    Privacy Policy
                  </a>
                  {" | "}
                  <a className="inline cursor-pointer" data-ditto-id="style-p-5" data-component="link" href="https://www.garyvaynerchuk.com/terms-of-use/">
                    Terms of Use
                  </a>
                  {" | "}
                  <button className="inline-block underline cursor-pointer" data-ditto-id="style-image-4" data-component="button" type="button">
                    Cookie Settings
                  </button>
                </span>
              </footer>
