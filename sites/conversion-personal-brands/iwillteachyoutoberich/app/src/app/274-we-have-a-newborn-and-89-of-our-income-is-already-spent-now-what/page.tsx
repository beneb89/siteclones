...
const Tile_meta: string[][] = [
    ...
    ["style-b-4", "style-p-29"]
];
const ListRow2_meta: string[][] = [
    ["style-heading-10", "style-b-5"],
    ["style-p-42", "style-span-32"],
    ["style-p-26", "style-span-95"],
    ["style-ul-3", "style-div-105"],
    ["style-div-40", "style-div-41"],
    ["style-div-50", "style-heading-6"],
...
const Tile2_meta: string[][] = [
    ...
    ["style-div-108", "style-div-100"],
    ["style-div-56", "style-div-62"],
    ...
    ["style-span-89", "style-wpforms-96007-field-10-2"],
    ["style-wpforms-96007-field-11-container", "style-label-7"],
    ["style-span-50", "style-wpforms-96007-field-11-2"],
    ["style-div-44", "style-div-101"],
    ["style-div-45", "style-wpforms-submit-96007-2"],
    ["style-div-30", "n252"],
    ["style-span-39", "style-br"],
    ["style-p-30", "style-heading-4"],
    ["style-p-31", "style-p-5"],
    ["n259", "style-p-6"],
    ["n261", "style-p-7"],
    ["style-p-37", "style-p-8"],
    ["style-p-41", "style-p-9"],
    ["style-p-47", "style-link-15"],
    ["style-div-46", "style-div-64"],
    ["style-div-102", "style-div-104"],
    ["style-link-16", "style-div-47"],
    ["style-span-58", "style-span-56"],
    ["style-span-59", "style-icon"],
    ["style-span-37", "style-link-17"],
    ["style-div-48", "style-div-31"],
    ["style-div-49", "n284"],
    ["style-p-10", "style-p-15"],
    ["style-p-11", "style-p-16"],
    ["style-p-12", "style-p-17"],
    ["style-ul", "style-li-2"],
    ["style-li", "style-heading-5"],
    ["style-div-110", "style-link-19"],
    ["style-span-12", "n298"],
    ["style-svg", "style-hs-web-interactives-top-anchor-2"],
    ["style-hs-web-interactives-floating-container", "style-heading-15"],
    ...
    ["style-div-78", "style-p-43"],
    ["n321", "style-wpforms-form-53563"],
    ["style-p-51", "style-div-126"],
    ["style-wpforms-53563-field-20-container", "style-wpforms-53563-field-20"],
    ["style-strong-4", "interaction-wpforms-53563-field-21-container"],
    ["style-wpforms-53563-field-21", "style-wpforms-53563-field-10-container"],
    ["style-label", "n332"],
    ["style-wpforms-53563-field-10", "n334"],
    ...
    ["style-div-52", "style-div-67"],
    ["style-div-53", "style-link-24"],
    ["style-image-4", "style-div-114"],
    ["style-div-54", "n352"],
    ["style-heading-12", "style-div-68"],
    ["style-p-35", "style-br-29"],
    ["style-wpforms-96007", "style-wpforms-form-96007-2"],
    ["style-div-66", "style-wpforms-96007-field-10-container-3"],
    ["style-label-4", "style-span-65"],
    ["style-wpforms-96007-field-10-4", "style-wpforms-96007-field-11-container-3"],
    ["style-label-5", "style-span-81"],
    ["style-wpforms-96007-field-11-3", "style-div-69"],
    ["style-div-55", "n370"],
    ["style-wpforms-submit-96007", "style-div-111"],
    ["style-menu-footer", "style-div-59"],
    ["style-div-27", "style-heading-13"],
    ["style-div-28", "style-p-36"],
    ...
    ["n395", "n396"],
    ["n397", "style-span-82"],
    ["style-icon-3", "style-span-83"],
    ["style-link-22", "style-div-75"],
    ["style-div-118", "style-div-76"],
    ["style-div-85", "style-div-32"],
    ["style-div-35", "style-div-33"],
    ["style-div-36", "style-p-27"],
    ...
    ["style-hs-web-interactives-top-anchor-3", "n422"],
    ["style-div-87", "style-div-77"],
    ["style-div-88", "n426"],
    ["style-div-89", "n428"],
    ["style-div-79", "style-div-83"],
    ["style-div-80", "style-link-26"],
    ["style-div-81", "style-span-85"],
    ["style-span-84", "style-span-86"],
    ["style-icon-2", "style-span-87"],
    ["style-div-90", "n440"],
    ["style-span-94", "n442"],
    ["style-svg-4", "style-hs-web-interactives-top-anchor-4"],
    ["style-hs-web-interactives-floating-container-2", "style-div-91"],
    ["style-div-96", "style-div-92"],
    ["style-div-97", "style-div-93"],
    ["style-heading-17", "style-div-94"],
    ["style-div-98", "n454"],
    ["style-p-44", "style-div-95"],
    ["n457", "n458"],
    ["n459", "style-p-58"],
    ["style-p-59", "style-section-2"],
    ["style-div-120", "style-div-115"],
    ["style-div-121", "style-div-116"],
    ["style-div-122", "style-image-5"],
    ["style-div-123", "n470"],
    ["style-div-117", "style-div-119"],
    ["n473", "n474"],
    ["n475", "n476"],
    ["n477", "n478"],
    ["n479", "n480"],
...
const Logo2_meta: string[][] = [
    ["style-div-5", "style-p-3"],
    ["style-strong", "style-div-18"],
    ["style-div-6", "style-p-4"],
    ["style-div-7", "style-div-19"],
    ["style-heading", "style-i-3"]
];
const Logo_styles = [
...
export default function Page() {
  return (
    <>
        ...
        <div className="block relative z-1 mb-[106.5px] max-lg:mb-20 max-lg:overflow-hidden 2xl:mb-40">
          <div className="block max-w-480 px-[33.3px] mx-auto max-lg:max-w-170 max-lg:px-4 2xl:px-12.5">
            <div className="grid items-start gap-x-[13.3px] [grid-template-areas:'a2_a2_a2_a3'_'a4_a4_a4_a4'_'a5_a6_a6_.'] grid-cols-4 max-lg:grid-cols-1 max-lg:gap-x-[initial] max-lg:[grid-template-areas:initial] 2xl:gap-x-5">
              ...
              {" "}
              <div className="h-[65.5px] flex sticky top-20 z-1 mt-[33.3px] mr-[4.1625rem] flex-col items-start [grid-column-start:a5] [grid-column-end:a5] [grid-row-start:a5] [grid-row-end:a5] max-lg:h-[5.2375rem] max-lg:mt-7.5 max-lg:static max-lg:top-auto max-lg:z-[initial] max-lg:mr-0 max-lg:[grid-column-start:initial] max-lg:[grid-column-end:initial] max-lg:[grid-row-start:initial] max-lg:[grid-row-end:initial] 2xl:h-[5.65rem] 2xl:top-30 2xl:mt-12.5 2xl:mr-25" data-ditto-id="style-div-74">
                <div className="block text-base font-bold leading-[1.125rem] max-lg:text-lg max-lg:leading-[1.25rem] 2xl:text-2xl 2xl:leading-[1.625rem]">
                  Ramit Sethi
                </div>
                {" "}
                <div className="block mt-[13.3px] max-lg:mt-5 2xl:mt-5" data-ditto-id="style-div-39">
                  <div className="flex" data-ditto-id="style-div-106">
              ...
              {" "}
              <div className="block mt-[33.3px] [grid-column-start:a6] [grid-column-end:a6] [grid-row-start:a6] [grid-row-end:a6] max-lg:mt-7.5 max-lg:[grid-column-start:initial] max-lg:[grid-column-end:initial] max-lg:[grid-row-start:initial] max-lg:[grid-row-end:initial] 2xl:mt-12.5" data-ditto-id="style-div-21">
                <div className="block text-base leading-[1.375rem] max-lg:[font-size:inherit] 2xl:text-2xl 2xl:leading-[2.125rem]" data-ditto-id="style-div-20">
                  <p className="block mb-[13.3px] [font-family:'PP_Mori'] text-lg leading-[1.9375rem] max-lg:mb-[0.9375rem] 2xl:mb-5" data-ditto-id="style-p-13">
                  ...
                  {" "}
                  <h4 className="block my-[13.3px] [font-family:'PP_Mori'] font-bold italic leading-[1.125rem] [overflow-wrap:break-word] max-lg:my-5 2xl:my-5 2xl:leading-[1.625rem]" data-ditto-id="style-heading-8" data-component="heading">
                    <strong className="inline" data-ditto-id="style-strong-2">
                      In this episode we uncover:
                    </strong>
                  </h4>
                  {" "}
                  <ul className="grid mb-6 gap-1 [list-style-type:disc] list-inside grid-cols-1 2xl:mb-9 2xl:gap-1.5" data-ditto-id="style-ul-2">
                    {ListRow2_data.map((d, i) => <ListRow2 key={i} d={d} styles={ListRow2_styles[i]} />)}
                  </ul>
                  {" "}
                  <h4 className="block my-[13.3px] [font-family:'PP_Mori'] font-bold italic leading-[1.125rem] [overflow-wrap:break-word] max-lg:my-5 2xl:my-5 2xl:leading-[1.625rem]" data-ditto-id="style-heading-11" data-component="heading">
                  ...
                  <p className="block my-[13.3px] [font-family:'PP_Mori'] text-lg leading-[1.9375rem] max-lg:my-[0.9375rem] 2xl:my-5" data-ditto-id="style-p-32">
                    ...
                    <span className="inline" data-ditto-id="style-span-53">
                      <br className="inline" data-ditto-id="style-br-30" />
                      {" "}
                    </span>
                    ...
                    <span className="inline" data-ditto-id="style-span-44">
                    ...
                    <span className="inline" data-ditto-id="style-span-45">
                      <br className="inline" data-ditto-id="style-br-31" />
                      {" "}
                    </span>
                  ...
                  {" "}
                  <h4 className="block my-[13.3px] [font-family:'PP_Mori'] font-bold italic leading-[1.125rem] [overflow-wrap:break-word] max-lg:my-5 2xl:my-5 2xl:leading-[1.625rem]" data-ditto-id="style-heading-9" data-component="heading">
                  ...
                  {" "}
                  <p className="block my-[13.3px] [font-family:'PP_Mori'] text-lg leading-[1.9375rem] max-lg:my-[0.9375rem] 2xl:my-5" data-ditto-id="style-p-18">
                  ...
                  {" "}
                  <p className="block my-[13.3px] [font-family:'PP_Mori'] text-lg leading-[1.9375rem] max-lg:my-[0.9375rem] 2xl:my-5" data-ditto-id="style-p-19">
                  ...
                  {" "}
                  <p className="block my-[13.3px] [font-family:'PP_Mori'] text-lg leading-[1.9375rem] max-lg:my-[0.9375rem] 2xl:my-5" data-ditto-id="style-p-38">
                  ...
                  {" "}
                  <h2 className="block mt-10 mb-[1.6625rem] [font-family:'PP_Mori'] text-[2.1875rem] font-bold leading-[2.375rem] [overflow-wrap:break-word] max-lg:mt-7.5 max-lg:mb-2.5 max-lg:text-[1.5625rem] max-lg:leading-[1.75rem] 2xl:mt-15 2xl:mb-10 2xl:text-[3.25rem] 2xl:leading-[3.5625rem]" data-ditto-id="style-heading-7" data-component="heading" aria-level="2">
                    <b className="inline font-black" data-ditto-id="style-b-3">
            ...
            <div className="grid items-start gap-x-[13.3px] grid-cols-8 max-lg:gap-x-7.5 max-lg:grid-cols-1 max-lg:[align-items:initial] 2xl:gap-x-5">
              <div className="flex max-w-[159.7px] col-start-1 col-end-5 max-lg:max-w-35 max-lg:[grid-column-start:initial] max-lg:[grid-column-end:initial] 2xl:max-w-60">
                <a className="block cursor-pointer" data-ditto-id="style-link-4" data-component="link" href="/">
                  {" "}
                  <img className="w-40 h-[3.1875rem] block max-w-full overflow-clip align-middle pointer-events-none max-lg:w-35 max-lg:h-11 2xl:w-[11.4375rem] 2xl:h-14.5" data-ditto-id="style-image-2" data-component="image" alt="I Will Teach You To Be Rich by Ramit Sethi" src="/assets/cloned/images/b3cf84ae74ab.svg" />
                  {" "}
                </a>
                {" "}
              </div>
              ...
              <div className="block col-start-8 col-end-9 max-lg:mt-7.5 max-lg:[grid-column-start:initial] max-lg:[grid-column-end:initial]">
                <a className="w-full h-[2.8125rem] border border-solid border-primary inline-flex max-w-full px-5 rounded-[2.7px] justify-center items-center overflow-hidden [background-size:100%_100%] [background-position:0%_50%] bg-no-repeat [background-clip:padding-box] [-webkit-background-clip:padding-box] cursor-pointer max-lg:h-15 max-lg:px-2.5 max-lg:rounded-sm 2xl:h-[3.4375rem] 2xl:px-7.5 2xl:rounded-sm" style={{ backgroundImage: "linear-gradient(var(--primary), var(--primary))" }} data-ditto-id="style-link-5" data-component="link" href="https://member.iwillteachyoutoberich.com/" target="_blank">
                  {" "}
                  <span className="block relative z-2 min-w-0 pt-0.5 overflow-hidden text-center capitalize whitespace-nowrap text-nowrap max-lg:pt-[0.15rem] 2xl:pt-[0.1875rem]" data-ditto-id="style-span-10">
                    Student Login
                  </span>
                  {" "}
                </a>
      ...
      {" "}
      <div className="h-0 block absolute top-[82681.9px] inset-x-0 max-md:hidden 2xl:top-[4658.5875rem]">
        ...
        <div className="w-100 h-145 border border-solid border-color-001 block fixed top-0 left-0 z-2000000000 mx-110 bg-background max-md:invisible md:max-lg:mx-46 2xl:h-152.5 2xl:mx-190">
          <iframe className="w-99.5 h-145 block max-w-full overflow-clip max-md:invisible 2xl:h-152.5" title="recaptcha challenge expires in two minutes" />
        </div>
      </div>
    </>
  );
