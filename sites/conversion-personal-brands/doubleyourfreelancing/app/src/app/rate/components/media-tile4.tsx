    ...
    <li className="flex max-h-[1e+06px] mb-5 justify-start items-start content-start [word-break:break-word] 2xl:hidden">
      <div className="block relative z-1 max-h-[1e+06px] 2xl:hidden">
        <div className="box-content w-[1.1875rem] h-[1.1875rem] table max-h-[1e+06px] pt-[0.1875rem] pr-2.5 text-[1.1875rem] leading-0 text-center 2xl:hidden">
          <svg className="box-content w-[1.1875rem] h-[1.1875rem] inline-block max-h-[1e+06px] overflow-hidden align-middle text-color-024 leading-[1.1875rem] 2xl:hidden" data-component="icon" viewBox="0 0 448 512" data-id="icon-check-double-light" data-name="" fill="currentColor">
