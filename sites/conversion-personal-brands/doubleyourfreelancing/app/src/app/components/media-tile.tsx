...
export default function MediaTile({ d, styles }: { d: MediaTileData; styles: MediaTileStyles }) {
  return (
    <li className="box-content flex max-h-[1e+06px] mb-5 justify-start items-start content-start text-background [word-break:break-word] 2xl:hidden">
      <div className="box-content block relative z-1 max-h-[1e+06px] 2xl:hidden">
      ...
      <span className="box-content block z-0 max-h-[1e+06px] leading-[1.4375rem] 2xl:hidden">
