...
export default function MediaTile({ d }: { d: MediaTileData }) {
  return (
    <li className="w-[26.4375rem] h-[27.1875rem] min-h-px flex float-left px-[1.0625rem] max-md:w-[22.4375rem] max-md:h-[426.3px] md:max-lg:w-94 md:max-lg:h-[410.3px] 2xl:w-[423.7px] 2xl:h-[27.2125rem]">
      <article className="box-content block relative max-w-105 mb-10.5 pb-12.5 rounded-xl bg-surface-2">
        ...
        <div className="box-content block px-7.5 max-md:pb-[1.5625rem]">
          ...
          {" "}
          <a className="box-content block mt-0.5 text-color-001 text-xl font-medium leading-7.5 cursor-pointer after:content-[''] after:block after:absolute after:inset-0 after:w-[24.3125rem] after:h-[24.5625rem] after:rounded-tl-xl max-md:after:w-[20.3125rem] max-md:after:h-[384.3px] md:max-lg:after:w-85.5 md:max-lg:after:h-[368.3px] 2xl:after:w-[389.7px] 2xl:after:h-[24.5875rem]" data-component="link" href={d.href}>
            {d.label}
          </a>
          {" "}
