export type TextLink8Data = {
  href: string;
  label: string;
};
/** A text link. */
export default function TextLink8({ d }: { d: TextLink8Data }) {
  return (
    <a className="min-h-8 border-2 border-solid border-clr-1 flex min-w-[fit-content] py-2 px-3 rounded-lg text-sm leading-[1.0625rem] cursor-pointer" href={d.href} target="_self">
      {" "}
