import type { TextLink19Styles } from "../_styles";
import { cn } from "../../../../lib/utils";
export type TextLink19Data = {
  id: string;
  title: string;
  label: string;
  id2: string;
...
/** A text link. */
export default function TextLink19({ d, styles }: { d: TextLink19Data; styles: TextLink19Styles }) {
  return (
