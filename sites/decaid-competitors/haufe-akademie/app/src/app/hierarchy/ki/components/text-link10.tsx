import type { TextLink10Styles } from "../_styles";
import { cn } from "../../../../lib/utils";
export type TextLink10Data = {
  label: string;
  label2: string;
};
/** A text link. */
export default function TextLink10({ d, styles }: { d: TextLink10Data; styles: TextLink10Styles }) {
  return (
