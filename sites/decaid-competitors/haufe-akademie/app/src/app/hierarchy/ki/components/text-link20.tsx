import type { TextLink20Styles } from "../_styles";
import { cn } from "../../../../lib/utils";
export type TextLink20Data = {
  id: string;
  title: string;
  label: string;
  id2: string;
...
/** A text link. */
export default function TextLink20({ d, styles }: { d: TextLink20Data; styles: TextLink20Styles }) {
  return (
        ...
        <div className="flex gap-4">
          <div className="flex flex-wrap gap-4 text-muted-foreground">
            <div className="flex items-center gap-4 text-sm leading-3.5">
              <div className="block p-2 rounded-sm text-foreground bg-color-008">
                {"\n\t\t\t\t\t\t\t\tNeu"}
              </div>
              {" "}
            </div>
