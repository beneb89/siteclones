import type { TextLink17Styles } from "../_styles";
import { cn } from "../../../../lib/utils";
export type TextLink17Data = {
  id: string;
  title: string;
  label: string;
  id2: string;
...
/** A text link. */
export default function TextLink17({ d, styles }: { d: TextLink17Data; styles: TextLink17Styles }) {
  return (
        ...
        <div className="flex justify-between items-start">
          <div className="flex flex-col">
            ...
            <div className="flex flex-col gap-2">
              ...
              {" "}
              <div className={cn("block text-color-003 max-lg:text-sm max-lg:leading-5", styles.className2)}>
                {d.label}
              </div>
              {" "}
            </div>
