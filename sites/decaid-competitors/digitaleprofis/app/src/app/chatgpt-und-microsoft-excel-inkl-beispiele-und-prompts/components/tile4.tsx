...
export default function Tile4({ d, styles }: { d: Tile4Data; styles: Tile4Styles }) {
  return (
    <tr className="table-row align-middle">
      ...
      <td className={cn("border-solid border-l border-l-border table-cell py-4 px-[1.05rem] align-top text-muted max-md:py-[13.1px] max-md:px-[0.9rem]", styles.className5)}>
        {d.text5}
      </td>
    </tr>
  );
