...
export default function Tile3({ d, styles }: { d: Tile3Data; styles: Tile3Styles }) {
  return (
    <tr className={cn("table-row align-middle", styles.className)}>
      <td className={cn("table-cell py-4 px-[1.05rem] align-top text-muted max-md:sticky max-md:left-0 max-md:z-1 max-md:py-[13.1px] max-md:px-[0.9rem] max-md:font-semibold max-md:bg-background max-md:shadow-[var(--border)_1px_0px_0px_0px] max-md:text-[color:inherit]", styles.className2)}>
        {d.text}
      </td>
