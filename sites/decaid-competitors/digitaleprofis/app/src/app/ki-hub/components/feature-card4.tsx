...
export default function FeatureCard4({ d, styles }: { d: FeatureCard4Data; styles: FeatureCard4Styles }) {
  return (
    <article className={cn("h-60 min-h-60 border border-solid border-border grid min-w-0 p-7 rounded-[28px] content-between overflow-hidden text-left bg-surface-4 grid-cols-[minmax(0,_1fr)] max-md:rounded-[22px]", styles.className)}>
