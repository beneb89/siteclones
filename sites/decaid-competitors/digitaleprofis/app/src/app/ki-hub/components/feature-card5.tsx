...
export default function FeatureCard5({ d, styles }: { d: FeatureCard5Data; styles: FeatureCard5Styles }) {
  return (
    <article className={cn("h-[19.6375rem] min-h-60 border border-solid border-border grid min-w-0 p-7 rounded-[28px] content-between overflow-hidden text-left bg-background grid-cols-[minmax(0,_1fr)] max-md:rounded-[22px] md:max-lg:h-60 2xl:h-[19.875rem]", styles.className)}>
