  ...
  return (
    <div className="block relative my-2.5 max-md:overflow-hidden">
      <div className="flex relative rounded-lg overflow-hidden bg-background" id={d.id}>
        <div className={cn("w-20 h-[9.175rem] min-h-20 flex min-w-20 mr-4.5 pt-[0.4375rem] pb-2 px-3 flex-col justify-end text-background [font-family:Korb,_sans-serif] text-sm leading-3.5 uppercase bg-foreground max-md:mr-3 max-md:pt-2.5 max-md:justify-start", styles.className)}>
