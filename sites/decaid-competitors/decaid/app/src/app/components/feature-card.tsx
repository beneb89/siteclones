...
export default function FeatureCard({ d, styles }: { d: FeatureCardData; styles: FeatureCardStyles }) {
  return (
    <div className={cn("h-95 min-h-95 flex relative py-2.5 px-5 rounded-[20px] flex-col justify-center items-center text-center bg-accent max-lg:pt-6.5 max-lg:pb-8 max-lg:min-h-0", styles.className)} id={d.id}>
      <div className={cn("w-25 h-25 flex absolute -top-[3.8rem] min-w-0 rounded-full justify-center items-center bg-background shadow-[var(--clr-34)_0px_4px_20px_-12px] max-md:w-20 max-md:h-20", styles.className2)}>
