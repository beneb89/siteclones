...
export default function MediaTile({ d, styles }: { d: MediaTileData; styles: MediaTileStyles }) {
  return (
    <div className="box-content block min-w-0 overflow-x-hidden overflow-y-auto [font-family:Raleway,_sans-serif,_sans-serif]">
      <a className={cn("h-37.5 flex mb-5 rounded-[10px] overflow-hidden cursor-pointer w-full max-md:flex-col", styles.className)} data-component="link" href="/kundenprojekte/ausbildung-zum-mainframe-anwendungsentwickler" rel="noopener" target="_self">
