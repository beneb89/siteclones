...
export default function MediaTile({ d, styles }: { d: MediaTileData; styles: MediaTileStyles }) {
  return (
    <div className="box-content block min-w-0 overflow-x-hidden overflow-y-auto [font-family:Raleway,_sans-serif,_sans-serif]">
      <a className={cn("h-37.5 flex mb-5 rounded-[10px] overflow-hidden text-primary cursor-pointer w-full max-md:flex-col", styles.className)} data-component="link" href="/job-profile/berufsbilder-aus-dem-bereich-kunstliche-intelligenz/was-macht-eine-ai-business-developer" rel="noopener" target="_self">
        ...
        <div className="flex p-6 items-center flex-1 gap-4 text-foreground bg-surface">
          ...
          <span className="border border-solid border-background flex rounded-full justify-center items-center shrink-0 text-background bg-color-003 h-12 w-12">
            {" "}
