...
export default function MediaCard({ d, styles }: { d: MediaCardData; styles: MediaCardStyles }) {
  return (
    <article className="flex rounded-[10px] flex-col col-start-[span_4] col-end-[span_4] overflow-hidden bg-surface h-full max-lg:[grid-column-start:initial] max-lg:[grid-column-end:initial]">
      <a className="flex flex-col cursor-pointer h-full" data-component="link" href={d.href}>
        ...
        <div className="flex py-5 px-10 flex-col items-start flex-1 gap-5 max-md:py-[16.3px] max-md:px-[21.3px] max-md:gap-[16.3px] md:max-lg:py-[1.125rem] md:max-lg:px-[1.9rem] md:max-lg:gap-[1.125rem]">
          <span className={cn("flex py-2 px-4 rounded-full text-xs leading-[1.0625rem] max-md:text-[0.6875rem] max-md:leading-4", styles.className)}>
            {d.label}
          </span>
