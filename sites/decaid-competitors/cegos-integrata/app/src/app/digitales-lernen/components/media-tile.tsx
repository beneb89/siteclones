...
export default function MediaTile({ d }: { d: MediaTileData }) {
  return (
    <div className="box-content block min-w-0 overflow-x-hidden overflow-y-auto [font-family:Raleway,_sans-serif,_sans-serif]">
      <a className="h-37.5 flex mb-5 rounded-[10px] overflow-hidden cursor-pointer w-full max-md:h-[17.0875rem] max-md:flex-col" data-component="link" href={d.href} rel="noopener" target="_self">
        ...
        <div className="flex p-6 items-center flex-1 gap-4 text-foreground bg-surface">
          ...
          <span className="border border-solid border-color-004 flex rounded-full justify-center items-center shrink-0 text-background bg-color-004 h-12 w-12">
            {" "}
