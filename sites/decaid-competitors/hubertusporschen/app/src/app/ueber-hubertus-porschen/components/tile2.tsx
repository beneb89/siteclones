...
export default function Tile2({ d }: { d: Tile2Data }) {
  return (
    <div className="block py-4.5 px-3 text-center bg-background 2xl:hidden">
      <div className="block mb-[0.4rem] [font-family:'Source_Serif_4',_Georgia,_'Times_New_Roman',_serif] text-3xl leading-7.5 max-md:mb-1.5 2xl:hidden">
        {d.text}
      </div>
      {" "}
