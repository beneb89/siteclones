...
export default function MediaLink({ d }: { d: MediaLinkData }) {
  return (
    <a className="block overflow-hidden bg-surface-2 cursor-pointer 2xl:hidden" data-component="link" download="" href={d.href}>
      {" "}
      <img className="w-full h-[19.0625rem] block max-w-full overflow-clip object-cover align-middle aspect-[4/5] max-md:h-[23.0625rem] md:max-lg:h-93.5 2xl:hidden" data-component="image" alt={d.alt} height="1000" src={d.imgSrc} width="800" />
      {" "}
