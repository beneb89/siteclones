...
export default function FeatureCard3({ d, styles }: { d: FeatureCard3Data; styles: FeatureCard3Styles }) {
  return (
    <li className={cn("grid py-[1.8625rem] items-start gap-[1.8625rem] grid-cols-[120px_1fr] max-md:py-7 max-md:gap-2 max-md:grid-cols-1 2xl:hidden", styles.className)}>
