...
export default function Tile2({ d }: { d: Tile2Data }) {
  return (
    <div className="block py-[14.9px] px-4 [font-family:'IBM_Plex_Mono',_ui-monospace,_Menlo,_monospace] text-[0.8125rem] leading-[1.375rem] bg-color-005 max-md:py-3.5 max-md:leading-[1.3125rem] 2xl:hidden">
