...
export default function FeatureCard({ d }: { d: FeatureCardData }) {
  return (
    <div className="border-t-[3px] border-solid border-t-accent block p-8 bg-surface-2 2xl:hidden">
      ...
      {" "}
      <h3 className="block mb-3 text-primary [font-family:'Source_Serif_4',_Georgia,_'Times_New_Roman',_serif] text-xl font-medium leading-6 tracking-[-0.2px] 2xl:hidden" data-component="heading">
        {d.title}
      </h3>
      {" "}
