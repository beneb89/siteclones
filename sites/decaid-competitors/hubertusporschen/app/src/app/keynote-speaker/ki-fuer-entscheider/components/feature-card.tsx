...
export default function FeatureCard({ d, styles }: { d: FeatureCardData; styles: FeatureCardStyles }) {
  return (
    <article className={cn("border-r border-solid border-r-border border-b border-b-border block py-9 bg-color-002 2xl:hidden", styles.className)}>
      <div className="block mb-3 text-primary [font-family:'Source_Serif_4',_Georgia,_'Times_New_Roman',_serif] text-[2.625rem] font-semibold italic leading-10.5 tracking-[-1.05px] 2xl:hidden">
        {d.text}
      </div>
      {" "}
