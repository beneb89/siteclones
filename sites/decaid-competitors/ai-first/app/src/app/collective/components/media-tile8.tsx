...
import type { MediaTile8Styles } from "../_styles";
...
/** A media tile. */
export default function MediaTile8({ d, styles }: { d: MediaTile8Data; styles: MediaTile8Styles }) {
  return (
    <div className="border border-solid border-surface block relative shrink-0 overflow-hidden bg-surface-5 [backdrop-filter:blur(8px)] w-[12.5rem] max-md:w-40">
      <div className="w-46.5 h-[154.3px] block absolute top-0 left-0 z-10 m-1.5 pointer-events-none md:max-lg:h-[8.1375rem] 2xl:h-[9.675rem]">
      ...
      <div className="flex relative z-5 py-8 px-5 flex-col items-center text-center">
        <svg className="block mb-4 overflow-hidden align-middle text-color-002 h-5 w-5" data-component="icon" aria-hidden="true" fill="none" height="24" viewBox="0 -960 960 960" width="24" xmlns="http://www.w3.org/2000/svg">{d.icon}</svg>
