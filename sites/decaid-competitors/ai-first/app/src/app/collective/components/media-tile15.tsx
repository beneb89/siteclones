export type MediaTile15Data = {
  label: string;
};
/** A media tile. */
export default function MediaTile15({ d }: { d: MediaTile15Data }) {
  return (
    <li className="list-item">
      <a className="flex relative pl-4 items-center text-muted-foreground [font-family:'Martina_Plantijn',_Georgia,_serif] text-lg italic leading-7 [font-feature-settings:'calt',_'liga',_'onum'] cursor-pointer max-md:pl-3 max-md:text-sm max-md:leading-5" data-component="link" href="/hub/ab-testing-ideen">
