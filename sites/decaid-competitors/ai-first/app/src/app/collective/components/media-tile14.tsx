...
/** A media tile. */
export default function MediaTile14({ d }: { d: MediaTile14Data }) {
  return (
    <div className="flex flex-col items-end text-right max-md:items-start max-md:text-left">
      ...
      <p className="block text-primary text-base leading-[1.375rem] max-md:text-sm max-md:leading-[1.25rem] md:max-lg:text-[0.9375rem] md:max-lg:leading-[1.3125rem] 2xl:leading-5.5 2xl:[font-size:inherit]">
