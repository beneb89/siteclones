...
export default function MediaTile({ d, styles }: { d: MediaTileData; styles: MediaTileStyles }) {
  return (
    <div className={cn("flex items-center shrink-0", styles.className)}>
      <a className="h-7 flex relative px-5 items-center text-muted [font-family:'Martina_Plantijn',_Georgia,_serif] text-lg italic leading-7 [font-feature-settings:'calt',_'liga',_'onum'] cursor-pointer" data-component="link" href={d.href}>
      ...
      <span className="block text-color-008" aria-hidden="true">
        |
      </span>
    </div>
  );
