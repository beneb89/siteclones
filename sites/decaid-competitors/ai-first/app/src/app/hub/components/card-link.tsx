...
export default function CardLink({ d, styles }: { d: CardLinkData; styles: CardLinkStyles }) {
  return (
    <a className="flex relative flex-col overflow-hidden bg-color-005 cursor-pointer aspect-[3/4]" style={{ maskImage: "radial-gradient(4px at 4px 0px, var(--clr-2) 97%, var(--background)), radial-gradient(4px at 4px 100%, var(--clr-2) 97%, var(--background)), radial-gradient(4px at 0px 4px, var(--clr-2) 97%, var(--background)), radial-gradient(4px at 100% 4px, var(--clr-2) 97%, var(--background))" }} data-component="link" href="/hub/ab-testing-ideen">
      ...
      <div className="h-full flex absolute top-0 inset-x-0 z-17 min-w-0 p-[0.3125rem] justify-start items-start [filter:drop-shadow(var(--clr-17)_0px_1px_3px)] pointer-events-none md:max-lg:p-1.5">
        <div className="flex py-[0.3rem] px-2.5 rounded-br-[14px] justify-center items-center gap-[0.3rem] text-xs leading-4.5 bg-color-005 pointer-events-none">
