...
export default function MediaTile({ d }: { d: MediaTileData }) {
  return (
    <li className="hidden 2xl:w-[228.3px] 2xl:block 2xl:max-w-[calc(25%_-_30px)] 2xl:mt-2.5 2xl:ml-7.5 2xl:flex-col 2xl:justify-start 2xl:basis-full before:content-[''] before:hidden max-lg:before:hidden" id={d.id}>
