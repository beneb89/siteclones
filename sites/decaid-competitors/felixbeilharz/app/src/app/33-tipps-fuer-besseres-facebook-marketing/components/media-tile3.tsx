...
export default function MediaTile3({ d }: { d: MediaTile3Data }) {
  return (
    <li className="box-content flex justify-start items-start content-start text-foreground text-base leading-7 [word-break:break-word]">
      ...
      <span className="box-content block z-0 leading-[2.3125rem]">
        {d.text}
      </span>
    </li>
  );
