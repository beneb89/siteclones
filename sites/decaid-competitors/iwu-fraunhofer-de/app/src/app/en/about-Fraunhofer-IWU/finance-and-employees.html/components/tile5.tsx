...
export default function Tile5({ d, styles }: { d: Tile5Data; styles: Tile5Styles }) {
  return (
    <tr className="h-8 table-row align-middle bg-surface [border-spacing:0px_1px] max-md:hidden 2xl:h-[2.4rem]">
      <td className={cn("h-full table-cell py-[0.4375rem] px-[0.9375rem] align-middle [border-spacing:0px_1px] max-md:hidden 2xl:py-[0.525rem] 2xl:px-4.5", styles.className)}>
        {d.text}
      </td>
