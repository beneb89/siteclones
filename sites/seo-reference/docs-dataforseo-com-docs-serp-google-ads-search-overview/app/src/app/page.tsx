          ...
          <div className="block max-w-384 px-[1.2rem] mx-auto max-md:px-3 md:max-lg:px-[0.9375rem]">
            <div className="grid items-start gap-x-2.5 grid-cols-1 2xl:gap-x-2 2xl:grid-cols-[208px_1281.62px]">
              ...
              <div className="border border-solid border-border block p-[1.2rem] rounded-[12.8px] bg-border max-md:p-3 max-md:rounded-lg md:max-lg:p-[0.9375rem] md:max-lg:rounded-[10px]">
                <div className="w-full grid items-start gap-x-8 grid-cols-[1fr_480px] grid-rows-1 aspect-[0.838] max-lg:gap-x-10 max-lg:grid-cols-1 max-md:aspect-[0.144] md:max-lg:aspect-[0.461] 2xl:aspect-[0.866]">
                  <div className="block overflow-hidden">
                    <div className="block">
                      <div className="block -mx-[0.9375rem] before:content-['_'] before:table before:w-0 before:h-0 before:text-foreground before:text-sm before:leading-[1.0625rem] md:max-lg:before:text-[0.9375rem] md:max-lg:before:leading-[1.0625rem] after:content-['_'] after:table after:w-0 after:h-0 after:text-foreground after:text-sm after:leading-[1.0625rem] md:max-lg:after:text-[0.9375rem] md:max-lg:after:leading-[1.0625rem]">
                        <div className="h-[1434.1px] min-h-px block relative float-left max-md:h-[2249.7px] max-md:[float:initial] md:max-lg:h-[95.6875rem]">
                              ...
                              <div className="block mb-[2.1875rem]">
                                <div className="block">
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    {"DataForSEO Google Ads Search API provides data on ads that are run by advertisers on the Google Ads platform. Data is based on the "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-6 hover:text-clr-6 hover:outline-clr-6 hover:[text-decoration-color:var(--clr-6)] focus:border-clr-14 focus:text-clr-14 focus:outline-clr-14 focus:[text-decoration-color:var(--clr-14)]" data-component="link" href="https://adstransparency.google.com/" rel="noopener noreferrer" target="_blank">
                                  ...
                                  {" "}
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    {"The returned results are specific to the indicated "}
                                    ...
                                    {" (available in the "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-12 hover:text-clr-12 hover:outline-clr-12 hover:[text-decoration-color:var(--clr-12)] focus:border-clr-19 focus:text-clr-19 focus:outline-clr-19 focus:[text-decoration-color:var(--clr-19)]" data-component="link" href="/v3/serp/google/ads_advertisers/task_get/advanced/" rel="noopener noreferrer" target="_blank">
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    ...
                                    {" Google Ads Search API provides results for "}
                                    <code className="inline-flex my-[0.3rem] p-[0.3rem] rounded-xs items-center gap-x-[0.4rem] [word-break:break-word] bg-border max-lg:my-1.5 max-lg:p-1.5 max-lg:gap-x-2" data-component="badge">
                                      desktop
                                    </code>
                                    {" and "}
                                    ...
                                    <a className="inline text-primary cursor-pointer hover:border-clr-12 hover:text-clr-12 hover:outline-clr-12 hover:[text-decoration-color:var(--clr-12)] focus:border-clr-19 focus:text-clr-19 focus:outline-clr-19 focus:[text-decoration-color:var(--clr-19)]" data-component="link" href="https://dataforseo.com/help-center/rank-absolute-vs-rank-group" rel="noopener noreferrer" target="_blank">
                                      in our help article.
                                    </a>
                                  </p>
                                  {" "}
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    <br className="inline" />
                                    {" "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-12 hover:text-clr-12 hover:outline-clr-12 hover:[text-decoration-color:var(--clr-12)] focus:border-clr-20 focus:text-clr-20 focus:outline-clr-20 focus:[text-decoration-color:var(--clr-20)]" data-component="link" href="/v3/serp/google/ads_search/task_get/advanced/" rel="noopener noreferrer" target="_blank">
                                      Google Ads Search Advanced endpoint
                                    </a>
                                    {" provides data on the top 40 search engine results for the specified parameters."}
                                  </p>
                                  {" "}
                                  <h3 className="block text-base font-bold leading-[1.5625rem] md:max-lg:text-[1.0625rem]" data-component="heading">
                                    Methods
                                  ...
                                  {" "}
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    <a className="inline text-primary cursor-pointer hover:border-clr-12 hover:text-clr-12 hover:outline-clr-12 hover:[text-decoration-color:var(--clr-12)] focus:border-clr-19 focus:text-clr-19 focus:outline-clr-19 focus:[text-decoration-color:var(--clr-19)]" data-component="link" href="/v3/serp/google/ads_search/task_post/" rel="noopener noreferrer" target="_blank">
                                      The Standard method
                                    </a>
                                    {" of data retrieval requires making separate POST and GET requests to retrieve the results after our system collects them."}
                                  </p>
                                  {" "}
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    ...
                                    <a className="inline text-primary cursor-pointer hover:border-clr-12 hover:text-clr-12 hover:outline-clr-12 hover:[text-decoration-color:var(--clr-12)] focus:border-clr-19 focus:text-clr-19 focus:outline-clr-19 focus:[text-decoration-color:var(--clr-19)]" data-component="link" href="/v3/serp/google/ads_search/tasks_ready/" rel="noopener noreferrer" target="_blank">
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    ...
                                    <a className="inline text-primary cursor-pointer hover:border-clr-12 hover:text-clr-12 hover:outline-clr-12 hover:[text-decoration-color:var(--clr-12)] focus:border-clr-19 focus:text-clr-19 focus:outline-clr-19 focus:[text-decoration-color:var(--clr-19)]" data-component="link" href="https://dataforseo.com/help-center/completed-tasks" rel="noopener noreferrer" target="_blank">
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    ...
                                    {" above the default value will increase the cost of the task. For example, if the default value is 40, you will be billed for every 40 results. So, if you specify "}
                                    <code className="inline-flex mt-[0.3rem] p-[0.3rem] rounded-xs items-center gap-x-[0.4rem] [word-break:break-word] bg-border max-lg:mt-1.5 max-lg:p-1.5 max-lg:gap-x-2" data-component="badge">
                                      "depth": 45
                                    </code>
                                    , the price for the task will be multiplied by 2 and you will be billed as for 80 results.
                                  </p>
                                  {" "}
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    {"The cost can be calculated on the "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-12 hover:text-clr-12 hover:outline-clr-12 hover:[text-decoration-color:var(--clr-12)] focus:border-clr-19 focus:text-clr-19 focus:outline-clr-19 focus:[text-decoration-color:var(--clr-19)]" data-component="link" href="https://dataforseo.com/pricing/serp/google-ads-search-serp-api" rel="noopener noreferrer" target="_blank" title="Pricing">
                                      Pricing
                                    </a>
                                    {" page. To learn more about the cost of all SERP API methods, priorities, and additional parameters, please refer to "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-12 hover:text-clr-12 hover:outline-clr-12 hover:[text-decoration-color:var(--clr-12)] focus:border-clr-19 focus:text-clr-19 focus:outline-clr-19 focus:[text-decoration-color:var(--clr-19)]" data-component="link" href="https://dataforseo.com/help-center/serp-api-cost-explained" rel="noopener noreferrer" target="_blank">
                                      this help article
                                    </a>
                                    .
                                  </p>
                                  ...
                                  <p className="block mt-3 leading-[1.25rem] max-lg:mt-[0.9375rem]">
                                    {"You can test Google Ads Search API for free using DataForSEO "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-12 hover:text-clr-12 hover:outline-clr-12 hover:[text-decoration-color:var(--clr-12)] focus:border-clr-19 focus:text-clr-19 focus:outline-clr-19 focus:[text-decoration-color:var(--clr-19)]" data-component="link" href="/v3/appendix/sandbox/">
                                      Sandbox.
                                    </a>
                                  </p>
                                  {" "}
