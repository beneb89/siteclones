...
import { ListRow6_styles, ListRow6_styles2, ListRow6_styles3, ListRow6_styles4 } from "../_styles";
import { listRow6Data as listRow6DataContent, listRow6Data2 as listRow6Data2Content, listRow6Data3 as listRow6Data3Content, listRow6Data4 as listRow6Data4Content } from "../content";
...
/** Site footer. */
export default function Footer({ logos = Logo_data, listRow6Data = listRow6DataContent, listRow6Data2 = listRow6Data2Content, listRow6Data3 = listRow6Data3Content, listRow6Data4 = listRow6Data4Content } = {}) {
  return (
    <footer className="border-t border-solid border-t-surface-2 block py-16 text-color-001 bg-foreground">
      <div className="grid px-8 gap-12 grid-cols-[265.469px_189.641px_189.625px_189.625px_189.625px] mx-auto max-w-7xl max-md:px-4 max-lg:grid-cols-1">
        <div className="block">
          ...
          <div className="block mt-6">
            <div className="flex gap-4 text-color-005">
        ...
        <div className="block">
          ...
          <ul className="block [list-style-type:none] list-outside">
            {listRow6Data2.map((d, i) => <ListRow6 key={i} d={d} styles={ListRow6_styles2[i]} />)}
          </ul>
        </div>
        <div className="block">
          <h5 className="block mb-4 text-background [font-family:'Geist_Mono',_'Geist_Mono_Fallback',_ui-monospace,_SFMono-Regular,_Menlo,_Monaco,_Consolas,_'Liberation_Mono',_'Courier_New',_monospace] text-[0.8125rem] font-medium leading-[1.25rem] tracking-[1.04px] uppercase" data-component="heading">
          ...
          <ul className="block [list-style-type:none] list-outside">
            {listRow6Data3.map((d, i) => <ListRow6 key={i} d={d} styles={ListRow6_styles3[i]} />)}
          </ul>
        </div>
        <div className="block">
          <h5 className="block mb-4 text-background [font-family:'Geist_Mono',_'Geist_Mono_Fallback',_ui-monospace,_SFMono-Regular,_Menlo,_Monaco,_Consolas,_'Liberation_Mono',_'Courier_New',_monospace] text-[0.8125rem] font-medium leading-[1.25rem] tracking-[1.04px] uppercase" data-component="heading">
          ...
          <ul className="block [list-style-type:none] list-outside">
            {listRow6Data4.map((d, i) => <ListRow6 key={i} d={d} styles={ListRow6_styles4[i]} />)}
          </ul>
        </div>
      </div>
      <div className="border-t border-solid border-t-surface-2 flex mt-12 pt-6 px-8 justify-between items-center gap-3 text-color-013 [font-family:'Geist_Mono',_'Geist_Mono_Fallback',_ui-monospace,_SFMono-Regular,_Menlo,_Monaco,_Consolas,_'Liberation_Mono',_'Courier_New',_monospace] text-[0.6875rem] leading-[1.0625rem] tracking-[1.1px] uppercase mx-auto max-w-7xl max-md:px-4 max-md:flex-col max-md:items-start">
