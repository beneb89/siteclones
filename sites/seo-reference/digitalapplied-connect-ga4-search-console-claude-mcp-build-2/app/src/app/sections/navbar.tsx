      ...
      <div className="block px-8 mx-auto max-w-7xl max-md:px-4">
        <div className="flex justify-between items-center h-[4.25rem]">
          ...
          <div className="flex items-center gap-2.5 max-md:hidden">
            <a className="block py-2 px-3.5 rounded-[10px] text-color-003 text-sm font-medium leading-[1.25rem] cursor-pointer hover:bg-surface" data-component="link" href="/auth/login">
              Log in
            </a>
            <a className="border border-solid border-clr-0 flex px-4 rounded-[10px] justify-center items-center shrink-0 gap-1 text-surface-5 text-sm font-medium leading-5 whitespace-nowrap text-nowrap bg-color-010 [background-clip:padding-box] [-webkit-background-clip:padding-box] cursor-pointer h-[2.375rem] hover:bg-clr-13" data-component="button" href="/get-started">
              Start engines
            </a>
          </div>
