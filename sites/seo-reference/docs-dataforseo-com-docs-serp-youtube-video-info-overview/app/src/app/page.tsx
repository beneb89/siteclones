          ...
          <div className="block max-w-384 px-[1.2rem] mx-auto max-md:px-3 md:max-lg:px-[0.9375rem]">
            <div className="grid items-start gap-x-2.5 grid-cols-1 2xl:gap-x-2 2xl:grid-cols-[208px_1281.62px]">
              ...
              <div className="border border-solid border-border block p-[1.2rem] rounded-[12.8px] bg-border max-md:p-3 max-md:rounded-lg md:max-lg:p-[0.9375rem] md:max-lg:rounded-[10px]">
                <div className="w-full grid items-start gap-x-8 grid-cols-[1fr_480px] grid-rows-1 aspect-[0.801] max-lg:gap-x-10 max-lg:grid-cols-1 max-md:aspect-[0.137] md:max-lg:aspect-[0.445] 2xl:aspect-[0.839]">
                  <div className="block overflow-hidden">
                    <div className="block">
                      <div className="block -mx-[0.9375rem] before:content-['_'] before:table before:w-0 before:h-0 before:text-foreground before:text-sm before:leading-[1.0625rem] md:max-lg:before:text-[0.9375rem] md:max-lg:before:leading-[1.0625rem] after:content-['_'] after:table after:w-0 after:h-0 after:text-foreground after:text-sm after:leading-[1.0625rem] md:max-lg:after:text-[0.9375rem] md:max-lg:after:leading-[1.0625rem]">
                        <div className="h-[93.6875rem] min-h-px block relative float-left max-md:h-[148.725rem] max-md:[float:initial] md:max-lg:h-[99.175rem] 2xl:h-[1479.3px]">
                              ...
                              <div className="block mb-[2.1875rem]">
                                <div className="block">
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    {"YouTube Video Info API provides data based on the "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-9 hover:text-clr-9 hover:outline-clr-9 hover:[text-decoration-color:var(--clr-9)] focus:border-clr-21 focus:text-clr-21 focus:outline-clr-21 focus:[text-decoration-color:var(--clr-21)]" data-component="link" href="/v3/serp/youtube/video_info/task_post/" rel="noopener noreferrer" target="_blank">
                                      YouTube Video Info
                                    </a>
                                    {" search engine. We collect detailed information from the watching page about key video and content metrics as well as the channel where the video is published. "}
                                  </p>
                                  {" "}
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    ...
                                    <a className="inline text-primary cursor-pointer hover:border-clr-9 hover:text-clr-9 hover:outline-clr-9 hover:[text-decoration-color:var(--clr-9)] focus:border-clr-18 focus:text-clr-18 focus:outline-clr-18 focus:[text-decoration-color:var(--clr-18)]" data-component="link" href="https://dataforseo.com/help-center/rank-absolute-vs-rank-group" rel="noopener noreferrer" target="_blank">
                                      in our help article.
                                    </a>
                                  </p>
                                  {" "}
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    <br className="inline" />
                                    {" "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-9 hover:text-clr-9 hover:outline-clr-9 hover:[text-decoration-color:var(--clr-9)] focus:border-clr-18 focus:text-clr-18 focus:outline-clr-18 focus:[text-decoration-color:var(--clr-18)]" data-component="link" href="/v3/serp/youtube/video_info/live/advanced/" rel="noopener noreferrer" target="_blank">
                                      Youtube Video Info Advanced endpoint
                                    </a>
                                    {" provides detailed data on the specified YouTube video, key metrics, and the channel where the video is published. "}
                                  </p>
                                  {" "}
                                  <h3 className="block text-base font-bold leading-[1.5625rem] md:max-lg:text-[1.0625rem]" data-component="heading">
                                    Methods
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    ...
                                    {" and "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-12 hover:text-clr-12 hover:outline-clr-12 hover:[text-decoration-color:var(--clr-12)] focus:border-clr-22 focus:text-clr-22 focus:outline-clr-22 focus:[text-decoration-color:var(--clr-22)]" data-component="link" href="/v3/serp/youtube/video_info/task_get/advanced/" rel="noopener noreferrer" target="_blank">
                                      GET
                                    </a>
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    ...
                                    <a className="inline text-primary cursor-pointer hover:border-clr-9 hover:text-clr-9 hover:outline-clr-9 hover:[text-decoration-color:var(--clr-9)] focus:border-clr-18 focus:text-clr-18 focus:outline-clr-18 focus:[text-decoration-color:var(--clr-18)]" data-component="link" href="/v3/serp/youtube/video_info/tasks_ready/" rel="noopener noreferrer" target="_blank">
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    ...
                                    <a className="inline text-primary cursor-pointer hover:border-clr-9 hover:text-clr-9 hover:outline-clr-9 hover:[text-decoration-color:var(--clr-9)] focus:border-clr-18 focus:text-clr-18 focus:outline-clr-18 focus:[text-decoration-color:var(--clr-18)]" data-component="link" href="https://dataforseo.com/help-center/completed-tasks" rel="noopener noreferrer" target="_blank">
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    ...
                                    <a className="inline text-primary cursor-pointer hover:border-clr-9 hover:text-clr-9 hover:outline-clr-9 hover:[text-decoration-color:var(--clr-9)] focus:border-clr-18 focus:text-clr-18 focus:outline-clr-18 focus:[text-decoration-color:var(--clr-18)]" data-component="link" href="https://dataforseo.com/pricing/serp/youtube-serp-api" rel="noopener noreferrer" target="_blank" title="Pricing">
                                      Pricing
                                    </a>
                                    {" page. To learn more about the cost of all SERP API methods, priorities, and additional parameters, please refer to "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-9 hover:text-clr-9 hover:outline-clr-9 hover:[text-decoration-color:var(--clr-9)] focus:border-clr-18 focus:text-clr-18 focus:outline-clr-18 focus:[text-decoration-color:var(--clr-18)]" data-component="link" href="https://dataforseo.com/help-center/serp-api-cost-explained" rel="noopener noreferrer" target="_blank">
                                      this help article
                                    </a>
                                    .
                                  </p>
                                  ...
                                  <p className="block mt-3 leading-[1.25rem] max-lg:mt-[0.9375rem]">
                                    {"You can test YouTube Video Info API for free using DataForSEO "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-9 hover:text-clr-9 hover:outline-clr-9 hover:[text-decoration-color:var(--clr-9)] focus:border-clr-18 focus:text-clr-18 focus:outline-clr-18 focus:[text-decoration-color:var(--clr-18)]" data-component="link" href="/v3/appendix/sandbox/">
                                      Sandbox.
                                    </a>
                                  </p>
                                  {" "}
