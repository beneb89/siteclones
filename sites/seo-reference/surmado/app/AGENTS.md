...
This is a generated ditto.site clone app for https://www.surmado.com/blog/answer-engine-optimization-aeo-geo-guide. It is a static Next.js App Router project produced from captured DOM, CSS, assets, metadata, and interaction recipes.
...
`src/app/ditto` contains generated runtime utilities for captured interactions and motion. Current runtime utilities: Accordion, DittoMotion, DropdownMenu. Do not casually rewrite these files; they are plumbing that maps captured recipes to stable `data-ditto-id` anchors in delivered apps.
...
- / - Answer Engine Optimization: The Complete AEO and GEO Guide for 2026 | Surmado Blog
