      ...
      <header className="w-full h-[89.9px] block sticky top-0 z-100 shrink-0 bg-background max-md:h-[92.3px] md:max-lg:h-[5.8rem] 2xl:h-[3.3rem]" id="header">
        <div className="block max-w-384 px-[1.2rem] mx-auto max-md:px-3 md:max-lg:px-[0.9375rem]">
          <div className="flex py-[0.6rem] justify-between items-center">
            {" "}
            <a className="block flex-1 text-primary cursor-pointer hover:border-clr-6 hover:text-clr-6 hover:outline-clr-6 hover:[text-decoration-color:var(--clr-6)] focus:border-clr-16 focus:text-clr-16 focus:outline-clr-16 focus:[text-decoration-color:var(--clr-16)]" data-component="link" aria-current="page" href="/v3/" rel="home">
                  ...
                  <div className="block overflow-hidden">
                    <div className="block">
                      <div className="block -mx-[0.9375rem] before:content-['_'] before:table before:w-0 before:h-0 before:text-foreground before:text-sm before:leading-[1.0625rem] md:max-lg:before:text-[0.9375rem] md:max-lg:before:leading-[1.0625rem] after:content-['_'] after:table after:w-0 after:h-0 after:text-foreground after:text-sm after:leading-[1.0625rem] md:max-lg:after:text-[0.9375rem] md:max-lg:after:leading-[1.0625rem]">
                        <div className="h-[1168.5px] min-h-px block relative float-left max-md:h-[1849.5px] max-md:[float:initial] md:max-lg:h-[77.175rem] 2xl:h-[71.8125rem]">
                            ...
                            <div className="block">
                              <div className="block mb-[2.1875rem]">
                                <div className="block">
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    {"• "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-9 hover:text-clr-9 hover:outline-clr-9 hover:[text-decoration-color:var(--clr-9)] focus:border-clr-19 focus:text-clr-19 focus:outline-clr-19 focus:[text-decoration-color:var(--clr-19)]" data-component="link" href="/v3/ai_optimization/llm_responses/overview/">
                                      LLM Responses API
                                    </a>
                                    {" enables real-time generation of structured responses from leading LLMs, including ChatGPT, Claude, Gemini, and Perplexity, based on your specified input parameters."}
                                  </p>
                                  {" "}
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    {"• "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-9 hover:text-clr-9 hover:outline-clr-9 hover:[text-decoration-color:var(--clr-9)] focus:border-clr-19 focus:text-clr-19 focus:outline-clr-19 focus:[text-decoration-color:var(--clr-19)]" data-component="link" href="/v3/ai_optimization/chat_gpt/llm_scraper/overview/">
                                      LLM Scraper API
                                    </a>
                                    {" provides results from scraped ChatGPT searches, based on the keyword and other input parameters."}
                                  </p>
                                  {" "}
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    {"• "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-9 hover:text-clr-9 hover:outline-clr-9 hover:[text-decoration-color:var(--clr-9)] focus:border-clr-19 focus:text-clr-19 focus:outline-clr-19 focus:[text-decoration-color:var(--clr-19)]" data-component="link" href="/v3/ai_optimization/ai_keyword_data/overview/">
                                      AI Keyword Data API
                                    </a>
                                    {" delivers search volume estimates and user intent insights based on keyword usage in AI tools like ChatGPT and other large language models."}
                                  </p>
                                  {" "}
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    {"• "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-9 hover:text-clr-9 hover:outline-clr-9 hover:[text-decoration-color:var(--clr-9)] focus:border-clr-19 focus:text-clr-19 focus:outline-clr-19 focus:[text-decoration-color:var(--clr-19)]" data-component="link" href="/v3/ai_optimization/llm_mentions/overview/">
                                      LLM Mentions API
                                    </a>
                                    {" provides data on keyword, brand and website mentions in LLMs, including metrics like AI search volume, impressions and mentions count."}
                                  </p>
                                  {" "}
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    {"To find answers on common questions about AI Optimization API and find guidance on most efficient use, "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-9 hover:text-clr-9 hover:outline-clr-9 hover:[text-decoration-color:var(--clr-9)] focus:border-clr-19 focus:text-clr-19 focus:outline-clr-19 focus:[text-decoration-color:var(--clr-19)]" data-component="link" href="https://dataforseo.com/help-center/category/ai-optimization-api" rel="noopener noreferrer" target="_blank">
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    ...
                                    {" when setting a task, and we will notify you on completion of tasks or send them to you respectively."}
                                  </p>
                                  {" "}
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    {"If you need to set several tasks, you can receive the list of id for all completed tasks using "}
                                    <strong className="inline font-bold">
                                      ‘Tasks Ready’
                                    </strong>
                                    {" endpoint, and then collect the results of each separate task using ‘Task GET’ endpoint."}
                                  </p>
                                  {" "}
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    ...
                                    <a className="inline text-primary cursor-pointer hover:border-clr-9 hover:text-clr-9 hover:outline-clr-9 hover:[text-decoration-color:var(--clr-9)] focus:border-clr-19 focus:text-clr-19 focus:outline-clr-19 focus:[text-decoration-color:var(--clr-19)]" data-component="link" href="https://dataforseo.com/pricing/ai-optimization" rel="noopener noreferrer" target="_blank" title="Pricing">
                                      Pricing
                                    </a>
                                    {" page. You can check your spending in your "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-13 hover:text-clr-13 hover:outline-clr-13 hover:[text-decoration-color:var(--clr-13)] focus:border-clr-22 focus:text-clr-22 focus:outline-clr-22 focus:[text-decoration-color:var(--clr-22)]" data-component="link" href="https://app.dataforseo.com/api-access" rel="noopener noreferrer" target="_blank">
                                      account dashboard
                                    </a>
                                    {" or by making a separate call to "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-9 hover:text-clr-9 hover:outline-clr-9 hover:[text-decoration-color:var(--clr-9)] focus:border-clr-19 focus:text-clr-19 focus:outline-clr-19 focus:[text-decoration-color:var(--clr-19)]" data-component="link" href="/v3/appendix/user_data/?php" rel="noopener noreferrer" target="_blank">
                                      the User Data endpoint
                                    </a>
                                  </p>
                                  {" "}
                                  <p className="block mt-3 leading-[1.25rem] max-lg:mt-[0.9375rem]">
                                    {"You can test AI Optimization API for free using DataForSEO "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-9 hover:text-clr-9 hover:outline-clr-9 hover:[text-decoration-color:var(--clr-9)] focus:border-clr-19 focus:text-clr-19 focus:outline-clr-19 focus:[text-decoration-color:var(--clr-19)]" data-component="link" href="/v3/appendix/sandbox/">
                                      Sandbox.
                                    </a>
                                  </p>
                                  {" "}
                      ...
                      {" "}
                      <blockquote className="block my-3.5 mx-10 md:max-lg:my-[14.5px]">
                        <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
