...
import { listRow5Data as listRow5DataContent, listRow5Data2 as listRow5Data2Content, listRow5Data3 as listRow5Data3Content, listRow5Data4 as listRow5Data4Content, listRow6Data as listRow6DataContent, logos as logosContent } from "../content";
...
/** Site footer. */
export default function Footer({ mediaTileData = MediaTile_data, listRow5Data = listRow5DataContent, listRow5Data2 = listRow5Data2Content, listRow5Data3 = listRow5Data3Content, listRow5Data4 = listRow5Data4Content, listRow6Data = listRow6DataContent, logos = logosContent } = {}) {
  return (
    <footer className="block relative z-100">
      <div className="box-content block relative before:content-['_'] before:table before:w-0 before:h-0 before:text-foreground before:text-sm before:font-medium before:leading-[1.4375rem] after:content-['_'] after:table after:w-0 after:h-0 after:text-foreground after:text-sm after:font-medium after:leading-[1.4375rem]">
        <div className="box-content block relative bg-color-002 bg-cover [background-position:50%_50%]">
          <div className="box-content block py-[4.0625rem] px-[1.5625rem]">
            <div className="box-content block before:content-['_'] before:table before:w-0 before:h-0 before:text-foreground before:text-sm before:font-medium before:leading-[1.4375rem] after:content-['_'] after:table after:w-0 after:h-0 after:text-foreground after:text-sm after:font-medium after:leading-[1.4375rem]">
              <div className="box-content block -mx-[0.9375rem]">
                <div className="w-[13.125rem] h-[685.3px] min-h-[685.3px] border-r border-solid border-r-color-008 block float-left px-2.5 max-md:w-[22.1875rem] max-md:h-[23.15rem] max-lg:inline-block max-lg:mb-7.5 max-lg:align-top max-lg:text-center max-lg:min-h-0 max-lg:[float:initial] max-lg:pl-0 md:max-lg:w-187 md:max-lg:h-[18.8375rem] 2xl:w-[316.7px] 2xl:h-[662.3px] 2xl:min-h-[662.3px]">
                  <div className="box-content block px-[0.9375rem]">
                    <div className="box-content block mb-5" id="text-3">
                      <div className="box-content block text-muted-foreground">
                        ...
                        {" "}
                        <a className="box-content inline text-background cursor-pointer hover:border-accent hover:text-accent hover:outline-accent hover:[text-decoration-color:var(--accent)]" data-component="link" href="/">
                          {" "}
                ...
                {" "}
                <div className="w-[13.125rem] h-[685.3px] min-h-[685.3px] border-r border-solid border-r-color-008 block float-left px-2.5 max-md:w-[22.1875rem] max-lg:h-[620.3px] max-lg:inline-block max-lg:mb-7.5 max-lg:align-top max-lg:text-center max-lg:min-h-0 max-lg:border-r-[0] max-lg:border-initial max-lg:border-r-[initial] max-lg:[float:initial] md:max-lg:w-187 2xl:w-[316.7px] 2xl:h-[662.3px] 2xl:min-h-[662.3px]">
                  <div className="box-content block px-[0.9375rem]">
                ...
                {" "}
                <div className="w-[13.125rem] h-[685.3px] min-h-[685.3px] border-r border-solid border-r-color-008 block float-left px-2.5 max-md:w-[22.1875rem] max-lg:h-[287.1px] max-lg:inline-block max-lg:mb-7.5 max-lg:align-top max-lg:text-center max-lg:min-h-0 max-lg:[float:initial] md:max-lg:w-187 2xl:w-[316.7px] 2xl:h-[662.3px] 2xl:min-h-[662.3px]">
                  <div className="box-content block px-[0.9375rem]">
                    <div className="box-content block mb-5" id="custom_html-2">
                      ...
                      <div className="box-content block text-muted-foreground">
                        <ul className="box-content block [list-style-type:none] list-outside">
                          {listRow5Data3.map((d, i) => <ListRow5 key={i} d={d} />)}
                        </ul>
                      </div>
                    </div>
                    {" "}
                ...
                {" "}
                <div className="w-[13.125rem] h-[685.3px] min-h-[685.3px] border-r border-solid border-r-color-008 block float-left px-2.5 max-md:w-[22.1875rem] max-lg:h-[218.1px] max-lg:inline-block max-lg:mb-7.5 max-lg:align-top max-lg:text-center max-lg:min-h-0 max-lg:border-r-[0] max-lg:border-initial max-lg:border-r-[initial] max-lg:[float:initial] md:max-lg:w-187 2xl:w-[316.7px] 2xl:h-[662.3px] 2xl:min-h-[662.3px]">
                  <div className="box-content block px-[0.9375rem]">
                    <div className="box-content block mb-5" id="text-6">
                      ...
                      <div className="box-content block text-muted-foreground">
                        <ul className="box-content block [list-style-type:none] list-outside">
                          {listRow5Data4.map((d, i) => <ListRow5 key={i} d={d} />)}
                        </ul>
                      </div>
                      {" "}
                    </div>
                ...
                {" "}
                <div className="w-[13.125rem] h-[685.3px] min-h-[685.3px] border-r border-solid border-r-color-008 block float-left px-2.5 max-md:w-[22.1875rem] max-lg:h-[333.1px] max-lg:inline-block max-lg:mb-7.5 max-lg:align-top max-lg:text-center max-lg:min-h-0 max-lg:[float:initial] md:max-lg:w-187 2xl:w-[316.7px] 2xl:h-[662.3px] 2xl:min-h-[662.3px]">
                  <div className="box-content block px-[0.9375rem]">
                ...
                <div className="w-[13.125rem] h-[685.3px] min-h-[685.3px] block float-left px-2.5 max-md:w-[22.1875rem] max-lg:h-[300.3px] max-lg:inline-block max-lg:align-top max-lg:text-center max-lg:min-h-0 max-lg:[float:initial] max-lg:pr-0 md:max-lg:w-187 2xl:w-[316.7px] 2xl:h-[662.3px] 2xl:min-h-[662.3px]">
                  <div className="box-content block px-[0.9375rem]">
                      ...
                      <div className="box-content block text-muted-foreground">
                        <ul className="box-content block [list-style-type:none] list-outside">
                          <li className="box-content list-item">
                            <a className="box-content inline text-background cursor-pointer hover:border-accent hover:text-accent hover:outline-accent hover:[text-decoration-color:var(--accent)]" data-component="link" href="/privacy-policy/">
                              Privacy Policy
                            </a>
                          </li>
                          <li className="box-content list-item">
                            <a className="box-content inline text-background cursor-pointer hover:border-accent hover:text-accent hover:outline-accent hover:[text-decoration-color:var(--accent)]" data-component="link" href="/terms-of-service/">
                              Terms of Services
                            </a>
                          </li>
                        </ul>
                    ...
                    <div className="box-content block mb-5" id="text-37">
                      <div className="box-content block text-muted-foreground">
                        <p className="box-content block">
                          <a className="box-content inline text-background cursor-pointer hover:border-accent hover:text-accent hover:outline-accent hover:[text-decoration-color:var(--accent)]" data-component="link" href="/wp-content/uploads/2021/12/27001_DATAFORSEO-.pdf" rel="noopener" target="_blank">
