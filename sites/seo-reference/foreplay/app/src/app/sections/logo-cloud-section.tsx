...
/** Logo Cloud section. */
export default function LogoCloudSection({ logos = Logo2_data } = {}) {
  return (
    <div className="flex flex-col gap-2 text-balance">
      <div className="block relative rounded-[20px] overflow-hidden aspect-[1.71/1]">
        <img className="w-full h-110 block max-w-full overflow-clip object-cover aspect-[1.71/1] align-middle" data-component="image" alt="man holding up a sign about google transparency center" height="440" sizes="(max-width: 767px) 100vw, 752px" src="/assets/cloned/images/1580bdb34d34.png" srcSet="/assets/cloned/images/06b4811e7726.png 500w, /assets/cloned/images/2963776e3f7f.png 800w, /assets/cloned/images/23f1ae40ffeb.png 1080w, /assets/cloned/images/7207f15534e2.png 1600w, /assets/cloned/images/1580bdb34d34.png 1920w" width="752" />
        <div className="h-full border border-solid border-border block absolute top-0 inset-x-0 rounded-[20px] pointer-events-none" />
      </div>
      <div className="flex py-10 justify-start items-center gap-4 max-md:grid max-md:py-4 max-md:grid-cols-[48px_263px] max-md:[grid-auto-columns:1fr] max-md:justify-items-stretch">
        ...
        <div className="flex justify-start items-center gap-1 max-md:flex-wrap max-md:gap-2 max-md:col-start-[span_2] max-md:col-end-[span_2] max-md:row-start-[span_1] max-md:row-end-[span_1]" id="w-node-_41ff7c22-c947-7192-f024-b6c1dcb8f621-f7a7652f">
