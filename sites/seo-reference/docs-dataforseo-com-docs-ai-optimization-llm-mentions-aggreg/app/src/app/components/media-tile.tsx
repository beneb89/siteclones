  ...
  return (
    <ul className="block [list-style-type:none] list-outside" id={d.id}>
      <li className="list-item" id={d.id2}>
        <button className="w-full flex ml-[0.3rem] py-[0.5625rem] px-4 items-center gap-x-2 text-color-004 leading-[1.0625rem] text-left cursor-pointer max-md:leading-[1rem] 2xl:py-[0.45rem] 2xl:px-[0.8rem] 2xl:gap-x-[0.4rem] 2xl:leading-[0.9375rem]">
          {d.label}
