...
import { MediaLink_styles, TextLink_styles, Tile3_styles, Tile4_styles } from "./_styles";
...
const Tile3_data: Tile3Data[] = [
    ...
    { text: "\"time\"", text2: "\"1.9593 sec.\"" },
    { text: "\"cost\"", text2: "0.101" },
    { text: "\"tasks_count\"", text2: "1" },
    { text: "\"tasks_error\"", text2: "0" }
];
const Tile4_data: Tile4Data[] = [
    { text: "\"id\"", text2: "\"12121212-1535-0635-0000-a76352adde37\"" },
    { text: "\"status_code\"", text2: "20000" },
    { text: "\"status_message\"", text2: "\"Ok.\"" },
    { text: "\"time\"", text2: "\"1.9079 sec.\"" },
    { text: "\"cost\"", text2: "0.101" },
      ...
      <header className="w-full h-[89.9px] block sticky top-0 z-100 shrink-0 bg-background max-md:h-[92.3px] md:max-lg:h-[5.8rem] 2xl:h-[3.3rem]" id="header">
        <div className="block max-w-384 px-[1.2rem] mx-auto max-md:px-3 md:max-lg:px-[0.9375rem]">
          <div className="flex py-[0.6rem] justify-between items-center">
            {" "}
            <a className="block flex-1 text-primary cursor-pointer hover:border-clr-15 hover:text-clr-15 hover:outline-clr-15 hover:[text-decoration-color:var(--clr-15)] focus:border-clr-36 focus:text-clr-36 focus:outline-clr-36 focus:[text-decoration-color:var(--clr-36)]" data-component="link" aria-current="page" href="/v3/" rel="home">
            ...
            <div className="flex justify-center items-center flex-1 gap-x-[0.8rem] max-lg:justify-end max-lg:gap-x-2">
              <button className="w-[13.4rem] h-[2.1rem] border border-solid border-color-005 block relative max-w-[13.4rem] rounded-md shrink-0 leading-[1rem] text-left cursor-pointer max-lg:w-9 max-lg:h-9 max-lg:flex max-lg:justify-center max-lg:items-center max-lg:leading-0 max-lg:border-[0] max-lg:border-initial max-lg:border-[initial] hover:border-clr-16 focus:border-clr-37" data-component="button" title="Search documentation (Ctrl+K)">
                <Icon />
                {" "}
                <span className="inline pl-[1.9rem] text-color-004 text-[0.6875rem] leading-[0.8125rem] max-lg:hidden">
                  {" Search "}
                </span>
                {" "}
                <kbd className="w-[2.775rem] h-[1.275rem] border border-solid border-color-005 flex absolute top-2 right-2 py-[0.2rem] px-[0.4rem] rounded-[4.8px] items-center gap-[0.1rem] text-color-004 text-[0.625rem] font-medium leading-[0.625rem] bg-border transform-[matrix(1,0,0,1,0,-10.1875)] max-lg:hidden">
              ...
              {" "}
              <button className="w-[23%] h-[2.1rem] min-h-[2.1rem] border border-solid border-border flex px-[1.2rem] rounded-md justify-center items-center gap-x-1 text-[0.8125rem] leading-[1.1875rem] text-center whitespace-nowrap text-nowrap bg-color-005 cursor-pointer max-lg:h-9 max-lg:rounded-lg max-md:leading-[1.3125rem] max-lg:min-h-0 max-lg:border-[0] max-lg:border-initial max-lg:border-[initial] max-lg:px-0 max-lg:[font-size:inherit] max-lg:bg-[initial] md:max-lg:w-[10%] md:max-lg:leading-[1.375rem] 2xl:w-[19.5%] hover:bg-clr-17 hover:border-clr-18" data-component="button" type="button">
              ...
              <div className="flex justify-end items-center flex-1 transform-[none] max-lg:invisible">
                ...
                <nav className="block max-lg:invisible" data-component="nav">
                  <ul className="flex items-center gap-x-[0.8rem] [list-style-type:none] list-outside max-lg:invisible">
                    <li className="w-full list-item max-lg:invisible">
                      <a className="h-[2.1rem] min-h-[2.1rem] border border-solid border-border flex px-[1.2rem] rounded-md justify-center items-center text-[0.8125rem] leading-[1.1875rem] text-center whitespace-nowrap text-nowrap bg-color-005 cursor-pointer max-lg:invisible hover:bg-clr-20 hover:border-color-005" data-component="button" href="https://app.dataforseo.com/signin/" target="_blank">
                        Sign In
                      </a>
                    </li>
                    <li className="w-full list-item max-lg:invisible">
                      <a className="h-[2.1rem] min-h-[2.1rem] border border-solid border-clr-1 flex px-[1.2rem] rounded-md justify-center items-center text-background text-[0.8125rem] font-semibold leading-[1.1875rem] text-center whitespace-nowrap text-nowrap bg-clr-2 cursor-pointer max-lg:invisible hover:bg-clr-21 hover:border-clr-22 focus:bg-clr-40 focus:border-clr-41" data-component="button" href="https://app.dataforseo.com/register/" target="_blank">
                        Sign Up
                      </a>
                    </li>
                    <li className="w-full list-item max-lg:invisible">
                      <button className="h-[2.1rem] min-h-[2.1rem] border border-solid border-border flex relative px-[0.8rem] rounded-md justify-center items-center text-[0.8125rem] leading-[1.1875rem] text-center whitespace-nowrap text-nowrap bg-color-005 cursor-pointer max-lg:invisible hover:bg-clr-18 hover:border-clr-20" data-component="button" aria-label="Toggle theme" id="theme-toggle" title="Switch to dark theme">
                        {" "}
        ...
        {" "}
        <div className="border-t border-solid border-t-border block py-2.5 bg-color-002 2xl:hidden">
          ...
          <div className="block max-w-384 px-[1.2rem] mx-auto max-md:px-3 md:max-lg:px-[0.9375rem]">
            <div className="grid items-start gap-x-2.5 grid-cols-1 2xl:gap-x-2 2xl:grid-cols-[208px_1281.62px]">
              <aside className="w-320 h-200 block fixed top-0 left-0 z-100 invisible opacity-0 min-w-0 max-h-200 pr-2 overflow-auto text-[0.9375rem] bg-clr-0 max-md:w-[23.4375rem] max-md:h-203 max-md:max-h-203 max-lg:[font-size:inherit] md:max-lg:w-192 md:max-lg:h-256 md:max-lg:max-h-256 2xl:w-52 2xl:h-243 2xl:sticky 2xl:top-[4.5625rem] 2xl:max-h-243 2xl:text-[0.8125rem] 2xl:left-auto 2xl:z-[initial] 2xl:[visibility:inherit] 2xl:opacity-[initial] 2xl:bg-[initial]">
                <button className="w-10 h-10 flex fixed top-5 right-5 z-102 rounded-[50%] justify-center items-center leading-[1.0625rem] text-left bg-color-005 cursor-pointer max-md:w-7.5 max-md:h-7.5 max-md:leading-[1rem] md:max-lg:w-[2.1375rem] md:max-lg:h-[2.1375rem] 2xl:w-[2.1rem] 2xl:h-[2.1rem] 2xl:top-4 2xl:right-4 2xl:leading-[0.9375rem] 2xl:z-[initial]">
                  ...
                  <nav className="block" id="menu-menu">
                    <ul className="block [list-style-type:none] list-outside" id="menu-main-menu-1">
                      <li className="list-item" id="menu-item-25749">
                        <a className="block py-[0.5625rem] px-4 text-color-004 cursor-pointer 2xl:py-[0.45rem] 2xl:px-[0.8rem]" href="/v3/">
                          Introduction
                        </a>
                      </li>
                      <li className="list-item" id="menu-item-25750">
                        <a className="block py-[0.5625rem] px-4 text-color-004 cursor-pointer 2xl:py-[0.45rem] 2xl:px-[0.8rem]" href="/v3/auth/">
                          Authentication
                        </a>
                      </li>
                    </ul>
              ...
              {" "}
              <div className="border border-solid border-border block p-[1.2rem] rounded-[12.8px] bg-color-002 max-md:p-3 max-md:rounded-lg md:max-lg:p-[0.9375rem] md:max-lg:rounded-[10px]">
                <div className="w-full grid items-start gap-x-8 grid-cols-[1fr_480px] max-lg:gap-x-10 max-lg:grid-cols-1">
                          ...
                          <div className="h-full block px-[0.9375rem] before:content-['_'] before:table before:w-0 before:h-0 before:text-foreground before:text-sm before:leading-[1.0625rem] md:max-lg:before:text-[0.9375rem] md:max-lg:before:leading-[1.0625rem] after:content-['_'] after:table after:w-0 after:h-0 after:text-foreground after:text-sm after:leading-[1.0625rem] md:max-lg:after:text-[0.9375rem] md:max-lg:after:leading-[1.0625rem]">
                            <div className="h-full block">
                              <div className="block mb-[2.1875rem]">
                                <div className="block">
                                  <h2 className="block mb-[0.6rem] text-[1.3125rem] font-semibold leading-[1.9375rem] max-lg:mb-3" data-component="heading">
                                    Live LLM Mentions Aggregated Metrics (Legacy)
                                  </h2>
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    ...
                                    <a className="inline-flex my-[0.3rem] p-[0.3rem] rounded-xs items-center gap-x-[0.4rem] [word-break:break-word] bg-border cursor-pointer max-lg:my-1.5 max-lg:p-1.5 max-lg:gap-x-2 hover:bg-clr-17">
                                    ...
                                    {" "}
                                    <strong className="inline font-bold">
                                      <a className="inline text-primary cursor-pointer hover:border-clr-19 hover:text-clr-19 hover:outline-clr-19 hover:[text-decoration-color:var(--clr-19)] focus:border-clr-42 focus:text-clr-42 focus:outline-clr-42 focus:[text-decoration-color:var(--clr-42)]" data-component="link" href="/v3/ai_optimization/llm_mentions/target_metrics/live/">
                                        {"See new documentation >>"}
                                      </a>
                                    </strong>
                                    <br className="inline" />
                                    {" The current path ("}
                                    <code className="inline-flex my-[0.3rem] p-[0.3rem] rounded-xs items-center gap-x-[0.4rem] [word-break:break-word] bg-border max-lg:my-1.5 max-lg:p-1.5 max-lg:gap-x-2">
                                  ...
                                  <p className="block mt-3 leading-[1.25rem] max-lg:mt-[0.9375rem]">
                                    {"Live LLM Mentions endpoint provides aggregated metrics for mentions of the keywords or domains specified in the "}
                                    ...
                                    {" array of the request. The results are specific to the selected platform ("}
                                    <code className="inline-flex my-[0.3rem] p-[0.3rem] rounded-xs items-center gap-x-[0.4rem] [word-break:break-word] bg-border max-lg:my-1.5 max-lg:p-1.5 max-lg:gap-x-2" data-component="badge">
                                      google
                                    </code>
                              ...
                              <div className="flex my-3 py-2 px-[0.8rem] rounded-md flex-wrap items-center gap-y-2 gap-x-1 text-[0.6875rem] font-semibold bg-clr-3 max-lg:my-[0.9375rem] max-md:p-2.5 max-lg:rounded-lg max-lg:gap-y-2.5 max-lg:gap-x-[0.3125rem] max-md:[font-size:inherit] md:max-lg:py-2.5 md:max-lg:px-[11.5px] md:max-lg:text-[0.875rem]">
                                ...
                                {" POST "}
                                <button className="flex p-[0.3rem] rounded-xs items-center gap-x-[0.4rem] font-normal leading-[0.8125rem] text-left [word-break:break-word] bg-border cursor-pointer max-lg:p-1.5 max-lg:gap-x-2 max-lg:leading-[1rem] hover:bg-clr-17" data-component="button">
                              ...
                              <article className="border-l border-solid border-l-clr-4 flex my-6 py-[0.4rem] pl-[0.8rem] flex-col gap-y-[0.4rem] max-lg:border-l-2 max-md:my-[0.9375rem] max-lg:py-2 max-lg:pl-4 max-lg:gap-y-2 md:max-lg:my-[18.7px]">
                                ...
                                <div className="block">
                                  <p className="block my-[0.15rem] leading-[1.25rem] max-lg:my-[0.1875rem]">
                                    ...
                                    <a className="inline text-primary cursor-pointer hover:border-clr-19 hover:text-clr-19 hover:outline-clr-19 hover:[text-decoration-color:var(--clr-19)] focus:border-clr-39 focus:text-clr-39 focus:outline-clr-39 focus:[text-decoration-color:var(--clr-39)]" data-component="link" href="https://dataforseo.com/pricing/ai-optimization/llm-mentions" target="_blank">
                                      Pricing page
                                    </a>
                                    {". "}
                                  </p>
                              ...
                              <div className="block mb-[2.1875rem]">
                                <div className="block">
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    ...
                                    <a className="inline text-primary cursor-pointer hover:border-clr-19 hover:text-clr-19 hover:outline-clr-19 hover:[text-decoration-color:var(--clr-19)] focus:border-clr-39 focus:text-clr-39 focus:outline-clr-39 focus:[text-decoration-color:var(--clr-39)]" data-component="link" href="https://en.wikipedia.org/wiki/JSON">
                                      JSON
                                    </a>
                                  ...
                                  <div className="block">
                                    <div className="border border-solid border-border block rounded-md overflow-x-auto overflow-y-hidden max-lg:rounded-lg">
                                      <table className="w-[687.3px] table min-w-120 text-[0.75rem] [border-collapse:collapse] [border-spacing:2px] max-md:w-150 max-lg:min-w-150 md:max-lg:w-[704.3px] md:max-lg:text-[0.8125rem] 2xl:w-[727.3px]">
                                        <thead className="table-header-group align-middle text-left bg-color-002 [border-collapse:collapse] [border-spacing:2px]">
                                          <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]">
                                            <th className="border-r border-solid border-r-color-010 table-cell py-2 px-[0.6rem] align-middle font-semibold [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:px-3">
                                              Field name
                                            </th>
                                            <th className="border-r border-solid border-r-color-010 table-cell py-2 px-[0.6rem] align-middle font-semibold [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:px-3">
                                              Type
                                        ...
                                        <tbody className="table-row-group align-middle [border-collapse:collapse] [border-spacing:2px]">
                                          <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="target">
                                            <td className="border-r border-solid border-r-border table-cell relative py-2 px-[0.6rem] leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:px-3 md:max-lg:leading-[1.375rem]">
                                              <strong className="inline font-bold [border-collapse:collapse] [border-spacing:2px]">
                                                <code className="inline py-[0.1rem] px-[0.35rem] rounded-xs bg-color-002 [border-collapse:collapse] [border-spacing:2px] max-lg:py-0.5 max-lg:px-[0.4375rem]">
                                                  target
                                                </code>
                                              </strong>
                                            </td>
                                          ...
                                          <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="target-keyword_entity-keyword">
                                            ...
                                            <td className="table-cell relative py-2 pr-[0.6rem] pl-5 leading-[1.3125rem] [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem]">
                                              ...
                                              <p className="block max-w-[90%] leading-[1.0625rem] [border-collapse:collapse] [border-spacing:2px] md:max-lg:leading-[1.125rem]">
                                                ...
                                                <a className="inline text-primary cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:border-clr-19 hover:text-clr-19 hover:outline-clr-19 hover:[text-decoration-color:var(--clr-19)] focus:border-clr-43 focus:text-clr-43 focus:outline-clr-43 focus:[text-decoration-color:var(--clr-43)]" data-component="link" href="https://dataforseo.com/help-center/rules-and-limitations-of-keyword-and-keywords-fields-in-dataforseo-apis" rel="noopener noreferrer" target="_blank">
                                                  Help Center article
                                                </a>
                                              </p>
                                            </td>
                                          ...
                                          <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="initial_dataset_filters">
                                            <td className="border-r border-solid border-r-border table-cell relative py-2 px-[0.6rem] leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:px-3 md:max-lg:leading-[1.375rem]">
                                              <code className="inline py-[0.1rem] px-[0.35rem] rounded-xs bg-color-002 [border-collapse:collapse] [border-spacing:2px] max-lg:py-0.5 max-lg:px-[0.4375rem]">
                                            ...
                                            <td className="table-cell relative py-2 pr-[0.6rem] pl-5 leading-[1.3125rem] [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem]">
                                              ...
                                              <p className="block max-w-[90%] leading-[1.0625rem] [border-collapse:collapse] [border-spacing:2px] md:max-lg:leading-[1.125rem]">
                                                ...
                                                <br className="inline [border-collapse:collapse] [border-spacing:2px]" />
                                                {"learn more about the initial dataset filters in "}
                                                <a className="inline text-primary cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:border-clr-24 hover:text-clr-24 hover:outline-clr-24 hover:[text-decoration-color:var(--clr-24)] focus:border-clr-44 focus:text-clr-44 focus:outline-clr-44 focus:[text-decoration-color:var(--clr-44)]" data-component="link" href="https://dataforseo.com/help-center/what-are-the-initial-dataset-filters-and-how-do-they-work" rel="noopener noreferrer" target="_blank">
                                                  this help center article.
                                                </a>
                                              </p>
                                            </td>
                                          </tr>
                                          <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="internal_list_limit">
                                            <td className="border-r border-solid border-r-border table-cell relative py-2 px-[0.6rem] leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:px-3 md:max-lg:leading-[1.375rem]">
                                              <code className="inline py-[0.1rem] px-[0.35rem] rounded-xs bg-color-002 [border-collapse:collapse] [border-spacing:2px] max-lg:py-0.5 max-lg:px-[0.4375rem]">
                                                internal_list_limit
                                              </code>
                                            ...
                                            <tbody className="table-row-group align-middle [border-collapse:collapse] [border-spacing:2px]">
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="version">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-3 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:hidden before:absolute before:inset-y-0 before:left-0 before:w-px before:bg-border after:content-[''] after:hidden after:absolute after:top-4.5 after:left-0 after:h-px after:bg-border">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-45">
                                                    version
                                                  </code>
                                                </td>
                                                <td className="border-r border-solid border-r-border table-cell py-2 px-[0.6rem] leading-[1.3125rem] [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:px-3 md:max-lg:leading-[1.375rem]">
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="status_code">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-3 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:hidden before:absolute before:inset-y-0 before:left-0 before:w-px before:bg-border after:content-[''] after:hidden after:absolute after:top-4.5 after:left-0 after:h-px after:bg-border">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-46">
                                                    status_code
                                                  </code>
                                                </td>
                                                <td className="border-r border-solid border-r-border table-cell py-2 px-[0.6rem] leading-[1.3125rem] [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:px-3 md:max-lg:leading-[1.375rem]">
                                                ...
                                                <td className="table-cell relative py-2 pr-[0.6rem] pl-5 leading-[1.3125rem] [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem]">
                                                  <p className="block max-w-[90%] leading-[1.0625rem] [border-collapse:collapse] [border-spacing:2px] md:max-lg:leading-[1.125rem]">
                                                    ...
                                                    <a className="inline text-primary cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:border-clr-19 hover:text-clr-19 hover:outline-clr-19 hover:[text-decoration-color:var(--clr-19)] focus:border-clr-43 focus:text-clr-43 focus:outline-clr-43 focus:[text-decoration-color:var(--clr-43)]" data-component="link" href="/v3/appendix/errors">
                                                      here
                                                    </a>
                                                    <br className="inline [border-collapse:collapse] [border-spacing:2px]" />
                                                    <strong className="inline font-bold [border-collapse:collapse] [border-spacing:2px]">
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks_count">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-3 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:hidden before:absolute before:inset-y-0 before:left-0 before:w-px before:bg-border after:content-[''] after:hidden after:absolute after:top-4.5 after:left-0 after:h-px after:bg-border">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-26 focus:bg-clr-47">
                                                    tasks_count
                                                  </code>
                                                </td>
                                                <td className="border-r border-solid border-r-border table-cell py-2 px-[0.6rem] leading-[1.3125rem] [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:px-3 md:max-lg:leading-[1.375rem]">
                                                ...
                                                <td className="table-cell relative py-2 pr-[0.6rem] pl-5 leading-[1.3125rem] [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem]">
                                                  <p className="block max-w-[90%] leading-[1.0625rem] [border-collapse:collapse] [border-spacing:2px] md:max-lg:leading-[1.125rem]">
                                                    <em className="inline italic [border-collapse:collapse] [border-spacing:2px]">
                                                      ...
                                                      <strong className="inline font-bold [border-collapse:collapse] [border-spacing:2px]">
                                                        <code className="inline-flex mt-[0.3rem] py-0.5 px-1 rounded-[3px] items-center gap-x-[0.4rem] [word-break:break-word] bg-border cursor-pointer [border-collapse:collapse] [border-spacing:2px] whitespace-nowrap max-lg:mt-1.5 max-lg:gap-x-2 hover:bg-clr-26 focus:bg-clr-48" data-component="badge">
                                                          tasks
                                                        </code>
                                                      </strong>
                                                      {" array"}
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-id">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-6 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[12.1rem] before:left-3 before:w-px before:bg-border max-md:before:right-49 md:max-lg:before:right-[12.6875rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[11.6625rem] after:bottom-[2.1rem] after:left-3 after:w-2 after:h-px after:bg-border max-md:after:right-[11.8125rem] max-md:after:bottom-[3.4rem] md:max-lg:after:right-49 md:max-lg:after:bottom-[2.375rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-46">
                                                    id
                                                  </code>
                                                </td>
                                                ...
                                                <td className="table-cell relative py-2 pr-[0.6rem] pl-5 leading-[1.3125rem] [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem]">
                                                  <p className="block max-w-[90%] leading-[1.0625rem] [border-collapse:collapse] [border-spacing:2px] md:max-lg:leading-[1.125rem]">
                                                    ...
                                                    <strong className="inline font-bold [border-collapse:collapse] [border-spacing:2px]">
                                                      ...
                                                      <a className="inline text-primary cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:border-clr-19 hover:text-clr-19 hover:outline-clr-19 hover:[text-decoration-color:var(--clr-19)] focus:border-clr-39 focus:text-clr-39 focus:outline-clr-39 focus:[text-decoration-color:var(--clr-39)]" data-component="link" href="https://en.wikipedia.org/wiki/Universally_unique_identifier">
                                                        UUID
                                                      </a>
                                                      {" format"}
                                                    </strong>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-status_code">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-6 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[12.1rem] before:left-3 before:w-px before:bg-border max-md:before:right-49 md:max-lg:before:right-[12.6875rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[11.6625rem] after:bottom-[4.2rem] after:left-3 after:w-2 after:h-px after:bg-border max-md:after:right-[11.8125rem] max-md:after:bottom-[5.5rem] md:max-lg:after:right-49 md:max-lg:after:bottom-[4.5625rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-46">
                                                    status_code
                                                  </code>
                                                </td>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-status_message">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-6 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[12.1rem] before:left-3 before:w-px before:bg-border max-md:before:right-49 md:max-lg:before:right-[12.6875rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[11.6625rem] after:bottom-[3.15rem] after:left-3 after:w-2 after:h-px after:bg-border max-md:after:right-[11.8125rem] max-md:after:bottom-[3.4rem] md:max-lg:after:right-49 md:max-lg:after:bottom-[55.5px] 2xl:after:bottom-[2.1rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-46">
                                                    status_message
                                                  </code>
                                                </td>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-time">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-6 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[12.1rem] before:left-3 before:w-px before:h-[2.3125rem] before:bg-border max-md:before:right-49 max-md:before:h-[2.5625rem] md:max-lg:before:right-[12.6875rem] md:max-lg:before:h-[2.6125rem] after:content-[''] after:block after:absolute after:inset-y-4.5 after:right-[11.6625rem] after:left-3 after:w-2 after:h-px after:bg-border max-md:after:right-[11.8125rem] max-md:after:bottom-5.5 md:max-lg:after:right-49 md:max-lg:after:bottom-[1.425rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-45">
                                                    time
                                                  </code>
                                                </td>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result_count">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-6 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[12.1rem] before:left-3 before:w-px before:h-[2.6rem] before:bg-border max-md:before:right-49 max-md:before:h-[2.925rem] md:max-lg:before:right-[12.6875rem] md:max-lg:before:h-12 after:content-[''] after:block after:absolute after:top-4.5 after:right-[11.6625rem] after:bottom-[1.4125rem] after:left-3 after:w-2 after:h-px after:bg-border max-md:after:right-[11.8125rem] max-md:after:bottom-7 md:max-lg:after:right-49 md:max-lg:after:bottom-[1.8rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-26 focus:bg-clr-50">
                                                    result_count
                                                  </code>
                                                </td>
                                                <td className="border-r border-solid border-r-border table-cell py-2 px-[0.6rem] leading-[1.3125rem] [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:px-3 md:max-lg:leading-[1.375rem]">
                                                ...
                                                <td className="table-cell relative py-2 pr-[0.6rem] pl-5 leading-[1.3125rem] [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem]">
                                                  <p className="block max-w-[90%] leading-[1.0625rem] [border-collapse:collapse] [border-spacing:2px] md:max-lg:leading-[1.125rem]">
                                                    <em className="inline italic [border-collapse:collapse] [border-spacing:2px]">
                                                      ...
                                                      <code className="inline-flex mt-[0.3rem] py-0.5 px-1 rounded-[3px] items-center gap-x-[0.4rem] [word-break:break-word] bg-border cursor-pointer [border-collapse:collapse] [border-spacing:2px] max-lg:mt-1.5 max-lg:gap-x-2 hover:bg-clr-26 focus:bg-clr-48" data-component="badge">
                                                        result
                                                      </code>
                                                      {" array"}
                                                    </em>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-path">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-6 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[12.1rem] before:left-3 before:w-px before:h-[2.3125rem] before:bg-border max-md:before:right-49 max-md:before:h-[2.5625rem] md:max-lg:before:right-[12.6875rem] md:max-lg:before:h-[2.6125rem] after:content-[''] after:block after:absolute after:inset-y-4.5 after:right-[11.6625rem] after:left-3 after:w-2 after:h-px after:bg-border max-md:after:right-[11.8125rem] max-md:after:bottom-5.5 md:max-lg:after:right-49 md:max-lg:after:bottom-[1.425rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-47">
                                                    path
                                                  </code>
                                                </td>
                                                <td className="border-r border-solid border-r-border table-cell py-2 px-[0.6rem] leading-[1.3125rem] [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:px-3 md:max-lg:leading-[1.375rem]">
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-data">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-6 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[12.1rem] before:left-3 before:w-px before:h-[3.2875rem] before:bg-border max-md:before:right-49 max-md:before:h-[3.5375rem] md:max-lg:before:right-[12.6875rem] md:max-lg:before:h-[3.5625rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[11.6625rem] after:bottom-[2.1rem] after:left-3 after:w-2 after:h-px after:bg-border max-md:after:right-[11.8125rem] max-md:after:bottom-[2.35rem] md:max-lg:after:right-49 md:max-lg:after:bottom-[2.375rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-45">
                                                    data
                                                  </code>
                                                </td>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-6 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:top-0 before:right-[12.1rem] before:bottom-[18.5px] before:left-3 before:w-px before:h-[18.5px] before:bg-border max-md:before:right-49 max-md:before:bottom-[20.5px] max-md:before:h-[20.5px] md:max-lg:before:right-[12.6875rem] md:max-lg:before:bottom-[1.3125rem] md:max-lg:before:h-[1.3125rem] after:content-[''] after:block after:absolute after:inset-y-4.5 after:right-[11.6625rem] after:left-3 after:w-2 after:h-px after:bg-border max-md:after:right-[11.8125rem] max-md:after:bottom-5.5 md:max-lg:after:right-49 md:max-lg:after:bottom-[1.425rem]">
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-9 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[11.35rem] before:left-6 before:w-px before:bg-border max-md:before:right-46 md:max-lg:before:right-[11.9375rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[10.9125rem] after:bottom-[3.15rem] after:left-6 after:w-2 after:h-px after:bg-border max-md:after:right-[11.0625rem] max-md:after:bottom-[4.45rem] md:max-lg:after:right-46 md:max-lg:after:bottom-[55.5px]">
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-location">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-12 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[10.6rem] before:left-9 before:w-px before:h-[4.3375rem] before:bg-border max-md:before:right-43 max-md:before:h-[4.5875rem] md:max-lg:before:right-[11.1875rem] md:max-lg:before:h-[74.5px] after:content-[''] after:block after:absolute after:top-4.5 after:right-[10.1625rem] after:bottom-[3.15rem] after:left-9 after:w-2 after:h-px after:bg-border max-md:after:right-[10.3125rem] max-md:after:bottom-[3.4rem] md:max-lg:after:right-43 md:max-lg:after:bottom-[55.5px]">
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-location-type">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:h-[2.3125rem] before:bg-border max-md:before:right-40 max-md:before:h-[2.5625rem] md:max-lg:before:right-[10.4375rem] md:max-lg:before:h-[2.6125rem] after:content-[''] after:block after:absolute after:inset-y-4.5 after:right-[9.4125rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-5.5 md:max-lg:after:right-40 md:max-lg:after:bottom-[1.425rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-45">
                                                    type
                                                  </code>
                                                </td>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-location-key">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:bg-border max-md:before:right-40 md:max-lg:before:right-[10.4375rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[2.1rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[3.4rem] md:max-lg:after:right-40 md:max-lg:after:bottom-[2.375rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-47">
                                                    key
                                                  </code>
                                                </td>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-location-mentions">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:bg-border max-md:before:right-40 md:max-lg:before:right-[10.4375rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[3.15rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[4.45rem] md:max-lg:after:right-40 md:max-lg:after:bottom-[55.5px]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-46">
                                                    mentions
                                                  </code>
                                                </td>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-location-ai_search_volume">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:h-[3.2875rem] before:bg-border max-md:before:right-40 max-md:before:h-[3.5375rem] md:max-lg:before:right-[10.4375rem] md:max-lg:before:h-[3.5625rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[2.1rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[2.35rem] md:max-lg:after:right-40 md:max-lg:after:bottom-[2.375rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-45">
                                                    ai_search_volume
                                                  </code>
                                                </td>
                                                ...
                                                <td className="table-cell relative py-2 pr-[0.6rem] pl-5 leading-[1.3125rem] [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem]">
                                                  <p className="block max-w-[90%] leading-[1.0625rem] [border-collapse:collapse] [border-spacing:2px] md:max-lg:leading-[1.125rem]">
                                                    ...
                                                    <a className="inline text-primary cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:border-clr-19 hover:text-clr-19 hover:outline-clr-19 hover:[text-decoration-color:var(--clr-19)] focus:border-clr-51 focus:text-clr-51 focus:outline-clr-51 focus:[text-decoration-color:var(--clr-51)]" data-component="link" href="https://dataforseo.com/help-center/how-the-ai-search-volume-metric-works-in-llm-mentions" rel="noopener noreferrer" target="_blank">
                                                      here
                                                    </a>
                                                  </p>
                                                </td>
                                              </tr>
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-location-impressions">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:top-0 before:right-[9.85rem] before:bottom-[30.7px] before:left-12 before:w-px before:h-[30.7px] before:bg-border max-md:before:right-40 max-md:before:bottom-[33.3px] max-md:before:h-[33.3px] md:max-lg:before:right-[10.4375rem] md:max-lg:before:bottom-[33.5px] md:max-lg:before:h-[33.5px] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[2.65rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[2.975rem] md:max-lg:after:right-40 md:max-lg:after:bottom-12">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-46">
                                                    impressions
                                                  </code>
                                                </td>
                                                ...
                                                <td className="table-cell relative py-2 pr-[0.6rem] pl-5 leading-[1.3125rem] [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem]">
                                                  <p className="block max-w-[90%] leading-[1.0625rem] [border-collapse:collapse] [border-spacing:2px] md:max-lg:leading-[1.125rem]">
                                                    ...
                                                    <br className="inline [border-collapse:collapse] [border-spacing:2px]" />
                                                    {"deprecated field, the value will be "}
                                                    <code className="inline-flex mt-[0.3rem] py-0.5 px-1 rounded-[3px] items-center gap-x-[0.4rem] [word-break:break-word] bg-border cursor-pointer [border-collapse:collapse] [border-spacing:2px] max-lg:mt-1.5 max-lg:gap-x-2 hover:bg-clr-28 focus:bg-clr-52" data-component="badge">
                                                      null
                                                    </code>
                                                  </p>
                                                </td>
                                              </tr>
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-language">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-12 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[10.6rem] before:left-9 before:w-px before:h-[4.3375rem] before:bg-border max-md:before:right-43 max-md:before:h-[4.5875rem] md:max-lg:before:right-[11.1875rem] md:max-lg:before:h-[74.5px] after:content-[''] after:block after:absolute after:top-4.5 after:right-[10.1625rem] after:bottom-[3.15rem] after:left-9 after:w-2 after:h-px after:bg-border max-md:after:right-[10.3125rem] max-md:after:bottom-[3.4rem] md:max-lg:after:right-43 md:max-lg:after:bottom-[55.5px]">
                                                  <button className="w-4.5 h-4.5 border border-solid border-muted-foreground flex absolute left-[1.6875rem] z-1 rounded-[3px] justify-center items-center shrink-0 align-middle text-muted-foreground font-bold leading-3 text-center bg-background cursor-pointer [border-collapse:collapse] [border-spacing:2px] md:max-lg:text-[0.75rem] hover:border-clr-27 focus:border-clr-49" data-component="button" title="Collapse children">
                                                    −
                                                  </button>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-language-type">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:h-[2.3125rem] before:bg-border max-md:before:right-40 max-md:before:h-[2.5625rem] md:max-lg:before:right-[10.4375rem] md:max-lg:before:h-[2.6125rem] after:content-[''] after:block after:absolute after:inset-y-4.5 after:right-[9.4125rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-5.5 md:max-lg:after:right-40 md:max-lg:after:bottom-[1.425rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-26 focus:bg-clr-45">
                                                    type
                                                  </code>
                                                </td>
                                                <td className="border-r border-solid border-r-border table-cell py-2 px-[0.6rem] leading-[1.3125rem] [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:px-3 md:max-lg:leading-[1.375rem]">
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-language-key">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:bg-border max-md:before:right-40 md:max-lg:before:right-[10.4375rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[2.1rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[3.4rem] md:max-lg:after:right-40 md:max-lg:after:bottom-[2.375rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-46">
                                                    key
                                                  </code>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-language-mentions">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:bg-border max-md:before:right-40 md:max-lg:before:right-[10.4375rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[3.15rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[4.45rem] md:max-lg:after:right-40 md:max-lg:after:bottom-[55.5px]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-46">
                                                    mentions
                                                  </code>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-language-ai_search_volume">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:h-[3.2875rem] before:bg-border max-md:before:right-40 max-md:before:h-[3.5375rem] md:max-lg:before:right-[10.4375rem] md:max-lg:before:h-[3.5625rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[2.1rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[2.35rem] md:max-lg:after:right-40 md:max-lg:after:bottom-[2.375rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-45">
                                                    ai_search_volume
                                                  </code>
                                                ...
                                                <td className="table-cell relative py-2 pr-[0.6rem] pl-5 leading-[1.3125rem] [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem]">
                                                  <p className="block max-w-[90%] leading-[1.0625rem] [border-collapse:collapse] [border-spacing:2px] md:max-lg:leading-[1.125rem]">
                                                    ...
                                                    <br className="inline [border-collapse:collapse] [border-spacing:2px]" />
                                                    {"learn more about this metric "}
                                                    <a className="inline text-primary cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:border-clr-19 hover:text-clr-19 hover:outline-clr-19 hover:[text-decoration-color:var(--clr-19)] focus:border-clr-39 focus:text-clr-39 focus:outline-clr-39 focus:[text-decoration-color:var(--clr-39)]" data-component="link" href="https://dataforseo.com/help-center/how-the-ai-search-volume-metric-works-in-llm-mentions" rel="noopener noreferrer" target="_blank">
                                                      here
                                                    </a>
                                                  </p>
                                                </td>
                                              </tr>
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-language-impressions">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:top-0 before:right-[9.85rem] before:bottom-[30.7px] before:left-12 before:w-px before:h-[30.7px] before:bg-border max-md:before:right-40 max-md:before:bottom-[33.3px] max-md:before:h-[33.3px] md:max-lg:before:right-[10.4375rem] md:max-lg:before:bottom-[33.5px] md:max-lg:before:h-[33.5px] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[2.65rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[2.975rem] md:max-lg:after:right-40 md:max-lg:after:bottom-12">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-26">
                                                    impressions
                                                  </code>
                                                </td>
                                                <td className="border-r border-solid border-r-border table-cell py-2 px-[0.6rem] leading-[1.3125rem] [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:px-3 md:max-lg:leading-[1.375rem]">
                                                ...
                                                <td className="table-cell relative py-2 pr-[0.6rem] pl-5 leading-[1.3125rem] [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem]">
                                                  <p className="block max-w-[90%] leading-[1.0625rem] [border-collapse:collapse] [border-spacing:2px] md:max-lg:leading-[1.125rem]">
                                                    ...
                                                    <br className="inline [border-collapse:collapse] [border-spacing:2px]" />
                                                    {"deprecated field, the value will be "}
                                                    <code className="inline-flex mt-[0.3rem] py-0.5 px-1 rounded-[3px] items-center gap-x-[0.4rem] [word-break:break-word] bg-border cursor-pointer [border-collapse:collapse] [border-spacing:2px] max-lg:mt-1.5 max-lg:gap-x-2 hover:bg-clr-26 focus:bg-clr-53" data-component="badge">
                                                      null
                                                    </code>
                                                  </p>
                                                </td>
                                              </tr>
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-platform">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-12 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[10.6rem] before:left-9 before:w-px before:h-[4.3375rem] before:bg-border max-md:before:right-43 max-md:before:h-[4.5875rem] md:max-lg:before:right-[11.1875rem] md:max-lg:before:h-[74.5px] after:content-[''] after:block after:absolute after:top-4.5 after:right-[10.1625rem] after:bottom-[3.15rem] after:left-9 after:w-2 after:h-px after:bg-border max-md:after:right-[10.3125rem] max-md:after:bottom-[3.4rem] md:max-lg:after:right-43 md:max-lg:after:bottom-[55.5px]">
                                                  <button className="w-4.5 h-4.5 border border-solid border-muted-foreground flex absolute left-[1.6875rem] z-1 rounded-[3px] justify-center items-center shrink-0 align-middle text-muted-foreground font-bold leading-3 text-center bg-background cursor-pointer [border-collapse:collapse] [border-spacing:2px] md:max-lg:text-[0.75rem] hover:border-clr-27 focus:border-clr-49" data-component="button" title="Collapse children">
                                                    −
                                                  </button>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-platform-type">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:h-[2.3125rem] before:bg-border max-md:before:right-40 max-md:before:h-[2.5625rem] md:max-lg:before:right-[10.4375rem] md:max-lg:before:h-[2.6125rem] after:content-[''] after:block after:absolute after:inset-y-4.5 after:right-[9.4125rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-5.5 md:max-lg:after:right-40 md:max-lg:after:bottom-[1.425rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-26 focus:bg-clr-47">
                                                    type
                                                  </code>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-platform-key">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:bg-border max-md:before:right-40 md:max-lg:before:right-[10.4375rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[2.1rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[3.4rem] md:max-lg:after:right-40 md:max-lg:after:bottom-[2.375rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-46">
                                                    key
                                                  </code>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-platform-mentions">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:bg-border max-md:before:right-40 md:max-lg:before:right-[10.4375rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[3.15rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[4.45rem] md:max-lg:after:right-40 md:max-lg:after:bottom-[55.5px]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-45">
                                                    mentions
                                                  </code>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-platform-ai_search_volume">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:h-[3.2875rem] before:bg-border max-md:before:right-40 max-md:before:h-[3.5375rem] md:max-lg:before:right-[10.4375rem] md:max-lg:before:h-[3.5625rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[2.1rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[2.35rem] md:max-lg:after:right-40 md:max-lg:after:bottom-[2.375rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-26 focus:bg-clr-50">
                                                    ai_search_volume
                                                  </code>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-platform-impressions">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:top-0 before:right-[9.85rem] before:bottom-[30.7px] before:left-12 before:w-px before:h-[30.7px] before:bg-border max-md:before:right-40 max-md:before:bottom-[33.3px] max-md:before:h-[33.3px] md:max-lg:before:right-[10.4375rem] md:max-lg:before:bottom-[33.5px] md:max-lg:before:h-[33.5px] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[2.65rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[2.975rem] md:max-lg:after:right-40 md:max-lg:after:bottom-12">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-46">
                                                    impressions
                                                  </code>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-sources_domain">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-12 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[10.6rem] before:left-9 before:w-px before:bg-border max-md:before:right-43 md:max-lg:before:right-[11.1875rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[10.1625rem] after:bottom-[5.25rem] after:left-9 after:w-2 after:h-px after:bg-border max-md:after:right-[10.3125rem] max-md:after:bottom-[7.6rem] md:max-lg:after:right-43 md:max-lg:after:bottom-[5.65rem]">
                                                  <button className="w-4.5 h-4.5 border border-solid border-muted-foreground flex absolute left-[1.6875rem] z-1 rounded-[3px] justify-center items-center shrink-0 align-middle text-muted-foreground font-bold leading-3 text-center bg-background cursor-pointer [border-collapse:collapse] [border-spacing:2px] md:max-lg:text-[0.75rem] hover:border-clr-27 focus:border-clr-54" data-component="button" title="Collapse children">
                                                    −
                                                  </button>
                                                  <strong className="inline font-bold [border-collapse:collapse] [border-spacing:2px]">
                                                    <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-45">
                                                ...
                                                <td className="table-cell relative py-2 pr-[0.6rem] pl-5 leading-[1.3125rem] [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem]">
                                                  <p className="block max-w-[90%] leading-[1.0625rem] [border-collapse:collapse] [border-spacing:2px] md:max-lg:leading-[1.125rem]">
                                                    ...
                                                    <a className="inline text-primary cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:border-clr-24 hover:text-clr-24 hover:outline-clr-24 hover:[text-decoration-color:var(--clr-24)] focus:border-clr-39 focus:text-clr-39 focus:outline-clr-39 focus:[text-decoration-color:var(--clr-39)]" data-component="link" href="https://dataforseo.com/help-center/how-to-get-llm-citation-data-with-llm-mentions-api" target="_blank">
                                                      Help Center
                                                    </a>
                                                  </p>
                                                </td>
                                              </tr>
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-sources_domain-type">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:h-[2.3125rem] before:bg-border max-md:before:right-40 max-md:before:h-[2.5625rem] md:max-lg:before:right-[10.4375rem] md:max-lg:before:h-[2.6125rem] after:content-[''] after:block after:absolute after:inset-y-4.5 after:right-[9.4125rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-5.5 md:max-lg:after:right-40 md:max-lg:after:bottom-[1.425rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-46">
                                                    type
                                                  </code>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-sources_domain-key">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:bg-border max-md:before:right-40 md:max-lg:before:right-[10.4375rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[3.15rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[5.5rem] md:max-lg:after:right-40 md:max-lg:after:bottom-[55.5px]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-26 focus:bg-clr-45">
                                                    key
                                                  </code>
                                                </td>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-sources_domain-mentions">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:bg-border max-md:before:right-40 md:max-lg:before:right-[10.4375rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[3.15rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[4.45rem] md:max-lg:after:right-40 md:max-lg:after:bottom-[55.5px]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-45">
                                                    mentions
                                                  </code>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-sources_domain-ai_search_volume">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:h-[3.2875rem] before:bg-border max-md:before:right-40 max-md:before:h-[3.5375rem] md:max-lg:before:right-[10.4375rem] md:max-lg:before:h-[3.5625rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[2.1rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[2.35rem] md:max-lg:after:right-40 md:max-lg:after:bottom-[2.375rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-45">
                                                    ai_search_volume
                                                  </code>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-sources_domain-impressions">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:top-0 before:right-[9.85rem] before:bottom-[30.7px] before:left-12 before:w-px before:h-[30.7px] before:bg-border max-md:before:right-40 max-md:before:bottom-[33.3px] max-md:before:h-[33.3px] md:max-lg:before:right-[10.4375rem] md:max-lg:before:bottom-[33.5px] md:max-lg:before:h-[33.5px] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[2.65rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[2.975rem] md:max-lg:after:right-40 md:max-lg:after:bottom-12">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-45">
                                                    impressions
                                                  </code>
                                                ...
                                                <td className="table-cell relative py-2 pr-[0.6rem] pl-5 leading-[1.3125rem] [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem]">
                                                  <p className="block max-w-[90%] leading-[1.0625rem] [border-collapse:collapse] [border-spacing:2px] md:max-lg:leading-[1.125rem]">
                                                    ...
                                                    <br className="inline [border-collapse:collapse] [border-spacing:2px]" />
                                                    {"deprecated field, the value will be "}
                                                    <code className="inline-flex mt-[0.3rem] py-0.5 px-1 rounded-[3px] items-center gap-x-[0.4rem] [word-break:break-word] bg-border cursor-pointer [border-collapse:collapse] [border-spacing:2px] max-lg:mt-1.5 max-lg:gap-x-2 hover:bg-clr-26" data-component="badge">
                                                      null
                                                    </code>
                                                  </p>
                                                </td>
                                              </tr>
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-search_results_domain">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-12 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[10.6rem] before:left-9 before:w-px before:bg-border max-md:before:right-43 md:max-lg:before:right-[11.1875rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[10.1625rem] after:bottom-[3.15rem] after:left-9 after:w-2 after:h-px after:bg-border max-md:after:right-[10.3125rem] max-md:after:bottom-[5.5rem] md:max-lg:after:right-43 md:max-lg:after:bottom-[55.5px]">
                                                  <button className="w-4.5 h-4.5 border border-solid border-muted-foreground flex absolute left-[1.6875rem] z-1 rounded-[3px] justify-center items-center shrink-0 align-middle text-muted-foreground font-bold leading-3 text-center bg-background cursor-pointer [border-collapse:collapse] [border-spacing:2px] md:max-lg:text-[0.75rem] hover:border-clr-27 focus:border-clr-49" data-component="button" title="Collapse children">
                                                    −
                                                  </button>
                                                  <strong className="inline font-bold [border-collapse:collapse] [border-spacing:2px]">
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-search_results_domain-type">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:h-[2.3125rem] before:bg-border max-md:before:right-40 max-md:before:h-[2.5625rem] md:max-lg:before:right-[10.4375rem] md:max-lg:before:h-[2.6125rem] after:content-[''] after:block after:absolute after:inset-y-4.5 after:right-[9.4125rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-5.5 md:max-lg:after:right-40 md:max-lg:after:bottom-[1.425rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-46">
                                                    type
                                                  </code>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-search_results_domain-key">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:bg-border max-md:before:right-40 md:max-lg:before:right-[10.4375rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[3.15rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[5.5rem] md:max-lg:after:right-40 md:max-lg:after:bottom-[55.5px]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-45">
                                                    key
                                                  </code>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-search_results_domain-mentions">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:bg-border max-md:before:right-40 md:max-lg:before:right-[10.4375rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[3.15rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[4.45rem] md:max-lg:after:right-40 md:max-lg:after:bottom-[55.5px]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-46">
                                                    mentions
                                                  </code>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-search_results_domain-ai_search_volume">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:h-[3.2875rem] before:bg-border max-md:before:right-40 max-md:before:h-[3.5375rem] md:max-lg:before:right-[10.4375rem] md:max-lg:before:h-[3.5625rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[2.1rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[2.35rem] md:max-lg:after:right-40 md:max-lg:after:bottom-[2.375rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-45">
                                                    ai_search_volume
                                                  </code>
                                                ...
                                                <td className="table-cell relative py-2 pr-[0.6rem] pl-5 leading-[1.3125rem] [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem]">
                                                  <p className="block max-w-[90%] leading-[1.0625rem] [border-collapse:collapse] [border-spacing:2px] md:max-lg:leading-[1.125rem]">
                                                    ...
                                                    <br className="inline [border-collapse:collapse] [border-spacing:2px]" />
                                                    {"learn more about this metric "}
                                                    <a className="inline text-primary cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:border-clr-24 hover:text-clr-24 hover:outline-clr-24 hover:[text-decoration-color:var(--clr-24)] focus:border-clr-43 focus:text-clr-43 focus:outline-clr-43 focus:[text-decoration-color:var(--clr-43)]" data-component="link" href="https://dataforseo.com/help-center/how-the-ai-search-volume-metric-works-in-llm-mentions" rel="noopener noreferrer" target="_blank">
                                                      here
                                                    </a>
                                                  </p>
                                                </td>
                                              </tr>
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-search_results_domain-impressions">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:top-0 before:right-[9.85rem] before:bottom-[30.7px] before:left-12 before:w-px before:h-[30.7px] before:bg-border max-md:before:right-40 max-md:before:bottom-[33.3px] max-md:before:h-[33.3px] md:max-lg:before:right-[10.4375rem] md:max-lg:before:bottom-[33.5px] md:max-lg:before:h-[33.5px] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[2.65rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[2.975rem] md:max-lg:after:right-40 md:max-lg:after:bottom-12">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-46">
                                                    impressions
                                                  </code>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-brand_entities_title">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-12 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[10.6rem] before:left-9 before:w-px before:bg-border max-md:before:right-43 md:max-lg:before:right-[11.1875rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[10.1625rem] after:bottom-[3.15rem] after:left-9 after:w-2 after:h-px after:bg-border max-md:after:right-[10.3125rem] max-md:after:bottom-[4.45rem] md:max-lg:after:right-43 md:max-lg:after:bottom-[55.5px]">
                                                  <button className="w-4.5 h-4.5 border border-solid border-muted-foreground flex absolute left-[1.6875rem] z-1 rounded-[3px] justify-center items-center shrink-0 align-middle text-muted-foreground font-bold leading-3 text-center bg-background cursor-pointer [border-collapse:collapse] [border-spacing:2px] md:max-lg:text-[0.75rem] hover:border-clr-27 focus:border-clr-49" data-component="button" title="Collapse children">
                                                    −
                                                  </button>
                                                  <strong className="inline font-bold [border-collapse:collapse] [border-spacing:2px]">
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-brand_entities_title-type">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:h-[2.3125rem] before:bg-border max-md:before:right-40 max-md:before:h-[2.5625rem] md:max-lg:before:right-[10.4375rem] md:max-lg:before:h-[2.6125rem] after:content-[''] after:block after:absolute after:inset-y-4.5 after:right-[9.4125rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-5.5 md:max-lg:after:right-40 md:max-lg:after:bottom-[1.425rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-46">
                                                    type
                                                  </code>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-brand_entities_title-key">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:bg-border max-md:before:right-40 md:max-lg:before:right-[10.4375rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[3.15rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[5.5rem] md:max-lg:after:right-40 md:max-lg:after:bottom-[55.5px]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-45">
                                                    key
                                                  </code>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-brand_entities_title-mentions">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:bg-border max-md:before:right-40 md:max-lg:before:right-[10.4375rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[3.15rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[4.45rem] md:max-lg:after:right-40 md:max-lg:after:bottom-[55.5px]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-46">
                                                    mentions
                                                  </code>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-brand_entities_title-ai_search_volume">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:h-[3.2875rem] before:bg-border max-md:before:right-40 max-md:before:h-[3.5375rem] md:max-lg:before:right-[10.4375rem] md:max-lg:before:h-[3.5625rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[2.1rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[2.35rem] md:max-lg:after:right-40 md:max-lg:after:bottom-[2.375rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-46">
                                                    ai_search_volume
                                                  </code>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-brand_entities_title-impressions">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:top-0 before:right-[9.85rem] before:bottom-[30.7px] before:left-12 before:w-px before:h-[30.7px] before:bg-border max-md:before:right-40 max-md:before:bottom-[33.3px] max-md:before:h-[33.3px] md:max-lg:before:right-[10.4375rem] md:max-lg:before:bottom-[33.5px] md:max-lg:before:h-[33.5px] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[2.65rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[2.975rem] md:max-lg:after:right-40 md:max-lg:after:bottom-12">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-45">
                                                    impressions
                                                  </code>
                                                ...
                                                <td className="table-cell relative py-2 pr-[0.6rem] pl-5 leading-[1.3125rem] [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem]">
                                                  <p className="block max-w-[90%] leading-[1.0625rem] [border-collapse:collapse] [border-spacing:2px] md:max-lg:leading-[1.125rem]">
                                                    ...
                                                    <br className="inline [border-collapse:collapse] [border-spacing:2px]" />
                                                    {"deprecated field, the value will be "}
                                                    <code className="inline-flex mt-[0.3rem] py-0.5 px-1 rounded-[3px] items-center gap-x-[0.4rem] [word-break:break-word] bg-border cursor-pointer [border-collapse:collapse] [border-spacing:2px] max-lg:mt-1.5 max-lg:gap-x-2 hover:bg-clr-26 focus:bg-clr-52" data-component="badge">
                                                      null
                                                    </code>
                                                  </p>
                                                </td>
                                              </tr>
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-brand_entities_category">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-12 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:top-0 before:right-[10.6rem] before:bottom-[34.7px] before:left-9 before:w-px before:bg-border max-md:before:right-43 max-md:before:bottom-[2.8125rem] md:max-lg:before:right-[11.1875rem] md:max-lg:before:bottom-[2.325rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[10.1625rem] after:bottom-[3.15rem] after:left-9 after:w-2 after:h-px after:bg-border max-md:after:right-[10.3125rem] max-md:after:bottom-[4.45rem] md:max-lg:after:right-43 md:max-lg:after:bottom-[55.5px]">
                                                  <button className="w-4.5 h-4.5 border border-solid border-muted-foreground flex absolute left-[1.6875rem] z-1 rounded-[3px] justify-center items-center shrink-0 align-middle text-muted-foreground font-bold leading-3 text-center bg-background cursor-pointer [border-collapse:collapse] [border-spacing:2px] md:max-lg:text-[0.75rem] hover:border-clr-27 focus:border-clr-49" data-component="button" title="Collapse children">
                                                    −
                                                  </button>
                                                  <strong className="inline font-bold [border-collapse:collapse] [border-spacing:2px]">
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-brand_entities_category-type">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:h-[2.3125rem] before:bg-border max-md:before:right-40 max-md:before:h-[2.5625rem] md:max-lg:before:right-[10.4375rem] md:max-lg:before:h-[2.6125rem] after:content-[''] after:block after:absolute after:inset-y-4.5 after:right-[9.4125rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-5.5 md:max-lg:after:right-40 md:max-lg:after:bottom-[1.425rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-47">
                                                    type
                                                  </code>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-brand_entities_category-key">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:bg-border max-md:before:right-40 md:max-lg:before:right-[10.4375rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[3.15rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[5.5rem] md:max-lg:after:right-40 md:max-lg:after:bottom-[4.5625rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-46">
                                                    key
                                                  </code>
                                                </td>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-brand_entities_category-mentions">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:bg-border max-md:before:right-40 md:max-lg:before:right-[10.4375rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[3.15rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[4.45rem] md:max-lg:after:right-40 md:max-lg:after:bottom-[55.5px]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-45">
                                                    mentions
                                                  </code>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-brand_entities_category-ai_search_volume">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:inset-y-0 before:right-[9.85rem] before:left-12 before:w-px before:h-[3.2875rem] before:bg-border max-md:before:right-40 max-md:before:h-[3.5375rem] md:max-lg:before:right-[10.4375rem] md:max-lg:before:h-[3.5625rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[2.1rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[2.35rem] md:max-lg:after:right-40 md:max-lg:after:bottom-[2.375rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-45">
                                                    ai_search_volume
                                                  </code>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-total-brand_entities_category-impressions">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-15 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:top-0 before:right-[9.85rem] before:bottom-[30.7px] before:left-12 before:w-px before:h-[30.7px] before:bg-border max-md:before:right-40 max-md:before:bottom-[33.3px] max-md:before:h-[33.3px] md:max-lg:before:right-[10.4375rem] md:max-lg:before:bottom-[33.5px] md:max-lg:before:h-[33.5px] after:content-[''] after:block after:absolute after:top-4.5 after:right-[9.4125rem] after:bottom-[2.65rem] after:left-12 after:w-2 after:h-px after:bg-border max-md:after:right-[9.5625rem] max-md:after:bottom-[2.975rem] md:max-lg:after:right-40 md:max-lg:after:bottom-12">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-46">
                                                    impressions
                                                  </code>
                                              ...
                                              <tr className="table-row relative align-middle [border-collapse:collapse] [border-spacing:2px]" id="tasks-result-items">
                                                <td className="border-r border-solid border-r-border table-cell relative py-2 pr-[0.6rem] pl-9 leading-[1.3125rem] whitespace-nowrap text-nowrap [border-collapse:collapse] [border-spacing:2px] max-lg:py-2.5 max-lg:pr-3 md:max-lg:leading-[1.375rem] before:content-[''] before:block before:absolute before:top-0 before:right-[11.35rem] before:bottom-[47.5px] before:left-6 before:w-px before:h-[47.5px] before:bg-border max-md:before:right-46 max-md:before:bottom-[3.125rem] max-md:before:h-[3.125rem] md:max-lg:before:right-[11.9375rem] md:max-lg:before:bottom-[3.1875rem] md:max-lg:before:h-[3.1875rem] after:content-[''] after:block after:absolute after:top-4.5 after:right-[10.9125rem] after:bottom-[4.75rem] after:left-6 after:w-2 after:h-px after:bg-border max-md:after:right-[11.0625rem] max-md:after:bottom-[5.075rem] md:max-lg:after:right-46 md:max-lg:after:bottom-[5.1875rem]">
                                                  <code className="inline py-0.5 px-1 rounded-[3px] bg-color-002 cursor-pointer [border-collapse:collapse] [border-spacing:2px] hover:bg-clr-25 focus:bg-clr-46">
                                                    items
                                                  </code>
                                                </td>
                  ...
                  <div className="w-120 h-176 flex sticky top-[7.4375rem] flex-col gap-y-2 overflow-hidden transform-[none] max-md:w-[23.4375rem] max-md:h-203 max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:z-999 max-lg:invisible max-lg:opacity-0 max-lg:min-w-0 max-lg:gap-y-2.5 max-lg:overflow-auto max-lg:bg-background max-md:transform-[matrix(1,0,0,1,0,812)] md:max-lg:w-192 md:max-lg:h-256 md:max-lg:transform-[matrix(1,0,0,1,0,1024)] 2xl:h-[59.4rem] 2xl:top-[4.5625rem]">
                    <div className="w-120 h-full border border-solid border-border flex absolute top-0 left-0 min-w-0 p-[1.2rem] rounded-[12.8px] flex-col flex-1 gap-y-[0.8rem] bg-color-002 max-lg:invisible" id="example-code">
                      <div className="w-[422.9px] flex rounded-md items-center shrink-0 gap-2 overflow-auto bg-color-002 max-lg:invisible">
                        {TextLink_data.map((d, i) => <TextLink key={i} d={d} styles={TextLink_styles[i]} />)}
                        {" "}
                        <button className="h-[2.1rem] border border-solid border-clr-1 hidden min-w-0 px-[1.2rem] rounded-md justify-center items-center text-color-004 text-[0.8125rem] leading-[0.9375rem] text-center cursor-pointer max-lg:h-10.5 max-lg:flex max-md:px-3 max-md:text-xs max-md:leading-[0.875rem] max-lg:rounded-[initial] md:max-lg:px-[0.9375rem]" type="button">
                          <Icon11 />
                          {" "}
                        </button>
                        {" "}
                          ...
                          <div className="h-full block max-h-full pr-[0.4rem] pb-[0.8rem] overflow-auto max-lg:invisible">
                            <div className="h-full block max-lg:invisible">
                              <pre className="block [font-family:monospace,_monospace] whitespace-pre text-nowrap max-lg:invisible">
                                <code className="inline pb-[0.8rem] text-color-004 [font-family:Inter,_sans-serif] text-[0.6875rem] max-lg:invisible">
                                  <div className="block text-color-001 max-lg:invisible">
                                    <div className="block [font-family:Monaco,_Menlo,_'Ubuntu_Mono',_Consolas,_'Source_Code_Pro',_source-code-pro,_'Droid_Sans_Mono',_monospace] text-[0.75rem] whitespace-pre-wrap max-lg:invisible">
                                      ...
                                      <div className="block relative max-lg:invisible">
                                        <span className="inline text-color-003 max-lg:invisible">
                                          login
                                        </span>
                                        <span className="inline text-color-006 max-lg:invisible">
                                          =
                                        </span>
                    ...
                    {" "}
                    <div className="h-full border border-solid border-border flex relative p-[1.2rem] rounded-[12.8px] flex-col flex-1 gap-y-[0.8rem] bg-color-002 transform-[matrix(1,0,0,1,0,704)] max-lg:invisible 2xl:transform-[matrix(1,0,0,1,0,950.391)]">
                          ...
                          <div className="block max-lg:invisible">
                            <div className="block relative rounded-md overflow-hidden text-color-001 [font-family:Monaco,_Menlo,_'Ubuntu_Mono',_Consolas,_'Source_Code_Pro',_source-code-pro,_monospace] text-xs leading-3.5 text-left bg-clr-8 max-lg:invisible" id="ace-json-5">
                              <div className="w-12 h-0 block absolute z-4 overflow-hidden text-muted bg-clr-9 cursor-default max-lg:invisible" aria-hidden="true">
                                <div className="w-12 h-[1e+06px] block relative z-1 overflow-hidden text-right whitespace-pre text-nowrap transform-[matrix(1,0,0,1,0,8)] max-lg:invisible">
                                  <div className="w-12 h-3.5 block absolute left-0 pr-[0.8125rem] pl-[1.1875rem] bg-no-repeat max-lg:invisible" aria-hidden="false">
                                    1
                                    <span className="h-3.5 border border-solid border-clr-1 inline-block -mr-3 ml-px rounded-[3px] align-top [background-position:50%_50%] bg-no-repeat cursor-pointer max-lg:invisible hover:bg-clr-30 hover:border-clr-31 hover:shadow-[var(--clr-32)_0px_1px_1px_0px]" style={{ backgroundImage: "url(data:image/png" }} data-component="button" aria-expanded="true" aria-label="Toggle code folding, rows 1 through 155" role="button" title="Fold code" />
                                  </div>
                                  ...
                                  <div className="w-12 h-3.5 block absolute top-28 left-0 pr-[0.8125rem] pl-[1.1875rem] bg-no-repeat max-lg:invisible" aria-hidden="false">
                                    9
                                    <span className="h-3.5 border border-solid border-clr-1 inline-block -mr-3 ml-px rounded-[3px] align-top [background-position:50%_50%] bg-no-repeat cursor-pointer max-lg:invisible hover:bg-clr-30 hover:border-clr-31 hover:shadow-[var(--clr-32)_0px_1px_1px_0px]" style={{ backgroundImage: "url(data:image/png" }} data-component="button" aria-expanded="true" aria-label="Toggle code folding, rows 9 through 154" role="button" title="Fold code" />
                                  </div>
                                  <div className="w-12 h-3.5 block absolute top-31.5 left-0 pr-[0.8125rem] pl-[1.1875rem] bg-no-repeat max-lg:invisible" aria-hidden="false">
                                    10
                                    <span className="h-3.5 border border-solid border-clr-1 inline-block -mr-3 ml-px rounded-[3px] align-top [background-position:50%_50%] bg-no-repeat cursor-pointer max-lg:invisible hover:bg-clr-30 hover:border-clr-31 hover:shadow-[var(--clr-32)_0px_1px_1px_0px]" style={{ backgroundImage: "url(data:image/png" }} data-component="button" aria-expanded="true" aria-label="Toggle code folding, rows 10 through 153" role="button" title="Fold code" />
                                  </div>
                                  ...
                                  <div className="w-12 h-3.5 block absolute top-56 left-0 pr-[0.8125rem] pl-[1.1875rem] bg-no-repeat max-lg:invisible" aria-hidden="false">
                                    17
                                    <span className="h-3.5 border border-solid border-clr-1 inline-block -mr-3 ml-px rounded-[3px] align-top [background-position:50%_50%] bg-no-repeat cursor-pointer max-lg:invisible hover:bg-clr-30 hover:border-clr-31 hover:shadow-[var(--clr-32)_0px_1px_1px_0px]" style={{ backgroundImage: "url(data:image/png" }} data-component="button" aria-expanded="true" aria-label="Toggle code folding, rows 17 through 23" role="button" title="Fold code" />
                                  </div>
                              ...
                              <div className="w-[24.075rem] h-0 block absolute left-12 overflow-hidden bg-clr-8 cursor-text max-lg:invisible">
                                <div className="w-[24.075rem] h-65.5 block absolute min-w-full transform-[matrix(1,0,0,1,0,8)] max-lg:invisible">
                                  <div className="w-[24.075rem] h-full block absolute top-0 z-1 overflow-hidden whitespace-pre text-nowrap pointer-events-none max-lg:invisible" />
                                  <div className="w-[24.075rem] h-full block absolute top-0 z-1 overflow-hidden whitespace-pre text-nowrap pointer-events-none max-lg:invisible">
                                    <div className="w-[0.45rem] h-3.5 border border-solid border-color-009 block absolute left-1 z-6 -mt-px -ml-px rounded-[3px] pointer-events-none max-lg:invisible" />
                                  </div>
                                  ...
                                  <div className="w-[24.075rem] h-full block absolute top-0 z-1 overflow-hidden whitespace-pre text-nowrap pointer-events-none max-lg:invisible" />
                                  <div className="w-[24.075rem] h-full block absolute top-0 z-4 overflow-hidden whitespace-pre text-nowrap pointer-events-none max-lg:invisible">
                              ...
                              <div className="w-5 h-58.5 block absolute top-0 right-0 z-6 overflow-x-hidden overflow-y-scroll max-lg:invisible">
                                <div className="w-5 h-546.5 block absolute cursor-text max-lg:invisible" />
                              </div>
                            </div>
                            <button className="w-12.5 h-[1.3625rem] block absolute top-[0.55rem] right-[0.55rem] z-10 opacity-70 py-1 px-2.5 rounded-sm text-background text-xs leading-[0.875rem] text-center bg-clr-7 cursor-pointer max-lg:invisible" data-component="button">
                              Copy
                      ...
                      <button className="w-[1.8rem] h-[1.8rem] flex absolute top-18 right-10 z-10 opacity-70 min-w-0 p-[0.4rem] rounded-[4.8px] justify-center items-center text-color-008 leading-[1rem] text-center bg-clr-11 cursor-pointer max-lg:invisible hover:bg-foreground hover:text-clr-33 hover:opacity-[0.998824] hover:outline-clr-33 hover:[text-decoration-color:var(--clr-33)] focus:bg-clr-57 focus:opacity-[0.704979]" data-component="button" title="Toggle fullscreen (Esc to exit)">
                        <Icon12 />
                        {" "}
                      </button>
                      <button className="w-[1.8rem] h-[1.8rem] flex absolute top-18 right-18 z-10 opacity-70 min-w-0 p-[0.4rem] rounded-[4.8px] justify-center items-center text-color-008 leading-[1rem] text-center bg-clr-11 cursor-pointer max-lg:invisible hover:bg-clr-34 hover:text-clr-35 hover:opacity-[0.998818] hover:outline-clr-35 hover:[text-decoration-color:var(--clr-35)] focus:opacity-[0.704979] focus:outline-color-008 focus:[text-decoration-color:var(--color-008)]" data-component="button" title="Search in JSON (Ctrl+F / Cmd+F)">
                        <Icon13 />
                        {" "}
                      </button>
                    </div>
