...
/** Site footer. */
export default function Footer({ listRow5Data = listRow5DataContent } = {}) {
  return (
    <footer className="block pt-12 pb-10 px-4 text-muted-foreground text-xs leading-4.5 md:max-lg:px-10" role="contentinfo">
      ...
      <div className="flex justify-center items-center max-lg:flex-col-reverse max-lg:flex-wrap">
        <div className="flex mx-2 items-center shrink-0">
          <a className="h-6.5 block mr-2 cursor-pointer hover:border-clr-12 hover:text-clr-12 hover:outline-clr-12 hover:[text-decoration-color:var(--clr-12)] hover:underline" data-component="link" aria-label="GitHub Homepage" href="/">
            {" "}
            <Icon43 />
            {" "}
          </a>
