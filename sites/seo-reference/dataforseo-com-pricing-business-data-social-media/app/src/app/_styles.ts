...
export const Tile_styles: TileStyles[] = [
    ...
    { className: "whitespace-nowrap hover:border-background hover:text-background hover:outline-background hover:[text-decoration-color:var(--background)] focus:border-muted focus:outline-muted focus:[text-decoration-color:var(--muted)]" },
    { className: "whitespace-nowrap hover:border-background hover:text-background hover:outline-background hover:[text-decoration-color:var(--background)] focus:border-muted focus:outline-muted focus:[text-decoration-color:var(--muted)]" },
    { className: "hover:border-clr-8 hover:text-clr-8 hover:outline-clr-8 hover:[text-decoration-color:var(--clr-8)] focus:border-clr-14 focus:text-clr-14 focus:outline-clr-14 focus:[text-decoration-color:var(--clr-14)]" }
];
...
export const ListRow5_styles: ListRow5Styles[] = [
    { className: "border-b border-dotted border-b-border", className2: "text-color-001" },
    { className: "border-b border-dotted border-b-border", className2: "text-color-001" },
    { className: "border-b border-dotted border-b-border", className2: "text-color-001" },
    { className: "border-b border-dotted border-b-border", className2: "text-color-001" },
    { className: "border-b border-dotted border-b-border", className2: "text-color-001" },
