          ...
          <div className="box-content block py-[4.0625rem] px-[1.5625rem]">
            <div className="box-content block before:content-['_'] before:table before:w-0 before:h-0 before:text-foreground before:text-sm before:font-medium before:leading-[1.4375rem] after:content-['_'] after:table after:w-0 after:h-0 after:text-foreground after:text-sm after:font-medium after:leading-[1.4375rem]">
              <div className="box-content block -mx-[0.9375rem]">
                <div className="w-[13.125rem] h-[685.3px] min-h-[685.3px] border-r border-solid border-r-color-004 block float-left px-2.5 max-md:w-[22.1875rem] max-md:h-[23.15rem] max-lg:inline-block max-lg:mb-7.5 max-lg:align-top max-lg:text-center max-lg:min-h-0 max-lg:[float:initial] max-lg:pl-0 md:max-lg:w-187 md:max-lg:h-[18.8375rem] 2xl:w-[316.7px] 2xl:h-[662.3px] 2xl:min-h-[662.3px]">
                ...
                {" "}
                <div className="w-[13.125rem] h-[685.3px] min-h-[685.3px] border-r border-solid border-r-color-004 block float-left px-2.5 max-md:w-[22.1875rem] max-lg:h-[620.3px] max-lg:inline-block max-lg:mb-7.5 max-lg:align-top max-lg:text-center max-lg:min-h-0 max-lg:border-r-[0] max-lg:border-initial max-lg:border-r-[initial] max-lg:[float:initial] md:max-lg:w-187 2xl:w-[316.7px] 2xl:h-[662.3px] 2xl:min-h-[662.3px]">
                  <div className="box-content block px-[0.9375rem]">
                ...
                {" "}
                <div className="w-[13.125rem] h-[685.3px] min-h-[685.3px] border-r border-solid border-r-color-004 block float-left px-2.5 max-md:w-[22.1875rem] max-lg:h-[287.1px] max-lg:inline-block max-lg:mb-7.5 max-lg:align-top max-lg:text-center max-lg:min-h-0 max-lg:[float:initial] md:max-lg:w-187 2xl:w-[316.7px] 2xl:h-[662.3px] 2xl:min-h-[662.3px]">
                  <div className="box-content block px-[0.9375rem]">
                ...
                {" "}
                <div className="w-[13.125rem] h-[685.3px] min-h-[685.3px] border-r border-solid border-r-color-004 block float-left px-2.5 max-md:w-[22.1875rem] max-lg:h-[218.1px] max-lg:inline-block max-lg:mb-7.5 max-lg:align-top max-lg:text-center max-lg:min-h-0 max-lg:border-r-[0] max-lg:border-initial max-lg:border-r-[initial] max-lg:[float:initial] md:max-lg:w-187 2xl:w-[316.7px] 2xl:h-[662.3px] 2xl:min-h-[662.3px]">
                  <div className="box-content block px-[0.9375rem]">
                ...
                {" "}
                <div className="w-[13.125rem] h-[685.3px] min-h-[685.3px] border-r border-solid border-r-color-004 block float-left px-2.5 max-md:w-[22.1875rem] max-lg:h-[333.1px] max-lg:inline-block max-lg:mb-7.5 max-lg:align-top max-lg:text-center max-lg:min-h-0 max-lg:[float:initial] md:max-lg:w-187 2xl:w-[316.7px] 2xl:h-[662.3px] 2xl:min-h-[662.3px]">
                  <div className="box-content block px-[0.9375rem]">
