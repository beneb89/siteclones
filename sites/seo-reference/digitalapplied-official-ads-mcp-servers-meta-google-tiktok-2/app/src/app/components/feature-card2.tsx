...
export default function FeatureCard2({ d, styles }: { d: FeatureCard2Data; styles: FeatureCard2Styles }) {
  return (
    <a className={cn("h-[18.35rem] min-h-65 border border-solid border-border flex p-7 rounded-[18px] flex-col gap-3.5 bg-background cursor-pointer hover:border-clr-15 hover:shadow-[var(--clr-0)_0px_0px_0px_0px,var(--clr-0)_0px_0px_0px_0px,var(--clr-0)_0px_0px_0px_0px,var(--clr-0)_0px_0px_0px_0px,var(--clr-16)_0px_20px_40px_-20px]", styles.className)} data-component="link" href={d.href}>
      <span className="border border-solid border-color-005 block py-1 px-2 rounded-md self-start text-primary [font-family:'Geist_Mono',_'Geist_Mono_Fallback',_ui-monospace,_SFMono-Regular,_Menlo,_Monaco,_Consolas,_'Liberation_Mono',_'Courier_New',_monospace] text-[0.6875rem] leading-[1rem] tracking-[1.26px] uppercase bg-color-009">
        AI Development
      </span>
