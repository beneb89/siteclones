...
This is a generated ditto.site clone app for https://about.ads.microsoft.com/en/solutions/technology/agentic-commerce/mcp-server. It is a static Next.js App Router project produced from captured DOM, CSS, assets, metadata, and interaction recipes.
...
`src/app/ditto` contains generated runtime utilities for captured interactions and motion. Current runtime utilities: Accordion, DittoMotion, DittoWire, DropdownMenu. Do not casually rewrite these files; they are plumbing that maps captured recipes to stable `data-ditto-id` anchors in delivered apps.
...
- / - Microsoft MCP Server | Microsoft Advertising
