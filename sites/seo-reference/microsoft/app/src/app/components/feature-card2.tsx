...
export default function FeatureCard2({ d, styles }: { d: FeatureCard2Data; styles: FeatureCard2Styles }) {
  return (
    <uhf-footer-nav-group class={cn("block max-w-[33.3333%] flex-1 max-md:max-w-full", styles.className)}>
      <h2 className={cn("block mb-[0.8125rem] pt-9 text-muted-foreground [font-family:'Segoe_UI',_SegoeUI-regular,_sans-serif] text-[0.9375rem] font-bold leading-[1.1875rem] [overflow-wrap:break-word]", styles.className2)} data-component="heading">
        {d.title}
      </h2>
      {" "}
      <ul className="block mt-3 leading-4 [list-style-type:none] list-outside">
        ...
        <li className="list-item text-muted-foreground">
          <a className="inline-flex [font-family:'Segoe_UI',_SegoeUI-regular,_sans-serif] leading-4.5 [overflow-wrap:break-word] cursor-pointer hover:underline" data-component="link" href={d.href8}>
            {d.label8}
          </a>
        </li>
      </ul>
