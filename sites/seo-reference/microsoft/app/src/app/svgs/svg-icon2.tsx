export default function Icon2() {
  return (
    <svg className="w-[2.5625rem] h-4 block min-w-10 max-w-full mr-1.5 pr-2 overflow-hidden max-lg:w-[2.6875rem] 2xl:w-[2.6875rem] focus:outline-clr-10 focus:[outline-style:auto] focus:outline-[5px]" data-component="icon" height="16" role="img" viewBox="0 0 30 14" width="43" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
      <title>
