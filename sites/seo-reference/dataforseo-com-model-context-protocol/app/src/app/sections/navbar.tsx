...
export default function Navbar({ tileData = tileDataContent, listRowData = listRowDataContent, listRow2Data = ListRow2_data } = {}) {
  return (
    <header className="border-b border-solid border-b-surface block relative z-1000 bg-background">
      ...
      <div className="block">
        <div className="flex relative max-w-320 py-4 px-[2.4rem] justify-between items-center mx-auto max-md:px-4 md:max-lg:px-[1.4375rem] 2xl:px-12">
          <div className="flex items-center">
            <a className="h-8 block text-primary font-semibold cursor-pointer hover:border-clr-18 hover:text-clr-18 hover:outline-clr-18 hover:[text-decoration-color:var(--clr-18)]" data-component="link" href="/">
              {" "}
          ...
          <nav className="w-[36.1875rem] block mr-8 ml-[251.3px] transform-[none] max-md:w-[23.4375rem] max-lg:fixed max-lg:top-25.5 max-lg:bottom-0 max-lg:left-0 max-lg:z-1 max-lg:invisible max-lg:min-w-0 max-lg:p-6 max-lg:shrink-0 max-lg:overflow-x-hidden max-lg:overflow-y-auto max-lg:bg-background max-md:transform-[matrix(1,0,0,1,-375,0)] max-lg:mx-0 md:max-lg:w-192 md:max-lg:transform-[matrix(1,0,0,1,-768,0)] 2xl:ml-[232.1px]" data-component="nav">
            ...
            <div className="hidden max-lg:h-[25.025rem] max-lg:border-t max-lg:border-solid max-lg:border-t-surface max-lg:block max-lg:mt-8 max-lg:pt-8">
              ...
              <ul className="block [list-style-type:none] list-outside max-lg:h-[18.3125rem]" id="menu-top-bar-menu-1">
                <li className="border-b border-solid border-b-surface list-item max-lg:h-[3.0625rem]" id="menu-item-96745">
                  <a className="block py-3 text-color-007 text-[0.9375rem] font-semibold leading-6 cursor-pointer" href="https://docs.dataforseo.com/v3">
                    API Docs
                  </a>
                </li>
                <li className="border-b border-solid border-b-surface grid max-lg:h-[3.0625rem] max-lg:grid-cols-1" id="menu-item-96746">
                  <a className="flex min-w-0 py-3 justify-between items-center text-color-007 text-[0.9375rem] font-semibold leading-6 cursor-pointer max-lg:h-12 after:content-[''] after:block after:w-[0.4375rem] after:h-[0.4375rem] after:-mt-[0.1875rem] after:ml-2 max-lg:after:transform-[matrix(0.707107,0.707107,-0.707107,0.707107,0,0)] max-lg:after:origin-[3.5px_3.5px]" href="/free-seo-stats">
                    Free Tools
                  </a>
                  {" "}
                </li>
                <li className="border-b border-solid border-b-surface grid max-lg:h-[3.0625rem] max-lg:grid-cols-1" id="menu-item-96752">
