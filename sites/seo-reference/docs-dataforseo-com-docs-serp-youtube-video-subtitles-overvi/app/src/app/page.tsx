...
import { MediaLink_styles, TextLink_styles } from "./_styles";
    ...
    <>
      <header className="w-full h-[89.9px] block sticky top-0 z-100 shrink-0 bg-background max-md:h-[92.3px] md:max-lg:h-[5.8rem] 2xl:h-[3.3rem]" id="header">
        <div className="block max-w-384 px-[1.2rem] mx-auto max-md:px-3 md:max-lg:px-[0.9375rem]">
          <div className="flex py-[0.6rem] justify-between items-center">
            {" "}
            <a className="block flex-1 text-primary cursor-pointer hover:border-clr-6 hover:text-clr-6 hover:outline-clr-6 hover:[text-decoration-color:var(--clr-6)] focus:border-clr-15 focus:text-clr-15 focus:outline-clr-15 focus:[text-decoration-color:var(--clr-15)]" data-component="link" aria-current="page" href="/v3/" rel="home">
      ...
      <main className="block grow shrink-0" id="content">
        <div className="block mt-2.5 2xl:mt-2">
          <div className="block max-w-384 px-[1.2rem] mx-auto max-md:px-3 md:max-lg:px-[0.9375rem]">
            <div className="grid items-start gap-x-2.5 grid-cols-1 grid-rows-1 aspect-[0.807] max-md:aspect-[0.147] md:max-lg:aspect-[0.456] 2xl:gap-x-2 2xl:grid-cols-[208px_1281.62px] 2xl:aspect-square">
              ...
              <div className="border border-solid border-border block p-[1.2rem] rounded-[12.8px] bg-border max-md:p-3 max-md:rounded-lg md:max-lg:p-[0.9375rem] md:max-lg:rounded-[10px]">
                <div className="w-full grid items-start gap-x-8 grid-cols-[1fr_480px] grid-rows-1 aspect-[0.801] max-lg:gap-x-10 max-lg:grid-cols-1 max-md:aspect-[0.138] md:max-lg:aspect-[0.445] 2xl:aspect-[0.85]">
                  <div className="block overflow-hidden">
                    <div className="block">
                      <div className="block -mx-[0.9375rem] before:content-['_'] before:table before:w-0 before:h-0 before:text-foreground before:text-sm before:leading-[1.0625rem] md:max-lg:before:text-[0.9375rem] md:max-lg:before:leading-[1.0625rem] after:content-['_'] after:table after:w-0 after:h-0 after:text-foreground after:text-sm after:leading-[1.0625rem] md:max-lg:after:text-[0.9375rem] md:max-lg:after:leading-[1.0625rem]">
                        <div className="h-[93.6875rem] min-h-px block relative float-left max-md:h-590 max-md:[float:initial] md:max-lg:h-[99.175rem] 2xl:h-[91.2375rem]">
                              ...
                              <div className="block mb-[2.1875rem]">
                                <div className="block">
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    {"YouTube Video Subtitles API provides data based on the "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-10 hover:text-clr-10 hover:outline-clr-10 hover:[text-decoration-color:var(--clr-10)] focus:border-clr-17 focus:text-clr-17 focus:outline-clr-17 focus:[text-decoration-color:var(--clr-17)]" data-component="link" href="/v3/serp/youtube/video_subtitles/task_post/" rel="noopener noreferrer" target="_blank">
                                      YouTube Video Subtitles
                                    </a>
                                    {" search engine. We collect detailed information from the watching page about a subtitled text, its language, and duration in the video."}
                                  </p>
                                  {" "}
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    {"The returned results are specific to the indicated video id parameter. You can always check the returned results accessing the "}
                                    ...
                                    {" in the Incognito mode to make sure the received data is entirely relevant. "}
                                  </p>
                                  {" "}
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    ...
                                    {" YouTube SERP API provides results for "}
                                    ...
                                    {" only. You can indicate the following OS that you would like to receive SERP results for when setting a task: Windows, macOS."}
                                    <br className="inline" />
                                    {" "}
                                    <br className="inline" />
                                    ...
                                    {" parameters that show search engine result’s position among the group of elements or across all the elements in SERP respectively. Learn more about the difference between rank absolute and rank group "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-10 hover:text-clr-10 hover:outline-clr-10 hover:[text-decoration-color:var(--clr-10)] focus:border-clr-17 focus:text-clr-17 focus:outline-clr-17 focus:[text-decoration-color:var(--clr-17)]" data-component="link" href="https://dataforseo.com/help-center/rank-absolute-vs-rank-group" rel="noopener noreferrer" target="_blank">
                                      in our help article.
                                    </a>
                                  </p>
                                  {" "}
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    <br className="inline" />
                                    {" "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-10 hover:text-clr-10 hover:outline-clr-10 hover:[text-decoration-color:var(--clr-10)] focus:border-clr-17 focus:text-clr-17 focus:outline-clr-17 focus:[text-decoration-color:var(--clr-17)]" data-component="link" href="/v3/serp/youtube/video_subtitles/live/advanced/" rel="noopener noreferrer" target="_blank">
                                      Youtube Video Subtitles Advanced endpoint
                                    </a>
                                    {" provides data on the specified YouTube video, subtitles, and language."}
                                  </p>
                                  {" "}
                                  <h3 className="block text-base font-bold leading-[1.5625rem] md:max-lg:text-[1.0625rem]" data-component="heading">
                                    Methods
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    ...
                                    {" is the best solution for you. Unlike the Standard method, this method doesn’t require making separate "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-10 hover:text-clr-10 hover:outline-clr-10 hover:[text-decoration-color:var(--clr-10)] focus:border-clr-17 focus:text-clr-17 focus:outline-clr-17 focus:[text-decoration-color:var(--clr-17)]" data-component="link" href="/v3/serp/youtube/video_subtitles/task_post/" rel="noopener noreferrer" target="_blank">
                                      POST
                                    </a>
                                    {" and "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-10 hover:text-clr-10 hover:outline-clr-10 hover:[text-decoration-color:var(--clr-10)] focus:border-clr-17 focus:text-clr-17 focus:outline-clr-17 focus:[text-decoration-color:var(--clr-17)]" data-component="link" href="/v3/serp/youtube/video_subtitles/task_get/advanced/" rel="noopener noreferrer" target="_blank">
                                      GET
                                    </a>
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    ...
                                    <a className="inline text-primary cursor-pointer hover:border-clr-10 hover:text-clr-10 hover:outline-clr-10 hover:[text-decoration-color:var(--clr-10)] focus:border-clr-20 focus:text-clr-20 focus:outline-clr-20 focus:[text-decoration-color:var(--clr-20)]" data-component="link" href="/v3/serp/youtube/video_subtitles/task_post/" rel="noopener noreferrer" target="_blank">
                                      the Standard method
                                    </a>
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    ...
                                    {" for all completed tasks using "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-10 hover:text-clr-10 hover:outline-clr-10 hover:[text-decoration-color:var(--clr-10)] focus:border-clr-20 focus:text-clr-20 focus:outline-clr-20 focus:[text-decoration-color:var(--clr-20)]" data-component="link" href="/v3/serp/youtube/video_subtitles/tasks_ready/" rel="noopener noreferrer" target="_blank">
                                      ‘Tasks Ready’ endpoint,
                                    </a>
                                    {" and then collect the results of each separate task using "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-10 hover:text-clr-10 hover:outline-clr-10 hover:[text-decoration-color:var(--clr-10)] focus:border-clr-20 focus:text-clr-20 focus:outline-clr-20 focus:[text-decoration-color:var(--clr-20)]" data-component="link" href="/v3/serp/youtube/video_subtitles/task_get/advanced/" rel="noopener noreferrer" target="_blank">
                                      ‘Task GET’ endpoint.
                                    </a>
                                  </p>
                                  {" "}
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    {"Learn more about task completion and obtaining a list of completed tasks in "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-10 hover:text-clr-10 hover:outline-clr-10 hover:[text-decoration-color:var(--clr-10)] focus:border-clr-17 focus:text-clr-17 focus:outline-clr-17 focus:[text-decoration-color:var(--clr-17)]" data-component="link" href="https://dataforseo.com/help-center/completed-tasks" rel="noopener noreferrer" target="_blank">
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    ...
                                    <a className="inline text-primary cursor-pointer hover:border-clr-10 hover:text-clr-10 hover:outline-clr-10 hover:[text-decoration-color:var(--clr-10)] focus:border-clr-17 focus:text-clr-17 focus:outline-clr-17 focus:[text-decoration-color:var(--clr-17)]" data-component="link" href="https://dataforseo.com/pricing/serp/youtube-serp-api" rel="noopener noreferrer" target="_blank" title="Pricing">
                                      Pricing
                                    </a>
                                    {" page. To learn more about the cost of all SERP API methods, priorities, and additional parameters, please refer to "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-10 hover:text-clr-10 hover:outline-clr-10 hover:[text-decoration-color:var(--clr-10)] focus:border-clr-17 focus:text-clr-17 focus:outline-clr-17 focus:[text-decoration-color:var(--clr-17)]" data-component="link" href="https://dataforseo.com/help-center/serp-api-cost-explained" rel="noopener noreferrer" target="_blank">
                                      this help article
                                    </a>
                                    .
                                  </p>
                                  ...
                                  <p className="block mt-3 leading-[1.25rem] max-lg:mt-[0.9375rem]">
                                    {"You can test YouTube Video Subtitles API for free using DataForSEO "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-10 hover:text-clr-10 hover:outline-clr-10 hover:[text-decoration-color:var(--clr-10)] focus:border-clr-17 focus:text-clr-17 focus:outline-clr-17 focus:[text-decoration-color:var(--clr-17)]" data-component="link" href="/v3/appendix/sandbox/">
                                      Sandbox.
                                    </a>
                                  </p>
                                  {" "}
