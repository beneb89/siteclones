...
const MediaTile_data: MediaTileData[] = [
    { alt: "fastest", imgSrc: "/assets/cloned/images/f89164c245db.webp", label: "fastest", text: "Real-time results", text2: "YouTube SERP API features a turnaround time of up to 6 seconds" },
...
export default function CostEfficientSolutionSection({ mediaTileData = MediaTile_data } = {}) {
  return (
