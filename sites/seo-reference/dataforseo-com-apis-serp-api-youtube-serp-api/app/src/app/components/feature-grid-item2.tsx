export type FeatureGridItem2Data = {
  variant: string;
  title: string;
  description: string;
  label?: string;
...
export default function FeatureGridItem2({ d }: { d: FeatureGridItem2Data }) {
  switch (d.variant) {
    ...
    case "gui-for-api-usage":
      return (
        <div className="w-[356.7px] h-[17.6375rem] min-h-px block relative float-left m-2.5 py-[1.5625rem] rounded-md [background-size:20%] [background-position:90%_10%] bg-no-repeat shadow-[var(--clr-2)_0px_7px_20px_0px] max-md:w-75 max-md:h-[17.4625rem] max-lg:min-w-75 max-md:[background-size:18%] max-lg:min-h-0 max-md:[float:initial] md:max-lg:w-157.5 md:max-lg:h-52 md:max-lg:[background-size:15%] md:max-lg:[background-position:95%_90%]" style={{ backgroundImage: "url(\"/assets/cloned/images/2691dcc9ac93.png\")" }}>
          <div className="h-full block px-[0.9375rem] text-[1rem] before:content-['_'] before:table before:w-0 before:h-0 before:text-foreground before:text-base before:font-medium before:leading-[1.4375rem] before:text-left after:content-['_'] after:table after:w-0 after:h-0 after:text-foreground after:text-base after:font-medium after:leading-[1.4375rem] after:text-left">
            <div className="box-content h-full block">
              <div className="box-content block">
                <div className="box-content block">
    ...
    case "ad-hoc-integration-and-deployment-support":
      return (
        <div className="w-[356.7px] h-[17.6375rem] min-h-px block relative float-left m-2.5 py-[1.5625rem] rounded-md [background-size:20%] [background-position:90%_10%] bg-no-repeat shadow-[var(--clr-2)_0px_7px_20px_0px] max-md:w-75 max-md:h-[19.0375rem] max-lg:min-w-75 max-md:[background-size:18%] max-lg:min-h-0 max-md:[float:initial] md:max-lg:w-157.5 md:max-lg:h-52 md:max-lg:[background-size:15%] md:max-lg:[background-position:95%_90%]" style={{ backgroundImage: "url(\"/assets/cloned/images/bde5c55a5cfd.png\")" }}>
          <div className="h-full block px-[0.9375rem] text-[1rem] before:content-['_'] before:table before:w-0 before:h-0 before:text-foreground before:text-base before:font-medium before:leading-[1.4375rem] before:text-left after:content-['_'] after:table after:w-0 after:h-0 after:text-foreground after:text-base after:font-medium after:leading-[1.4375rem] after:text-left">
            <div className="box-content h-full block">
              <div className="box-content block">
                <div className="box-content block">
