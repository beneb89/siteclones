...
export const Tile_styles: TileStyles[] = [
    ...
    { className: "whitespace-nowrap after:content-[''] after:block after:w-0 after:h-0 after:mt-0.5 hover:border-background hover:text-background hover:outline-background hover:[text-decoration-color:var(--background)]" },
    { className: "whitespace-nowrap after:content-[''] after:block after:w-0 after:h-0 after:mt-0.5 hover:border-background hover:text-background hover:outline-background hover:[text-decoration-color:var(--background)]" },
    { className: "whitespace-nowrap hover:border-background hover:text-background hover:outline-background hover:[text-decoration-color:var(--background)]" },
    { className: "whitespace-nowrap hover:border-clr-5 hover:text-clr-5 hover:outline-clr-5 hover:[text-decoration-color:var(--clr-5)]" },
    { className: "hover:border-clr-5 hover:text-clr-5 hover:outline-clr-5 hover:[text-decoration-color:var(--clr-5)]" }
];
...
export const ListRow3_styles: ListRow3Styles[] = [
    { className: "border-b border-dotted border-b-surface" },
    { className: "border-b border-dotted border-b-surface" },
    { className: "border-b border-dotted border-b-surface" },
    { className: "border-b border-dotted border-b-surface" },
    { className: "border-b border-dotted border-b-surface" },
...
export const MediaTile2_styles: MediaTile2Styles[] = [
    { className: "md:max-lg:h-15" },
    { className: "md:max-lg:h-[5.1875rem]" },
    { className: "md:max-lg:h-[5.1875rem]" }
];
