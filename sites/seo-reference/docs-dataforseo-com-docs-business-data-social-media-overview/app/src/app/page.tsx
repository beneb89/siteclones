          ...
          <div className="block max-w-384 px-[1.2rem] mx-auto max-md:px-3 md:max-lg:px-[0.9375rem]">
            <div className="grid items-start gap-x-2.5 grid-cols-1 2xl:gap-x-2 2xl:grid-cols-[208px_1281.62px]">
              ...
              <div className="border border-solid border-border block p-[1.2rem] rounded-[12.8px] bg-border max-md:p-3 max-md:rounded-lg md:max-lg:p-[0.9375rem] md:max-lg:rounded-[10px]">
                <div className="w-full grid items-start gap-x-8 grid-cols-[1fr_480px] grid-rows-1 aspect-[3/2] max-lg:gap-x-10 max-lg:grid-cols-1 max-md:aspect-[0.278] md:max-lg:aspect-[0.826] 2xl:aspect-[1.306]">
                  <div className="block overflow-hidden">
                    <div className="block">
                      <div className="block -mx-[0.9375rem] before:content-['_'] before:table before:w-0 before:h-0 before:text-foreground before:text-sm before:leading-[1.0625rem] md:max-lg:before:text-[0.9375rem] md:max-lg:before:leading-[1.0625rem] after:content-['_'] after:table after:w-0 after:h-0 after:text-foreground after:text-sm after:leading-[1.0625rem] md:max-lg:after:text-[0.9375rem] md:max-lg:after:leading-[1.0625rem]">
                        <div className="h-[45.75rem] min-h-px block relative float-left max-md:h-[1062.5px] max-md:[float:initial] md:max-lg:h-[49.0125rem]">
                            ...
                            <div className="block">
                              <div className="block mb-[2.1875rem]">
                                <div className="block">
                                  ...
                                  {" "}
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    {"For now, Social Media API supports only one social media platform — Pinterest. More datasources will be made available in the future. "}
                                  </p>
                                  {" "}
                                  ...
                                  {" "}
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    <a className="inline text-primary cursor-pointer hover:border-clr-10 hover:text-clr-10 hover:outline-clr-10 hover:[text-decoration-color:var(--clr-10)] focus:border-clr-20 focus:text-clr-20 focus:outline-clr-20 focus:[text-decoration-color:var(--clr-20)]" data-component="link" href="/v3/business_data/social_media/pinterest/live/" rel="noopener noreferrer" target="_blank">
                                      This endpoint
                                    </a>
                                    {" provides the number of pins a page received through a "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-10 hover:text-clr-10 hover:outline-clr-10 hover:[text-decoration-color:var(--clr-10)] focus:border-clr-21 focus:text-clr-21 focus:outline-clr-21 focus:[text-decoration-color:var(--clr-21)]" data-component="link" href="https://developers.pinterest.com/docs/widgets/save/?" rel="noopener noreferrer" target="_blank">
                                      Pinterest Save Button embed
                                    </a>
                                    {". "}
                                  </p>
                                  {" "}
                                  ...
                                  {" "}
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    {"The returned results are specific to the URLs passed in the "}
                                  ...
                                  <p className="block mt-3 leading-[1.25rem] max-lg:mt-[0.9375rem]">
                                    ...
                                    <a className="inline text-primary cursor-pointer hover:border-clr-10 hover:text-clr-10 hover:outline-clr-10 hover:[text-decoration-color:var(--clr-10)] focus:border-clr-21 focus:text-clr-21 focus:outline-clr-21 focus:[text-decoration-color:var(--clr-21)]" data-component="link" href="https://dataforseo.com/pricing/business-data/social-media" rel="noopener noreferrer" target="_blank" title="Pricing">
                                      Pricing
                                    </a>
                                    {" page. You can check your spending in your "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-10 hover:text-clr-10 hover:outline-clr-10 hover:[text-decoration-color:var(--clr-10)] focus:border-clr-21 focus:text-clr-21 focus:outline-clr-21 focus:[text-decoration-color:var(--clr-21)]" data-component="link" href="https://app.dataforseo.com/api-access" rel="noopener noreferrer" target="_blank">
                                      account dashboard
                                    </a>
                                    {" or by making a separate call to "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-10 hover:text-clr-10 hover:outline-clr-10 hover:[text-decoration-color:var(--clr-10)] focus:border-clr-21 focus:text-clr-21 focus:outline-clr-21 focus:[text-decoration-color:var(--clr-21)]" data-component="link" href="/v3/appendix/user_data/?php" rel="noopener noreferrer" target="_blank">
