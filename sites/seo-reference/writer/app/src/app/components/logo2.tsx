...
export default function Logo2({ d }: { d: Logo2Data }) {
  return (
    <a className="h-10 block float-left my-0.5 mx-[0.4375rem] align-middle text-[2rem] leading-[2.375rem] cursor-pointer" data-component="link" aria-label={d.ariaLabel} href={d.href} rel="nofollow noopener" target="_blank" title={d.label}>
