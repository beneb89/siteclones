...
export default function HeroSection() {
  return (
    <div className="block mx-auto max-w-3xl">
      ...
      <img className="w-full h-[26.8125rem] block max-w-full mt-8 overflow-clip align-middle max-md:h-[11.4375rem] md:max-lg:h-100.5" data-component="image" alt="Google Ads MCP: The Complete Guide (2026)" src="/assets/cloned/images/77af09183903.png" />
    </div>
  );
}
