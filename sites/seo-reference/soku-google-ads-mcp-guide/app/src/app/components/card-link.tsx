    ...
    <a className="border border-solid border-border flex p-6 rounded-[14px] flex-col overflow-hidden cursor-pointer hover:bg-clr-11 hover:border-clr-12" data-component="link" href={d.href}>
      ...
      <div className="flex justify-between items-start gap-4">
        <div className="block flex-1">
          <span className="border border-solid border-clr-2 inline-flex mb-3 py-0.5 px-2 rounded-[26px] justify-center items-center shrink-0 gap-1 overflow-hidden text-color-003 text-xs font-medium leading-4 whitespace-nowrap text-nowrap bg-surface h-5" data-component="badge">
            {d.label}
          </span>
