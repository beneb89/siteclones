...
import { ListRow8_styles, LogoCloudItem_styles } from "../_styles";
import { listRow7Data as listRow7DataContent, listRow7Data2 as listRow7Data2Content, listRow8Data as listRow8DataContent, listRow7Data3 as listRow7Data3Content, listRow9Data as listRow9DataContent, logos as logosContent } from "../content";
...
/** Site footer. */
export default function Footer2({ mediaTileData = MediaTile_data, listRow7Data = listRow7DataContent, listRow7Data2 = listRow7Data2Content, listRow8Data = listRow8DataContent, listRow7Data3 = listRow7Data3Content, listRow9Data = listRow9DataContent, logos = logosContent } = {}) {
  return (
    <footer className="block pt-20 pb-12 text-muted-foreground bg-clr-10">
      <div className="block px-[2.4rem] max-md:px-4 md:max-lg:px-[1.4375rem] 2xl:px-12">
        <div className="grid grid-cols-[1.2fr_1fr_1fr_1fr_1fr_1fr] max-md:grid-cols-1 md:max-lg:grid-cols-3">
          <div className="border-r border-solid border-r-surface-3 flex pr-6 flex-col gap-6 max-md:border-b max-md:border-b-surface-3 max-md:pb-8 max-md:border-r-[0] max-md:border-initial max-md:border-r-[initial] max-md:pr-0">
            <div className="block mb-5" id="text-3">
              <div className="block">
                <div className="h-6 block" />
                {" "}
                <a className="h-[1.8375rem] inline-block text-background text-sm font-medium leading-[1.375rem] cursor-pointer hover:border-color-002 hover:text-color-002 hover:outline-color-002 hover:[text-decoration-color:var(--color-002)] focus:border-clr-16 focus:text-clr-16 focus:outline-clr-16 focus:[text-decoration-color:var(--clr-16)]" data-component="link" href="/">
                  {" "}
          ...
          {" "}
          <div className="border-r border-solid border-r-surface-3 block px-6 max-md:border-b max-md:border-b-surface-3 max-md:py-8 max-md:border-r-[0] max-md:border-initial max-md:border-r-[initial] max-md:px-0">
          ...
          <div className="border-r border-solid border-r-surface-3 block px-6 max-md:border-b max-md:border-b-surface-3 max-md:py-8 max-md:border-r-[0] max-md:border-initial max-md:border-r-[initial] max-md:px-0">
            <div className="block mb-5" id="text-32">
              ...
              <div className="block">
                <ul className="block [list-style-type:none] list-outside">
                  {listRow9Data.map((d, i) => <ListRow9 key={i} d={d} />)}
                </ul>
                {" "}
              </div>
              {" "}
          ...
          <div className="block pl-6 max-md:pt-8 max-md:pl-0">
              ...
              <div className="block">
                <ul className="block [list-style-type:none] list-outside">
                  <li className="list-item">
                    <a className="inline-block text-background text-sm font-medium leading-[1.375rem] cursor-pointer hover:border-color-002 hover:text-color-002 hover:outline-color-002 hover:[text-decoration-color:var(--color-002)] focus:border-clr-16 focus:text-clr-16 focus:outline-clr-16 focus:[text-decoration-color:var(--clr-16)]" data-component="link" href="/privacy-policy/">
                      Privacy Policy
                    </a>
                  </li>
                  <li className="list-item">
                    <a className="inline-block text-background text-sm font-medium leading-[1.375rem] cursor-pointer hover:border-color-002 hover:text-color-002 hover:outline-color-002 hover:[text-decoration-color:var(--color-002)] focus:border-clr-16 focus:text-clr-16 focus:outline-clr-16 focus:[text-decoration-color:var(--clr-16)]" data-component="link" href="/terms-of-service/">
                      Terms of Services
                    </a>
                  </li>
                </ul>
            ...
            <div className="block mb-5" id="text-37">
              <div className="block">
                <p className="block">
                  <a className="h-17.5 inline-block text-background text-sm font-medium leading-[1.375rem] cursor-pointer hover:border-color-002 hover:text-color-002 hover:outline-color-002 hover:[text-decoration-color:var(--color-002)] focus:border-clr-16 focus:text-clr-16 focus:outline-clr-16 focus:[text-decoration-color:var(--clr-16)]" data-component="link" href="/wp-content/uploads/2021/12/27001_DATAFORSEO-.pdf" rel="noopener" target="_blank">
