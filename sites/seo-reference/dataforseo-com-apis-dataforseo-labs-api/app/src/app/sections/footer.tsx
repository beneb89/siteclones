...
import { ListRow7_meta, ListRow7_meta2, ListRow7_meta3, ListRow7_meta4 } from "../ditto-meta";
import { LogoCloudItem_styles } from "../_styles";
import { listRow7Data as listRow7DataContent, listRow7Data2 as listRow7Data2Content, listRow7Data3 as listRow7Data3Content, listRow7Data4 as listRow7Data4Content, listRow8Data as listRow8DataContent, logos as logosContent } from "../content";
...
/** Site footer. */
export default function Footer({ mediaTile3Data = MediaTile3_data, listRow7Data = listRow7DataContent, listRow7Data2 = listRow7Data2Content, listRow7Data3 = listRow7Data3Content, listRow7Data4 = listRow7Data4Content, listRow8Data = listRow8DataContent, logos = logosContent } = {}) {
  return (
          ...
          <div className="box-content block py-[4.0625rem] px-[1.5625rem]">
            <div className="box-content block before:content-['_'] before:table before:w-0 before:h-0 before:text-foreground before:text-sm before:font-medium before:leading-[1.4375rem] after:content-['_'] after:table after:w-0 after:h-0 after:text-foreground after:text-sm after:font-medium after:leading-[1.4375rem]">
              <div className="box-content block -mx-[0.9375rem]">
                <div className="w-[13.125rem] h-[685.3px] min-h-[685.3px] border-r border-solid border-r-border block float-left px-2.5 max-md:w-[22.1875rem] max-md:h-[23.15rem] max-lg:inline-block max-lg:mb-7.5 max-lg:align-top max-lg:text-center max-lg:min-h-0 max-lg:[float:initial] max-lg:pl-0 md:max-lg:w-187 md:max-lg:h-[18.8375rem] 2xl:w-[316.7px] 2xl:h-[662.3px] 2xl:min-h-[662.3px]">
                  <div className="box-content block px-[0.9375rem]">
                    ...
                    <div className="box-content block mb-5" id="block-5">
                      <ul className="flex flex-wrap items-center gap-3 text-[1.5rem] [list-style-type:none] list-outside max-lg:justify-center">
                        {mediaTile3Data.map((d, i) => <MediaTile3 key={i} d={d} />)}
                      </ul>
                      {" "}
                    </div>
                    {" "}
                ...
                {" "}
                <div className="w-[13.125rem] h-[685.3px] min-h-[685.3px] border-r border-solid border-r-border block float-left px-2.5 max-md:w-[22.1875rem] max-lg:h-[620.3px] max-lg:inline-block max-lg:mb-7.5 max-lg:align-top max-lg:text-center max-lg:min-h-0 max-lg:border-r-[0] max-lg:border-initial max-lg:border-r-[initial] max-lg:[float:initial] md:max-lg:w-187 2xl:w-[316.7px] 2xl:h-[662.3px] 2xl:min-h-[662.3px]">
                  <div className="box-content block px-[0.9375rem]">
                    <div className="box-content block mb-5" id="text-4">
                      ...
                      <div className="box-content block text-muted-foreground">
                        <ul className="box-content block [list-style-type:none] list-outside">
                          {listRow7Data.map((d, i) => <ListRow7 key={i} d={d} meta={ListRow7_meta[i]} />)}
                        </ul>
                      </div>
                      {" "}
                    </div>
                    <div className="box-content block mb-5" id="text-31">
                      ...
                      <div className="box-content block text-muted-foreground">
                        <ul className="box-content block [list-style-type:none] list-outside">
                          {listRow7Data2.map((d, i) => <ListRow7 key={i} d={d} meta={ListRow7_meta2[i]} />)}
                        </ul>
                        {" "}
                      </div>
                      {" "}
                ...
                {" "}
                <div className="w-[13.125rem] h-[685.3px] min-h-[685.3px] border-r border-solid border-r-border block float-left px-2.5 max-md:w-[22.1875rem] max-lg:h-[287.1px] max-lg:inline-block max-lg:mb-7.5 max-lg:align-top max-lg:text-center max-lg:min-h-0 max-lg:[float:initial] md:max-lg:w-187 2xl:w-[316.7px] 2xl:h-[662.3px] 2xl:min-h-[662.3px]">
                  <div className="box-content block px-[0.9375rem]">
                    <div className="box-content block mb-5" id="custom_html-2">
                      ...
                      <div className="box-content block text-muted-foreground">
                        <ul className="box-content block [list-style-type:none] list-outside">
                          {listRow7Data3.map((d, i) => <ListRow7 key={i} d={d} meta={ListRow7_meta3[i]} />)}
                        </ul>
                      </div>
                    </div>
                    {" "}
                ...
                {" "}
                <div className="w-[13.125rem] h-[685.3px] min-h-[685.3px] border-r border-solid border-r-border block float-left px-2.5 max-md:w-[22.1875rem] max-lg:h-[218.1px] max-lg:inline-block max-lg:mb-7.5 max-lg:align-top max-lg:text-center max-lg:min-h-0 max-lg:border-r-[0] max-lg:border-initial max-lg:border-r-[initial] max-lg:[float:initial] md:max-lg:w-187 2xl:w-[316.7px] 2xl:h-[662.3px] 2xl:min-h-[662.3px]">
                  <div className="box-content block px-[0.9375rem]">
                    <div className="box-content block mb-5" id="text-6">
                      ...
                      <div className="box-content block text-muted-foreground">
                        <ul className="box-content block [list-style-type:none] list-outside">
                          {listRow7Data4.map((d, i) => <ListRow7 key={i} d={d} meta={ListRow7_meta4[i]} />)}
                        </ul>
                      </div>
                      {" "}
                    </div>
                ...
                {" "}
                <div className="w-[13.125rem] h-[685.3px] min-h-[685.3px] border-r border-solid border-r-border block float-left px-2.5 max-md:w-[22.1875rem] max-lg:h-[333.1px] max-lg:inline-block max-lg:mb-7.5 max-lg:align-top max-lg:text-center max-lg:min-h-0 max-lg:[float:initial] md:max-lg:w-187 2xl:w-[316.7px] 2xl:h-[662.3px] 2xl:min-h-[662.3px]">
                  <div className="box-content block px-[0.9375rem]">
