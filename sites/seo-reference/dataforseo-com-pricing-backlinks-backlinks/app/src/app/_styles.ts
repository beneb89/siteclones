...
export const Tile_styles: TileStyles[] = [
    { className: "whitespace-nowrap hover:border-background hover:text-background hover:outline-background hover:[text-decoration-color:var(--background)] focus:border-clr-14 focus:text-clr-14 focus:outline-clr-14 focus:[text-decoration-color:var(--clr-14)]" },
    ...
    { className: "whitespace-nowrap after:content-[''] after:block after:w-0 after:h-0 after:mt-0.5 hover:border-clr-8 hover:text-clr-8 hover:outline-clr-8 hover:[text-decoration-color:var(--clr-8)] focus:border-muted focus:outline-muted focus:[text-decoration-color:var(--muted)]" },
...
export const ListRow3_styles: ListRow3Styles[] = [
    { className: "border-b border-dotted border-b-border" },
    { className: "border-b border-dotted border-b-border" },
    { className: "border-b border-dotted border-b-border" },
    { className: "border-b border-dotted border-b-border" },
    { className: "border-b border-dotted border-b-border" },
...
export const ListRow3_styles2: ListRow3Styles[] = [
    { className: "border-b border-dotted border-b-border" },
    { className: "border-b border-dotted border-b-border" },
    { className: "border-b border-dotted border-b-border" },
    { className: "border-b border-dotted border-b-border" },
...
export const ListRow3_styles3: ListRow3Styles[] = [
    { className: "border-b border-dotted border-b-border" },
    { className: "border-b border-dotted border-b-border" },
    { className: "border-b border-dotted border-b-border" },
    {  }
];
export const ListRow3_styles4: ListRow3Styles[] = [
    { className: "border-b border-dotted border-b-border" },
    { className: "border-b border-dotted border-b-border" },
    { className: "border-b border-dotted border-b-border" },
    {  }
];
export const ListRow3_styles5: ListRow3Styles[] = [
    { className: "border-b border-dotted border-b-border" },
    { className: "border-b border-dotted border-b-border" },
    { className: "border-b border-dotted border-b-border" },
    { className: "border-b border-dotted border-b-border" },
...
export const ListRow3_styles6: ListRow3Styles[] = [
    { className: "border-b border-dotted border-b-border" },
    { className: "border-b border-dotted border-b-border" },
    { className: "border-b border-dotted border-b-border" },
    { className: "border-b border-dotted border-b-border" },
...
export const ListRow3_styles7: ListRow3Styles[] = [
    { className: "border-b border-dotted border-b-border" },
    { className: "border-b border-dotted border-b-border" },
    { className: "border-b border-dotted border-b-border" },
    { className: "border-b border-dotted border-b-border" },
