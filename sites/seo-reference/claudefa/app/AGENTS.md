...
This is a generated ditto.site clone app for https://claudefa.st/blog/tools/mcp-extensions/google-ads-mcp-claude-code. It is a static Next.js App Router project produced from captured DOM, CSS, assets, metadata, and interaction recipes.
...
`src/app/ditto` contains generated runtime utilities for captured interactions and motion. Current runtime utilities: Accordion. Do not casually rewrite these files; they are plumbing that maps captured recipes to stable `data-ditto-id` anchors in delivered apps.
...
- / - Google Ads MCP for Claude Code: Run PMax + Search
