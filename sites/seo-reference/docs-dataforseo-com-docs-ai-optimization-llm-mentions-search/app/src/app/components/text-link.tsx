...
export default function TextLink({ d, styles }: { d: TextLinkData; styles: TextLinkStyles }) {
  return (
    <button className={cn("h-[2.1rem] border border-solid flex px-[1.2rem] rounded-md justify-center items-center grow text-color-003 text-[0.8125rem] leading-[0.9375rem] text-center cursor-pointer max-lg:invisible hover:text-clr-30 hover:outline-clr-30 hover:[text-decoration-color:var(--clr-30)] focus:text-clr-56 focus:outline-clr-56 focus:[text-decoration-color:var(--clr-56)]", styles.className)} data-component="button">
      {d.label}
    </button>
  );
}
