...
const Logo_data: LogoData[] = [
    { href: "/surendranb/google-analytics-mcp/discussions", id: "discussions-tab", icon: <>
          <path d="M1.75 1h8.5c.966 0 1.75.784 1.75 1.75v5.5A1.75 1.75 0 0 1 10.25 10H7.061l-2.574 2.573A1.458 1.458 0 0 1 2 11.543V10h-.25A1.75 1.75 0 0 1 0 8.25v-5.5C0 1.784.784 1 1.75 1ZM1.5 2.75v5.5c0 .138.112.25.25.25h1a.75.75 0 0 1 .75.75v2.19l2.72-2.72a.749.749 0 0 1 .53-.22h3.5a.25.25 0 0 0 .25-.25v-5.5a.25.25 0 0 0-.25-.25h-8.5a.25.25 0 0 0-.25.25Zm13 2a.25.25 0 0 0-.25-.25h-.5a.75.75 0 0 1 0-1.5h.5c.966 0 1.75.784 1.75 1.75v5.5A1.75 1.75 0 0 1 14.25 12H14v1.543a1.458 1.458 0 0 1-2.487 1.03L9.22 12.28a.749.749 0 0 1 .326-1.275.749.749 0 0 1 .734.215l2.22 2.22v-2.19a.75.75 0 0 1 .75-.75h1a.25.25 0 0 0 .25-.25Z" />
          </>, label: "Discussions" },
    { href: "/surendranb/google-analytics-mcp/actions", id: "actions-tab", icon: <>
          <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Zm4.879-2.773 4.264 2.559a.25.25 0 0 1 0 .428l-4.264 2.559A.25.25 0 0 1 6 10.559V5.442a.25.25 0 0 1 .379-.215Z" />
          </>, label: "Actions" },
    { href: "/surendranb/google-analytics-mcp/projects", id: "projects-tab", icon: <>
    ...
    <div className="block pt-4 bg-surface" id="repository-container-header">
        ...
        <div className="block min-w-0 max-w-full grow">
          <div className="h-full flex flex-wrap items-center text-xl leading-7.5 [word-break:break-word] max-md:text-lg max-md:leading-[1.6875rem]">
            ...
            <span className="block self-stretch" itemProp="author">
              {" "}
              <a className="inline text-primary cursor-pointer hover:underline" data-component="link" aria-keyshortcuts="Alt+ArrowUp" href="/surendranb" rel="author">
                {" surendranb "}
              </a>
              {" "}
            </span>
            ...
            <strong className="block mr-2 self-stretch font-semibold" itemProp="name">
              {" "}
              <a className="inline text-primary cursor-pointer hover:underline" data-component="link" href="/surendranb/google-analytics-mcp">
        ...
        <div className="block max-w-[70%] shrink-0" id="repository-details-container">
          <ul className="inline py-0.5 shrink-0 [list-style-type:disc] list-outside max-md:hidden">
            <li className="list-item float-left mr-2 text-xs leading-4.5 [list-style-type:none]">
              <a className="h-7 border border-solid border-border inline-block relative py-[0.1875rem] px-3 rounded-md align-middle text-color-004 font-medium leading-5 whitespace-nowrap text-nowrap bg-surface cursor-pointer hover:bg-clr-14" data-component="button" aria-describedby="tooltip-2d64efb5-9c99-47c0-a3f7-00cd7a31942a" aria-label="You must be signed in to change notification settings" href="/login?return_to=%2Fsurendranb%2Fgoogle-analytics-mcp" id="repository-details-watch-button" rel="nofollow">
                {" "}
                <Icon6 />
                {"Notifications "}
              </a>
              {" "}
              <tool-tip class="w-[max-content] h-px hidden absolute top-0 left-0 opacity-0 max-w-80 my-auto py-1 px-2 rounded-md text-background leading-[1.25rem] text-center [overflow-wrap:normal] text-balance bg-color-004 [clip-path:inset(0px_100%_100%_0px)] after:content-[''] after:block after:absolute after:inset-x-0 after:h-1" for="repository-details-watch-button" id="tooltip-2d64efb5-9c99-47c0-a3f7-00cd7a31942a" role="tooltip">
                You must be signed in to change notification settings
              </tool-tip>
              {" "}
            </li>
            <li className="list-item float-left mr-2 text-xs leading-4.5 [list-style-type:none]">
              <a className="h-7 border border-solid border-border inline-block relative py-[0.1875rem] px-3 rounded-md align-middle text-color-004 font-medium leading-5 whitespace-nowrap text-nowrap bg-surface cursor-pointer hover:bg-clr-14" data-component="button" href="/login?return_to=%2Fsurendranb%2Fgoogle-analytics-mcp" id="fork-button" rel="nofollow">
                {" "}
                <Icon7 />
                {"Fork "}
                <span className="border border-solid border-clr-0 inline-block min-w-5 ml-0.5 px-1.5 rounded-3xl align-top leading-4.5 text-center bg-color-001" data-component="badge" id="repo-network-counter" title="47">
                  47
                </span>
                {" "}
              </a>
            ...
            <li className="list-item float-left text-xs leading-4.5 [list-style-type:none]">
              <div className="flex align-middle before:content-[''] before:table before:w-0 before:h-7 max-md:before:w-auto max-md:before:h-auto after:content-[''] after:table after:w-0 after:h-7 max-md:after:w-auto max-md:after:h-auto">
                <a className="h-7 border border-solid border-border block relative py-[0.1875rem] px-3 rounded-md align-middle text-color-004 font-medium leading-5 whitespace-nowrap text-nowrap bg-surface cursor-pointer after:content-['You_must_be_signed_in_to_star_a_repository'] after:hidden after:absolute after:top-full after:right-1/2 after:z-1000000 after:mt-1.5 after:-mr-4 after:py-1 after:px-2 after:text-background after:text-xs after:leading-[1.25rem] after:text-center after:bg-color-004 after:opacity-0 after:rounded-tl-md hover:bg-clr-14" data-component="link" aria-label="You must be signed in to star a repository" href="/login?return_to=%2Fsurendranb%2Fgoogle-analytics-mcp" rel="nofollow">
                  ...
                  {" "}
                  <span className="border border-solid border-clr-0 inline-block min-w-5 ml-0.5 px-1.5 rounded-3xl align-top leading-4.5 text-center bg-color-001" data-component="badge" aria-label="235 users starred this repository" id="repo-stars-counter-star" title="235">
                    235
                  </span>
                  {" "}
                </a>
      ...
      <nav className="min-h-12 flex px-8 justify-between overflow-hidden shadow-[var(--color-003)_0px_-1px_0px_0px_inset] max-md:px-4 md:max-lg:px-6" data-component="nav" aria-label="Repository">
        <ul className="flex items-center gap-2 [list-style-type:none] list-outside">
          ...
          <li className="flex">
            <a className="h-7.5 flex relative px-2 rounded-md items-center leading-7.5 text-center whitespace-nowrap text-nowrap cursor-pointer hover:bg-color-001 hover:border-b-color-003 focus:border-b-color-003" data-component="link" href="/surendranb/google-analytics-mcp/issues" id="issues-tab">
              {" "}
              <Icon10 />
              {" "}
              ...
              {" "}
              <span className="border border-solid border-clr-0 block min-w-5 ml-2 px-1.5 rounded-3xl text-xs font-medium leading-4.5 bg-color-001" id="issues-repo-tab-count" title="6">
                6
              </span>
              {" "}
            </a>
          ...
          <li className="flex">
            <a className="h-7.5 flex relative px-2 rounded-md items-center leading-7.5 text-center whitespace-nowrap text-nowrap cursor-pointer max-md:invisible hover:bg-color-001 hover:border-b-color-003 focus:border-b-color-003" data-component="link" href="/surendranb/google-analytics-mcp/pulls" id="pull-requests-tab">
              {" "}
              <Icon11 />
              {" "}
              ...
              {" "}
              <span className="border border-solid border-clr-0 block min-w-5 ml-2 px-1.5 rounded-3xl text-xs font-medium leading-4.5 bg-color-001 max-md:invisible" id="pull-requests-repo-tab-count" title="4">
                4
              </span>
              {" "}
            </a>
          ...
          <li className="flex">
            <a className="h-7.5 flex relative px-2 rounded-md items-center leading-7.5 text-center whitespace-nowrap text-nowrap cursor-pointer max-lg:invisible hover:bg-color-001 hover:border-b-color-003 focus:border-b-color-003" data-component="link" href="/surendranb/google-analytics-mcp/pulse" id="insights-tab">
              {" "}
              <Icon13 />
              {" "}
        ...
        <div className="w-16 h-8 block absolute right-0 invisible min-w-0 pr-8 self-center max-md:w-12 max-md:pr-4 max-lg:[visibility:inherit] md:max-lg:w-14 md:max-lg:pr-6">
          <action-menu class="block">
            <focus-group class="inline">
              {" "}
              <button className="w-8 h-8 border border-solid border-border inline-grid relative min-w-[max-content] rounded-md justify-center items-center content-center gap-1 grid-cols-[16px] text-muted-foreground font-medium leading-7.5 text-center whitespace-nowrap text-nowrap bg-surface cursor-pointer" aria-controls="action-menu-7889ea3b-f24d-418b-a8a7-348c4f579751-list" aria-haspopup="true" aria-labelledby="tooltip-e29ec5a5-eaf0-46fb-b50b-6f59ef44fe1f" id="action-menu-7889ea3b-f24d-418b-a8a7-348c4f579751-button" type="button">
                {" "}
                <Icon14 />
                {" "}
              </button>
              <tool-tip class="w-[max-content] h-px hidden absolute top-0 left-0 opacity-0 max-w-80 my-auto py-1 px-2 rounded-md text-background text-xs leading-[1.25rem] text-center [overflow-wrap:normal] text-balance bg-color-004 [clip-path:inset(0px_100%_100%_0px)] after:content-[''] after:block after:absolute after:inset-x-0 after:h-1" aria-hidden="true" for="action-menu-7889ea3b-f24d-418b-a8a7-348c4f579751-button" id="tooltip-e29ec5a5-eaf0-46fb-b50b-6f59ef44fe1f" role="tooltip">
