export default function Icon12() {
  return (
    <svg className="w-3.5 h-3.5 block opacity-72 my-[3.5px] shrink-0 align-middle 2xl:hidden focus:outline-clr-18 focus:[outline-style:auto] focus:outline-[5px]" data-component="icon" fill="currentColor" viewBox="0 0 576 512">
