export default function Icon() {
  return (
    <svg className="w-4 h-4 block mt-0.5 mr-3 shrink-0 align-middle text-muted 2xl:hidden focus:outline-clr-18 focus:[outline-style:auto] focus:outline-[5px]" data-component="icon" fill="currentColor" viewBox="0 0 512 512">
