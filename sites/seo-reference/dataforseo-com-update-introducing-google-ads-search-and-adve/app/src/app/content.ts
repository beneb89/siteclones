...
export const listRow3Data: ListRow3DataItem[] = [
    { href: "/updates", label: "All Publications" },
    { href: "/updates/category/announcement", label: "Announcement" },
    { href: "/updates/category/improvement", label: "Improvement" },
    { href: "/updates/category/databases", label: "Databases" },
    { href: "/updates/category/serp-api", label: "SERP API" },
    { href: "/updates/category/keyword-data-api", label: "Keyword Data API" },
    { href: "/updates/category/domain-analytics-api", label: "Domain Analytics API" },
    { href: "/updates/category/dataforseo-labs-api", label: "DataForSEO Labs API" },
    { href: "/updates/category/business-data-api", label: "Business Data API" },
    { href: "/updates/category/merchant-api", label: "Merchant API" },
    { href: "/updates/category/onpage-api", label: "On-Page API" },
    { href: "/updates/category/backlinks-api", label: "Backlinks API" },
    { href: "/updates/category/app-data-api", label: "App Data API" },
    { href: "/updates/category/content-analysis-api", label: "Content Analysis API" },
    { href: "/updates/category/content-generation-api", label: "Content Generation API" },
    { href: "/updates/category/third-party-integrations", label: "Third-Party Integrations" },
    { href: "/updates/category/ai-optimization-api", label: "AI Optimization API" }
];
