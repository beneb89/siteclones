...
export const metadata = {
  ...
  "title": "Meta Ads MCP: The Complete Guide (2026) | Soku",
  "description": "The complete guide to the official Meta Ads MCP — what shipped, the 29 tools, MCP vs CLI, setup and scopes, how it compares to community connectors, the honest…",
  "alternates": {
    "canonical": "/blog/meta-ads-mcp-guide"
  },
  "openGraph": {
    "title": "Meta Ads MCP: The Complete Guide (2026)",
    "description": "The complete guide to the official Meta Ads MCP — what shipped, the 29 tools, MCP vs CLI, setup and scopes, how it compares to community connectors, the honest limits, and the agent operating model that makes it safe to run on spend.",
    "type": "article",
    "siteName": "Soku AI",
    "url": "/blog/meta-ads-mcp-guide",
    "images": [
      "https://cdn.soku.ai/marketing/images/blog/meta-ads-mcp-guide/cover-2.png"
    ]
  },
  "twitter": {
    ...
    <html lang={"en"}>
      <head>
        ...
        <script
          key="ditto-json-ld-3"
          type="application/ld+json"
          dangerouslySetInnerHTML={{ __html: ["{\"@context\":\"https://schema.org\",\"@type\":\"Article\",\"headline\":\"Meta Ads MCP: The Complete Guide (2026)\",\"description\":\"The complete guide to the official Meta Ads MCP — what shipped, the 29 tools, MCP vs CLI, setup and scopes, how it compares to community connectors, the honest limits, and the agent operating model that makes it safe to run on spend.\",\"url\":\"", "/blog/meta-ads-mcp-guide\",\"dateModified\":\"2026-07-24\",\"datePublished\":\"2026-06-08\",\"author\":{\"@type\":\"Person\",\"name\":\"Soku Team\"},\"publisher\":{\"@type\":\"Organization\",\"name\":\"Soku AI\",\"logo\":{\"@type\":\"ImageObject\",\"url\":\"https://cdn.soku.ai/marketing/logo.svg\"}},\"image\":\"https://cdn.soku.ai/marketing/images/blog/meta-ads-mcp-guide/cover-2.png\"}"].join(SITE_ORIGIN) }}
        />
        <script
          key="ditto-json-ld-4"
          type="application/ld+json"
          dangerouslySetInnerHTML={{ __html: ["{\"@context\":\"https://schema.org\",\"@type\":\"BreadcrumbList\",\"itemListElement\":[{\"@type\":\"ListItem\",\"position\":1,\"name\":\"Home\",\"item\":\"", "/\"},{\"@type\":\"ListItem\",\"position\":2,\"name\":\"Blog\",\"item\":\"", "/blog\"},{\"@type\":\"ListItem\",\"position\":3,\"name\":\"AI & Marketing\",\"item\":\"", "/blog?category=ai-marketing\"},{\"@type\":\"ListItem\",\"position\":4,\"name\":\"Meta Ads MCP: The Complete Guide (2026)\"}]}"].join(SITE_ORIGIN) }}
        />
      </head>
