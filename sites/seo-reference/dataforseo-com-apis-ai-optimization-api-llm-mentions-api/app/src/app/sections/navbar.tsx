...
export default function Navbar({ tileData = tileDataContent, listRowData = listRowDataContent, listRow2Data = ListRow2_data } = {}) {
  return (
    <header className="border-b border-solid border-b-border block relative z-1000 bg-background">
      <div className="block text-background text-xs leading-[1.1875rem] bg-clr-0">
        <div className="block max-w-320 px-[2.4rem] mx-auto max-md:px-4 md:max-lg:px-[1.4375rem] 2xl:px-12">
          <div className="h-10 min-h-10 flex justify-between items-center max-lg:justify-center">
            <div className="block">
              <a className="inline-block py-1 px-5 rounded-[20px] text-clr-0 text-[0.8125rem] font-medium leading-[1.3125rem] bg-primary cursor-pointer whitespace-nowrap max-md:px-2.5 hover:transform-[matrix(1.01921,0,0,1.01921,0,0)] focus:outline-clr-0 focus:transform-[matrix(1.00027,0,0,1.00027,0,0)]" data-component="link" href="/apis/ai-optimization-api/llm-mentions-api">
      ...
      <div className="block">
        <div className="flex relative max-w-320 py-4 px-[2.4rem] justify-between items-center mx-auto max-md:px-4 md:max-lg:px-[1.4375rem] 2xl:px-12">
          <div className="flex items-center">
            <a className="h-8 block text-primary font-semibold cursor-pointer hover:text-clr-30 hover:[text-decoration-color:var(--clr-30)] focus:outline-primary" data-component="link" href="/">
              {" "}
              <img className="w-54.5 h-8 block max-w-full overflow-clip aspect-[auto_429/63] align-middle focus:outline-primary" data-component="image" alt="DataForSEO" height="63" src="/assets/cloned/images/5fa9c05c43af.png" width="429" />
              {" "}
            </a>
            {" "}
          </div>
          ...
          <nav className="w-[36.1875rem] block mr-8 ml-[251.3px] transform-[none] max-md:w-[23.4375rem] max-lg:fixed max-lg:top-25.5 max-lg:bottom-0 max-lg:left-0 max-lg:z-1 max-lg:invisible max-lg:min-w-0 max-lg:p-6 max-lg:shrink-0 max-lg:overflow-x-hidden max-lg:overflow-y-auto max-lg:bg-background max-md:transform-[matrix(1,0,0,1,-375,0)] max-lg:mx-0 md:max-lg:w-192 md:max-lg:transform-[matrix(1,0,0,1,-768,0)] 2xl:ml-[232.1px]" data-component="nav">
            ...
            <div className="hidden max-lg:h-[25.025rem] max-lg:border-t max-lg:border-solid max-lg:border-t-border max-lg:block max-lg:mt-8 max-lg:pt-8">
              ...
              <ul className="block [list-style-type:none] list-outside max-lg:h-[18.3125rem]" id="menu-top-bar-menu-1">
                <li className="border-b border-solid border-b-border list-item max-lg:h-[3.0625rem]" id="menu-item-96745">
                  <a className="block py-3 text-color-006 text-[0.9375rem] font-semibold leading-6 cursor-pointer" href="https://docs.dataforseo.com/v3">
                    API Docs
                  </a>
                </li>
                <li className="border-b border-solid border-b-border grid max-lg:h-[3.0625rem] max-lg:grid-cols-1" id="menu-item-96746">
                  <a className="flex min-w-0 py-3 justify-between items-center text-color-006 text-[0.9375rem] font-semibold leading-6 cursor-pointer max-lg:h-12 after:content-[''] after:block after:w-[0.4375rem] after:h-[0.4375rem] after:-mt-[0.1875rem] after:ml-2 max-lg:after:transform-[matrix(0.707107,0.707107,-0.707107,0.707107,0,0)] max-lg:after:origin-[3.5px_3.5px]" href="/free-seo-stats">
                    Free Tools
                  </a>
                  {" "}
                </li>
                <li className="border-b border-solid border-b-border grid max-lg:h-[3.0625rem] max-lg:grid-cols-1" id="menu-item-96752">
          ...
          <div className="flex items-center gap-4 max-lg:hidden">
            <a className="h-[3.15rem] border-2 border-solid border-primary flex relative z-1 py-3 px-6 rounded-sm justify-center items-center gap-[0.4375rem] overflow-hidden text-primary text-sm font-bold leading-[1.375rem] cursor-pointer whitespace-nowrap before:content-[''] before:block before:absolute before:inset-y-0 before:inset-x-[59.5px] before:-z-1 before:w-0 before:h-[2.9rem] before:bg-primary before:opacity-0 before: before:origin-[0px_23.1953px] max-lg:before:left-1/2 max-lg:before:h-full max-lg:before:right-auto max-lg:before:bottom-auto max-lg:before:transform-[none] max-lg:before:origin-[initial] hover:text-clr-31 hover:[text-decoration-color:var(--clr-31)] focus:text-clr-47 focus:outline-clr-47 focus:[text-decoration-color:var(--clr-47)]" data-ditto-id="style-button" data-component="button" href="https://app.dataforseo.com/register">
              Try for free
            </a>
          </div>
          {" "}
          <button className="w-10 h-10 hidden relative z-2 min-w-0 rounded-[7px] flex-col justify-center items-center shrink-0 gap-[0.4375rem] text-muted text-sm font-medium leading-[1.375rem] text-center cursor-pointer max-lg:flex max-md:ml-[85.1px] md:max-lg:ml-[29rem]">
