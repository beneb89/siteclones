export default function Icon() {
  return (
    <svg className="w-auto h-4 block shrink-0 overflow-hidden align-middle pointer-events-none" data-component="icon" height="20" viewBox="0 0 16 16" width="20" strokeLinejoin="round" fill="currentColor">
