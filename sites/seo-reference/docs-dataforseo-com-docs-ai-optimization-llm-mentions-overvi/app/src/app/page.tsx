    ...
    <>
      ...
      <main className="block grow shrink-0" id="content">
        <div className="block mt-2.5 2xl:mt-2">
          <div className="block max-w-384 px-[1.2rem] mx-auto max-md:px-3 md:max-lg:px-[0.9375rem]">
            <div className="grid items-start gap-x-2.5 grid-cols-1 grid-rows-1 aspect-[1.668] max-md:aspect-[0.365] md:max-lg:aspect-[1.044] 2xl:gap-x-2 2xl:grid-cols-[208px_1281.62px] 2xl:aspect-[3/2]">
              ...
              <div className="border border-solid border-border block p-[1.2rem] rounded-[12.8px] bg-border max-md:p-3 max-md:rounded-lg md:max-lg:p-[0.9375rem] md:max-lg:rounded-[10px]">
                <div className="w-full grid items-start gap-x-8 grid-cols-[1fr_480px] grid-rows-1 aspect-[1.706] max-lg:gap-x-10 max-lg:grid-cols-1 max-md:aspect-[0.347] md:max-lg:aspect-[1.046] 2xl:aspect-[1.306]">
                  <div className="block overflow-hidden">
                    <div className="block">
                      <div className="block -mx-[0.9375rem] before:content-['_'] before:table before:w-0 before:h-0 before:text-foreground before:text-sm before:leading-[1.0625rem] md:max-lg:before:text-[0.9375rem] md:max-lg:before:leading-[1.0625rem] after:content-['_'] after:table after:w-0 after:h-0 after:text-foreground after:text-sm after:leading-[1.0625rem] md:max-lg:after:text-[0.9375rem] md:max-lg:after:leading-[1.0625rem]">
                        <div className="h-[41.0625rem] min-h-px block relative float-left max-md:h-[58.4875rem] max-md:[float:initial] md:max-lg:h-[675.5px] 2xl:h-[39.8375rem]">
                              ...
                              <div className="block mb-[2.1875rem]">
                                <div className="block">
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    ...
                                    <a className="inline text-primary cursor-pointer hover:border-clr-10 hover:text-clr-10 hover:outline-clr-10 hover:[text-decoration-color:var(--clr-10)] focus:border-clr-18 focus:text-clr-18 focus:outline-clr-18 focus:[text-decoration-color:var(--clr-18)]" data-component="link" href="https://dataforseo.com/help-center/category/ai-optimization-api" rel="noopener noreferrer" target="_blank">
                                  ...
                                  <p className="block my-3 leading-[1.25rem] max-lg:my-[0.9375rem]">
                                    ...
                                    <a className="inline text-primary cursor-pointer hover:border-clr-10 hover:text-clr-10 hover:outline-clr-10 hover:[text-decoration-color:var(--clr-10)] focus:border-clr-18 focus:text-clr-18 focus:outline-clr-18 focus:[text-decoration-color:var(--clr-18)]" data-component="link" href="https://dataforseo.com/pricing/ai-optimization/llm-mentions" rel="noopener noreferrer" target="_blank" title="Pricing">
                                      Pricing
                                    </a>
                                    {" page. You can check your spending in your "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-10 hover:text-clr-10 hover:outline-clr-10 hover:[text-decoration-color:var(--clr-10)] focus:border-clr-18 focus:text-clr-18 focus:outline-clr-18 focus:[text-decoration-color:var(--clr-18)]" data-component="link" href="https://app.dataforseo.com/api-access" rel="noopener noreferrer" target="_blank">
                                      account dashboard
                                    </a>
                                    {" or by making a separate call to "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-10 hover:text-clr-10 hover:outline-clr-10 hover:[text-decoration-color:var(--clr-10)] focus:border-clr-18 focus:text-clr-18 focus:outline-clr-18 focus:[text-decoration-color:var(--clr-18)]" data-component="link" href="/v3/appendix/user_data/?php" rel="noopener noreferrer" target="_blank">
                                      the User Data endpoint
                                    </a>
                                  </p>
                                  {" "}
                                  <p className="block mt-3 leading-[1.25rem] max-lg:mt-[0.9375rem]">
                                    {"You can test LLM Mentions API for free using DataForSEO "}
                                    <a className="inline text-primary cursor-pointer hover:border-clr-10 hover:text-clr-10 hover:outline-clr-10 hover:[text-decoration-color:var(--clr-10)] focus:border-clr-21 focus:text-clr-21 focus:outline-clr-21 focus:[text-decoration-color:var(--clr-21)]" data-component="link" href="/v3/appendix/sandbox/">
                                      Sandbox.
                                    </a>
                                  </p>
                                  {" "}
